/*
 ...
 License: MIT
*/
(function(G){'use strict';function O(a){return function(){var b=arguments[0],d;d="["+(a?a+":":"")+b+"] http://errors.angularjs.org/1.5.7-build.4884+sha.458ac0b/"+(a?a+"/":"")+b;for(b=1;b<arguments.length;b++){d=d+(1==b?"?":"&")+"p"+(b-1)+"=";var c=encodeURIComponent,e;e=arguments[b];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;d+=c(e)}return Error(d)}}function oa(a){if(null==a||Va(a))return!1;if(K(a)||H(a)||
...
!K(b)&&I(b)&&r(b,function(a,c){var d=a.match(l);a.substring(d[0].length)||(b[c]=d[0]+c)});return b}var f={},g=/^\s*directive\:\s*([\w\-]+)\s+(.*)$/,h=/(([\w\-]+)(?:\:([^;]+))?;?)/,k=ce("ngSrc,ngSrcset,src,srcset"),l=/^(?:(\^\^?)?(\?)?(\^\^?)?)?/,m=/^(on[a-z]+|formaction)$/,n=S();this.directive=function w(b,d){Oa(b,"directive");H(b)?(c(b),sb(d,"directiveFactory"),f.hasOwnProperty(b)||(f[b]=[],a.factory(b+"Directive",["$injector","$exceptionHandler",function(a,c){var d=[];r(f[b],function(f,g){try{var h=
...
h.push(a)}if(b){c&&(b=O(b,c,d));b.require=v.require;b.directiveName=N;if(q===v||v.$$isolateScope)b=fa(b,{isolateScope:!0});k.push(b)}}function p(a,e,f,g,l){function m(a,b,c,d){var e;Ya(a)||(d=c,c=b,b=a,a=void 0);U&&(e=w);c||(c=U?N.parent():N);if(d){var f=l.$$slots[d];if(f)return f(a,b,e,c,s);if(y(f))throw ea("noslot",d,va(N));}else return l(a,b,e,c,s)}var u,v,t,E,z,w,L,N;b===f?(g=d,N=d.$$element):(N=F(f),g=new Qa(N,d));z=e;q?E=e.$new(!0):n&&(z=e.$parent);l&&(L=m,L.$$boundTransclude=l,L.isSlotFilled=
...
A=0,G=a.length;A<G;A++){v=a[A];var H=v.$$start,Ra=v.$$end;H&&(w=Zc(b,H,Ra));L=void 0;if(u>v.priority)break;if(x=v.scope)v.templateUrl||(I(x)?(V("new/isolated scope",q||n,v,w),q=v):V("new/isolated scope",q,v,w)),n=n||v;N=v.name;if(!Ca&&(v.replace&&(v.templateUrl||v.template)||v.transclude&&!v.$$tlb)){for(x=A+1;Ca=a[x++];)if(Ca.transclude&&!Ca.$$tlb||Ca.replace&&(Ca.templateUrl||Ca.template)){wa=!0;break}Ca=!0}!v.templateUrl&&v.controller&&(x=v.controller,C=C||S(),V("'"+N+"' controller",C[N],v,w),C[N]=
...
n,b.html(e);a.unshift(q);m=Ra(a,u,c,f,b,C,g,h,k);r(d,function(a,c){a===u&&(d[c]=b[0])});for(p=s(b[0].childNodes,f);l.length;){e=l.shift();D=l.shift();var w=l.shift(),z=l.shift(),E=b[0];if(!e.$$destroyed){if(D!==n){var J=D.className;k.hasElementTranscludeDirective&&C.replace||(E=Xb(u));ca(w,F(D),E);ja(F(E),J)}D=m.transcludeOnThisElement?wa(e,m.transclude,z):z;m(p,e,E,d,D)}}l=null}).catch(A);return function(a,b,c,d,e){a=e;b.$$destroyed||(l?l.push(b,c,d,a):(m.transcludeOnThisElement&&(a=wa(b,m.transclude,
...
rb=function(){if(x(rb.name_))return rb.name_;var a,b,d=La.length,c,e;for(b=0;b<d;++b)if(c=La[b],a=G.document.querySelector("["+c.replace(":","\\:")+"jq]")){e=a.getAttribute(c+"jq");break}return rb.name_=e},de=/:/g,La=["ng-","data-ng-","ng:","x-ng-"],ie=/[A-Z]/g,Ec=!1,cb=3,ne={full:"1.5.7-build.4884+sha.458ac0b",major:1,minor:5,dot:7,codeName:"snapshot"};T.expando="ng339";var gb=T.cache={},Qf=1;T._data=function(a){return this.cache[a[this.expando]]||{}};var Lf=/([\:\-\_]+(.))/g,Mf=/^moz([A-Z])/,yb=
...
b){T.prototype[b]=function(b,c,e){for(var f,g=0,h=this.length;g<h;g++)y(f)?(f=a(this[g],b,c,e),x(f)&&(f=F(f))):Qc(f,a(this[g],b,c,e));return x(f)?f:this};T.prototype.bind=T.prototype.on;T.prototype.unbind=T.prototype.off});Pa.prototype={put:function(a,b){this[Fa(a,this.nextUid)]=b},get:function(a){return this[Fa(a,this.nextUid)]},remove:function(a){var b=this[a=Fa(a,this.nextUid)];delete this[a];return b}};var Jf=[function(){this.$get=[function(){return Pa}]}],Xf=/^([^\(]+?)=>/,Yf=/^[^\(]*\(\s*([^\)]*)\)/m,
Fg=/,/,Gg=/^\s*(_?)(\S+?)\1\s*$/,Wf=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Ga=O("$injector");db.$$annotate=function(a,b,d){var c;if("function"===typeof a){if(!(c=a.$inject)){c=[];if(a.length){if(b)throw H(d)&&d||(d=a.name||Zf(a)),Ga("strictdi",d);b=Wc(a);r(b[1].split(Fg),function(a){a.replace(Gg,function(a,b,d){c.push(d)})})}a.$inject=c}}else K(a)?(b=a.length-1,Na(a[b],"fn"),c=a.slice(0,b)):Na(a,"fn",!0);return c};var Sd=O("$animate"),af=function(){this.$get=A},bf=function(){var a=new Pa,b=[];this.$get=
...
d.ngSwitchWhen]=c.cases["!"+d.ngSwitchWhen]||[];c.cases["!"+d.ngSwitchWhen].push({transclude:e,element:b})}}),Pe=Ta({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,b,d,c,e){c.cases["?"]=c.cases["?"]||[];c.cases["?"].push({transclude:e,element:b})}}),Ug=O("ngTransclude"),Re=["$compile",function(a){return{restrict:"EAC",terminal:!0,link:function(b,d,c,e,f){c.ngTransclude===c.$attr.ngTransclude&&(c.ngTransclude="");if(!f)throw Ug("orphan",va(d));f(function(c,e){c.length?
(d.empty(),d.append(c)):(a(d.contents())(b),e.$destroy())},null,c.ngTransclude||c.ngTranscludeSlot)}}}],re=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(b,d){"text/ng-template"===d.type&&a.put(d.id,b[0].text)}}}],Vg={$setViewValue:A,$render:A},Wg=["$element","$scope",function(a,b){var d=this,c=new Pa;d.ngModelCtrl=Vg;d.unknownOption=F(G.document.createElement("option"));d.renderUnknownOption=function(b){b="? "+Fa(b)+" ?";d.unknownOption.val(b);a.prepend(d.unknownOption);
a.val(b)};b.$on("$destroy",function(){d.renderUnknownOption=A});d.removeUnknownOption=function(){d.unknownOption.parent()&&d.unknownOption.remove()};d.readValue=function(){d.removeUnknownOption();return a.val()};d.writeValue=function(b){d.hasOption(b)?(d.removeUnknownOption(),a.val(b),""===b&&d.emptyOption.prop("selected",!0)):null==b&&d.emptyOption?(d.removeUnknownOption(),a.val("")):d.renderUnknownOption(b)};d.addOption=function(a,b){if(8!==b[0].nodeType){Oa(a,'"option value"');""===a&&(d.emptyOption=
b);var g=c.get(a)||0;c.put(a,g+1);d.ngModelCtrl.$render()}};d.removeOption=function(a){var b=c.get(a);b&&(1===b?(c.remove(a),""===a&&(d.emptyOption=void 0)):c.put(a,b-1))};d.hasOption=function(a){return!!c.get(a)};d.registerOption=function(a,b,c,h,k){if(h){var l;c.$observe("value",function(a){x(l)&&d.removeOption(l);l=a;d.addOption(a,b)})}else k?a.$watch(k,function(a,e){c.$set("value",a);e!==a&&d.removeOption(e);d.addOption(a,b)}):d.addOption(c.value,b);b.on("$destroy",function(){d.removeOption(c.value);
d.ngModelCtrl.$render()})}}],se=function(){return{restrict:"E",require:["select","?ngModel"],controller:Wg,priority:1,link:{pre:function(a,b,d,c){var e=c[1];if(e){var f=c[0];f.ngModelCtrl=e;b.on("change",function(){a.$apply(function(){e.$setViewValue(f.readValue())})});if(d.multiple){f.readValue=function(){var a=[];r(b.find("option"),function(b){b.selected&&a.push(b.value)});return a};f.writeValue=function(a){var c=new Pa(a);r(b.find("option"),function(a){a.selected=x(c.get(a.value))})};var g,h=NaN;
...
F(G.document).ready(function(){fe(G.document,Cc)}))})(window);!window.angular.$$csp().noInlineStyle&&window.angular.element(document.head).prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>');
