/*
 ...
 License: MIT
*/
(function(P,Y,s){'use strict';function Q(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.0-build.3179+sha.0f806d9/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function eb(b){if(null==b||Sa(b))return!1;var a=b.length;
...
a.push(c);return a.sort()}function ld(b,a,c){for(var d=bc(b),e=0;e<d.length;e++)a.call(c,b[d[e]],d[e]);return d}function cc(b){return function(a,c){b(c,a)}}function md(){return++fb}function dc(b,a){a?b.$$hashKey=a:delete b.$$hashKey}function B(b){var a=b.$$hashKey;r(arguments,function(a){a!==b&&r(a,function(a,c){b[c]=a})});dc(b,a);return b}function V(b){return parseInt(b,10)}function ec(b,a){return B(new (B(function(){},{prototype:b})),a)}function y(){}function Fa(b){return b}function fa(b){return function(){return b}}
...
b.find))}function od(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function pa(b){return K(b.nodeName||b[0].nodeName)}function pd(b,a,c){var d=[];r(b,function(b,f,g){d.push(a.call(c,b,f,g))});return d}function Ca(b,a){if(b.indexOf)return b.indexOf(a);for(var c=0;c<b.length;c++)if(a===b[c])return c;return-1}function Ia(b,a){var c=Ca(b,a);0<=c&&b.splice(c,1);return a}function Ja(b,a,c,d){if(Sa(b)||Ta(b))throw Ua("cpws");if(a){if(b===a)throw Ua("cpi");c=c||[];d=d||[];if(S(b)){var e=
Ca(c,b);if(-1!==e)return d[e];c.push(b);d.push(a)}if(H(b))for(var f=a.length=0;f<b.length;f++)e=Ja(b[f],null,c,d),S(b[f])&&(c.push(b[f]),d.push(e)),a.push(e);else{var g=a.$$hashKey;H(a)?a.length=0:r(a,function(c,b){delete a[b]});for(f in b)b.hasOwnProperty(f)&&(e=Ja(b[f],null,c,d),S(b[f])&&(c.push(b[f]),d.push(e)),a[f]=e);dc(a,g)}}else if(a=b)H(b)?a=Ja(b,[],c,d):ia(b)?a=new Date(b.getTime()):gb(b)?(a=new RegExp(b.source,b.toString().match(/[^\/]*$/)[0]),a.lastIndex=b.lastIndex):S(b)&&(e=Object.create(Object.getPrototypeOf(b)),
...
(a[b]=c())}var c=Q("$injector"),d=Q("ng");b=a(b,"angular",Object);b.$$minErr=b.$$minErr||Q;return a(b,"module",function(){var b={};return function(f,g,h){if("hasOwnProperty"===f)throw d("badname","module");g&&b.hasOwnProperty(f)&&(b[f]=null);return a(b,f,function(){function a(c,d,e,f){f||(f=b);return function(){f[e||"push"]([c,d,arguments]);return q}}if(!g)throw c("nomod",f);var b=[],d=[],e=[],k=a("$injector","invoke","push",d),q={_invokeQueue:b,_configBlocks:d,_runBlocks:e,requires:g,name:f,provider:a("$provide",
"provider"),factory:a("$provide","factory"),service:a("$provide","service"),value:a("$provide","value"),constant:a("$provide","constant","unshift"),animation:a("$animateProvider","register"),filter:a("$filterProvider","register"),controller:a("$controllerProvider","register"),directive:a("$compileProvider","directive"),config:k,run:function(a){e.push(a);return this}};h&&k(h);return q})}})}function yd(b){B(b,{bootstrap:jc,copy:Ja,extend:B,equals:ra,element:x,forEach:r,injector:Hb,noop:y,bind:fc,toJson:sa,
...
f[e[1]].apply(f,e[2])}}if(!l.get(a)){l.put(a,!0);try{D(a)?(c=Ya(a),b=b.concat(f(c.requires)).concat(c._runBlocks),d(c._invokeQueue),d(c._configBlocks)):E(a)?b.push(p.invoke(a)):H(a)?b.push(p.invoke(a)):kb(a,"module")}catch(e){throw H(a)&&(a=a[a.length-1]),e.message&&e.stack&&-1==e.stack.indexOf(e.message)&&(e=e.message+"\n"+e.stack),Na("modulerr",a,e.stack||e.message||e);}}});return b}function g(b,c){function d(a){if(b.hasOwnProperty(a)){if(b[a]===h)throw Na("cdep",a+" <- "+m.join(" <- "));return b[a]}try{return m.unshift(a),
b[a]=h,b[a]=c(a)}catch(e){throw b[a]===h&&delete b[a],e;}finally{m.shift()}}function e(b,c,f,h){"string"===typeof f&&(h=f,f=null);var g=[];h=Rb(b,a,h);var m,k,l;k=0;for(m=h.length;k<m;k++){l=h[k];if("string"!==typeof l)throw Na("itkn",l);g.push(f&&f.hasOwnProperty(l)?f[l]:d(l))}H(b)&&(b=b[m]);return b.apply(c,g)}return{invoke:e,instantiate:function(a,b,c){var d=function(){};d.prototype=(H(a)?a[a.length-1]:a).prototype;d=new d;a=e(a,d,b,c);return S(a)||E(a)?a:d},get:d,annotate:Rb,has:function(a){return n.hasOwnProperty(a+
"Provider")||b.hasOwnProperty(a)}}}a=!0===a;var h={},m=[],l=new $a([],!0),n={$provide:{provider:c(d),factory:c(e),service:c(function(a,b){return e(a,["$injector",function(a){return a.instantiate(b)}])}),value:c(function(a,b){return e(a,fa(b))}),constant:c(function(a,b){La(a,"constant");n[a]=b;k[a]=b}),decorator:function(a,b){var c=p.get(a+"Provider"),d=c.$get;c.$get=function(){var a=q.invoke(d,c);return q.invoke(b,null,{$delegate:a})}}}},p=n.$injector=g(n,function(){throw Na("unpr",m.join(" <- "));
}),k={},q=k.$injector=g(k,function(a){var b=p.get(a+"Provider");return q.invoke(b.$get,b,s,a)});r(f(b),function(a){q.invoke(a||y)});return q}function ke(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location","$rootScope",function(a,c,d){function e(a){var b=null;r(a,function(a){b||"a"!==pa(a)||(b=a)});return b}function f(){var b=c.hash(),d;b?(d=g.getElementById(b))?d.scrollIntoView():(d=e(g.getElementsByName(b)))?d.scrollIntoView():"top"===b&&a.scrollTo(0,0):a.scrollTo(0,
...
var h=this,m=a[0],l=b.location,n=b.history,p=b.setTimeout,k=b.clearTimeout,q={};h.isMock=!1;var t=0,v=[];h.$$completeOutstandingRequest=e;h.$$incOutstandingRequestCount=function(){t++};h.notifyWhenNoOutstandingRequests=function(a){r(w,function(a){a()});0===t?a():v.push(a)};var w=[],A;h.addPollFn=function(a){F(A)&&f(100,p);w.push(a);return a};var O=l.href,z=a.find("base"),W=null;h.url=function(a,c){l!==b.location&&(l=b.location);n!==b.history&&(n=b.history);if(a){if(O!=a)return O=a,d.history?c?n.replaceState(null,
"",a):(n.pushState(null,"",a),z.attr("href",z.attr("href"))):(W=a,c?l.replace(a):l.href=a),h}else return W||l.href.replace(/%27/g,"'")};var C=[],Z=!1;h.onUrlChange=function(a){if(!Z){if(d.history)x(b).on("popstate",g);if(d.hashchange)x(b).on("hashchange",g);else h.addPollFn(g);Z=!0}C.push(a);return a};h.$$checkUrlChange=g;h.baseHref=function(){var a=z.attr("href");return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};var N={},L="",T=h.baseHref();h.cookies=function(a,b){var d,e,f,h;if(a)b===s?m.cookie=
...
b){var c;t++;c=p(function(){delete q[c];e(a)},b||0);q[c]=!0;return c};h.defer.cancel=function(a){return q[a]?(delete q[a],k(a),e(y),!0):!1}}function me(){this.$get=["$window","$log","$sniffer","$document",function(b,a,c,d){return new Xe(b,d,a,c)}]}function ne(){this.$get=function(){function b(b,d){function e(a){a!=p&&(k?k==a&&(k=a.n):k=a,f(a.n,a.p),f(a,p),p=a,p.n=null)}function f(a,b){a!=b&&(a&&(a.p=b),b&&(b.n=a))}if(b in a)throw Q("$cacheFactory")("iid",b);var g=0,h=B({},d,{id:b}),m={},l=d&&d.capacity||
Number.MAX_VALUE,n={},p=null,k=null;return a[b]={put:function(a,b){if(l<Number.MAX_VALUE){var c=n[a]||(n[a]={key:a});e(c)}if(!F(b))return a in m||g++,m[a]=b,g>l&&this.remove(k.key),b},get:function(a){if(l<Number.MAX_VALUE){var b=n[a];if(!b)return;e(b)}return m[a]},remove:function(a){if(l<Number.MAX_VALUE){var b=n[a];if(!b)return;b==p&&(p=b.p);b==k&&(k=b.n);f(b.n,b.p);delete n[a]}delete m[a];g--},removeAll:function(){m={};g=0;n={};p=k=null},destroy:function(){n=h=m=null;delete a[b]},info:function(){return B({},
h,{size:g})}}}var a={};b.info=function(){var b={};r(a,function(a,e){b[e]=a.info()});return b};b.get=function(b){return a[b]};return b}}function Ee(){this.$get=["$cacheFactory",function(b){return b("templates")}]}function mc(b,a){var c={},d=/^\s*directive\:\s*([\d\w_\-]+)\s+(.*)$/,e=/(([\d\w_\-]+)(?:\:([^;]+))?;?)/,f=od("ngSrc,ngSrcset,src,srcset"),g=/^(on[a-z]+|formaction)$/;this.directive=function l(a,d){La(a,"directive");D(a)?(Jb(d,"directiveFactory"),c.hasOwnProperty(a)||(c[a]=[],b.factory(a+"Directive",
["$injector","$exceptionHandler",function(b,d){var e=[];r(c[a],function(c,f){try{var h=b.invoke(c);E(h)?h={compile:fa(h)}:!h.compile&&h.link&&(h.compile=fa(h.link));h.priority=h.priority||0;h.index=f;h.name=h.name||a;h.require=h.require||h.controller&&h.name;h.restrict=h.restrict||"EA";e.push(h)}catch(g){d(g)}});return e}])),c[a].push(d)):r(a,cc(l));return this};this.aHrefSanitizationWhitelist=function(b){return G(b)?(a.aHrefSanitizationWhitelist(b),this):a.aHrefSanitizationWhitelist()};this.imgSrcSanitizationWhitelist=
function(b){return G(b)?(a.imgSrcSanitizationWhitelist(b),this):a.imgSrcSanitizationWhitelist()};var h=!0;this.debugInfoEnabled=function(a){return G(a)?(h=a,this):h};this.$get=["$injector","$interpolate","$exceptionHandler","$templateRequest","$parse","$controller","$rootScope","$document","$sce","$animate","$$sanitizeUri",function(a,b,p,k,q,t,v,w,A,O,z){function W(a,b){try{a.addClass(b)}catch(c){}}function C(a,b,c,d,e){a instanceof x||(a=x(a));r(a,function(b,c){3==b.nodeType&&b.nodeValue.match(/\S+/)&&
(a[c]=x(b).wrap("<span></span>").parent()[0])});var f=Z(a,b,a,c,d,e);C.$$addScopeClass(a);var h=null,g=a,k;return function(b,c,d,e,l){Jb(b,"scope");h||(h=(l=l&&l[0])?"foreignobject"!==pa(l)&&l.toString().match(/SVG/)?"svg":"html":"html");"html"!==h&&a[0]!==k&&(g=x(U(h,x("<div>").append(a).html())));k=a[0];l=c?Ka.clone.call(g):g;if(d)for(var p in d)l.data("$"+p+"Controller",d[p].instance);C.$$addScopeInfo(l,b);c&&c(l,b);f&&f(b,l,l,e);return l}}function Z(a,b,c,d,e,f){function h(a,c,d,e){var f,k,l,
p,n,q,O;if(v)for(O=Array(c.length),p=0;p<g.length;p+=3)f=g[p],O[f]=c[f];else O=c;p=0;for(n=g.length;p<n;)k=O[g[p++]],c=g[p++],f=g[p++],c?(c.scope?(l=a.$new(),C.$$addScopeInfo(x(k),l)):l=a,q=c.transcludeOnThisElement?N(a,c.transclude,e,c.elementTranscludeOnThisElement):!c.templateOnThisElement&&e?e:!e&&b?N(a,b):null,c(f,l,k,d,q)):f&&f(a,k.childNodes,s,e)}for(var g=[],k,l,p,n,v,q=0;q<a.length;q++){k=new Sb;l=L(a[q],[],k,0===q?d:s,e);(f=l.length?u(l,a[q],k,b,c,null,[],[],f):null)&&f.scope&&C.$$addScopeClass(k.$$element);
k=f&&f.terminal||!(p=a[q].childNodes)||!p.length?null:Z(p,f?(f.transcludeOnThisElement||!f.templateOnThisElement)&&f.transclude:b);if(f||k)g.push(q,f,k),n=!0,v=v||f;f=null}return n?h:null}function N(a,b,c,d){return function(e,f,h,g){var k=!1;e||(e=a.$new(),k=e.$$transcluded=!0);f=b(e,f,h,c,g);if(k&&!d)f.on("$destroy",function(){e.$destroy()});return f}}function L(b,f,h,g,k){var p=h.$attr,n;switch(b.nodeType){case 1:ea(f,va(pa(b)),"E",g,k);for(var v,q,O,t=b.attributes,A=0,z=t&&t.length;A<z;A++){var w=
!1,N=!1;v=t[A];if(!aa||8<=aa||v.specified){n=v.name;v=da(v.value);q=va(n);if(O=J.test(q))n=Wa(q.substr(6),"-");var W=q.replace(/(Start|End)$/,""),C;a:{var r=W;if(c.hasOwnProperty(r)){C=void 0;for(var r=a.get(r+"Directive"),u=0,T=r.length;u<T;u++)if(C=r[u],C.multiElement){C=!0;break a}}C=!1}C&&q===W+"Start"&&(w=n,N=n.substr(0,n.length-5)+"end",n=n.substr(0,n.length-6));q=va(n.toLowerCase());p[q]=n;if(O||!h.hasOwnProperty(q))h[q]=v,Ac(b,q)&&(h[q]=!0);ya(b,f,v,q,O);ea(f,q,"A",g,k,w,N)}}b=b.className;
if(D(b)&&""!==b)for(;n=e.exec(b);)q=va(n[2]),ea(f,q,"C",g,k)&&(h[q]=da(n[3])),b=b.substr(n.index+n[0].length);break;case 3:P(f,b.nodeValue);break;case 8:try{if(n=d.exec(b.nodeValue))q=va(n[1]),ea(f,q,"M",g,k)&&(h[q]=da(n[2]))}catch($){}}f.sort(F);return f}function T(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ka("uterdir",b,c);1==a.nodeType&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&e--);d.push(a);a=a.nextSibling}while(0<e)}else d.push(a);return x(d)}function R(a,
b,c){return function(d,e,f,h,g){e=T(e[0],b,c);return a(d,e,f,h,g)}}function u(a,c,d,e,f,h,g,k,l){function v(a,b,c,d){if(a){c&&(a=R(a,c,d));a.require=I.require;a.directiveName=ha;if(u===I||I.$$isolateScope)a=ga(a,{isolateScope:!0});g.push(a)}if(b){c&&(b=R(b,c,d));b.require=I.require;b.directiveName=ha;if(u===I||I.$$isolateScope)b=ga(b,{isolateScope:!0});k.push(b)}}function O(a,b,c,d){var e,f="data",h=!1;if(D(b)){for(;"^"==(e=b.charAt(0))||"?"==e;)b=b.substr(1),"^"==e&&(f="inheritedData"),h=h||"?"==
e;e=null;d&&"data"===f&&(e=d[b])&&(e=e.instance);e=e||c[f]("$"+b+"Controller");if(!e&&!h)throw ka("ctreq",b,a);}else H(b)&&(e=[],r(b,function(b){e.push(O(a,b,c,d))}));return e}function A(a,e,f,h,l){function p(a,b,c){var d;Ta(a)||(c=b,b=a,a=s);B&&(d=T);c||(c=B?R.parent():R);return l(a,b,d,c)}var v,z,w,ma,T,$,R,M;c===f?(M=d,R=d.$$element):(R=x(f),M=new Sb(R,d));u&&(ma=e.$new(!0));$=l&&p;N&&(W={},T={},r(N,function(a){var b={$scope:a===u||a.$$isolateScope?ma:e,$element:R,$attrs:M,$transclude:$};w=a.controller;
"@"==w&&(w=M[a.name]);b=t(w,b,!0,a.controllerAs);T[a.name]=b;B||R.data("$"+a.name+"Controller",b.instance);W[a.name]=b}));if(u){var ea=/^\s*([@=&])(\??)\s*(\w*)\s*$/;C.$$addScopeInfo(R,ma,!0,!(Z&&(Z===u||Z===u.$$originalDirective)));C.$$addScopeClass(R,!0);h=W&&W[u.name];var L=ma;h&&h.identifier&&!0===u.bindToController&&(L=h.instance);r(u.scope,function(a,c){var d=a.match(ea)||[],f=d[3]||c,h="?"==d[2],d=d[1],g,k,l,p;ma.$$isolateBindings[c]=d+f;switch(d){case "@":M.$observe(f,function(a){ma[c]=a});
M.$$observers[f].$$scope=e;M[f]&&(L[c]=b(M[f])(e));break;case "=":if(h&&!M[f])break;k=q(M[f]);p=k.literal?ra:function(a,b){return a===b||a!==a&&b!==b};l=k.assign||function(){g=L[c]=k(e);throw ka("nonassign",M[f],u.name);};g=L[c]=k(e);h=e.$watch(q(M[f],function(a){p(a,L[c])||(p(a,g)?l(e,a=L[c]):L[c]=a);return g=a}),null,k.literal);ma.$on("$destroy",h);break;case "&":k=q(M[f]);L[c]=function(a){return k(e,a)};break;default:throw ka("iscp",u.name,c,a);}})}W&&(r(W,function(a){a()}),W=null);h=0;for(v=g.length;h<
v;h++)z=g[h],Fc(z,z.isolateScope?ma:e,R,M,z.require&&O(z.directiveName,z.require,R,T),$);h=e;u&&(u.template||null===u.templateUrl)&&(h=ma);a&&a(h,f.childNodes,s,l);for(h=k.length-1;0<=h;h--)z=k[h],Fc(z,z.isolateScope?ma:e,R,M,z.require&&O(z.directiveName,z.require,R,T),$)}l=l||{};for(var z=-Number.MAX_VALUE,w,N=l.controllerDirectives,W,u=l.newIsolateScopeDirective,Z=l.templateDirective,ea=l.nonTlbTranscludeDirective,y=!1,F=!1,B=l.hasElementTranscludeDirective,ca=d.$$element=x(c),I,ha,J,P=e,za,K=0,
...
Z,I,ca),Z=I,I.replace&&(h=I),A=Ye(a.splice(K,a.length-K),ca,d,f,y&&P,g,k,{controllerDirectives:N,newIsolateScopeDirective:u,templateDirective:Z,nonTlbTranscludeDirective:ea}),ya=a.length;else if(I.compile)try{za=I.compile(ca,d,P),E(za)?v(null,za,ub,V):za&&v(za.pre,za.post,ub,V)}catch(ba){p(ba,ta(ca))}I.terminal&&(A.terminal=!0,z=Math.max(z,I.priority))}A.scope=w&&!0===w.scope;A.transcludeOnThisElement=y;A.elementTranscludeOnThisElement=B;A.templateOnThisElement=F;A.transclude=P;l.hasElementTranscludeDirective=
B;return A}function $(a){for(var b=0,c=a.length;b<c;b++)a[b]=ec(a[b],{$$isolateScope:!0})}function ea(b,d,e,f,h,g,k){if(d===h)return null;h=null;if(c.hasOwnProperty(d)){var n;d=a.get(d+"Directive");for(var v=0,q=d.length;v<q;v++)try{n=d[v],(f===s||f>n.priority)&&-1!=n.restrict.indexOf(e)&&(g&&(n=ec(n,{$$start:g,$$end:k})),b.push(n),h=n)}catch(O){p(O)}}return h}function G(a,b){var c=b.$attr,d=a.$attr,e=a.$$element;r(a,function(d,e){"$"!=e.charAt(0)&&(b[e]&&b[e]!==d&&(d+=("style"===e?";":" ")+b[e]),
a.$set(e,d,!0,c[e]))});r(b,function(b,f){"class"==f?(W(e,b),a["class"]=(a["class"]?a["class"]+" ":"")+b):"style"==f?(e.attr("style",e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==f.charAt(0)||a.hasOwnProperty(f)||(a[f]=b,d[f]=c[f])})}function Ye(a,b,c,d,e,f,h,g){var l=[],n,p,v=b[0],q=a.shift(),O=B({},q,{templateUrl:null,transclude:null,replace:null,$$originalDirective:q}),t=E(q.templateUrl)?q.templateUrl(b,c):q.templateUrl,z=q.templateNamespace;b.empty();k(A.getTrustedResourceUrl(t)).then(function(k){var A,
w;k=X(k);if(q.replace){k=Kb.test(k)?x(U(z,da(k))):[];A=k[0];if(1!=k.length||1!==A.nodeType)throw ka("tplrt",q.name,t);k={$attr:{}};M(d,b,A);var C=L(A,[],k);S(q.scope)&&$(C);a=C.concat(a);G(c,k)}else A=v,b.html(k);a.unshift(O);n=u(a,A,c,e,b,q,f,h,g);r(d,function(a,c){a==A&&(d[c]=b[0])});for(p=Z(b[0].childNodes,e);l.length;){k=l.shift();w=l.shift();var R=l.shift(),T=l.shift(),C=b[0];if(w!==v){var ea=w.className;g.hasElementTranscludeDirective&&q.replace||(C=Mb(A));M(R,x(w),C);W(x(C),ea)}w=n.transcludeOnThisElement?
N(k,n.transclude,T):T;n(p,k,C,d,w)}l=null});return function(a,b,c,d,e){a=e;l?(l.push(b),l.push(c),l.push(d),l.push(a)):(n.transcludeOnThisElement&&(a=N(b,n.transclude,e)),n(p,b,c,d,a))}}function F(a,b){var c=b.priority-a.priority;return 0!==c?c:a.name!==b.name?a.name<b.name?-1:1:a.index-b.index}function Q(a,b,c,d){if(b)throw ka("multidir",b.name,c.name,a,ta(d));}function P(a,c){var d=b(c,!0);d&&a.push({priority:0,compile:function(a){a=a.parent();var b=!!a.length;b&&C.$$addBindingClass(a);return function(a,
...
if(k){if("multiple"===e&&"select"===pa(a))throw ka("selmulti",ta(a));c.push({priority:100,compile:function(){return{pre:function(c,d,l){d=l.$$observers||(l.$$observers={});if(g.test(e))throw ka("nodomevents");if(k=b(l[e],!0,za(a,e),f[e]||h))l[e]=k(c),(d[e]||(d[e]=[])).$$inter=!0,(l.$$observers&&l.$$observers[e].$$scope||c).$watch(k,function(a,b){"class"===e&&a!=b?l.$updateClass(a,b):l.$set(e,a)})}}}})}}function M(a,b,c){var d=b[0],e=b.length,f=d.parentNode,h,g;if(a)for(h=0,g=a.length;h<g;h++)if(a[h]==
...
d,b);a.$scope[b]=c}return function(g,h,m,l){var n,p,k;m=!0===m;l&&D(l)&&(k=l);D(g)&&(l=g.match(c),p=l[1],k=k||l[3],g=b.hasOwnProperty(p)?b[p]:lc(h.$scope,p,!0)||(a?lc(e,p,!0):s),kb(g,p,!0));if(m)return m=function(){},m.prototype=(H(g)?g[g.length-1]:g).prototype,n=new m,k&&f(h,k,n,p||g.name),B(function(){d.invoke(g,n,h,p);return n},{instance:n,identifier:k});n=d.instantiate(g,h,p);k&&f(h,k,n,p||g.name);return n}}]}function pe(){this.$get=["$window",function(b){return x(b.document)}]}function qe(){this.$get=
...
return n}return function(e,h,m,l,n,p,k,q){function t(){w=-1;O&&O();z&&z.abort()}function v(a,d,e,f,g){C&&c.cancel(C);O=z=null;0===d&&(d=e?200:"file"==Aa(h).protocol?404:0);a(1223===d?204:d,e,f,g||"");b.$$completeOutstandingRequest(y)}var w;b.$$incOutstandingRequestCount();h=h||b.url();if("jsonp"==K(e)){var A="_"+(d.counter++).toString(36);d[A]=function(a){d[A].data=a;d[A].called=!0};var O=f(h.replace("JSON_CALLBACK","angular.callbacks."+A),A,function(a,b){v(l,a,d[A].data,"",b);d[A]=y})}else{var z=
a(e);z.open(e,h,!0);r(n,function(a,b){G(a)&&z.setRequestHeader(b,a)});z.onreadystatechange=function(){if(z&&4==z.readyState){var a=null,b=null,c="";-1!==w&&(a=z.getAllResponseHeaders(),b="response"in z?z.response:z.responseText);-1===w&&10>aa||(c=z.statusText);v(l,w||z.status,b,a,c)}};k&&(z.withCredentials=!0);if(q)try{z.responseType=q}catch(W){if("json"!==q)throw W;}z.send(m||null)}if(0<p)var C=c(t,p);else p&&E(p.then)&&p.then(t)}}function re(){var b="{{",a="}}";this.startSymbol=function(a){return a?
(b=a,this):b};this.endSymbol=function(b){return b?(a=b,this):a};this.$get=["$parse","$exceptionHandler","$sce",function(c,d,e){function f(a){return"\\\\\\"+a}function g(f,g,q,t){function v(c){return c.replace(l,b).replace(n,a)}function w(a){try{var b;var c=q?e.getTrusted(q,a):e.valueOf(a);if(null==c)b="";else{switch(typeof c){case "string":break;case "number":c=""+c;break;default:c=sa(c)}b=c}return b}catch(h){a=Tb("interr",f,h.toString()),d(a)}}t=!!t;for(var A,O,z=0,r=[],C=[],Z=f.length,N=[],L=[];z<
...
d(a)}},{exp:f,expressions:r,$$watchDelegate:function(a,b,c){var d;return a.$watchGroup(C,function(c,e){var f=T(c);E(b)&&b.call(this,f,c!==e?d:f,a);d=f},c)}})}}var h=b.length,m=a.length,l=new RegExp(b.replace(/./g,f),"g"),n=new RegExp(a.replace(/./g,f),"g");g.startSymbol=function(){return b};g.endSymbol=function(){return a};return g}]}function se(){this.$get=["$rootScope","$window","$q","$$q",function(b,a,c,d){function e(e,h,m,l){var n=a.setInterval,p=a.clearInterval,k=0,q=G(l)&&!l,t=(q?d:c).defer(),
v=t.promise;m=G(m)?m:0;v.then(null,null,e);v.$$intervalId=n(function(){t.notify(k++);0<m&&k>=m&&(t.resolve(k),p(v.$$intervalId),delete f[v.$$intervalId]);q||b.$apply()},h);f[v.$$intervalId]=t;return v}var f={};e.cancel=function(b){return b&&b.$$intervalId in f?(f[b.$$intervalId].reject("canceled"),a.clearInterval(b.$$intervalId),delete f[b.$$intervalId],!0):!1};return e}]}function Ad(){this.$get=function(){return{id:"en-us",NUMBER_FORMATS:{DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{minInt:1,minFrac:0,
...
a.$watch(function(a){return d(a)},function(a,c,d){E(b)&&b.apply(this,arguments);e()},c)}function h(a,b){if(!b)return a;var c=function(c,d){var e=a(c,d),f=b(e,c,d);return G(e)?f:e};c.$$watchDelegate=a.$$watchDelegate;return c}a.csp=d.csp;return function(d,l){var n,p,k;switch(typeof d){case "string":return k=d=d.trim(),n=b[k],n||(":"===d.charAt(0)&&":"===d.charAt(1)&&(p=!0,d=d.substring(2)),n=new Xb(a),n=(new bb(n,c,a)).parse(d),n.constant?n.$$watchDelegate=g:p&&(n.$$watchDelegate=n.literal?f:e),b[k]=
n),h(n,l);case "function":return h(d,l);default:return h(y,l)}}}]}function ze(){this.$get=["$rootScope","$exceptionHandler",function(b,a){return Tc(function(a){b.$evalAsync(a)},a)}]}function Ae(){this.$get=["$browser","$exceptionHandler",function(b,a){return Tc(function(a){b.defer(a)},a)}]}function Tc(b,a){function c(a,b,c){function d(b){return function(c){e||(e=!0,b.call(a,c))}}var e=!1;return[d(b),d(c)]}function d(){this.$$state={status:0}}function e(a,b){return function(c){b.call(a,c)}}function f(c){!c.processScheduled&&
...
[];this.$$state.pending.push([d,a,b,c]);0<this.$$state.status&&f(this.$$state);return d.promise},"catch":function(a){return this.then(null,a)},"finally":function(a,b){return this.then(function(b){return l(b,!0,a)},function(b){return l(b,!1,a)},b)}};g.prototype={resolve:function(a){this.promise.$$state.status||(a===this.promise?this.$$reject(h("qcycle",a)):this.$$resolve(a))},$$resolve:function(b){var d,e;e=c(this,this.$$resolve,this.$$reject);try{if(S(b)||E(b))d=b&&b.then;E(d)?(this.promise.$$state.status=
...
this.$$nextSibling=this.$$prevSibling=this.$$childHead=this.$$childTail=null;this["this"]=this.$root=this;this.$$destroyed=!1;this.$$asyncQueue=[];this.$$postDigestQueue=[];this.$$listeners={};this.$$listenerCount={};this.$$isolateBindings={};this.$$applyAsyncQueue=[]}function l(b){if(t.$$phase)throw a("inprog",t.$$phase);t.$$phase=b}function n(a,b,c){do a.$$listenerCount[c]-=b,0===a.$$listenerCount[c]&&delete a.$$listenerCount[c];while(a=a.$parent)}function p(){}function k(){for(var a=t.$$applyAsyncQueue;a.length;)try{a.shift()()}catch(b){f(b)}d=
null}function q(){null===d&&(d=h.defer(function(){t.$apply(k)}))}m.prototype={constructor:m,$new:function(a){a?(a=new m,a.$root=this.$root,a.$$asyncQueue=this.$$asyncQueue,a.$$postDigestQueue=this.$$postDigestQueue):(this.$$ChildScope||(this.$$ChildScope=function(){this.$$watchers=this.$$nextSibling=this.$$childHead=this.$$childTail=null;this.$$listeners={};this.$$listenerCount={};this.$id=++fb;this.$$ChildScope=null},this.$$ChildScope.prototype=this),a=new this.$$ChildScope);a["this"]=a;a.$parent=
...
{},d)Fb.call(d,a)&&(f[a]=d[a]);else f=d})},$digest:function(){var e,g,m,n,q=this.$$asyncQueue,r=this.$$postDigestQueue,C,s,N=b,L,T=[],R,u,$;l("$digest");h.$$checkUrlChange();this===t&&null!==d&&(h.defer.cancel(d),k());c=null;do{s=!1;for(L=this;q.length;){try{$=q.shift(),$.scope.$eval($.expression)}catch(G){f(G)}c=null}a:do{if(n=L.$$watchers)for(C=n.length;C--;)try{if(e=n[C])if((g=e.get(L))!==(m=e.last)&&!(e.eq?ra(g,m):"number"===typeof g&&"number"===typeof m&&isNaN(g)&&isNaN(m)))s=!0,c=e,e.last=e.eq?
...
this.$$listeners={};this.$$watchers=this.$$asyncQueue=this.$$postDigestQueue=[];this.$destroy=this.$digest=this.$apply=y;this.$on=this.$watch=this.$watchGroup=function(){return y}}}},$eval:function(a,b){return g(a)(this,b)},$evalAsync:function(a){t.$$phase||t.$$asyncQueue.length||h.defer(function(){t.$$asyncQueue.length&&t.$digest()});this.$$asyncQueue.push({scope:this,expression:a})},$$postDigest:function(a){this.$$postDigestQueue.push(a)},$apply:function(a){try{return l("$apply"),this.$eval(a)}catch(b){f(b)}finally{t.$$phase=
...
e||e===s||""===e)return e;var g=h.hasOwnProperty(c)?h[c]:null;if(g&&e instanceof g)return e.$$unwrapTrustedValue();if(c===la.RESOURCE_URL){var g=Aa(e.toString()),p,k,q=!1;p=0;for(k=b.length;p<k;p++)if(d(b[p],g)){q=!0;break}if(q)for(p=0,k=a.length;p<k;p++)if(d(a[p],g)){q=!1;break}if(q)return e;throw Ba("insecurl",e.toString());}if(c===la.HTML)return f(e);throw Ba("unsafe");},valueOf:function(a){return a instanceof g?a.$$unwrapTrustedValue():a}}}]}function Be(){var b=!0;this.enabled=function(a){arguments.length&&
...
b?b:$c(b,a.PATTERNS[1],a.GROUP_SEP,a.DECIMAL_SEP,2).replace(/\u00A4/g,d)}}function Yc(b){var a=b.NUMBER_FORMATS;return function(b,d){return null==b?b:$c(b,a.PATTERNS[0],a.GROUP_SEP,a.DECIMAL_SEP,d)}}function $c(b,a,c,d,e){if(!isFinite(b)||S(b))return"";var f=0>b;b=Math.abs(b);var g=b+"",h="",m=[],l=!1;if(-1!==g.indexOf("e")){var n=g.match(/([\d\.]+)e(-?)(\d+)/);n&&"-"==n[2]&&n[3]>e+1?(g="0",b=0):(h=g,l=!0)}if(l)0<e&&-1<b&&1>b&&(h=b.toFixed(e));else{g=(g.split(ad)[1]||"").length;F(e)&&(e=Math.min(Math.max(a.minFrac,
g),a.maxFrac));b=+(Math.round(+(b.toString()+"e"+e)).toString()+"e"+-e);b=(""+b).split(ad);g=b[0];b=b[1]||"";var n=0,p=a.lgSize,k=a.gSize;if(g.length>=p+k)for(n=g.length-p,l=0;l<n;l++)0===(n-l)%k&&0!==l&&(h+=c),h+=g.charAt(l);for(l=n;l<g.length;l++)0===(g.length-l)%p&&0!==l&&(h+=c),h+=g.charAt(l);for(;b.length<e;)b+="0";e&&"0"!==e&&(h+=d+b.substr(0,e))}m.push(f?a.negPre:a.posPre);m.push(h);m.push(f?a.negSuf:a.posSuf);return m.join("")}function yb(b,a,c){var d="";0>b&&(d="-",b=-b);for(b=""+b;b.length<
...
function dd(b,a,c,d){function e(a,c){c=c?"-"+Wa(c,"-"):"";d.removeClass(b,(a?Pa:Qa)+c);d.addClass(b,(a?Qa:Pa)+c)}var f=this,g=b.parent().controller("form")||Ab,h=0,m=0,l=[],n=f.$error={};f.$name=a.name||a.ngForm;f.$dirty=!1;f.$pristine=!0;f.$valid=!0;f.$invalid=!1;f.$submitted=!1;g.$addControl(f);b.addClass(Ra);e(!0);f.$rollbackViewValue=function(){r(l,function(a){a.$rollbackViewValue()})};f.$commitViewValue=function(){r(l,function(a){a.$commitViewValue()})};f.$addControl=function(a){La(a.$name,"input");
l.push(a);a.$name&&(f[a.$name]=a)};f.$removeControl=function(a){a.$name&&f[a.$name]===a&&delete f[a.$name];f.$$clearControlValidity(a);Ia(l,a)};f.$$clearControlValidity=function(a){function b(c,d){f.$setValidity(d,!0,a)}r(f.$pending,b);r(n,b);g.$$clearControlValidity(f)};f.$$setPending=function(a,b){var c=f.$pending&&f.$pending[a];c&&-1!=Ca(c,b)||(m++,f.$valid=f.$invalid=s,f.$pending=f.$pending||{},c||(c=f.$pending[a]=[]),c.push(b),g.$$setPending(a,f))};f.$setValidity=function(a,b,c){var d=n[a],l,
r=f.$pending&&f.$pending[a];r&&(l=0<=Ca(r,c))&&(Ia(r,c),m--,0===r.length&&delete f.$pending[a]);if(r=f.$pending&&0===m)f.$pending=s;if(b){if(d||l)(d&&Ia(d,c),d&&d.length)||(n[a]&&h--,h?r&&(e(!1),f.$valid=!1,f.$invalid=!0):f.$pending||(e(b),f.$valid=!0,f.$invalid=!1),n[a]=!1,e(!0,a),g.$setValidity(a,!0,f))}else{f.$pending||(f.$valid=!1,f.$invalid=!0);h||e(b);if(d){if(-1!=Ca(d,c))return}else n[a]=d=[],h++,e(!1,a),g.$setValidity(a,!1,f);d.push(c)}};f.$setDirty=function(){d.removeClass(b,Ra);d.addClass(b,
Bb);f.$dirty=!0;f.$pristine=!1;g.$setDirty()};f.$setPristine=function(){d.setClass(b,Ra,Bb+" ng-submitted");f.$dirty=!1;f.$pristine=!0;f.$submitted=!1;r(l,function(a){a.$setPristine()})};f.$setSubmitted=function(){d.addClass(b,"ng-submitted");f.$submitted=!0;g.$setSubmitted()}}function Yb(b){b.$formatters.push(function(a){return b.$isEmpty(a)?a:a.toString()})}function cb(b,a,c,d,e,f){var g=a.prop("validity"),h=a[0].placeholder,m={},l=K(a[0].type);d.$$validityState=g;if(!e.android){var n=!1;a.on("compositionstart",
function(a){n=!0});a.on("compositionend",function(){n=!1;p()})}var p=function(e){if(!n){var f=a.val(),k=e&&e.type;if(aa&&"input"===(e||m).type&&a[0].placeholder!==h)h=a[0].placeholder;else{"password"===l||c.ngTrim&&"false"===c.ngTrim||(f=da(f));var p=g&&d.$$hasNativeValidators;if(d.$viewValue!==f||""===f&&p)b.$root.$$phase?d.$setViewValue(f,k,p):b.$apply(function(){d.$setViewValue(f,k,p)})}}};if(e.hasEvent("input"))a.on("input",p);else{var k,q=function(a){k||(k=f.defer(function(){p(a);k=null}))};
a.on("keydown",function(a){var b=a.keyCode;91===b||15<b&&19>b||37<=b&&40>=b||q(a)});if(e.hasEvent("paste"))a.on("paste cut",q)}a.on("change",p);d.$render=function(){a.val(d.$isEmpty(d.$viewValue)?"":d.$viewValue)}}function Cb(b,a){return function(c){var d;return ia(c)?c:D(c)&&(b.lastIndex=0,c=b.exec(c))?(c.shift(),d={yyyy:1970,MM:1,dd:1,HH:0,mm:0,ss:0},r(c,function(b,c){c<a.length&&(d[a[c]]=+b)}),new Date(d.yyyy,d.MM-1,d.dd,d.HH,d.mm,d.ss||0)):NaN}}function db(b,a,c,d){return function(e,f,g,h,m,l,
n){Db(e,f,g,h);cb(e,f,g,h,m,l);var p=h&&h.$options&&h.$options.timezone;h.$$parserName=b;h.$parsers.push(function(b){return h.$isEmpty(b)?null:a.test(b)?(b=c(b),"UTC"===p&&b.setMinutes(b.getMinutes()-b.getTimezoneOffset()),b):s});h.$formatters.push(function(a){return ia(a)?n("date")(a,d,p):""});g.min&&(h.$validators.min=function(a){return h.$isEmpty(a)||F(g.min)||c(a)>=c(g.min)});g.max&&(h.$validators.max=function(a){return h.$isEmpty(a)||F(g.max)||c(a)<=c(g.max)})}}function Db(b,a,c,d){(d.$$hasNativeValidators=
...
(b=b.concat(c.split(" ")))});return b}}return a}return{restrict:"AC",link:function(f,g,h){function m(a,b){var c=g.data("$classCounts")||{},d=[];r(a,function(a){if(0<b||c[a])c[a]=(c[a]||0)+b,c[a]===+(0<b)&&d.push(a)});g.data("$classCounts",c);return d.join(" ")}function l(b){if(!0===a||f.$index%2===a){var k=e(b||[]);if(!n){var l=m(k,1);h.$addClass(l)}else if(!ra(b,n)){var r=e(n),l=d(k,r),k=d(r,k),l=m(l,1),k=m(k,-1);l&&l.length&&c.addClass(g,l);k&&k.length&&c.removeClass(g,k)}}n=qa(b)}var n;f.$watch(h[b],
l,!0);h.$observe("class",function(a){l(f.$eval(h[b]))});"ngClass"!==b&&f.$watch("$index",function(c,d){var g=c&1;if(g!==(d&1)){var l=e(f.$eval(h[b]));g===a?(g=m(l,1),h.$addClass(g)):(g=m(l,-1),h.$removeClass(g))}})}}}]}var mf=/^\/(.+)\/([a-z]*)$/,K=function(b){return D(b)?b.toLowerCase():b},Fb=Object.prototype.hasOwnProperty,mb=function(b){return D(b)?b.toUpperCase():b},aa,x,ua,Va=[].slice,nf=[].push,Ha=Object.prototype.toString,Ua=Q("ng"),xa=P.angular||(P.angular={}),Ya,fb=0;aa=V((/msie (\d+)/.exec(K(navigator.userAgent))||
[])[1]);isNaN(aa)&&(aa=V((/trident\/.*; rv:(\d+)/.exec(K(navigator.userAgent))||[])[1]));y.$inject=[];Fa.$inject=[];var H=Array.isArray,da=function(b){return D(b)?b.trim():b},Xa=function(){if(G(Xa.isActive_))return Xa.isActive_;var b=!(!Y.querySelector("[ng-csp]")&&!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Xa.isActive_=b},jb=["ng-","data-ng-","ng:","x-ng-"],vd=/[A-Z]/g,kc=!1,Ib,zd={full:"1.3.0-build.3179+sha.0f806d9",major:1,minor:3,dot:0,codeName:"snapshot"};
...
"</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};ja.optgroup=ja.option;ja.tbody=ja.tfoot=ja.colgroup=ja.caption=ja.thead;ja.th=ja.td;var Ka=U.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===Y.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),U(P).on("load",a),this.on("DOMContentLoaded",a))},toString:function(){var b=[];r(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?x(this[b]):x(this[this.length+
b])},length:0,push:nf,sort:[].sort,splice:[].splice},tb={};r("multiple selected checked disabled readOnly required open".split(" "),function(b){tb[K(b)]=b});var Bc={};r("input select option textarea button form details".split(" "),function(b){Bc[b]=!0});var Cc={ngMinlength:"minlength",ngMaxlength:"maxlength",ngPattern:"pattern"};r({data:Nb,removeData:pb},function(b,a){U[a]=b});r({data:Nb,inheritedData:sb,scope:function(b){return x.data(b,"$scope")||sb(b.parentNode||b,["$isolateScope","$scope"])},
isolateScope:function(b){return x.data(b,"$isolateScope")||x.data(b,"$isolateScopeNoTemplate")},controller:xc,injector:function(b){return sb(b,"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:Ob,css:function(b,a,c){a=Za(a);if(G(c))b.style[a]=c;else return b.style[a]},attr:function(b,a,c){var d=K(a);if(tb[d])if(G(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||y).specified?d:s;else if(G(c))b.setAttribute(a,c);else if(b.getAttribute)return b=
b.getAttribute(a,2),null===b?s:b},prop:function(b,a,c){if(G(c))b[a]=c;else return b[a]},text:function(){function b(a,b){if(F(b)){var d=a.nodeType;return 1===d||3===d?a.textContent:""}a.textContent=b}b.$dv="";return b}(),val:function(b,a){if(F(a)){if(b.multiple&&"select"===pa(b)){var c=[];r(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(F(a))return b.innerHTML;ob(b,!0);b.innerHTML=a},empty:yc},function(b,a){U.prototype[a]=
function(a,d){var e,f,g=this.length;if(b!==yc&&(2==b.length&&b!==Ob&&b!==xc?a:d)===s){if(S(a)){for(e=0;e<g;e++)if(b===Nb)b(this[e],a);else for(f in a)b(this[e],f,a[f]);return this}e=b.$dv;g=e===s?Math.min(g,1):g;for(f=0;f<g;f++){var h=b(this[f],a,d);e=e?e+h:h}return e}for(e=0;e<g;e++)b(this[e],a,d);return this}});r({removeData:pb,on:function a(c,d,e,f){if(G(f))throw Lb("onargs");if(uc(c)){var g=qb(c,!0);f=g.events;var h=g.handle;h||(h=g.handle=Te(c,f));for(var g=0<=d.indexOf(" ")?d.split(" "):[d],
m=g.length;m--;){d=g[m];var l=f[d];l||(f[d]=[],"mouseenter"===d||"mouseleave"===d?a(c,of[d],function(a){var c=a.relatedTarget;c&&(c===this||this.contains(c))||h(a,d)}):"$destroy"!==d&&c.addEventListener(d,h,!1),l=f[d]);l.push(e)}}},off:wc,one:function(a,c,d){a=x(a);a.on(c,function f(){a.off(c,d);a.off(c,f)});a.on(c,d)},replaceWith:function(a,c){var d,e=a.parentNode;ob(a);r(new U(c),function(c){d?e.insertBefore(c,d.nextSibling):e.replaceChild(c,a);d=c})},children:function(a){var c=[];r(a.childNodes,
...
this,d=this.expression();this.consume("]");return B(function(e,f){var g=a(e,f),h=d(e,f);na(h,c.text);return g?Oa(g[h],c.text):s},{assign:function(e,f,g){var h=na(d(e,g),c.text);(g=Oa(a(e,g),c.text))||a.assign(e,g={});return g[h]=f}})},functionCall:function(a,c){var d=[];if(")"!==this.peekToken().text){do d.push(this.expression());while(this.expect(","))}this.consume(")");var e=this.text,f=d.length?[]:null;return function(g,h){var m=c?c(g,h):g,l=a(g,h,m)||y;if(f)for(var n=d.length;n--;)f[n]=d[n](g,
h);Oa(m,e);if(l){if(l.constructor===l)throw oa("isecfn",e);if(l===rf||l===sf||l===tf)throw oa("isecff",e);}m=l.apply?l.apply(m,f):l(f[0],f[1],f[2],f[3],f[4]);return Oa(m,e)}},arrayDeclaration:function(){var a=[],c=!0;if("]"!==this.peekToken().text){do{if(this.peek("]"))break;var d=this.expression();a.push(d);d.constant||(c=!1)}while(this.expect(","))}this.consume("]");return B(function(c,d){for(var g=[],h=0;h<a.length;h++)g.push(a[h](c,d));return g},{literal:!0,constant:c})},object:function(){var a=
...
e.parent().controller("form"),l=f.name||f.ngForm;l&&xb(a,l,g,l);if(m)e.on("$destroy",function(){m.$removeControl(g);l&&xb(a,l,s,l);B(g,Ab)})}}}}}]},Dd=fd(),Qd=fd(!0),vf=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,wf=/^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,xf=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,gd=/^(\d{4})-(\d{2})-(\d{2})$/,hd=/^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d))?$/,$b=/^(\d{4})-W(\d\d)$/,
...
f&&f.type)})});e.$render=function(){c[0].checked=d.value==e.$viewValue};d.$observe("value",e.$render)},checkbox:function(a,c,d,e,f,g,h,m){var l=ed(m,a,"ngTrueValue",d.ngTrueValue,!0),n=ed(m,a,"ngFalseValue",d.ngFalseValue,!1);c.on("click",function(d){a.$apply(function(){e.$setViewValue(c[0].checked,d&&d.type)})});e.$render=function(){c[0].checked=e.$viewValue};e.$isEmpty=function(a){return a!==l};e.$formatters.push(function(a){return ra(a,l)});e.$parsers.push(function(a){return a?l:n})},hidden:y,
...
Number.NaN;this.$validators={};this.$asyncValidators={};this.$validators={};this.$parsers=[];this.$formatters=[];this.$viewChangeListeners=[];this.$untouched=!0;this.$touched=!1;this.$pristine=!0;this.$dirty=!1;this.$valid=!0;this.$invalid=!1;this.$name=d.name;var l=f(d.ngModel),n=l.assign,p=null,k=this;this.$$setOptions=function(a){k.$options=a;if(!(n||a&&a.getterSetter))throw ac("nonassign",d.ngModel,ta(e));};this.$render=y;this.$isEmpty=function(a){return F(a)||""===a||null===a||a!==a};var q=e.inheritedData("$formController")||
Ab,t=0,v=0,w=this.$error={};e.addClass(Ra).addClass("ng-untouched");m(!0);this.$$clearValidity=function(){g.removeClass(e,"ng-pending");r(k.$error,function(a,c){var d=Wa(c,"-");g.removeClass(e,Qa+d);g.removeClass(e,Pa+d)});k.$pending&&k.$$clearPending();t=0;w=k.$error={};q.$$clearControlValidity(k)};this.$$clearPending=function(){v=0;k.$pending=s;g.removeClass(e,"ng-pending")};this.$$setPending=function(a,c,d){function f(c){return function(){var e=k.$viewValue||"";k.$pending&&k.$pending[a]&&d===e&&
(v--,delete k.$pending[a],k.$setValidity(a,c),0===v&&(k.$$clearPending(),k.$$updateValidModelValue(e),k.$$writeModelToScope()))}}k.$pending=k.$pending||{};xa.isUndefined(k.$pending[a])&&(k.$pending[a]=!0,v++);k.$valid=k.$invalid=s;q.$$setPending(a,k);g.addClass(e,"ng-pending");g.removeClass(e,Pa);g.removeClass(e,Qa);d=d||"";c.then(f(!0),f(!1))};this.$setValidity=function(a,c){if(k.$pending||w[a]!==!c)c?(w[a]&&t--,t||v||(m(!0),k.$valid=!0,k.$invalid=!1)):w[a]||(t++,v||(m(!1),k.$invalid=!0,k.$valid=
!1)),w[a]=!c,m(c,a),q.$setValidity(a,c,k)};this.$setPristine=function(){k.$dirty=!1;k.$pristine=!0;g.removeClass(e,Bb);g.addClass(e,Ra)};this.$setUntouched=function(){k.$touched=!1;k.$untouched=!0;g.setClass(e,"ng-untouched","ng-touched")};this.$setTouched=function(){k.$touched=!0;k.$untouched=!1;g.setClass(e,"ng-touched","ng-untouched")};this.$rollbackViewValue=function(){h.cancel(p);k.$viewValue=k.$$lastCommittedViewValue;k.$render()};this.$validate=function(){if(k.$modelValue===k.$modelValue){var a=
k.$modelValue;k.$$runValidators(k.$$invalidModelValue||k.$modelValue,k.$viewValue);a!==k.$modelValue&&k.$$writeModelToScope()}};this.$$runValidators=function(a,c){function d(e,f){var h=!0;r(e,function(d,e){var g=d(a,c);f(e,g);h=h&&g});return h}k.$pending&&k.$$clearPending();d(k.$validators,function(a,c){k.$setValidity(a,c)})&&d(k.$asyncValidators,function(c,d){if(!d||!E(d.then))throw ac("$asyncValidators",d);k.$$setPending(c,d,a)});k.$$updateValidModelValue(a)};this.$$updateValidModelValue=function(a){k.$modelValue=
k.$valid?a:s;k.$$invalidModelValue=k.$valid?s:a};this.$commitViewValue=function(a){var c=k.$viewValue;h.cancel(p);if(a||k.$$lastCommittedViewValue!==c){k.$$lastCommittedViewValue=c;k.$pristine&&(k.$dirty=!0,k.$pristine=!1,g.removeClass(e,Ra),g.addClass(e,Bb),q.$setDirty());var d;a=c;for(var f=0;f<k.$parsers.length;f++)if(a=k.$parsers[f](a),F(a)){d=!0;break}f=k.$$parserName||"parse";d?(k.$$invalidModelValue=k.$modelValue=s,k.$$clearValidity(),k.$setValidity(f,!1),k.$$writeModelToScope()):k.$modelValue===
a||!F(k.$$invalidModelValue)&&k.$$invalidModelValue==a||(k.$setValidity(f,!0),k.$$runValidators(a,c),k.$$writeModelToScope())}};this.$$writeModelToScope=function(){var d;k.$options&&k.$options.getterSetter&&E(d=l(a))?d(k.$modelValue):n(a,k.$modelValue);r(k.$viewChangeListeners,function(a){try{a()}catch(d){c(d)}})};this.$setViewValue=function(a,c,d){k.$viewValue=a;k.$options&&!k.$options.updateOnDefault||k.$$debounceViewValueCommit(c,d)};this.$$debounceViewValueCommit=function(a,c){var d=0,e=k.$options;
e&&G(e.debounce)&&(e=e.debounce,Ga(e)?d=e:Ga(e[a])?d=e[a]:Ga(e["default"])&&(d=e["default"]));h.cancel(p);d?p=h(function(){k.$commitViewValue(c)},d):k.$commitViewValue(c)};a.$watch(function(){var c=l(a);k.$options&&k.$options.getterSetter&&E(c)&&(c=c());if(k.$modelValue!==c&&(F(k.$$invalidModelValue)||k.$$invalidModelValue!=c)){for(var d=k.$formatters,e=d.length,f=c;e--;)f=d[e](f);k.$$runValidators(c,f);k.$viewValue!==f&&(k.$viewValue=k.$$lastCommittedViewValue=f,k.$render())}return c})}],ee=function(){return{restrict:"A",
...
function(a){var c=va("ng-"+a);sc[c]=["$parse","$rootScope",function(d,e){return{restrict:"A",compile:function(f,g){var h=d(g[c]);return function(c,d){var f=K(a);d.on(f,function(a){var d=function(){h(c,{$event:a})};Bf[f]&&e.$$phase?c.$evalAsync(d):c.$apply(d)})}}}}]});var Sd=["$animate",function(a){return{multiElement:!0,transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(c,d,e,f,g){var h,m,l;c.$watch(e.ngIf,function(c){c?m||g(function(c,f){m=f;c[c.length++]=Y.createComment(" end ngIf: "+
e.ngIf+" ");h={clone:c};a.enter(c,d.parent(),d)}):(l&&(l.remove(),l=null),m&&(m.$destroy(),m=null),h&&(l=lb(h.clone),a.leave(l).then(function(){l=null}),h=null))})}}}],Td=["$templateRequest","$anchorScroll","$animate","$sce",function(a,c,d,e){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",controller:xa.noop,compile:function(f,g){var h=g.ngInclude||g.src,m=g.onload||"",l=g.autoscroll;return function(f,g,k,q,r){var v=0,s,A,x,z=function(){A&&(A.remove(),A=null);s&&(s.$destroy(),
s=null);x&&(d.leave(x).then(function(){A=null}),A=x,x=null)};f.$watch(e.parseAsResourceUrl(h),function(e){var h=function(){!G(l)||l&&!f.$eval(l)||c()},k=++v;e?(a(e,!0).then(function(a){if(k===v){var c=f.$new();q.template=a;a=r(c,function(a){z();d.enter(a,null,g).then(h)});s=c;x=a;s.$emit("$includeContentLoaded");f.$eval(m)}},function(){k===v&&(z(),f.$emit("$includeContentError"))}),f.$emit("$includeContentRequested")):(z(),q.template=null)})}}}}],je=["$compile",function(a){return{restrict:"ECA",priority:-400,
require:"ngInclude",link:function(c,d,e,f){d.html(f.template);a(d.contents())(c)}}}],Ud=Ea({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),Vd=Ea({terminal:!0,priority:1E3}),Wd=["$locale","$interpolate",function(a,c){var d=/{}/g;return{restrict:"EA",link:function(e,f,g){var h=g.count,m=g.$attr.when&&f.attr(g.$attr.when),l=g.offset||0,n=e.$eval(m)||{},p={},k=c.startSymbol(),q=c.endSymbol(),s=/^when(Minus)?(.+)$/;r(g,function(a,c){s.test(c)&&(n[K(c.replace("when","").replace("Minus",
"-"))]=f.attr(g.$attr[c]))});r(n,function(a,e){p[e]=c(a.replace(d,k+h+"-"+l+q))});e.$watch(function(){var c=parseFloat(e.$eval(h));if(isNaN(c))return"";c in n||(c=a.pluralCat(c-l));return p[c](e)},function(a){f.text(a)})}}}],Xd=["$parse","$animate",function(a,c){var d=Q("ngRepeat"),e=function(a,c,d,e,l,n,p){a[d]=e;l&&(a[l]=n);a.$index=c;a.$first=0===c;a.$last=c===p-1;a.$middle=!(a.$first||a.$last);a.$odd=!(a.$even=0===(c&1))};return{restrict:"A",multiElement:!0,transclude:"element",priority:1E3,terminal:!0,
$$tlb:!0,compile:function(f,g){var h=g.ngRepeat,m=Y.createComment(" end ngRepeat: "+h+" "),l=h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!l)throw d("iexp",h);var n=l[1],p=l[2],k=l[3],q=l[4],l=n.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/);if(!l)throw d("iidexp",n);var t=l[3]||l[1],v=l[2];if(k&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(k)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent)$/.test(k)))throw d("badident",
k);var w,A,G,z,y={$id:Ma};q?w=a(q):(G=function(a,c){return Ma(c)},z=function(a){return a});return function(a,f,g,l,n){w&&(A=function(c,d,e){v&&(y[v]=c);y[t]=d;y.$index=e;return w(a,y)});var q=Object.create(null);a.$watchCollection(p,function(g){var l,p,N=f[0],y,w=Object.create(null),L,F,B,D,H,M,ga;k&&(a[k]=g);if(eb(g))H=g,p=A||G;else{p=A||z;H=[];for(ga in g)g.hasOwnProperty(ga)&&"$"!=ga.charAt(0)&&H.push(ga);H.sort()}L=H.length;ga=Array(L);for(l=0;l<L;l++)if(F=g===H?l:H[l],B=g[F],D=p(F,B,l),q[D])M=
q[D],delete q[D],w[D]=M,ga[l]=M;else{if(w[D])throw r(ga,function(a){a&&a.scope&&(q[a.id]=a)}),d("dupes",h,D,sa(B));ga[l]={id:D,scope:s,clone:s};w[D]=!0}for(y in q){M=q[y];D=lb(M.clone);c.leave(D);if(D[0].parent)for(l=0,p=D.length;l<p;l++)D[l].$$NG_REMOVED=!0;M.scope.$destroy()}for(l=0;l<L;l++)if(F=g===H?l:H[l],B=g[F],M=ga[l],M.scope){y=N;do y=y.nextSibling;while(y&&y.$$NG_REMOVED);M.clone[0]!=y&&c.move(lb(M.clone),null,x(N));N=M.clone[M.clone.length-1];e(M.scope,l,t,B,v,F,L)}else n(function(a,d){M.scope=
d;var f=m.cloneNode(!1);a[a.length++]=f;c.enter(a,null,x(N));N=f;M.clone=a;w[M.id]=M;e(M.scope,l,t,B,v,F,L)});q=w})}}}}],Yd=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,function(c){a[c?"removeClass":"addClass"](d,"ng-hide")})}}}],Rd=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngHide,function(c){a[c?"addClass":"removeClass"](d,"ng-hide")})}}}],Zd=Ea(function(a,c,d){a.$watch(d.ngStyle,function(a,d){d&&
a!==d&&r(d,function(a,d){c.css(d,"")});a&&c.css(a)},!0)}),$d=["$animate",function(a){return{restrict:"EA",require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,f){var g=[],h=[],m=[],l=[];c.$watch(e.ngSwitch||e.on,function(c){var d,e;d=0;for(e=m.length;d<e;++d)a.cancel(m[d]);d=m.length=0;for(e=l.length;d<e;++d){var q=lb(h[d].clone);l[d].$destroy();(m[d]=a.leave(q)).then(function(){m.splice(d,1)})}h.length=0;l.length=0;(g=f.cases["!"+c]||f.cases["?"])&&r(g,function(c){c.transclude(function(d,
...
q&&e.$watchCollection(function(){return g.$modelValue},function(){A||(e.$$postDigest(h),A=!0)})}if(m[1]){var k=m[0];m=m[1];var q=h.multiple,t=h.ngOptions,v=!1,y,A=!1,D=x(Y.createElement("option")),z=x(Y.createElement("optgroup")),B=D.clone();h=0;for(var C=g.children(),E=C.length;h<E;h++)if(""===C[h].value){y=v=C.eq(h);break}k.init(m,v,B);q&&(m.$isEmpty=function(a){return!a||0===a.length});t?p(e,g,m):q?n(e,g,m):l(e,g,m,k)}}}}],Hd=["$interpolate",function(a){var c={addOption:y,removeOption:y};return{restrict:"E",
priority:100,compile:function(d,e){if(F(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var l=d.parent(),n=l.data("$selectController")||l.parent().data("$selectController");n&&n.databound?d.prop("selected",!1):n=c;f?a.$watch(f,function(a,c){e.$set("value",a);c!==a&&n.removeOption(c);n.addOption(a,d)}):n.addOption(e.value,d);d.on("$destroy",function(){n.removeOption(e.value)})}}}}],Gd=fa({restrict:"E",terminal:!1});P.angular.bootstrap?console.log("WARNING: Tried to load angular more than once."):
