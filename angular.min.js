...
b.trim():b}:function(b){return C(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}();Ka=9>S?function(b){b=b.nodeName?b:b[0];return b.scopeName&&"HTML"!=b.scopeName?Ga(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var Xc=/[A-Z]/g,$c={full:"1.2.18-build.236+sha.299a327",major:1,minor:2,dot:18,codeName:"snapshot"},Wa=N.cache={},jb=N.expando="ng"+(new Date).getTime(),me=1,qb=Q.document.addEventListener?function(b,a,c){b.addEventListener(a,c,!1)}:function(b,
