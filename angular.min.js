/*
 ...
 License: MIT
*/
(function(x){'use strict';function oe(a){if(C(a))t(a.objectMaxDepth)&&(Oc.objectMaxDepth=Wb(a.objectMaxDepth)?a.objectMaxDepth:NaN);else return Oc}function Wb(a){return Y(a)&&0<a}function L(a,b){b=b||Error;return function(){var d=arguments[0],c;c="["+(a?a+":":"")+d+"] http://errors.angularjs.org/1.6.7-build.5502+sha.f2f5ac7/"+(a?a+"/":"")+d;for(d=1;d<arguments.length;d++){c=c+(1==d?"?":"&")+"p"+(d-1)+"=";var e=encodeURIComponent,f;f=arguments[d];f="function"==typeof f?f.toString().replace(/ \{[\s\S]*$/,
...
element:B,forEach:q,injector:ib,noop:A,bind:Va,toJson:gb,fromJson:Tc,identity:Ta,isUndefined:w,isDefined:t,isString:E,isFunction:z,isObject:C,isNumber:Y,isElement:Zb,isArray:G,version:Ge,isDate:ea,callbacks:{$$counter:0},getTestability:ze,reloadWithDebugInfo:ye,$$minErr:L,$$csp:Ja,$$encodeUriSegment:hb,$$encodeUriQuery:ka,$$lowercase:O,$$stringify:gc,$$uppercase:wb});hc=De(x);hc("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:He});a.provider("$compile",Zc).directive({a:Ie,input:$c,
...
d.hash();var b;a?(b=k.getElementById(a))?f(b):(b=e(k.getElementsByName(a)))?f(b):"top"===a&&f(null):f(null)}var k=b.document;a&&c.$watch(function(){return d.hash()},function(a,b){a===b&&""===a||ig(function(){c.$evalAsync(g)})});return g}]}function lb(a,b){if(!a&&!b)return"";if(!a)return b;if(!b)return a;G(a)&&(a=a.join(" "));G(b)&&(b=b.join(" "));return a+" "+b}function rg(a){E(a)&&(a=a.split(" "));var b=S();q(a,function(a){a.length&&(b[a]=!0)});return b}function Ka(a){return C(a)?a:{}}function sg(a,
...
c.match(ud);if(!g)throw vd("ctrlfmt",c);h=g[1];l=l||g[3];c=a.hasOwnProperty(h)?a[h]:Ce(e.$scope,h,!0);if(!c)throw vd("ctrlreg",h);ub(c,h,!0)}if(f)return f=(G(c)?c[c.length-1]:c).prototype,k=Object.create(f||null),l&&d(e,l,k,h||c.name),Q(function(){var a=b.invoke(c,k,e,h);a!==k&&(C(a)||z(a))&&(k=a,l&&d(e,l,k,h||c.name));return k},{instance:k,identifier:l});k=b.instantiate(c,e,h);l&&d(e,l,k,h||c.name);return k}}]}function Af(){this.$get=["$window",function(a){return B(a.document)}]}function Bf(){this.$get=
["$document","$rootScope",function(a,b){function d(){e=c.hidden}var c=a[0],e=c&&c.hidden;a.on("visibilitychange",d);b.$on("$destroy",function(){a.off("visibilitychange",d)});return function(){return e}}]}function Cf(){this.$get=["$log",function(a){return function(b,d){a.error.apply(a,arguments)}}]}function sc(a){return C(a)?ea(a)?a.toISOString():gb(a):a}function Hf(){this.$get=function(){return function(a){if(!a)return"";var b=[];Qc(a,function(a,c){null===a||w(a)||z(a)||(G(a)?q(a,function(a){b.push(ka(c)+
"="+ka(sc(a)))}):b.push(ka(c)+"="+ka(sc(a))))});return b.join("&")}}}function If(){this.$get=function(){return function(a){function b(a,e,f){G(a)?q(a,function(a,c){b(a,e+"["+(C(a)?c:"")+"]")}):C(a)&&!ea(a)?Qc(a,function(a,c){b(a,e+(f?"":"[")+c+(f?"":"]"))}):(z(a)&&(a=a()),d.push(ka(e)+"="+(null==a?"":ka(sc(a)))))}if(!a)return"";var d=[];b(a,"",!0);return d.join("&")}}}function tc(a,b){if(E(a)){var d=a.replace(wg,"").trim();if(d){var c=b("Content-Type"),c=c&&0===c.indexOf(wd),e;(e=c)||(e=(e=d.match(xg))&&
yg[e[0]].test(d));if(e)try{a=Tc(d)}catch(f){if(!c)return a;throw Mb("baddata",a,f);}}}return a}function xd(a){var b=S(),d;E(a)?q(a.split("\n"),function(a){d=a.indexOf(":");var e=O(R(a.substr(0,d)));a=R(a.substr(d+1));e&&(b[e]=b[e]?b[e]+", "+a:a)}):C(a)&&q(a,function(a,d){var f=O(d),g=R(a);f&&(b[f]=b[f]?b[f]+", "+g:g)});return b}function yd(a){var b;return function(d){b||(b=xd(a));return d?(d=b[O(d)],void 0===d&&(d=null),d):b}}function zd(a,b,d,c){if(z(c))return c(a,b,d);q(c,function(c){a=c(a,b,d)});
return a}function Gf(){var a=this.defaults={transformResponse:[tc],transformRequest:[function(a){return C(a)&&"[object File]"!==ja.call(a)&&"[object Blob]"!==ja.call(a)&&"[object FormData]"!==ja.call(a)?gb(a):a}],headers:{common:{Accept:"application/json, text/plain, */*"},post:la(uc),put:la(uc),patch:la(uc)},xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",paramSerializer:"$httpParamSerializer",jsonpCallbackParam:"callback"},b=!1;this.useApplyAsync=function(a){return t(a)?(b=!!a,this):b};
...
if(!C(b))throw L("$http")("badreq",b);if(!E(m.valueOf(b.url)))throw L("$http")("badreq",b.url);var g=Q({method:"get",transformRequest:a.transformRequest,transformResponse:a.transformResponse,paramSerializer:a.paramSerializer,jsonpCallbackParam:a.jsonpCallbackParam},b);g.headers=function(b){var c=a.headers,d=Q({},b.headers),f,g,h,c=Q({},c.common,c[O(b.method)]);a:for(f in c){g=O(f);for(h in d)if(O(h)===g)continue a;d[f]=c[f]}return e(d,la(b))}(b);g.method=wb(g.method);g.paramSerializer=E(g.paramSerializer)?
l.get(g.paramSerializer):g.paramSerializer;c.$$incOutstandingRequestCount();var k=[],n=[];b=h.resolve(g);q(v,function(a){(a.request||a.requestError)&&k.unshift(a.request,a.requestError);(a.response||a.responseError)&&n.push(a.response,a.responseError)});b=d(b,k);b=b.then(function(b){var c=b.headers,d=zd(b.data,yd(c),void 0,b.transformRequest);w(d)&&q(c,function(a,b){"content-type"===O(b)&&delete c[b]});w(b.withCredentials)&&!w(a.withCredentials)&&(b.withCredentials=a.withCredentials);return p(b,d).then(f,
f)});b=d(b,n);return b=b.finally(function(){c.$$completeOutstandingRequest(A)})}function p(c,d){function g(a){if(a){var c={};q(a,function(a,d){c[d]=function(c){function d(){a(c)}b?k.$applyAsync(d):k.$$phase?d():k.$apply(d)}});return c}}function l(a,c,d,e,f){function g(){p(c,a,d,e,f)}N&&(200<=a&&300>a?N.put(ba,[a,c,xd(d),e,f]):N.remove(ba));b?k.$applyAsync(g):(g(),k.$$phase||k.$apply())}function p(a,b,d,e,f){b=-1<=b?b:0;(200<=b&&300>b?D.resolve:D.reject)({data:a,status:b,headers:yd(d),config:c,statusText:e,
xhrStatus:f})}function v(a){p(a.data,a.status,la(a.headers()),a.statusText,a.xhrStatus)}function F(){var a=n.pendingRequests.indexOf(c);-1!==a&&n.pendingRequests.splice(a,1)}var D=h.defer(),V=D.promise,N,J,K=c.headers,r="jsonp"===O(c.method),ba=c.url;r?ba=m.getTrustedResourceUrl(ba):E(ba)||(ba=m.valueOf(ba));ba=u(ba,c.paramSerializer(c.params));r&&(ba=y(ba,c.jsonpCallbackParam));n.pendingRequests.push(c);V.then(F,F);!c.cache&&!a.cache||!1===c.cache||"GET"!==c.method&&"JSONP"!==c.method||(N=C(c.cache)?
c.cache:C(a.cache)?a.cache:I);N&&(J=N.get(ba),t(J)?J&&z(J.then)?J.then(v,v):G(J)?p(J[1],J[0],la(J[2]),J[3],J[4]):p(J,200,{},"OK","complete"):N.put(ba,V));w(J)&&((J=vc(c.url,Ad)?f()[c.xsrfCookieName||a.xsrfCookieName]:void 0)&&(K[c.xsrfHeaderName||a.xsrfHeaderName]=J),e(c.method,ba,d,l,K,c.timeout,c.withCredentials,c.responseType,g(c.eventHandlers),g(c.uploadEventHandlers)));return V}function u(a,b){0<b.length&&(a+=(-1===a.indexOf("?")?"?":"&")+b);return a}function y(a,b){var c=a.split("?");if(2<c.length)throw Mb("badjsonp",
...
!0))}}});nb(l.absUrl())!==nb(n)&&c.url(l.absUrl(),!0);var I=!0;c.onUrlChange(function(a,b){xc(a,u)?(d.$evalAsync(function(){var c=l.absUrl(),e=l.$$state,f;a=nb(a);l.$$parse(a);l.$$state=b;f=d.$broadcast("$locationChangeStart",a,c,b,e).defaultPrevented;l.absUrl()===a&&(f?(l.$$parse(c),l.$$state=e,k(c,!1,e)):(I=!1,h(c,e)))}),d.$$phase||d.$digest()):g.location.href=a});d.$watch(function(){if(I||l.$$urlUpdatedByLocation){l.$$urlUpdatedByLocation=!1;var a=nb(c.url()),b=nb(l.absUrl()),f=c.state(),g=l.$$replace,
...
yb)]=function(b){return g(a,b)}});return c}]}function Uf(){this.$get=["$window","$document",function(a,b){var d={},c=!((!a.nw||!a.nw.process)&&a.chrome&&(a.chrome.app&&a.chrome.app.runtime||!a.chrome.app&&a.chrome.runtime&&a.chrome.runtime.id))&&a.history&&a.history.pushState,e=Z((/android (\d+)/.exec(O((a.navigator||{}).userAgent))||[])[1]),f=/Boxee/i.test((a.navigator||{}).userAgent),g=b[0]||{},k=g.body&&g.body.style,h=!1,l=!1;k&&(h=!!("transition"in k||"webkitTransition"in k),l=!!("animation"in
...
this.$pristine=!0;this.$submitted=this.$invalid=!1;this.$$parentForm=Qb;this.$$element=a;this.$$animate=c;Zd(this)}function Zd(a){a.$$classCache={};a.$$classCache[$d]=!(a.$$classCache[pb]=a.$$element.hasClass(pb))}function ae(a){function b(a,b,c){c&&!a.$$classCache[b]?(a.$$animate.addClass(a.$$element,b),a.$$classCache[b]=!0):!c&&a.$$classCache[b]&&(a.$$animate.removeClass(a.$$element,b),a.$$classCache[b]=!1)}function d(a,c,d){c=c?"-"+Xc(c,"-"):"";b(a,pb+c,!0===d);b(a,$d+c,!1===d)}var c=a.set,e=a.unset;
...
b);a.attr("selected",b)}var Oc={objectMaxDepth:5},Wg=/^\/(.+)\/([a-z]*)$/,ra=Object.prototype.hasOwnProperty,O=function(a){return E(a)?a.toLowerCase():a},wb=function(a){return E(a)?a.toUpperCase():a},Da,B,ta,xa=[].slice,vg=[].splice,Xg=[].push,ja=Object.prototype.toString,Rc=Object.getPrototypeOf,za=L("ng"),fa=x.angular||(x.angular={}),hc,sb=0;Da=x.document.documentMode;var X=Number.isNaN||function(a){return a!==a};A.$inject=[];Ta.$inject=[];var G=Array.isArray,se=/^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array]$/,
...
noInlineStyle:!1}}}return Ja.rules},tb=function(){if(t(tb.name_))return tb.name_;var a,b,d=Ha.length,c,e;for(b=0;b<d;++b)if(c=Ha[b],a=x.document.querySelector("["+c.replace(":","\\:")+"jq]")){e=a.getAttribute(c+"jq");break}return tb.name_=e},ue=/:/g,Ha=["ng-","data-ng-","ng:","x-ng-"],xe=function(a){var b=a.currentScript;if(!b)return!0;if(!(b instanceof x.HTMLScriptElement||b instanceof x.SVGScriptElement))return!1;b=b.attributes;return[b.getNamedItem("src"),b.getNamedItem("href"),b.getNamedItem("xlink:href")].every(function(b){if(!b)return!0;
if(!b.value)return!1;var c=a.createElement("a");c.href=b.value;if(a.location.origin===c.origin)return!0;switch(c.protocol){case "http:":case "https:":case "ftp:":case "blob:":case "file:":case "data:":return!0;default:return!1}})}(x.document),Ae=/[A-Z]/g,Yc=!1,Na=3,Ge={full:"1.6.7-build.5502+sha.f2f5ac7",major:1,minor:6,dot:7,codeName:"snapshot"};T.expando="ng339";var kb=T.cache={},hg=1;T._data=function(a){return this.cache[a[this.expando]]||{}};var dg=/-([a-z])/g,Yg=/^-ms-/,Cb={mouseleave:"mouseout",
...
delete d[a]}}}},bh=/^([^?#]*)(\?([^#]*))?(#(.*))?$/,Ag={http:80,https:443,ftp:21},mb=L("$location"),Bg=/^\s*[\\/]{2,}/,ch={$$absUrl:"",$$html5:!1,$$replace:!1,absUrl:Nb("$$absUrl"),url:function(a){if(w(a))return this.$$url;var b=bh.exec(a);(b[1]||""===a)&&this.path(decodeURI(b[1]));(b[2]||b[1]||""===a)&&this.search(b[3]||"");this.hash(b[5]||"");return this},protocol:Nb("$$protocol"),host:Nb("$$host"),port:Nb("$$port"),path:Ed("$$path",function(a){a=null!==a?a.toString():"";return"/"===a.charAt(0)?
a:"/"+a}),search:function(a,b){switch(arguments.length){case 0:return this.$$search;case 1:if(E(a)||Y(a))a=a.toString(),this.$$search=ec(a);else if(C(a))a=pa(a,{}),q(a,function(b,c){null==b&&delete a[c]}),this.$$search=a;else throw mb("isrcharg");break;default:w(b)||null===b?delete this.$$search[a]:this.$$search[a]=b}this.$$compose();return this},hash:Ed("$$hash",function(a){return null!==a?a.toString():""}),replace:function(){this.$$replace=!0;return this}};q([Dd,zc,yc],function(a){a.prototype=Object.create(ch);
a.prototype.state=function(b){if(!arguments.length)return this.$$state;if(a!==yc||!this.$$html5)throw mb("nostate");this.$$state=w(b)?null:b;this.$$urlUpdatedByLocation=!0;return this}});var ab=L("$parse"),Fg={}.constructor.prototype.valueOf,Ub=S();q("+ - * / % === !== == != < > <= >= && || ! = |".split(" "),function(a){Ub[a]=!0});var dh={n:"\n",f:"\f",r:"\r",t:"\t",v:"\v","'":"'",'"':'"'},Cc=function(a){this.options=a};Cc.prototype={constructor:Cc,lex:function(a){this.text=a;this.index=0;for(this.tokens=
...
[];a&&q(a.split(g),function(a){a&&b.push(f?R(a):a)});return b}});c.$formatters.push(function(a){if(G(a))return a.join(e)});c.$isEmpty=function(a){return!a||!a.length}}}},pb="ng-valid",$d="ng-invalid",bb="ng-pristine",Vb="ng-dirty",rb=L("ngModel");Sb.$inject="$scope $exceptionHandler $attrs $element $parse $animate $timeout $q $interpolate".split(" ");Sb.prototype={$$initGetterSetters:function(){if(this.$options.getOption("getterSetter")){var a=this.$$parse(this.$$attr.ngModel+"()"),b=this.$$parse(this.$$attr.ngModel+
