/*
 ...
 License: MIT
*/
(function(P,Y,v){'use strict';function S(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3799+sha.c2031b1/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Oa(b){if(null==b||Pa(b))return!1;var a=b.length;
...
!(!Y.querySelector("[ng-csp]")&&!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Wa.isActive_=b},lb=["ng-","data-ng-","ng:","x-ng-"],Gd=/[A-Z]/g,qc=!1,Kb,na=1,jb=3,Kd={full:"1.4.0-build.3799+sha.c2031b1",major:1,minor:4,dot:0,codeName:"snapshot"};C.expando="ng339";var tb=C.cache={},bf=1;C._data=function(b){return this.cache[b[this.expando]]||{}};var Xe=/([\:\-\_]+(.))/g,Ye=/^moz([A-Z])/,Jf={mouseleave:"mouseout",mouseenter:"mouseover"},Nb=S("jqLite"),af=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,
...
e;return p(a,A)});var t=ea();a.$watchCollection(n,function(g){var k,n,p=f[0],A,C=ea(),D,E,H,B,I,z,K;q&&(a[q]=g);if(Oa(g))I=g,n=u||x;else for(K in n=u||w,I=[],g)g.hasOwnProperty(K)&&"$"!==K.charAt(0)&&I.push(K);D=I.length;K=Array(D);for(k=0;k<D;k++)if(E=g===I?k:I[k],H=g[E],B=n(E,H,k),t[B])z=t[B],delete t[B],C[B]=z,K[k]=z;else{if(C[B])throw r(K,function(a){a&&a.scope&&(t[a.id]=a)}),d("dupes",h,B,H);K[k]={id:B,scope:v,clone:v};C[B]=!0}for(A in t){z=t[A];B=nb(z.clone);c.leave(B);if(B[0].parentNode)for(k=
