...
!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return bb.isActive_=b},lb=function(){if(x(lb.name_))return lb.name_;var b,a,c=Ma.length,d,e;for(a=0;a<c;++a)if(d=Ma[a],b=Y.querySelector("["+d.replace(":","\\:")+"jq]")){e=b.getAttribute(d+"jq");break}return lb.name_=e},Ma=["ng-","data-ng-","ng:","x-ng-"],Vd=/[A-Z]/g,wc=!1,Ob,na=1,$a=3,Zd={full:"1.4.0-build.3941+sha.ffbeb32",major:1,minor:4,dot:0,codeName:"snapshot"};P.expando="ng339";var sb=P.cache={},tf=1;P._data=function(b){return this.cache[b[this.expando]]||
