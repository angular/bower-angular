/*
 ...
 License: MIT
*/
(function(O,Y,u){'use strict';function J(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3948+sha.65bed61/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Ra(b){if(null==b||Sa(b))return!1;var a=b.length;
...
m!==b.history&&(m=b.history);if(a){var f=p===e;if(x===a&&(!d.history||f))return l;var g=x&&Ha(x)===Ha(a);x=a;p=e;!d.history||g&&f?(g||(y=a),c?k.replace(a):g?(c=k,e=a.indexOf("#"),a=-1===e?"":a.substr(e+1),c.hash=a):k.href=a):(m[c?"replaceState":"pushState"](e,"",a),h(),p=v);return l}return y||k.href.replace(/%27/g,"'")};l.state=function(){return v};var L=[],M=!1,B=null;l.onUrlChange=function(a){if(!M){if(d.history)E(b).on("popstate",f);E(b).on("hashchange",f);M=!0}L.push(a);return a};l.$$checkUrlChange=
g;l.baseHref=function(){var a=A.attr("href");return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};l.defer=function(a,b){var c;G++;c=q(function(){delete t[c];e(a)},b||0);t[c]=!0;return c};l.defer.cancel=function(a){return t[a]?(delete t[a],r(a),e(z),!0):!1}}function Ne(){this.$get=["$window","$log","$sniffer","$document",function(b,a,c,d){return new Bf(b,d,a,c)}]}function Oe(){this.$get=function(){function b(b,d){function e(a){a!=q&&(r?r==a&&(r=a.n):r=a,f(a.n,a.p),f(a,q),q=a,q.n=null)}function f(a,
b){a!=b&&(a&&(a.p=b),b&&(b.n=a))}if(b in a)throw J("$cacheFactory")("iid",b);var h=0,g=T({},d,{id:b}),l={},k=d&&d.capacity||Number.MAX_VALUE,m={},q=null,r=null;return a[b]={put:function(a,b){if(!F(b)){if(k<Number.MAX_VALUE){var c=m[a]||(m[a]={key:a});e(c)}a in l||h++;l[a]=b;h>k&&this.remove(r.key);return b}},get:function(a){if(k<Number.MAX_VALUE){var b=m[a];if(!b)return;e(b)}return l[a]},remove:function(a){if(k<Number.MAX_VALUE){var b=m[a];if(!b)return;b==q&&(q=b.p);b==r&&(r=b.n);f(b.n,b.p);delete m[a]}delete l[a];
h--},removeAll:function(){l={};h=0;m={};q=r=null},destroy:function(){m=g=l=null;delete a[b]},info:function(){return T({},g,{size:h})}}}var a={};b.info=function(){var b={};n(a,function(a,e){b[e]=a.info()});return b};b.get=function(b){return a[b]};return b}}function gf(){this.$get=["$cacheFactory",function(b){return b("templates")}]}function xc(b,a){function c(a,b,c){var d=/^\s*([@&]|=(\*?))(\??)\s*(\w*)\s*$/,e={};n(a,function(a,f){var h=a.match(d);if(!h)throw ha("iscp",b,f,a,c?"controller bindings definition":
"isolate scope definition");e[f]={mode:h[1][0],collection:"*"===h[2],optional:"?"===h[3],attrName:h[4]||f}});return e}function d(a){var b=a.charAt(0);if(!b||b!==N(b))throw ha("baddir",a);}var e={},f=/^\s*directive\:\s*([\w\-]+)\s+(.*)$/,h=/(([\w\-]+)(?:\:([^;]+))?;?)/,g=Qd("ngSrc,ngSrcset,src,srcset"),l=/^(?:(\^\^?)?(\?)?(\^\^?)?)?/,k=/^(on[a-z]+|formaction)$/;this.directive=function r(a,f){Pa(a,"directive");D(a)?(d(a),Pb(f,"directiveFactory"),e.hasOwnProperty(a)||(e[a]=[],b.factory(a+"Directive",
["$injector","$exceptionHandler",function(b,d){var f=[];n(e[a],function(e,h){try{var g=b.invoke(e);H(g)?g={compile:pa(g)}:!g.compile&&g.link&&(g.compile=pa(g.link));g.priority=g.priority||0;g.index=h;g.name=g.name||a;g.require=g.require||g.controller&&g.name;g.restrict=g.restrict||"EA";var k=g,l=g,r=g.name,m={isolateScope:null,bindToController:null};C(l.scope)&&(!0===l.bindToController?(m.bindToController=c(l.scope,r,!0),m.isolateScope={}):m.isolateScope=c(l.scope,r,!1));C(l.bindToController)&&(m.bindToController=
c(l.bindToController,r,!0));if(C(m.bindToController)){var G=l.controller,S=l.controllerAs;if(!G)throw ha("noctrl",r);var n;a:if(S&&D(S))n=S;else{if(D(G)){var za=Qc.exec(G);if(za){n=za[3];break a}}n=void 0}if(!n)throw ha("noident",r);}var s=k.$$bindings=m;C(s.isolateScope)&&(g.$$isolateBindings=s.isolateScope);f.push(g)}catch(u){d(u)}});return f}])),e[a].push(f)):n(a,jc(r));return this};this.aHrefSanitizationWhitelist=function(b){return w(b)?(a.aHrefSanitizationWhitelist(b),this):a.aHrefSanitizationWhitelist()};
this.imgSrcSanitizationWhitelist=function(b){return w(b)?(a.imgSrcSanitizationWhitelist(b),this):a.imgSrcSanitizationWhitelist()};var m=!0;this.debugInfoEnabled=function(a){return w(a)?(m=a,this):m};this.$get=["$injector","$interpolate","$exceptionHandler","$templateRequest","$parse","$controller","$rootScope","$document","$sce","$animate","$$sanitizeUri",function(a,b,c,d,v,p,x,s,y,L,M){function B(a,b){try{a.addClass(b)}catch(c){}}function U(a,b,c,d,e){a instanceof E||(a=E(a));n(a,function(b,c){b.nodeType==
$a&&b.nodeValue.match(/\S+/)&&(a[c]=E(b).wrap("<span></span>").parent()[0])});var f=R(a,b,a,c,d,e);U.$$addScopeClass(a);var g=null;return function(b,c,d){Pb(b,"scope");d=d||{};var e=d.parentBoundTranscludeFn,h=d.transcludeControllers;d=d.futureParentElement;e&&e.$$boundTransclude&&(e=e.$$boundTransclude);g||(g=(d=d&&d[0])?"foreignobject"!==sa(d)&&d.toString().match(/SVG/)?"svg":"html":"html");d="html"!==g?E(Vb(g,E("<div>").append(a).html())):c?Na.clone.call(a):a;if(h)for(var k in h)d.data("$"+k+"Controller",
h[k].instance);U.$$addScopeInfo(d,b);c&&c(d,b);f&&f(b,d,d,e);return d}}function R(a,b,c,d,e,f){function g(a,c,d,e){var f,k,l,r,m,t,L;if(p)for(L=Array(c.length),r=0;r<h.length;r+=3)f=h[r],L[f]=c[f];else L=c;r=0;for(m=h.length;r<m;)if(k=L[h[r++]],c=h[r++],f=h[r++],c){if(c.scope){if(l=a.$new(),U.$$addScopeInfo(E(k),l),t=c.$$destroyBindings)c.$$destroyBindings=null,l.$on("$destroyed",t)}else l=a;t=c.transcludeOnThisElement?S(a,c.transclude,e,c.elementTranscludeOnThisElement):!c.templateOnThisElement&&
e?e:!e&&b?S(a,b):null;c(f,l,k,d,t,c)}else f&&f(a,k.childNodes,u,e)}for(var h=[],k,l,r,m,p,t=0;t<a.length;t++){k=new da;l=Ga(a[t],[],k,0===t?d:u,e);(f=l.length?w(l,a[t],k,b,c,null,[],[],f):null)&&f.scope&&U.$$addScopeClass(k.$$element);k=f&&f.terminal||!(r=a[t].childNodes)||!r.length?null:R(r,f?(f.transcludeOnThisElement||!f.templateOnThisElement)&&f.transclude:b);if(f||k)h.push(t,f,k),m=!0,p=p||f;f=null}return m?g:null}function S(a,b,c,d){return function(d,e,f,g,h){d||(d=a.$new(!1,h),d.$$transcluded=
!0);return b(d,e,{parentBoundTranscludeFn:c,transcludeControllers:f,futureParentElement:g})}}function Ga(a,b,c,d,e){var g=c.$attr,k;switch(a.nodeType){case oa:J(b,wa(sa(a)),"E",d,e);for(var l,r,m,p=a.attributes,t=0,L=p&&p.length;t<L;t++){var G=!1,M=!1;l=p[t];k=l.name;r=V(l.value);l=wa(k);if(m=ja.test(l))k=k.replace(Sc,"").substr(8).replace(/_(.)/g,function(a,b){return b.toUpperCase()});var B=l.replace(/(Start|End)$/,"");O(B)&&l===B+"Start"&&(G=k,M=k.substr(0,k.length-5)+"end",k=k.substr(0,k.length-
6));l=wa(k.toLowerCase());g[l]=k;if(m||!c.hasOwnProperty(l))c[l]=r,Lc(a,l)&&(c[l]=!0);$(a,b,r,l,m);J(b,l,"A",d,e,G,M)}a=a.className;C(a)&&(a=a.animVal);if(D(a)&&""!==a)for(;k=h.exec(a);)l=wa(k[2]),J(b,l,"C",d,e)&&(c[l]=V(k[3])),a=a.substr(k.index+k[0].length);break;case $a:xa(b,a.nodeValue);break;case 8:try{if(k=f.exec(a.nodeValue))l=wa(k[1]),J(b,l,"M",d,e)&&(c[l]=V(k[2]))}catch(Q){}}b.sort(Ia);return b}function za(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ha("uterdir",
b,c);a.nodeType==oa&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&e--);d.push(a);a=a.nextSibling}while(0<e)}else d.push(a);return E(d)}function Rc(a,b,c){return function(d,e,f,g,h){e=za(e[0],b,c);return a(d,e,f,g,h)}}function w(a,b,d,e,f,g,h,k,r){function m(a,b,c,d){if(a){c&&(a=Rc(a,c,d));a.require=K.require;a.directiveName=z;if(S===K||K.$$isolateScope)a=ba(a,{isolateScope:!0});h.push(a)}if(b){c&&(b=Rc(b,c,d));b.require=K.require;b.directiveName=z;if(S===K||K.$$isolateScope)b=ba(b,{isolateScope:!0});
k.push(b)}}function t(a,b,c,d){var e;if(D(b)){var f=b.match(l);b=b.substring(f[0].length);var g=f[1]||f[3],f="?"===f[2];"^^"===g?c=c.parent():e=(e=d&&d[b])&&e.instance;e||(d="$"+b+"Controller",e=g?c.inheritedData(d):c.data(d));if(!e&&!f)throw ha("ctreq",b,a);}else if(I(b))for(e=[],g=0,f=b.length;g<f;g++)e[g]=t(a,b[g],c,d);return e||null}function L(a,b,c,d,e,f){var g=ma(),h;for(h in d){var k=d[h],l={$scope:k===S||k.$$isolateScope?e:f,$element:a,$attrs:b,$transclude:c},r=k.controller;"@"==r&&(r=b[k.name]);
l=p(r,l,!0,k.controllerAs);g[k.name]=l;s||a.data("$"+k.name+"Controller",l.instance)}return g}function M(a,c,e,f,g,l){function r(a,b,c){var d;Va(a)||(c=b,b=a,a=u);s&&(d=R);c||(c=s?ia.parent():ia);return g(a,b,d,c,Ga)}var m,p,G,B,R,y,ia;b===e?(f=d,ia=d.$$element):(ia=E(e),f=new da(ia,d));S&&(B=c.$new(!0));g&&(y=r,y.$$boundTransclude=g);v&&(R=L(ia,f,y,v,B,c));S&&(U.$$addScopeInfo(ia,B,!0,!(x&&(x===S||x===S.$$originalDirective))),U.$$addScopeClass(ia,!0),B.$$isolateBindings=S.$$isolateBindings,aa(c,
f,B,B.$$isolateBindings,S,B));if(R){var n=S||Q,za;n&&R[n.name]&&(p=n.$$bindings.bindToController,(G=R[n.name])&&G.identifier&&p&&(za=G,l.$$destroyBindings=aa(c,f,G.instance,p,n)));for(m in R){G=R[m];var A=G();A!==G.instance&&(G.instance=A,ia.data("$"+K.name+"Controller",A),G===za&&(l.$$destroyBindings(),l.$$destroyBindings=aa(c,f,A,p,n)))}}m=0;for(l=h.length;m<l;m++)p=h[m],ca(p,p.isolateScope?B:c,ia,f,p.require&&t(p.directiveName,p.require,ia,R),y);var Ga=c;S&&(S.template||null===S.templateUrl)&&
(Ga=B);a&&a(Ga,e.childNodes,u,g);for(m=k.length-1;0<=m;m--)p=k[m],ca(p,p.isolateScope?B:c,ia,f,p.require&&t(p.directiveName,p.require,ia,R),y)}r=r||{};for(var B=-Number.MAX_VALUE,Q,v=r.controllerDirectives,S=r.newIsolateScopeDirective,x=r.templateDirective,R=r.nonTlbTranscludeDirective,y=!1,n=!1,s=r.hasElementTranscludeDirective,A=d.$$element=E(b),K,z,W,Ia=e,J,xa=0,N=a.length;xa<N;xa++){K=a[xa];var O=K.$$start,T=K.$$end;O&&(A=za(b,O,T));W=u;if(B>K.priority)break;if(W=K.scope)K.templateUrl||(C(W)?
(P("new/isolated scope",S||Q,K,A),S=K):P("new/isolated scope",S,K,A)),Q=Q||K;z=K.name;!K.templateUrl&&K.controller&&(W=K.controller,v=v||ma(),P("'"+z+"' controller",v[z],K,A),v[z]=K);if(W=K.transclude)y=!0,K.$$tlb||(P("transclusion",R,K,A),R=K),"element"==W?(s=!0,B=K.priority,W=A,A=d.$$element=E(Y.createComment(" "+z+": "+d[z]+" ")),b=A[0],Z(f,qa.call(W,0),b),Ia=U(W,e,B,g&&g.name,{nonTlbTranscludeDirective:R})):(W=E(Sb(b)).contents(),A.empty(),Ia=U(W,e));if(K.template)if(n=!0,P("template",x,K,A),
x=K,W=H(K.template)?K.template(A,d):K.template,W=ga(W),K.replace){g=K;W=Qb.test(W)?Tc(Vb(K.templateNamespace,V(W))):[];b=W[0];if(1!=W.length||b.nodeType!==oa)throw ha("tplrt",z,"");Z(f,A,b);N={$attr:{}};W=Ga(b,[],N);var Cf=a.splice(xa+1,a.length-(xa+1));S&&F(W);a=a.concat(W).concat(Cf);Uc(d,N);N=a.length}else A.html(W);if(K.templateUrl)n=!0,P("template",x,K,A),x=K,K.replace&&(g=K),M=Df(a.splice(xa,a.length-xa),A,d,f,y&&Ia,h,k,{controllerDirectives:v,newIsolateScopeDirective:S,templateDirective:x,
nonTlbTranscludeDirective:R}),N=a.length;else if(K.compile)try{J=K.compile(A,d,Ia),H(J)?m(null,J,O,T):J&&m(J.pre,J.post,O,T)}catch(X){c(X,ua(A))}K.terminal&&(M.terminal=!0,B=Math.max(B,K.priority))}M.scope=Q&&!0===Q.scope;M.transcludeOnThisElement=y;M.elementTranscludeOnThisElement=s;M.templateOnThisElement=n;M.transclude=Ia;r.hasElementTranscludeDirective=s;return M}function F(a){for(var b=0,c=a.length;b<c;b++)a[b]=Lb(a[b],{$$isolateScope:!0})}function J(b,d,f,g,h,k,l){if(d===h)return null;h=null;
if(e.hasOwnProperty(d)){var m;d=a.get(d+"Directive");for(var p=0,t=d.length;p<t;p++)try{m=d[p],(g===u||g>m.priority)&&-1!=m.restrict.indexOf(f)&&(k&&(m=Lb(m,{$$start:k,$$end:l})),b.push(m),h=m)}catch(L){c(L)}}return h}function O(b){if(e.hasOwnProperty(b))for(var c=a.get(b+"Directive"),d=0,f=c.length;d<f;d++)if(b=c[d],b.multiElement)return!0;return!1}function Uc(a,b){var c=b.$attr,d=a.$attr,e=a.$$element;n(a,function(d,e){"$"!=e.charAt(0)&&(b[e]&&b[e]!==d&&(d+=("style"===e?";":" ")+b[e]),a.$set(e,
d,!0,c[e]))});n(b,function(b,f){"class"==f?(B(e,b),a["class"]=(a["class"]?a["class"]+" ":"")+b):"style"==f?(e.attr("style",e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==f.charAt(0)||a.hasOwnProperty(f)||(a[f]=b,d[f]=c[f])})}function Df(a,b,c,e,f,g,h,k){var l=[],r,m,p=b[0],t=a.shift(),L=Lb(t,{templateUrl:null,transclude:null,replace:null,$$originalDirective:t}),G=H(t.templateUrl)?t.templateUrl(b,c):t.templateUrl,M=t.templateNamespace;b.empty();d(y.getTrustedResourceUrl(G)).then(function(d){var Q,
v;d=ga(d);if(t.replace){d=Qb.test(d)?Tc(Vb(M,V(d))):[];Q=d[0];if(1!=d.length||Q.nodeType!==oa)throw ha("tplrt",t.name,G);d={$attr:{}};Z(e,b,Q);var x=Ga(Q,[],d);C(t.scope)&&F(x);a=x.concat(a);Uc(c,d)}else Q=p,b.html(d);a.unshift(L);r=w(a,Q,c,f,b,t,g,h,k);n(e,function(a,c){a==Q&&(e[c]=b[0])});for(m=R(b[0].childNodes,f);l.length;){d=l.shift();v=l.shift();var y=l.shift(),U=l.shift(),x=b[0];if(!d.$$destroyed){if(v!==p){var A=v.className;k.hasElementTranscludeDirective&&t.replace||(x=Sb(Q));Z(y,E(v),x);
...
b&&U.$$addBindingClass(a);return function(a,c){var e=c.parent();b||U.$$addBindingClass(e);U.$$addBindingInfo(e,d.expressions);a.$watch(d,function(a){c[0].nodeValue=a})}}})}function Vb(a,b){a=N(a||"html");switch(a){case "svg":case "math":var c=Y.createElement("div");c.innerHTML="<"+a+">"+b+"</"+a+">";return c.childNodes[0].childNodes;default:return b}}function X(a,b){if("srcdoc"==b)return y.HTML;var c=sa(a);if("xlinkHref"==b||"form"==c&&"action"==b||"img"!=c&&("src"==b||"ngSrc"==b))return y.RESOURCE_URL}
function $(a,c,d,e,f){var h=X(a,e);f=g[e]||f;var l=b(d,!0,h,f);if(l){if("multiple"===e&&"select"===sa(a))throw ha("selmulti",ua(a));c.push({priority:100,compile:function(){return{pre:function(a,c,g){c=g.$$observers||(g.$$observers={});if(k.test(e))throw ha("nodomevents");var r=g[e];r!==d&&(l=r&&b(r,!0,h,f),d=r);l&&(g[e]=l(a),(c[e]||(c[e]=[])).$$inter=!0,(g.$$observers&&g.$$observers[e].$$scope||a).$watch(l,function(a,b){"class"===e&&a!=b?g.$updateClass(a,b):g.$set(e,a)}))}}}})}}function Z(a,b,c){var d=
...
arguments)},a,b)}function ca(a,b,d,e,f,g){try{a(b,d,e,f,g)}catch(h){c(h,ua(d))}}function aa(a,c,d,e,f,g){var h;n(e,function(e,g){var k=e.attrName,l=e.optional,r,m,p,L;switch(e.mode){case "@":c.$observe(k,function(a){d[g]=a});c.$$observers[k].$$scope=a;c[k]&&(d[g]=b(c[k])(a));break;case "=":if(l&&!c[k])break;m=v(c[k]);L=m.literal?ka:function(a,b){return a===b||a!==a&&b!==b};p=m.assign||function(){r=d[g]=m(a);throw ha("nonassign",c[k],f.name);};r=d[g]=m(a);l=function(b){L(b,d[g])||(L(b,r)?p(a,b=d[g]):
d[g]=b);return r=b};l.$stateful=!0;l=e.collection?a.$watchCollection(c[k],l):a.$watch(v(c[k],l),null,m.literal);h=h||[];h.push(l);break;case "&":if(!c.hasOwnProperty(k)&&l)break;m=v(c[k]);if(m===z&&l)break;d[g]=function(b){return m(a,b)}}});e=h?function(){for(var a=0,b=h.length;a<b;++a)h[a]()}:z;return g&&e!==z?(g.$on("$destroy",e),z):e}var da=function(a,b){if(b){var c=Object.keys(b),d,e,f;d=0;for(e=c.length;d<e;d++)f=c[d],this[f]=b[f]}else this.$attr={};this.$$element=a};da.prototype={$normalize:wa,
...
g&&"href"===a||"img"===g&&"src"===a)this[a]=b=M(b,"src"===a);else if("img"===g&&"srcset"===a){for(var g="",h=V(b),k=/(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/,k=/\s/.test(h)?k:/(,)/,h=h.split(k),k=Math.floor(h.length/2),l=0;l<k;l++)var r=2*l,g=g+M(V(h[r]),!0),g=g+(" "+V(h[r+1]));h=V(h[2*l]).split(/\s/);g+=M(V(h[0]),!0);2===h.length&&(g+=" "+V(h[1]));this[a]=b=g}!1!==d&&(null===b||b===u?this.$$element.removeAttr(e):this.$$element.attr(e,b));(a=this.$$observers)&&n(a[f],function(a){try{a(b)}catch(d){c(d)}})},
...
n.$parent}while(n=k);if((r||u.length)&&!t--)throw p.$$phase=null,c("infdig",a,y);}while(r||u.length);for(p.$$phase=null;A.length;)try{A.shift()()}catch(F){h(F)}},$destroy:function(){if(!this.$$destroyed){var a=this.$parent;this.$broadcast("$destroy");this.$$destroyed=!0;r(this,-this.$$watchersCount);for(var b in this.$$listenerCount)t(this,this.$$listenerCount[b],b);a&&a.$$childHead==this&&(a.$$childHead=this.$$nextSibling);a&&a.$$childTail==this&&(a.$$childTail=this.$$prevSibling);this.$$prevSibling&&
(this.$$prevSibling.$$nextSibling=this.$$nextSibling);this.$$nextSibling&&(this.$$nextSibling.$$prevSibling=this.$$prevSibling);this.$destroy=this.$digest=this.$apply=this.$evalAsync=this.$applyAsync=z;this.$on=this.$watch=this.$watchGroup=function(){return z};this.$$listeners={};this.$parent=this.$$nextSibling=this.$$prevSibling=this.$$childHead=this.$$childTail=this.$root=this.$$watchers=null}},$eval:function(a,b){return g(a)(this,b)},$evalAsync:function(a,b){p.$$phase||u.length||l.defer(function(){u.length&&
p.$digest()});u.push({scope:this,expression:a,locals:b})},$$postDigest:function(a){A.push(a)},$apply:function(a){try{return q("$apply"),this.$eval(a)}catch(b){h(b)}finally{p.$$phase=null;try{p.$digest()}catch(c){throw h(c),c;}}},$applyAsync:function(a){function b(){c.$eval(a)}var c=this;a&&y.push(b);v()},$on:function(a,b){var c=this.$$listeners[a];c||(this.$$listeners[a]=c=[]);c.push(b);var d=this;do d.$$listenerCount[a]||(d.$$listenerCount[a]=0),d.$$listenerCount[a]++;while(d=d.$parent);var e=this;
...
[],A=p.$$postDigestQueue=[],y=p.$$applyAsyncQueue=[];return p}]}function be(){var b=/^\s*(https?|ftp|mailto|tel|file):/,a=/^\s*((https?|ftp|file|blob):|data:image\/)/;this.aHrefSanitizationWhitelist=function(a){return w(a)?(b=a,this):b};this.imgSrcSanitizationWhitelist=function(b){return w(b)?(a=b,this):a};this.$get=function(){return function(c,d){var e=d?a:b,f;f=Aa(c).href;return""===f||f.match(e)?c:"unsafe:"+f}}}function Rf(b){if("self"===b)return b;if(D(b)){if(-1<b.indexOf("***"))throw Ca("iwcard",
b);b=od(b).replace("\\*\\*",".*").replace("\\*","[^:/.?&;]*");return new RegExp("^"+b+"$")}if(Ua(b))return new RegExp("^"+b.source+"$");throw Ca("imatcher");}function pd(b){var a=[];w(b)&&n(b,function(b){a.push(Rf(b))});return a}function ef(){this.SCE_CONTEXTS=na;var b=["self"],a=[];this.resourceUrlWhitelist=function(a){arguments.length&&(b=pd(a));return b};this.resourceUrlBlacklist=function(b){arguments.length&&(a=pd(b));return a};this.$get=["$injector",function(c){function d(a,b){return"self"===
a?ad(b):!!a.exec(b.href)}function e(a){var b=function(a){this.$$unwrapTrustedValue=function(){return a}};a&&(b.prototype=new a);b.prototype.valueOf=function(){return this.$$unwrapTrustedValue()};b.prototype.toString=function(){return this.$$unwrapTrustedValue().toString()};return b}var f=function(a){throw Ca("unsafe");};c.has("$sanitize")&&(f=c.get("$sanitize"));var h=e(),g={};g[na.HTML]=e(h);g[na.CSS]=e(h);g[na.URL]=e(h);g[na.JS]=e(h);g[na.RESOURCE_URL]=e(g[na.URL]);return{trustAs:function(a,b){var c=
g.hasOwnProperty(a)?g[a]:null;if(!c)throw Ca("icontext",a,b);if(null===b||b===u||""===b)return b;if("string"!==typeof b)throw Ca("itype",a);return new c(b)},getTrusted:function(c,e){if(null===e||e===u||""===e)return e;var h=g.hasOwnProperty(c)?g[c]:null;if(h&&e instanceof h)return e.$$unwrapTrustedValue();if(c===na.RESOURCE_URL){var h=Aa(e.toString()),q,r,t=!1;q=0;for(r=b.length;q<r;q++)if(d(b[q],h)){t=!0;break}if(t)for(q=0,r=a.length;q<r;q++)if(d(a[q],h)){t=!1;break}if(t)return e;throw Ca("insecurl",
e.toString());}if(c===na.HTML)return f(e);throw Ca("unsafe");},valueOf:function(a){return a instanceof h?a.$$unwrapTrustedValue():a}}}]}function df(){var b=!0;this.enabled=function(a){arguments.length&&(b=!!a);return b};this.$get=["$parse","$sceDelegate",function(a,c){if(b&&8>fb)throw Ca("iequirks");var d=fa(na);d.isEnabled=function(){return b};d.trustAs=c.trustAs;d.getTrusted=c.getTrusted;d.valueOf=c.valueOf;b||(d.trustAs=d.getTrusted=function(a,b){return b},d.valueOf=Ta);d.parseAs=function(b,c){var e=
a(c);return e.literal&&e.constant?e:a(c,function(a){return d.getTrusted(b,a)})};var e=d.parseAs,f=d.getTrusted,h=d.trustAs;n(na,function(a,b){var c=N(b);d[db("parse_as_"+c)]=function(b){return e(a,b)};d[db("get_trusted_"+c)]=function(b){return f(a,b)};d[db("trust_as_"+c)]=function(b){return h(a,b)}});return d}]}function ff(){this.$get=["$window","$document",function(b,a){var c={},d=ca((/android (\d+)/.exec(N((b.navigator||{}).userAgent))||[])[1]),e=/Boxee/i.test((b.navigator||{}).userAgent),f=a[0]||
{},h,g=/^(Moz|webkit|ms)(?=[A-Z])/,l=f.body&&f.body.style,k=!1,m=!1;if(l){for(var q in l)if(k=g.exec(q)){h=k[0];h=h.substr(0,1).toUpperCase()+h.substr(1);break}h||(h="WebkitOpacity"in l&&"webkit");k=!!("transition"in l||h+"Transition"in l);m=!!("animation"in l||h+"Animation"in l);!d||k&&m||(k=D(l.webkitTransition),m=D(l.webkitAnimation))}return{history:!(!b.history||!b.history.pushState||4>d||e),hasEvent:function(a){if("input"===a&&11>=fb)return!1;if(F(c[a])){var b=f.createElement("div");c[a]="on"+
a in b}return c[a]},csp:bb(),vendorPrefix:h,transitions:k,animations:m,android:d}}]}function hf(){this.$get=["$templateCache","$http","$q",function(b,a,c){function d(e,f){d.totalPendingRequests++;var h=a.defaults&&a.defaults.transformResponse;I(h)?h=h.filter(function(a){return a!==Wb}):h===Wb&&(h=null);return a.get(e,{cache:b,transformResponse:h})["finally"](function(){d.totalPendingRequests--}).then(function(a){b.put(e,a.data);return a.data},function(a){if(!f)throw ha("tpload",e,a.status,a.statusText);
return c.reject(a)})}d.totalPendingRequests=0;return d}]}function jf(){this.$get=["$rootScope","$browser","$location",function(b,a,c){return{findBindings:function(a,b,c){a=a.getElementsByClassName("ng-binding");var h=[];n(a,function(a){var d=aa.element(a).data("$binding");d&&n(d,function(d){c?(new RegExp("(^|\\s)"+od(b)+"(\\s|\\||$)")).test(d)&&h.push(a):-1!=d.indexOf(b)&&h.push(a)})});return h},findModels:function(a,b,c){for(var h=["ng-","data-ng-","ng\\:"],g=0;g<h.length;++g){var l=a.querySelectorAll("["+
h[g]+"model"+(c?"=":"*=")+'"'+b+'"]');if(l.length)return l}},getLocation:function(){return c.url()},setLocation:function(a){a!==c.url()&&(c.url(a),b.$digest())},whenStable:function(b){a.notifyWhenNoOutstandingRequests(b)}}}]}function kf(){this.$get=["$rootScope","$browser","$q","$$q","$exceptionHandler",function(b,a,c,d,e){function f(f,l,k){H(f)||(k=l,l=f,f=z);var m=qa.call(arguments,3),q=w(k)&&!k,r=(q?d:c).defer(),t=r.promise,n;n=a.defer(function(){try{r.resolve(f.apply(null,m))}catch(a){r.reject(a),
e(a)}finally{delete h[t.$$timeoutId]}q||b.$apply()},l);t.$$timeoutId=n;h[n]=r;return t}var h={};f.cancel=function(b){return b&&b.$$timeoutId in h?(h[b.$$timeoutId].reject("canceled"),delete h[b.$$timeoutId],a.defer.cancel(b.$$timeoutId)):!1};return f}]}function Aa(b){fb&&(Z.setAttribute("href",b),b=Z.href);Z.setAttribute("href",b);return{href:Z.href,protocol:Z.protocol?Z.protocol.replace(/:$/,""):"",host:Z.host,search:Z.search?Z.search.replace(/^\?/,""):"",hash:Z.hash?Z.hash.replace(/^#/,""):"",hostname:Z.hostname,
port:Z.port,pathname:"/"===Z.pathname.charAt(0)?Z.pathname:"/"+Z.pathname}}function ad(b){b=D(b)?Aa(b):b;return b.protocol===qd.protocol&&b.host===qd.host}function lf(){this.$get=pa(O)}function rd(b){function a(a){try{return decodeURIComponent(a)}catch(b){return a}}var c=b[0],d={},e="";return function(){var b,h,g,l,k;if(c.cookie!==e)for(e=c.cookie,b=e.split("; "),d={},g=0;g<b.length;g++)h=b[g],l=h.indexOf("="),0<l&&(k=a(h.substring(0,l)),d[k]===u&&(d[k]=a(h.substring(l+1))));return d}}function qf(){this.$get=
rd}function Ec(b){function a(c,d){if(C(c)){var e={};n(c,function(b,c){e[c]=a(c,b)});return e}return b.factory(c+"Filter",d)}this.register=a;this.$get=["$injector",function(a){return function(b){return a.get(b+"Filter")}}];a("currency",sd);a("date",td);a("filter",Sf);a("json",Tf);a("limitTo",Uf);a("lowercase",Vf);a("number",ud);a("orderBy",vd);a("uppercase",Wf)}function Sf(){return function(b,a,c){if(!I(b)){if(null==b)return b;throw J("filter")("notarray",b);}var d;switch(ec(a)){case "function":break;
...
h=ec(a);if("string"===h&&"!"===a.charAt(0))return!Ka(b,a.substring(1),c,d);if(I(b))return b.some(function(b){return Ka(b,a,c,d)});switch(f){case "object":var g;if(d){for(g in b)if("$"!==g.charAt(0)&&Ka(b[g],a,c,!0))return!0;return e?!1:Ka(b,a,c,!1)}if("object"===h){for(g in a)if(e=a[g],!H(e)&&!F(e)&&(f="$"===g,!Ka(f?b:b[g],e,c,f,f)))return!1;return!0}return c(b,a);case "function":return!1;default:return c(b,a)}}function ec(b){return null===b?"null":typeof b}function sd(b){var a=b.NUMBER_FORMATS;return function(b,
d,e){F(d)&&(d=a.CURRENCY_SYM);F(e)&&(e=a.PATTERNS[1].maxFrac);return null==b?b:wd(b,a.PATTERNS[1],a.GROUP_SEP,a.DECIMAL_SEP,e).replace(/\u00A4/g,d)}}function ud(b){var a=b.NUMBER_FORMATS;return function(b,d){return null==b?b:wd(b,a.PATTERNS[0],a.GROUP_SEP,a.DECIMAL_SEP,d)}}function wd(b,a,c,d,e){if(C(b))return"";var f=0>b;b=Math.abs(b);var h=Infinity===b;if(!h&&!isFinite(b))return"";var g=b+"",l="",k=!1,m=[];h&&(l="\u221e");if(!h&&-1!==g.indexOf("e")){var q=g.match(/([\d\.]+)e(-?)(\d+)/);q&&"-"==
q[2]&&q[3]>e+1?b=0:(l=g,k=!0)}if(h||k)0<e&&1>b&&(l=b.toFixed(e),b=parseFloat(l));else{h=(g.split(xd)[1]||"").length;F(e)&&(e=Math.min(Math.max(a.minFrac,h),a.maxFrac));b=+(Math.round(+(b.toString()+"e"+e)).toString()+"e"+-e);var h=(""+b).split(xd),g=h[0],h=h[1]||"",q=0,r=a.lgSize,t=a.gSize;if(g.length>=r+t)for(q=g.length-r,k=0;k<q;k++)0===(q-k)%t&&0!==k&&(l+=c),l+=g.charAt(k);for(k=q;k<g.length;k++)0===(g.length-k)%r&&0!==k&&(l+=c),l+=g.charAt(k);for(;h.length<e;)h+="0";e&&"0"!==e&&(l+=d+h.substr(0,
e))}0===b&&(f=!1);m.push(f?a.negPre:a.posPre,l,f?a.negSuf:a.posSuf);return m.join("")}function Db(b,a,c){var d="";0>b&&(d="-",b=-b);for(b=""+b;b.length<a;)b="0"+b;c&&(b=b.substr(b.length-a));return d+b}function ba(b,a,c,d){c=c||0;return function(e){e=e["get"+b]();if(0<c||e>-c)e+=c;0===e&&-12==c&&(e=12);return Db(e,a,d)}}function Eb(b,a){return function(c,d){var e=c["get"+b](),f=nb(a?"SHORT"+b:b);return d[f][e]}}function yd(b){var a=(new Date(b,0,1)).getDay();return new Date(b,0,(4>=a?5:12)-a)}function zd(b){return function(a){var c=
yd(a.getFullYear());a=+new Date(a.getFullYear(),a.getMonth(),a.getDate()+(4-a.getDay()))-+c;a=1+Math.round(a/6048E5);return Db(a,b)}}function fc(b,a){return 0>=b.getFullYear()?a.ERAS[0]:a.ERAS[1]}function td(b){function a(a){var b;if(b=a.match(c)){a=new Date(0);var f=0,h=0,g=b[8]?a.setUTCFullYear:a.setFullYear,l=b[8]?a.setUTCHours:a.setHours;b[9]&&(f=ca(b[9]+b[10]),h=ca(b[9]+b[11]));g.call(a,ca(b[1]),ca(b[2])-1,ca(b[3]));f=ca(b[4]||0)-f;h=ca(b[5]||0)-h;g=ca(b[6]||0);b=Math.round(1E3*parseFloat("0."+
(b[7]||0)));l.call(a,f,h,g,b)}return a}var c=/^(\d{4})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/;return function(c,e,f){var h="",g=[],l,k;e=e||"mediumDate";e=b.DATETIME_FORMATS[e]||e;D(c)&&(c=Yf.test(c)?ca(c):a(c));X(c)&&(c=new Date(c));if(!ea(c)||!isFinite(c.getTime()))return c;for(;e;)(k=Zf.exec(e))?(g=Ya(g,k,1),e=g.pop()):(g.push(e),e=null);var m=c.getTimezoneOffset();f&&(m=pc(f,c.getTimezoneOffset()),c=Mb(c,f,!0));n(g,function(a){l=$f[a];h+=l?
l(c,b.DATETIME_FORMATS,m):a.replace(/(^'|'$)/g,"").replace(/''/g,"'")});return h}}function Tf(){return function(b,a){F(a)&&(a=2);return Za(b,a)}}function Uf(){return function(b,a,c){a=Infinity===Math.abs(Number(a))?Number(a):ca(a);if(isNaN(a))return b;X(b)&&(b=b.toString());if(!I(b)&&!D(b))return b;c=!c||isNaN(c)?0:ca(c);c=0>c&&c>=-b.length?b.length+c:c;return 0<=a?b.slice(c,c+a):0===c?b.slice(a,b.length):b.slice(Math.max(0,c+a),c)}}function vd(b){return function(a,c,d){function e(a,b){return b?function(b,
c){return a(c,b)}:a}function f(a){switch(typeof a){case "number":case "boolean":case "string":return!0;default:return!1}}function h(a){return null===a?"null":"function"===typeof a.valueOf&&(a=a.valueOf(),f(a))||"function"===typeof a.toString&&(a=a.toString(),f(a))?a:""}function g(a,b){var c=typeof a,d=typeof b;c===d&&"object"===c&&(a=h(a),b=h(b));return c===d?("string"===c&&(a=a.toLowerCase(),b=b.toLowerCase()),a===b?0:a<b?-1:1):c<d?-1:1}if(!Ra(a))return a;c=I(c)?c:[c];0===c.length&&(c=["+"]);c=c.map(function(a){var c=
!1,d=a||Ta;if(D(a)){if("+"==a.charAt(0)||"-"==a.charAt(0))c="-"==a.charAt(0),a=a.substring(1);if(""===a)return e(g,c);d=b(a);if(d.constant){var f=d();return e(function(a,b){return g(a[f],b[f])},c)}}return e(function(a,b){return g(d(a),d(b))},c)});return qa.call(a).sort(e(function(a,b){for(var d=0;d<c.length;d++){var e=c[d](a,b);if(0!==e)return e}return 0},d))}}function La(b){H(b)&&(b={link:b});b.restrict=b.restrict||"AC";return pa(b)}function Ad(b,a,c,d,e){var f=this,h=[],g=f.$$parentForm=b.parent().controller("form")||
Fb;f.$error={};f.$$success={};f.$pending=u;f.$name=e(a.name||a.ngForm||"")(c);f.$dirty=!1;f.$pristine=!0;f.$valid=!0;f.$invalid=!1;f.$submitted=!1;g.$addControl(f);f.$rollbackViewValue=function(){n(h,function(a){a.$rollbackViewValue()})};f.$commitViewValue=function(){n(h,function(a){a.$commitViewValue()})};f.$addControl=function(a){Pa(a.$name,"input");h.push(a);a.$name&&(f[a.$name]=a)};f.$$renameControl=function(a,b){var c=a.$name;f[c]===a&&delete f[c];f[b]=a;a.$name=b};f.$removeControl=function(a){a.$name&&
...
f.$setPristine=function(){d.setClass(b,Qa,Gb+" ng-submitted");f.$dirty=!1;f.$pristine=!0;f.$submitted=!1;n(h,function(a){a.$setPristine()})};f.$setUntouched=function(){n(h,function(a){a.$setUntouched()})};f.$setSubmitted=function(){d.addClass(b,"ng-submitted");f.$submitted=!0;g.$setSubmitted()}}function gc(b){b.$formatters.push(function(a){return b.$isEmpty(a)?a:a.toString()})}function gb(b,a,c,d,e,f){var h=N(a[0].type);if(!e.android){var g=!1;a.on("compositionstart",function(a){g=!0});a.on("compositionend",
function(){g=!1;l()})}var l=function(b){k&&(f.defer.cancel(k),k=null);if(!g){var e=a.val();b=b&&b.type;"password"===h||c.ngTrim&&"false"===c.ngTrim||(e=V(e));(d.$viewValue!==e||""===e&&d.$$hasNativeValidators)&&d.$setViewValue(e,b)}};if(e.hasEvent("input"))a.on("input",l);else{var k,m=function(a,b,c){k||(k=f.defer(function(){k=null;b&&b.value===c||l(a)}))};a.on("keydown",function(a){var b=a.keyCode;91===b||15<b&&19>b||37<=b&&40>=b||m(a,this,this.value)});if(e.hasEvent("paste"))a.on("paste cut",m)}a.on("change",
l);d.$render=function(){a.val(d.$isEmpty(d.$viewValue)?"":d.$viewValue)}}function Hb(b,a){return function(c,d){var e,f;if(ea(c))return c;if(D(c)){'"'==c.charAt(0)&&'"'==c.charAt(c.length-1)&&(c=c.substring(1,c.length-1));if(ag.test(c))return new Date(c);b.lastIndex=0;if(e=b.exec(c))return e.shift(),f=d?{yyyy:d.getFullYear(),MM:d.getMonth()+1,dd:d.getDate(),HH:d.getHours(),mm:d.getMinutes(),ss:d.getSeconds(),sss:d.getMilliseconds()/1E3}:{yyyy:1970,MM:1,dd:1,HH:0,mm:0,ss:0,sss:0},n(e,function(b,c){c<
a.length&&(f[a[c]]=+b)}),new Date(f.yyyy,f.MM-1,f.dd,f.HH,f.mm,f.ss||0,1E3*f.sss||0)}return NaN}}function hb(b,a,c,d){return function(e,f,h,g,l,k,m){function q(a){return a&&!(a.getTime&&a.getTime()!==a.getTime())}function r(a){return w(a)?ea(a)?a:c(a):u}Cd(e,f,h,g);gb(e,f,h,g,l,k);var t=g&&g.$options&&g.$options.timezone,n;g.$$parserName=b;g.$parsers.push(function(b){return g.$isEmpty(b)?null:a.test(b)?(b=c(b,n),t&&(b=Mb(b,t)),b):u});g.$formatters.push(function(a){if(a&&!ea(a))throw Ib("datefmt",
a);if(q(a))return(n=a)&&t&&(n=Mb(n,t,!0)),m("date")(a,d,t);n=null;return""});if(w(h.min)||h.ngMin){var s;g.$validators.min=function(a){return!q(a)||F(s)||c(a)>=s};h.$observe("min",function(a){s=r(a);g.$validate()})}if(w(h.max)||h.ngMax){var v;g.$validators.max=function(a){return!q(a)||F(v)||c(a)<=v};h.$observe("max",function(a){v=r(a);g.$validate()})}}}function Cd(b,a,c,d){(d.$$hasNativeValidators=C(a[0].validity))&&d.$parsers.push(function(b){var c=a.prop("validity")||{};return c.badInput&&!c.typeMismatch?
u:b})}function Dd(b,a,c,d,e){if(w(d)){b=b(d);if(!b.constant)throw J("ngModel")("constexpr",c,d);return b(a)}return e}function hc(b,a){b="ngClass"+b;return["$animate",function(c){function d(a,b){var c=[],d=0;a:for(;d<a.length;d++){for(var e=a[d],m=0;m<b.length;m++)if(e==b[m])continue a;c.push(e)}return c}function e(a){var b=[];return I(a)?(n(a,function(a){b=b.concat(e(a))}),b):D(a)?a.split(" "):C(a)?(n(a,function(a,c){a&&(b=b.concat(c.split(" ")))}),b):a}return{restrict:"AC",link:function(f,h,g){function l(a,
b){var c=h.data("$classCounts")||{},d=[];n(a,function(a){if(0<b||c[a])c[a]=(c[a]||0)+b,c[a]===+(0<b)&&d.push(a)});h.data("$classCounts",c);return d.join(" ")}function k(b){if(!0===a||f.$index%2===a){var k=e(b||[]);if(!m){var t=l(k,1);g.$addClass(t)}else if(!ka(b,m)){var n=e(m),t=d(k,n),k=d(n,k),t=l(t,1),k=l(k,-1);t&&t.length&&c.addClass(h,t);k&&k.length&&c.removeClass(h,k)}}m=fa(b)}var m;f.$watch(g[b],k,!0);g.$observe("class",function(a){k(f.$eval(g[b]))});"ngClass"!==b&&f.$watch("$index",function(c,
d){var h=c&1;if(h!==(d&1)){var k=e(f.$eval(g[b]));h===a?(h=l(k,1),g.$addClass(h)):(h=l(k,-1),g.$removeClass(h))}})}}}]}function Bd(b){function a(a,b){b&&!f[a]?(k.addClass(e,a),f[a]=!0):!b&&f[a]&&(k.removeClass(e,a),f[a]=!1)}function c(b,c){b=b?"-"+uc(b,"-"):"";a(ib+b,!0===c);a(Ed+b,!1===c)}var d=b.ctrl,e=b.$element,f={},h=b.set,g=b.unset,l=b.parentForm,k=b.$animate;f[Ed]=!(f[ib]=e.hasClass(ib));d.$setValidity=function(b,e,f){e===u?(d.$pending||(d.$pending={}),h(d.$pending,b,f)):(d.$pending&&g(d.$pending,
b,f),Fd(d.$pending)&&(d.$pending=u));Wa(e)?e?(g(d.$error,b,f),h(d.$$success,b,f)):(h(d.$error,b,f),g(d.$$success,b,f)):(g(d.$error,b,f),g(d.$$success,b,f));d.$pending?(a(Gd,!0),d.$valid=d.$invalid=u,c("",null)):(a(Gd,!1),d.$valid=Fd(d.$error),d.$invalid=!d.$valid,c("",d.$valid));e=d.$pending&&d.$pending[b]?u:d.$error[b]?!1:d.$$success[b]?!0:null;c(b,e);l.$setValidity(b,e,d)}}function Fd(b){if(b)for(var a in b)return!1;return!0}var bg=/^\/(.+)\/([a-z]*)$/,N=function(b){return D(b)?b.toLowerCase():
b},sc=Object.prototype.hasOwnProperty,nb=function(b){return D(b)?b.toUpperCase():b},fb,E,la,qa=[].slice,Ef=[].splice,cg=[].push,ra=Object.prototype.toString,Da=J("ng"),aa=O.angular||(O.angular={}),cb,jb=0;fb=Y.documentMode;z.$inject=[];Ta.$inject=[];var I=Array.isArray,mc=/^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/,V=function(b){return D(b)?b.trim():b},od=function(b){return b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")},
bb=function(){if(w(bb.isActive_))return bb.isActive_;var b=!(!Y.querySelector("[ng-csp]")&&!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return bb.isActive_=b},lb=function(){if(w(lb.name_))return lb.name_;var b,a,c=Ma.length,d,e;for(a=0;a<c;++a)if(d=Ma[a],b=Y.querySelector("["+d.replace(":","\\:")+"jq]")){e=b.getAttribute(d+"jq");break}return lb.name_=e},Ma=["ng-","data-ng-","ng:","x-ng-"],Wd=/[A-Z]/g,vc=!1,Ob,oa=1,$a=3,$d={full:"1.4.0-build.3948+sha.65bed61",major:1,
minor:4,dot:0,codeName:"snapshot"};P.expando="ng339";var sb=P.cache={},wf=1;P._data=function(b){return this.cache[b[this.expando]]||{}};var rf=/([\:\-\_]+(.))/g,sf=/^moz([A-Z])/,dg={mouseleave:"mouseout",mouseenter:"mouseover"},Rb=J("jqLite"),vf=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Qb=/<|&#?\w+;/,tf=/<([\w:]+)/,uf=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,ga={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],
tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};ga.optgroup=ga.option;ga.tbody=ga.tfoot=ga.colgroup=ga.caption=ga.thead;ga.th=ga.td;var Na=P.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===Y.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),P(O).on("load",a))},toString:function(){var b=[];n(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?E(this[b]):E(this[this.length+
b])},length:0,push:cg,sort:[].sort,splice:[].splice},xb={};n("multiple selected checked disabled readOnly required open".split(" "),function(b){xb[N(b)]=b});var Mc={};n("input select option textarea button form details".split(" "),function(b){Mc[b]=!0});var Nc={ngMinlength:"minlength",ngMaxlength:"maxlength",ngMin:"min",ngMax:"max",ngPattern:"pattern"};n({data:Tb,removeData:qb},function(b,a){P[a]=b});n({data:Tb,inheritedData:wb,scope:function(b){return E.data(b,"$scope")||wb(b.parentNode||b,["$isolateScope",
"$scope"])},isolateScope:function(b){return E.data(b,"$isolateScope")||E.data(b,"$isolateScopeNoTemplate")},controller:Jc,injector:function(b){return wb(b,"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:tb,css:function(b,a,c){a=db(a);if(w(c))b.style[a]=c;else return b.style[a]},attr:function(b,a,c){var d=b.nodeType;if(d!==$a&&2!==d&&8!==d)if(d=N(a),xb[d])if(w(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||z).specified?
d:u;else if(w(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,2),null===b?u:b},prop:function(b,a,c){if(w(c))b[a]=c;else return b[a]},text:function(){function b(a,b){if(F(b)){var d=a.nodeType;return d===oa||d===$a?a.textContent:""}a.textContent=b}b.$dv="";return b}(),val:function(b,a){if(F(a)){if(b.multiple&&"select"===sa(b)){var c=[];n(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(F(a))return b.innerHTML;
pb(b,!0);b.innerHTML=a},empty:Kc},function(b,a){P.prototype[a]=function(a,d){var e,f,h=this.length;if(b!==Kc&&(2==b.length&&b!==tb&&b!==Jc?a:d)===u){if(C(a)){for(e=0;e<h;e++)if(b===Tb)b(this[e],a);else for(f in a)b(this[e],f,a[f]);return this}e=b.$dv;h=e===u?Math.min(h,1):h;for(f=0;f<h;f++){var g=b(this[f],a,d);e=e?e+g:g}return e}for(e=0;e<h;e++)b(this[e],a,d);return this}});n({removeData:qb,on:function a(c,d,e,f){if(w(f))throw Rb("onargs");if(Fc(c)){var h=rb(c,!0);f=h.events;var g=h.handle;g||(g=
h.handle=zf(c,f));for(var h=0<=d.indexOf(" ")?d.split(" "):[d],l=h.length;l--;){d=h[l];var k=f[d];k||(f[d]=[],"mouseenter"===d||"mouseleave"===d?a(c,dg[d],function(a){var c=a.relatedTarget;c&&(c===this||this.contains(c))||g(a,d)}):"$destroy"!==d&&c.addEventListener(d,g,!1),k=f[d]);k.push(e)}}},off:Ic,one:function(a,c,d){a=E(a);a.on(c,function f(){a.off(c,d);a.off(c,f)});a.on(c,d)},replaceWith:function(a,c){var d,e=a.parentNode;pb(a);n(new P(c),function(c){d?e.insertBefore(c,d.nextSibling):e.replaceChild(c,
a);d=c})},children:function(a){var c=[];n(a.childNodes,function(a){a.nodeType===oa&&c.push(a)});return c},contents:function(a){return a.contentDocument||a.childNodes||[]},append:function(a,c){var d=a.nodeType;if(d===oa||11===d){c=new P(c);for(var d=0,e=c.length;d<e;d++)a.appendChild(c[d])}},prepend:function(a,c){if(a.nodeType===oa){var d=a.firstChild;n(new P(c),function(c){a.insertBefore(c,d)})}},wrap:function(a,c){c=E(c).eq(0).clone()[0];var d=a.parentNode;d&&d.replaceChild(c,a);c.appendChild(a)},
remove:Ub,detach:function(a){Ub(a,!0)},after:function(a,c){var d=a,e=a.parentNode;c=new P(c);for(var f=0,h=c.length;f<h;f++){var g=c[f];e.insertBefore(g,d.nextSibling);d=g}},addClass:vb,removeClass:ub,toggleClass:function(a,c,d){c&&n(c.split(" "),function(c){var f=d;F(f)&&(f=!tb(a,c));(f?vb:ub)(a,c)})},parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},next:function(a){return a.nextElementSibling},find:function(a,c){return a.getElementsByTagName?a.getElementsByTagName(c):[]},clone:Sb,
triggerHandler:function(a,c,d){var e,f,h=c.type||c,g=rb(a);if(g=(g=g&&g.events)&&g[h])e={preventDefault:function(){this.defaultPrevented=!0},isDefaultPrevented:function(){return!0===this.defaultPrevented},stopImmediatePropagation:function(){this.immediatePropagationStopped=!0},isImmediatePropagationStopped:function(){return!0===this.immediatePropagationStopped},stopPropagation:z,type:h,target:a},c.type&&(e=T(e,c)),c=fa(g),f=d?[e].concat(d):[e],n(c,function(c){e.isImmediatePropagationStopped()||c.apply(a,
f)})}},function(a,c){P.prototype[c]=function(c,e,f){for(var h,g=0,l=this.length;g<l;g++)F(h)?(h=a(this[g],c,e,f),w(h)&&(h=E(h))):Hc(h,a(this[g],c,e,f));return w(h)?h:this};P.prototype.bind=P.prototype.on;P.prototype.unbind=P.prototype.off});eb.prototype={put:function(a,c){this[Ea(a,this.nextUid)]=c},get:function(a){return this[Ea(a,this.nextUid)]},remove:function(a){var c=this[a=Ea(a,this.nextUid)];delete this[a];return c}};var pf=[function(){this.$get=[function(){return eb}]}],Pc=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,
eg=/,/,fg=/^\s*(_?)(\S+?)\1\s*$/,Oc=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Fa=J("$injector");ab.$$annotate=function(a,c,d){var e;if("function"===typeof a){if(!(e=a.$inject)){e=[];if(a.length){if(c)throw D(d)&&d||(d=a.name||Af(a)),Fa("strictdi",d);c=a.toString().replace(Oc,"");c=c.match(Pc);n(c[1].split(eg),function(a){a.replace(fg,function(a,c,d){e.push(d)})})}a.$inject=e}}else I(a)?(c=a.length-1,Oa(a[c],"fn"),e=a.slice(0,c)):Oa(a,"fn",!0);return e};var gg=J("$animate"),Me=["$provide",function(a){this.$$selectors=
{};this.register=function(c,d){var e=c+"-animation";if(c&&"."!=c.charAt(0))throw gg("notcsel",c);this.$$selectors[c.substr(1)]=e;a.factory(e,d)};this.classNameFilter=function(a){1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?a:null);return this.$$classNameFilter};this.$get=["$$q","$$asyncCallback","$rootScope",function(a,d,e){function f(d){var f,g=a.defer();g.promise.$$cancelFn=function(){f&&f()};e.$$postDigest(function(){f=d(function(){g.resolve()})});return g.promise}function h(a,
c){var d=[],e=[],f=ma();n((a.attr("class")||"").split(/\s+/),function(a){f[a]=!0});n(c,function(a,c){var g=f[c];!1===a&&g?e.push(c):!0!==a||g||d.push(c)});return 0<d.length+e.length&&[d.length?d:null,e.length?e:null]}function g(a,c,d){for(var e=0,f=c.length;e<f;++e)a[c[e]]=d}function l(){m||(m=a.defer(),d(function(){m.resolve();m=null}));return m.promise}function k(a,c){if(aa.isObject(c)){var d=T(c.from||{},c.to||{});a.css(d)}}var m;return{animate:function(a,c,d){k(a,{from:c,to:d});return l()},enter:function(a,
c,d,e){k(a,e);d?d.after(a):c.prepend(a);return l()},leave:function(a,c){k(a,c);a.remove();return l()},move:function(a,c,d,e){return this.enter(a,c,d,e)},addClass:function(a,c,d){return this.setClass(a,c,[],d)},$$addClassImmediately:function(a,c,d){a=E(a);c=D(c)?c:I(c)?c.join(" "):"";n(a,function(a){vb(a,c)});k(a,d);return l()},removeClass:function(a,c,d){return this.setClass(a,[],c,d)},$$removeClassImmediately:function(a,c,d){a=E(a);c=D(c)?c:I(c)?c.join(" "):"";n(a,function(a){ub(a,c)});k(a,d);return l()},
setClass:function(a,c,d,e){var k=this,l=!1;a=E(a);var m=a.data("$$animateClasses");m?e&&m.options&&(m.options=aa.extend(m.options||{},e)):(m={classes:{},options:e},l=!0);e=m.classes;c=I(c)?c:c.split(" ");d=I(d)?d:d.split(" ");g(e,c,!0);g(e,d,!1);l&&(m.promise=f(function(c){var d=a.data("$$animateClasses");a.removeData("$$animateClasses");if(d){var e=h(a,d.classes);e&&k.$$setClassImmediately(a,e[0],e[1],d.options)}c()}),a.data("$$animateClasses",m));return m.promise},$$setClassImmediately:function(a,
c,d,e){c&&this.$$addClassImmediately(a,c);d&&this.$$removeClassImmediately(a,d);k(a,e);return l()},enabled:z,cancel:z}}]}],ha=J("$compile");xc.$inject=["$provide","$$sanitizeUriProvider"];var Sc=/^((?:x|data)[\:\-_])/i,Ff=J("$controller"),Qc=/^(\S+)(\s+as\s+(\w+))?$/,Xc="application/json",Xb={"Content-Type":Xc+";charset=utf-8"},Hf=/^\[|^\{(?!\{)/,If={"[":/]$/,"{":/}$/},Gf=/^\)\]\}',?\n/,Ja=aa.$interpolateMinErr=J("$interpolate");Ja.throwNoconcat=function(a){throw Ja("noconcat",a);};Ja.interr=function(a,
c){return Ja("interr",a,c.toString())};var hg=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,Lf={http:80,https:443,ftp:21},zb=J("$location"),ig={$$html5:!1,$$replace:!1,absUrl:Ab("$$absUrl"),url:function(a){if(F(a))return this.$$url;var c=hg.exec(a);(c[1]||""===a)&&this.path(decodeURIComponent(c[1]));(c[2]||c[1]||""===a)&&this.search(c[3]||"");this.hash(c[5]||"");return this},protocol:Ab("$$protocol"),host:Ab("$$host"),port:Ab("$$port"),path:ed("$$path",function(a){a=null!==a?a.toString():"";return"/"==a.charAt(0)?
a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(D(a)||X(a))a=a.toString(),this.$$search=rc(a);else if(C(a))a=ta(a,{}),n(a,function(c,e){null==c&&delete a[e]}),this.$$search=a;else throw zb("isrcharg");break;default:F(c)||null===c?delete this.$$search[a]:this.$$search[a]=c}this.$$compose();return this},hash:ed("$$hash",function(a){return null!==a?a.toString():""}),replace:function(){this.$$replace=!0;return this}};n([dd,ac,$b],function(a){a.prototype=Object.create(ig);
a.prototype.state=function(c){if(!arguments.length)return this.$$state;if(a!==$b||!this.$$html5)throw zb("nostate");this.$$state=F(c)?null:c;return this}});var da=J("$parse"),Mf=Function.prototype.call,Nf=Function.prototype.apply,Of=Function.prototype.bind,Jb=ma();n("+ - * / % === !== == != < > <= >= && || ! = |".split(" "),function(a){Jb[a]=!0});var jg={n:"\n",f:"\f",r:"\r",t:"\t",v:"\v","'":"'",'"':'"'},cc=function(a){this.options=a};cc.prototype={constructor:cc,lex:function(a){this.text=a;this.index=
...
c={type:s.Property,kind:"init"};this.peek().constant?c.key=this.constant():this.peek().identifier?c.key=this.identifier():this.throwError("invalid key",this.peek());this.consume(":");c.value=this.expression();a.push(c)}while(this.expect(","))}this.consume("}");return{type:s.ObjectExpression,properties:a}},throwError:function(a,c){throw da("syntax",c.text,a,c.index+1,this.text,this.text.substring(c.index));},consume:function(a){if(0===this.tokens.length)throw da("ueoe",this.text);var c=this.expect(a);
c||this.throwError("is unexpected, expecting ["+a+"]",this.peek());return c},peekToken:function(){if(0===this.tokens.length)throw da("ueoe",this.text);return this.tokens[0]},peek:function(a,c,d,e){return this.peekAhead(0,a,c,d,e)},peekAhead:function(a,c,d,e,f){if(this.tokens.length>a){a=this.tokens[a];var h=a.text;if(h===c||h===d||h===e||h===f||!(c||d||e||f))return a}return!1},expect:function(a,c,d,e){return(a=this.peek(a,c,d,e))?(this.tokens.shift(),a):!1},constants:{"true":{type:s.Literal,value:!0},
"false":{type:s.Literal,value:!1},"null":{type:s.Literal,value:null},undefined:{type:s.Literal,value:u},"this":{type:s.ThisExpression}}};ld.prototype={compile:function(a,c){var d=this,e=this.astBuilder.ast(a);this.state={nextId:0,filters:{},expensiveChecks:c,fn:{vars:[],body:[],own:{}},assign:{vars:[],body:[],own:{}},inputs:[]};$(e,d.$filter);var f="",h;this.stage="assign";if(h=jd(e))this.state.computing="assign",f=this.nextId(),this.recurse(h,f),f="fn.assign="+this.generateFunction("assign","s,v,l");
h=hd(e.body);d.stage="inputs";n(h,function(a,c){var e="fn"+c;d.state[e]={vars:[],body:[],own:{}};d.state.computing=e;var f=d.nextId();d.recurse(a,f);d.return_(f);d.state.inputs.push(e);a.watchId=c});this.state.computing="fn";this.stage="main";this.recurse(e);f='"'+this.USE+" "+this.STRICT+'";\n'+this.filterPrefix()+"var fn="+this.generateFunction("fn","s,l,a,i")+f+this.watchFns()+"return fn;";f=(new Function("$filter","ensureSafeMemberName","ensureSafeObject","ensureSafeFunction","ifDefined","plus",
"text",f))(this.$filter,Ba,ja,fd,Pf,gd,a);this.state=this.stage=u;f.literal=kd(e);f.constant=e.constant;return f},USE:"use",STRICT:"strict",watchFns:function(){var a=[],c=this.state.inputs,d=this;n(c,function(c){a.push("var "+c+"="+d.generateFunction(c,"s"))});c.length&&a.push("fn.inputs=["+c.join(",")+"];");return a.join("")},generateFunction:function(a,c){return"function("+c+"){"+this.varsPrefix(a)+this.body(a)+"};"},filterPrefix:function(){var a=[],c=this;n(this.state.filters,function(d,e){a.push(d+
"=$filter("+c.escape(e)+")")});return a.length?"var "+a.join(",")+";":""},varsPrefix:function(a){return this.state[a].vars.length?"var "+this.state[a].vars.join(",")+";":""},body:function(a){return this.state[a].body.join("")},recurse:function(a,c,d,e,f,h){var g,l,k=this,m,q;e=e||z;if(!h&&w(a.watchId))c=c||this.nextId(),this.if_("i",this.lazyAssign(c,this.computedMember("i",a.watchId)),this.lazyRecurse(a,c,d,e,f,!0));else switch(a.type){case s.Program:n(a.body,function(c,d){k.recurse(c.expression,
u,u,function(a){l=a});d!==a.body.length-1?k.current().body.push(l,";"):k.return_(l)});break;case s.Literal:q=this.escape(a.value);this.assign(c,q);e(q);break;case s.UnaryExpression:this.recurse(a.argument,u,u,function(a){l=a});q=a.operator+"("+this.ifDefined(l,0)+")";this.assign(c,q);e(q);break;case s.BinaryExpression:this.recurse(a.left,u,u,function(a){g=a});this.recurse(a.right,u,u,function(a){l=a});q="+"===a.operator?this.plus(g,l):"-"===a.operator?this.ifDefined(g,0)+a.operator+this.ifDefined(l,
0):"("+g+")"+a.operator+"("+l+")";this.assign(c,q);e(q);break;case s.LogicalExpression:c=c||this.nextId();k.recurse(a.left,c);k.if_("&&"===a.operator?c:k.not(c),k.lazyRecurse(a.right,c));e(c);break;case s.ConditionalExpression:c=c||this.nextId();k.recurse(a.test,c);k.if_(c,k.lazyRecurse(a.alternate,c),k.lazyRecurse(a.consequent,c));e(c);break;case s.Identifier:c=c||this.nextId();d&&(d.context="inputs"===k.stage?"s":this.assign(this.nextId(),this.getHasOwnProperty("l",a.name)+"?l:s"),d.computed=!1,
d.name=a.name);Ba(a.name);k.if_("inputs"===k.stage||k.not(k.getHasOwnProperty("l",a.name)),function(){k.if_("inputs"===k.stage||"s",function(){f&&1!==f&&k.if_(k.not(k.nonComputedMember("s",a.name)),k.lazyAssign(k.nonComputedMember("s",a.name),"{}"));k.assign(c,k.nonComputedMember("s",a.name))})},c&&k.lazyAssign(c,k.nonComputedMember("l",a.name)));(k.state.expensiveChecks||Cb(a.name))&&k.addEnsureSafeObject(c);e(c);break;case s.MemberExpression:g=d&&(d.context=this.nextId())||this.nextId();c=c||this.nextId();
k.recurse(a.object,g,u,function(){k.if_(k.notNull(g),function(){if(a.computed)l=k.nextId(),k.recurse(a.property,l),k.addEnsureSafeMemberName(l),f&&1!==f&&k.if_(k.not(k.computedMember(g,l)),k.lazyAssign(k.computedMember(g,l),"{}")),q=k.ensureSafeObject(k.computedMember(g,l)),k.assign(c,q),d&&(d.computed=!0,d.name=l);else{Ba(a.property.name);f&&1!==f&&k.if_(k.not(k.nonComputedMember(g,a.property.name)),k.lazyAssign(k.nonComputedMember(g,a.property.name),"{}"));q=k.nonComputedMember(g,a.property.name);
if(k.state.expensiveChecks||Cb(a.property.name))q=k.ensureSafeObject(q);k.assign(c,q);d&&(d.computed=!1,d.name=a.property.name)}e(c)})},!!f);break;case s.CallExpression:c=c||this.nextId();a.filter?(l=k.filter(a.callee.name),m=[],n(a.arguments,function(a){var c=k.nextId();k.recurse(a,c);m.push(c)}),q=l+"("+m.join(",")+")",k.assign(c,q),e(c)):(l=k.nextId(),g={},m=[],k.recurse(a.callee,l,g,function(){k.if_(k.notNull(l),function(){k.addEnsureSafeFunction(l);n(a.arguments,function(a){k.recurse(a,k.nextId(),
u,function(a){m.push(k.ensureSafeObject(a))})});g.name?(k.state.expensiveChecks||k.addEnsureSafeObject(g.context),q=k.member(g.context,g.name,g.computed)+"("+m.join(",")+")"):q=l+"("+m.join(",")+")";q=k.ensureSafeObject(q);k.assign(c,q);e(c)})}));break;case s.AssignmentExpression:l=this.nextId();g={};if(!id(a.left))throw da("lval");this.recurse(a.left,u,g,function(){k.if_(k.notNull(g.context),function(){k.recurse(a.right,l);k.addEnsureSafeObject(k.member(g.context,g.name,g.computed));q=k.member(g.context,
g.name,g.computed)+a.operator+l;k.assign(c,q);e(c||q)})},1);break;case s.ArrayExpression:m=[];n(a.elements,function(a){k.recurse(a,k.nextId(),u,function(a){m.push(a)})});q="["+m.join(",")+"]";this.assign(c,q);e(q);break;case s.ObjectExpression:m=[];n(a.properties,function(a){k.recurse(a.value,k.nextId(),u,function(c){m.push(k.escape(a.key.type===s.Identifier?a.key.name:""+a.key.value)+":"+c)})});q="{"+m.join(",")+"}";this.assign(c,q);e(q);break;case s.ThisExpression:this.assign(c,"s");e("s");break;
case s.NGValueParameter:this.assign(c,"v"),e("v")}},getHasOwnProperty:function(a,c){var d=a+"."+c,e=this.current().own;e.hasOwnProperty(d)||(e[d]=this.nextId(!1,a+"&&("+this.escape(c)+" in "+a+")"));return e[d]},assign:function(a,c){if(a)return this.current().body.push(a,"=",c,";"),a},filter:function(a){this.state.filters.hasOwnProperty(a)||(this.state.filters[a]=this.nextId(!0));return this.state.filters[a]},ifDefined:function(a,c){return"ifDefined("+a+","+this.escape(c)+")"},plus:function(a,c){return"plus("+
...
";")},addEnsureSafeMemberName:function(a){this.current().body.push(this.ensureSafeMemberName(a),";")},addEnsureSafeFunction:function(a){this.current().body.push(this.ensureSafeFunction(a),";")},ensureSafeObject:function(a){return"ensureSafeObject("+a+",text)"},ensureSafeMemberName:function(a){return"ensureSafeMemberName("+a+",text)"},ensureSafeFunction:function(a){return"ensureSafeFunction("+a+",text)"},lazyRecurse:function(a,c,d,e,f,h){var g=this;return function(){g.recurse(a,c,d,e,f,h)}},lazyAssign:function(a,
c){var d=this;return function(){d.assign(a,c)}},stringEscapeRegex:/[^ a-zA-Z0-9]/g,stringEscapeFn:function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)},escape:function(a){if(D(a))return"'"+a.replace(this.stringEscapeRegex,this.stringEscapeFn)+"'";if(X(a))return a.toString();if(!0===a)return"true";if(!1===a)return"false";if(null===a)return"null";if("undefined"===typeof a)return"undefined";throw da("esc");},nextId:function(a,c){var d="v"+this.state.nextId++;a||this.current().vars.push(d+
(c?"="+c:""));return d},current:function(){return this.state[this.state.computing]}};md.prototype={compile:function(a,c){var d=this,e=this.astBuilder.ast(a);this.expression=a;this.expensiveChecks=c;$(e,d.$filter);var f,h;if(f=jd(e))h=this.recurse(f);f=hd(e.body);var g;f&&(g=[],n(f,function(a,c){var e=d.recurse(a);a.input=e;g.push(e);a.watchId=c}));var l=[];n(e.body,function(a){l.push(d.recurse(a.expression))});f=0===e.body.length?function(){}:1===e.body.length?l[0]:function(a,c){var d;n(l,function(e){d=
e(a,c)});return d};h&&(f.assign=function(a,c,d){return h(a,d,c)});g&&(f.inputs=g);f.literal=kd(e);f.constant=e.constant;return f},recurse:function(a,c,d){var e,f,h=this,g;if(a.input)return this.inputs(a.input,a.watchId);switch(a.type){case s.Literal:return this.value(a.value,c);case s.UnaryExpression:return f=this.recurse(a.argument),this["unary"+a.operator](f,c);case s.BinaryExpression:return e=this.recurse(a.left),f=this.recurse(a.right),this["binary"+a.operator](e,f,c);case s.LogicalExpression:return e=
this.recurse(a.left),f=this.recurse(a.right),this["binary"+a.operator](e,f,c);case s.ConditionalExpression:return this["ternary?:"](this.recurse(a.test),this.recurse(a.alternate),this.recurse(a.consequent),c);case s.Identifier:return Ba(a.name,h.expression),h.identifier(a.name,h.expensiveChecks||Cb(a.name),c,d,h.expression);case s.MemberExpression:return e=this.recurse(a.object,!1,!!d),a.computed||(Ba(a.property.name,h.expression),f=a.property.name),a.computed&&(f=this.recurse(a.property)),a.computed?
this.computedMember(e,f,c,d,h.expression):this.nonComputedMember(e,f,h.expensiveChecks,c,d,h.expression);case s.CallExpression:return g=[],n(a.arguments,function(a){g.push(h.recurse(a))}),a.filter&&(f=this.$filter(a.callee.name)),a.filter||(f=this.recurse(a.callee,!0)),a.filter?function(a,d,e,h){for(var r=[],n=0;n<g.length;++n)r.push(g[n](a,d,e,h));a=f.apply(u,r,h);return c?{context:u,name:u,value:a}:a}:function(a,d,e,q){var r=f(a,d,e,q),n;if(null!=r.value){ja(r.context,h.expression);fd(r.value,h.expression);
n=[];for(var s=0;s<g.length;++s)n.push(ja(g[s](a,d,e,q),h.expression));n=ja(r.value.apply(r.context,n),h.expression)}return c?{value:n}:n};case s.AssignmentExpression:return e=this.recurse(a.left,!0,1),f=this.recurse(a.right),function(a,d,g,q){var r=e(a,d,g,q);a=f(a,d,g,q);ja(r.value,h.expression);r.context[r.name]=a;return c?{value:a}:a};case s.ArrayExpression:return g=[],n(a.elements,function(a){g.push(h.recurse(a))}),function(a,d,e,f){for(var h=[],n=0;n<g.length;++n)h.push(g[n](a,d,e,f));return c?
{value:h}:h};case s.ObjectExpression:return g=[],n(a.properties,function(a){g.push({key:a.key.type===s.Identifier?a.key.name:""+a.key.value,value:h.recurse(a.value)})}),function(a,d,e,f){for(var h={},n=0;n<g.length;++n)h[g[n].key]=g[n].value(a,d,e,f);return c?{value:h}:h};case s.ThisExpression:return function(a){return c?{value:a}:a};case s.NGValueParameter:return function(a,d,e,f){return c?{value:e}:e}}},"unary+":function(a,c){return function(d,e,f,h){d=a(d,e,f,h);d=w(d)?+d:0;return c?{value:d}:
d}},"unary-":function(a,c){return function(d,e,f,h){d=a(d,e,f,h);d=w(d)?-d:0;return c?{value:d}:d}},"unary!":function(a,c){return function(d,e,f,h){d=!a(d,e,f,h);return c?{value:d}:d}},"binary+":function(a,c,d){return function(e,f,h,g){var l=a(e,f,h,g);e=c(e,f,h,g);l=gd(l,e);return d?{value:l}:l}},"binary-":function(a,c,d){return function(e,f,h,g){var l=a(e,f,h,g);e=c(e,f,h,g);l=(w(l)?l:0)-(w(e)?e:0);return d?{value:l}:l}},"binary*":function(a,c,d){return function(e,f,h,g){e=a(e,f,h,g)*c(e,f,h,g);
...
h[a]:u;c&&ja(g,f);return d?{context:h,name:a,value:g}:g}},computedMember:function(a,c,d,e,f){return function(h,g,l,k){var m=a(h,g,l,k),q,n;null!=m&&(q=c(h,g,l,k),Ba(q,f),e&&1!==e&&m&&!m[q]&&(m[q]={}),n=m[q],ja(n,f));return d?{context:m,name:q,value:n}:n}},nonComputedMember:function(a,c,d,e,f,h){return function(g,l,k,m){g=a(g,l,k,m);f&&1!==f&&g&&!g[c]&&(g[c]={});l=null!=g?g[c]:u;(d||Cb(c))&&ja(l,h);return e?{context:g,name:c,value:l}:l}},inputs:function(a,c){return function(d,e,f,h){return h?h[c]:
a(d,e,f)}}};var dc=function(a,c,d){this.lexer=a;this.$filter=c;this.options=d;this.ast=new s(this.lexer);this.astCompiler=d.csp?new md(this.ast,c):new ld(this.ast,c)};dc.prototype={constructor:dc,parse:function(a){return this.astCompiler.compile(a,this.options.expensiveChecks)}};ma();ma();var Qf=Object.prototype.valueOf,Ca=J("$sce"),na={HTML:"html",CSS:"css",URL:"url",RESOURCE_URL:"resourceUrl",JS:"js"},ha=J("$compile"),Z=Y.createElement("a"),qd=Aa(O.location.href);rd.$inject=["$document"];Ec.$inject=
["$provide"];sd.$inject=["$locale"];ud.$inject=["$locale"];var xd=".",$f={yyyy:ba("FullYear",4),yy:ba("FullYear",2,0,!0),y:ba("FullYear",1),MMMM:Eb("Month"),MMM:Eb("Month",!0),MM:ba("Month",2,1),M:ba("Month",1,1),dd:ba("Date",2),d:ba("Date",1),HH:ba("Hours",2),H:ba("Hours",1),hh:ba("Hours",2,-12),h:ba("Hours",1,-12),mm:ba("Minutes",2),m:ba("Minutes",1),ss:ba("Seconds",2),s:ba("Seconds",1),sss:ba("Milliseconds",3),EEEE:Eb("Day"),EEE:Eb("Day",!0),a:function(a,c){return 12>a.getHours()?c.AMPMS[0]:c.AMPMS[1]},
Z:function(a,c,d){a=-1*d;return a=(0<=a?"+":"")+(Db(Math[0<a?"floor":"ceil"](a/60),2)+Db(Math.abs(a%60),2))},ww:zd(2),w:zd(1),G:fc,GG:fc,GGG:fc,GGGG:function(a,c){return 0>=a.getFullYear()?c.ERANAMES[0]:c.ERANAMES[1]}},Zf=/((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/,Yf=/^\-?\d+$/;td.$inject=["$locale"];var Vf=pa(N),Wf=pa(nb);vd.$inject=["$parse"];var ce=pa({restrict:"E",compile:function(a,c){if(!c.href&&!c.xlinkHref)return function(a,c){if("a"===c[0].nodeName.toLowerCase()){var f=
"[object SVGAnimatedString]"===ra.call(c.prop("href"))?"xlink:href":"href";c.on("click",function(a){c.attr(f)||a.preventDefault()})}}}}),ob={};n(xb,function(a,c){function d(a,d,f){a.$watch(f[e],function(a){f.$set(c,!!a)})}if("multiple"!=a){var e=wa("ng-"+c),f=d;"checked"===a&&(f=function(a,c,f){f.ngModel!==f[e]&&d(a,c,f)});ob[e]=function(){return{restrict:"A",priority:100,link:f}}}});n(Nc,function(a,c){ob[c]=function(){return{priority:100,link:function(a,e,f){if("ngPattern"===c&&"/"==f.ngPattern.charAt(0)&&
(e=f.ngPattern.match(bg))){f.$set("ngPattern",new RegExp(e[1],e[2]));return}a.$watch(f[c],function(a){f.$set(c,a)})}}}});n(["src","srcset","href"],function(a){var c=wa("ng-"+a);ob[c]=function(){return{priority:99,link:function(d,e,f){var h=a,g=a;"href"===a&&"[object SVGAnimatedString]"===ra.call(e.prop("href"))&&(g="xlinkHref",f.$attr[g]="xlink:href",h=null);f.$observe(c,function(c){c?(f.$set(g,c),fb&&h&&e.prop(h,f[g])):"href"===a&&f.$set(g,null)})}}}});var Fb={$addControl:z,$$renameControl:function(a,
c){a.$name=c},$removeControl:z,$setValidity:z,$setDirty:z,$setPristine:z,$setSubmitted:z};Ad.$inject=["$element","$attrs","$scope","$animate","$interpolate"];var Hd=function(a){return["$timeout",function(c){return{name:"form",restrict:a?"EAC":"E",controller:Ad,compile:function(d,e){d.addClass(Qa).addClass(ib);var f=e.name?"name":a&&e.ngForm?"ngForm":!1;return{pre:function(a,d,e,k){if(!("action"in e)){var m=function(c){a.$apply(function(){k.$commitViewValue();k.$setSubmitted()});c.preventDefault()};
d[0].addEventListener("submit",m,!1);d.on("$destroy",function(){c(function(){d[0].removeEventListener("submit",m,!1)},0,!1)})}var q=k.$$parentForm;f&&(Bb(a,k.$name,k,k.$name),e.$observe(f,function(c){k.$name!==c&&(Bb(a,k.$name,u,k.$name),q.$$renameControl(k,c),Bb(a,k.$name,k,k.$name))}));d.on("$destroy",function(){q.$removeControl(k);f&&Bb(a,e[f],u,k.$name);T(k,Fb)})}}}}}]},de=Hd(),qe=Hd(!0),ag=/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/,kg=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
lg=/^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,mg=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,Id=/^(\d{4})-(\d{2})-(\d{2})$/,Jd=/^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,ic=/^(\d{4})-W(\d\d)$/,Kd=/^(\d{4})-(\d\d)$/,Ld=/^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,Md={text:function(a,c,d,e,f,h){gb(a,c,d,e,f,h);gc(e)},date:hb("date",Id,Hb(Id,["yyyy","MM","dd"]),"yyyy-MM-dd"),"datetime-local":hb("datetimelocal",Jd,Hb(Jd,"yyyy MM dd HH mm ss sss".split(" ")),
"yyyy-MM-ddTHH:mm:ss.sss"),time:hb("time",Ld,Hb(Ld,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:hb("week",ic,function(a,c){if(ea(a))return a;if(D(a)){ic.lastIndex=0;var d=ic.exec(a);if(d){var e=+d[1],f=+d[2],h=d=0,g=0,l=0,k=yd(e),f=7*(f-1);c&&(d=c.getHours(),h=c.getMinutes(),g=c.getSeconds(),l=c.getMilliseconds());return new Date(e,0,k.getDate()+f,d,h,g,l)}}return NaN},"yyyy-Www"),month:hb("month",Kd,Hb(Kd,["yyyy","MM"]),"yyyy-MM"),number:function(a,c,d,e,f,h){Cd(a,c,d,e);gb(a,c,d,e,f,h);e.$$parserName=
"number";e.$parsers.push(function(a){return e.$isEmpty(a)?null:mg.test(a)?parseFloat(a):u});e.$formatters.push(function(a){if(!e.$isEmpty(a)){if(!X(a))throw Ib("numfmt",a);a=a.toString()}return a});if(w(d.min)||d.ngMin){var g;e.$validators.min=function(a){return e.$isEmpty(a)||F(g)||a>=g};d.$observe("min",function(a){w(a)&&!X(a)&&(a=parseFloat(a,10));g=X(a)&&!isNaN(a)?a:u;e.$validate()})}if(w(d.max)||d.ngMax){var l;e.$validators.max=function(a){return e.$isEmpty(a)||F(l)||a<=l};d.$observe("max",function(a){w(a)&&
!X(a)&&(a=parseFloat(a,10));l=X(a)&&!isNaN(a)?a:u;e.$validate()})}},url:function(a,c,d,e,f,h){gb(a,c,d,e,f,h);gc(e);e.$$parserName="url";e.$validators.url=function(a,c){var d=a||c;return e.$isEmpty(d)||kg.test(d)}},email:function(a,c,d,e,f,h){gb(a,c,d,e,f,h);gc(e);e.$$parserName="email";e.$validators.email=function(a,c){var d=a||c;return e.$isEmpty(d)||lg.test(d)}},radio:function(a,c,d,e){F(d.name)&&c.attr("name",++jb);c.on("click",function(a){c[0].checked&&e.$setViewValue(d.value,a&&a.type)});e.$render=
function(){c[0].checked=d.value==e.$viewValue};d.$observe("value",e.$render)},checkbox:function(a,c,d,e,f,h,g,l){var k=Dd(l,a,"ngTrueValue",d.ngTrueValue,!0),m=Dd(l,a,"ngFalseValue",d.ngFalseValue,!1);c.on("click",function(a){e.$setViewValue(c[0].checked,a&&a.type)});e.$render=function(){c[0].checked=e.$viewValue};e.$isEmpty=function(a){return!1===a};e.$formatters.push(function(a){return ka(a,k)});e.$parsers.push(function(a){return a?k:m})},hidden:z,button:z,submit:z,reset:z,file:z},yc=["$browser",
"$sniffer","$filter","$parse",function(a,c,d,e){return{restrict:"E",require:["?ngModel"],link:{pre:function(f,h,g,l){l[0]&&(Md[N(g.type)]||Md.text)(f,h,g,l[0],c,a,d,e)}}}}],ng=/^(true|false|\d+)$/,Ie=function(){return{restrict:"A",priority:100,compile:function(a,c){return ng.test(c.ngValue)?function(a,c,f){f.$set("value",a.$eval(f.ngValue))}:function(a,c,f){a.$watch(f.ngValue,function(a){f.$set("value",a)})}}}},ie=["$compile",function(a){return{restrict:"AC",compile:function(c){a.$$addBindingClass(c);
return function(c,e,f){a.$$addBindingInfo(e,f.ngBind);e=e[0];c.$watch(f.ngBind,function(a){e.textContent=a===u?"":a})}}}}],ke=["$interpolate","$compile",function(a,c){return{compile:function(d){c.$$addBindingClass(d);return function(d,f,h){d=a(f.attr(h.$attr.ngBindTemplate));c.$$addBindingInfo(f,d.expressions);f=f[0];h.$observe("ngBindTemplate",function(a){f.textContent=a===u?"":a})}}}}],je=["$sce","$parse","$compile",function(a,c,d){return{restrict:"A",compile:function(e,f){var h=c(f.ngBindHtml),
g=c(f.ngBindHtml,function(a){return(a||"").toString()});d.$$addBindingClass(e);return function(c,e,f){d.$$addBindingInfo(e,f.ngBindHtml);c.$watch(g,function(){e.html(a.getTrustedHtml(h(c))||"")})}}}}],He=pa({restrict:"A",require:"ngModel",link:function(a,c,d,e){e.$viewChangeListeners.push(function(){a.$eval(d.ngChange)})}}),le=hc("",!0),ne=hc("Odd",0),me=hc("Even",1),oe=La({compile:function(a,c){c.$set("ngCloak",u);a.removeClass("ng-cloak")}}),pe=[function(){return{restrict:"A",scope:!0,controller:"@",
priority:500}}],Dc={},og={blur:!0,focus:!0};n("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=wa("ng-"+a);Dc[c]=["$parse","$rootScope",function(d,e){return{restrict:"A",compile:function(f,h){var g=d(h[c],null,!0);return function(c,d){d.on(a,function(d){var f=function(){g(c,{$event:d})};og[a]&&e.$$phase?c.$evalAsync(f):c.$apply(f)})}}}}]});var se=["$animate",function(a){return{multiElement:!0,
transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(c,d,e,f,h){var g,l,k;c.$watch(e.ngIf,function(c){c?l||h(function(c,f){l=f;c[c.length++]=Y.createComment(" end ngIf: "+e.ngIf+" ");g={clone:c};a.enter(c,d.parent(),d)}):(k&&(k.remove(),k=null),l&&(l.$destroy(),l=null),g&&(k=mb(g.clone),a.leave(k).then(function(){k=null}),g=null))})}}}],te=["$templateRequest","$anchorScroll","$animate","$sce",function(a,c,d,e){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",
controller:aa.noop,compile:function(f,h){var g=h.ngInclude||h.src,l=h.onload||"",k=h.autoscroll;return function(f,h,n,t,s){var u=0,v,p,x,A=function(){p&&(p.remove(),p=null);v&&(v.$destroy(),v=null);x&&(d.leave(x).then(function(){p=null}),p=x,x=null)};f.$watch(e.parseAsResourceUrl(g),function(e){var g=function(){!w(k)||k&&!f.$eval(k)||c()},n=++u;e?(a(e,!0).then(function(a){if(n===u){var c=f.$new();t.template=a;a=s(c,function(a){A();d.enter(a,null,h).then(g)});v=c;x=a;v.$emit("$includeContentLoaded",
e);f.$eval(l)}},function(){n===u&&(A(),f.$emit("$includeContentError",e))}),f.$emit("$includeContentRequested",e)):(A(),t.template=null)})}}}}],Ke=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(c,d,e,f){/SVG/.test(d[0].toString())?(d.empty(),a(Gc(f.template,Y).childNodes)(c,function(a){d.append(a)},{futureParentElement:d})):(d.html(f.template),a(d.contents())(c))}}}],ue=La({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),
Ge=function(){return{restrict:"A",priority:100,require:"ngModel",link:function(a,c,d,e){var f=c.attr(d.$attr.ngList)||", ",h="false"!==d.ngTrim,g=h?V(f):f;e.$parsers.push(function(a){if(!F(a)){var c=[];a&&n(a.split(g),function(a){a&&c.push(h?V(a):a)});return c}});e.$formatters.push(function(a){return I(a)?a.join(f):u});e.$isEmpty=function(a){return!a||!a.length}}}},ib="ng-valid",Ed="ng-invalid",Qa="ng-pristine",Gb="ng-dirty",Gd="ng-pending",Ib=new J("ngModel"),pg=["$scope","$exceptionHandler","$attrs",
...
E=null,v,p=this;this.$$setOptions=function(a){if((p.$options=a)&&a.getterSetter){var c=f(d.ngModel+"()"),g=f(d.ngModel+"($$$p)");t=function(a){var d=q(a);H(d)&&(d=c(a));return d};s=function(a,c){H(q(a))?g(a,{$$$p:p.$modelValue}):r(a,p.$modelValue)}}else if(!q.assign)throw Ib("nonassign",d.ngModel,ua(e));};this.$render=z;this.$isEmpty=function(a){return F(a)||""===a||null===a||a!==a};var x=e.inheritedData("$formController")||Fb,A=0;Bd({ctrl:this,$element:e,set:function(a,c){a[c]=!0},unset:function(a,
c){delete a[c]},parentForm:x,$animate:h});this.$setPristine=function(){p.$dirty=!1;p.$pristine=!0;h.removeClass(e,Gb);h.addClass(e,Qa)};this.$setDirty=function(){p.$dirty=!0;p.$pristine=!1;h.removeClass(e,Qa);h.addClass(e,Gb);x.$setDirty()};this.$setUntouched=function(){p.$touched=!1;p.$untouched=!0;h.setClass(e,"ng-untouched","ng-touched")};this.$setTouched=function(){p.$touched=!0;p.$untouched=!1;h.setClass(e,"ng-touched","ng-untouched")};this.$rollbackViewValue=function(){g.cancel(E);p.$viewValue=
...
c){g(c,null)}),!1)}function f(){var d=[],e=!0;n(p.$asyncValidators,function(f,h){var k=f(a,c);if(!k||!H(k.then))throw Ib("$asyncValidators",k);g(h,u);d.push(k.then(function(){g(h,!0)},function(a){e=!1;g(h,!1)}))});d.length?k.all(d).then(function(){h(e)},z):h(!0)}function g(a,c){l===A&&p.$setValidity(a,c)}function h(a){l===A&&d(a)}A++;var l=A;(function(){var a=p.$$parserName||"parse";if(v===u)g(a,null);else return v||(n(p.$validators,function(a,c){g(c,null)}),n(p.$asyncValidators,function(a,c){g(c,
null)})),g(a,v),v;return!0})()?e()?f():h(!1):h(!1)};this.$commitViewValue=function(){var a=p.$viewValue;g.cancel(E);if(p.$$lastCommittedViewValue!==a||""===a&&p.$$hasNativeValidators)p.$$lastCommittedViewValue=a,p.$pristine&&this.$setDirty(),this.$$parseAndValidate()};this.$$parseAndValidate=function(){var c=p.$$lastCommittedViewValue;if(v=F(c)?u:!0)for(var d=0;d<p.$parsers.length;d++)if(c=p.$parsers[d](c),F(c)){v=!1;break}X(p.$modelValue)&&isNaN(p.$modelValue)&&(p.$modelValue=t(a));var e=p.$modelValue,
...
function(c){var d=0,e=p.$options;e&&w(e.debounce)&&(e=e.debounce,X(e)?d=e:X(e[c])?d=e[c]:X(e["default"])&&(d=e["default"]));g.cancel(E);d?E=g(function(){p.$commitViewValue()},d):l.$$phase?p.$commitViewValue():a.$apply(function(){p.$commitViewValue()})};a.$watch(function(){var c=t(a);if(c!==p.$modelValue){p.$modelValue=p.$$rawModelValue=c;v=u;for(var d=p.$formatters,e=d.length,f=c;e--;)f=d[e](f);p.$viewValue!==f&&(p.$viewValue=p.$$lastCommittedViewValue=f,p.$render(),p.$$runValidators(c,f,z))}return c})}],
Fe=["$rootScope",function(a){return{restrict:"A",require:["ngModel","^?form","^?ngModelOptions"],controller:pg,priority:1,compile:function(c){c.addClass(Qa).addClass("ng-untouched").addClass(ib);return{pre:function(a,c,f,h){var g=h[0],l=h[1]||Fb;g.$$setOptions(h[2]&&h[2].$options);l.$addControl(g);f.$observe("name",function(a){g.$name!==a&&l.$$renameControl(g,a)});a.$on("$destroy",function(){l.$removeControl(g)})},post:function(c,e,f,h){var g=h[0];if(g.$options&&g.$options.updateOn)e.on(g.$options.updateOn,
function(a){g.$$debounceViewValueCommit(a&&a.type)});e.on("blur",function(e){g.$touched||(a.$$phase?c.$evalAsync(g.$setTouched):c.$apply(g.$setTouched))})}}}}}],qg=/(\s+|^)default(\s+|$)/,Je=function(){return{restrict:"A",controller:["$scope","$attrs",function(a,c){var d=this;this.$options=ta(a.$eval(c.ngModelOptions));this.$options.updateOn!==u?(this.$options.updateOnDefault=!1,this.$options.updateOn=V(this.$options.updateOn.replace(qg,function(){d.$options.updateOnDefault=!0;return" "}))):this.$options.updateOnDefault=
!0}]}},ve=La({terminal:!0,priority:1E3}),rg=J("ngOptions"),sg=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,De=["$compile","$parse",function(a,c){function d(a,d,e){function f(a,c,d,e,g){this.selectValue=a;this.viewValue=c;this.label=d;this.group=e;this.disabled=g}var m=a.match(sg);if(!m)throw rg("iexp",a,ua(d));
var n=m[5]||m[7],r=m[6];a=/ as /.test(m[0])&&m[1];var s=m[9];d=c(m[2]?m[1]:n);var u=a&&c(a)||d,w=s&&c(s),v=s?function(a,c){return w(e,c)}:function(a){return Ea(a)},p=c(m[2]||m[1]),x=c(m[3]||""),A=c(m[4]||""),y=c(m[8]),L={},M=r?function(a,c){L[r]=c;L[n]=a;return L}:function(a){L[n]=a;return L};return{trackBy:s,getWatchables:c(y,function(a){var c=[];a=a||[];Object.keys(a).forEach(function(d){var f=M(a[d],d);d=v(a[d],f);c.push(d);m[2]&&(d=p(e,f),c.push(d));m[4]&&(f=A(e,f),c.push(f))});return c}),getOptions:function(){var a=
[],c={},d=y(e)||[];Object.keys(d).forEach(function(g){if("$"!==g.charAt(0)){var h=M(d[g],g),m=u(e,h);g=v(m,h);var n=p(e,h),q=x(e,h),h=A(e,h),m=new f(g,m,n,q,h);a.push(m);c[g]=m}});return{items:a,selectValueMap:c,getOptionFromViewValue:function(a){return c[v(a,M(a))]},getViewValueFromOption:function(a){return s?aa.copy(a.viewValue):a.viewValue}}}}}var e=Y.createElement("option"),f=Y.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select","?ngModel"],link:function(c,g,l,k){function m(a,
c){a.element=c;c.disabled=a.disabled;a.value!==c.value&&(c.value=a.selectValue);a.label!==c.label&&(c.label=a.label,c.textContent=a.label)}function q(a,c,d,e){c&&N(c.nodeName)===d?d=c:(d=e.cloneNode(!1),c?a.insertBefore(d,c):a.appendChild(d));return d}function r(a){for(var c;a;)c=a.nextSibling,Ub(a),a=c}function s(a){var c=p&&p[0],d=A&&A[0];if(c||d)for(;a&&(a===c||a===d);)a=a.nextSibling;return a}function u(){var a=y&&v.readValue();y=L.getOptions();var c={},d=g[0].firstChild;x&&g.prepend(p);d=s(d);
y.items.forEach(function(a){var h,k;a.group?(h=c[a.group],h||(h=q(g[0],d,"optgroup",f),d=h.nextSibling,h.label=a.group,h=c[a.group]={groupElement:h,currentOptionElement:h.firstChild}),k=q(h.groupElement,h.currentOptionElement,"option",e),m(a,k),h.currentOptionElement=k.nextSibling):(k=q(g[0],d,"option",e),m(a,k),d=k.nextSibling)});Object.keys(c).forEach(function(a){r(c[a].currentOptionElement)});r(d);w.$render();if(!w.$isEmpty(a)){var h=v.readValue();if(L.trackBy&&!ka(a,h)||a!==h)w.$setViewValue(h),
w.$render()}}var w=k[1];if(w){var v=k[0];k=l.multiple;var p=v.emptyOption,x=!!p,A=E(e.cloneNode(!1));A.val("?");var y,L=d(l.ngOptions,g,c);v.writeValue=function(a){var c=y.getOptionFromViewValue(a);c&&!c.disabled?g[0].value!==c.selectValue&&(A.remove(),x||p.remove(),g[0].value=c.selectValue,c.element.selected=!0,c.element.setAttribute("selected","selected")):null===a||x?(A.remove(),x||g.prepend(p),g.val(""),p.prop("selected",!0),p.attr("selected",!0)):(x||p.remove(),g.prepend(A),g.val("?"),A.prop("selected",
!0),A.attr("selected",!0))};v.readValue=function(){var a=y.selectValueMap[g.val()];return a&&!a.disabled?(x||p.remove(),A.remove(),y.getViewValueFromOption(a)):null};k&&(w.$isEmpty=function(a){return!a||0===a.length},v.writeValue=function(a){y.items.forEach(function(a){a.element.selected=!1});a&&a.forEach(function(a){(a=y.getOptionFromViewValue(a))&&!a.disabled&&(a.element.selected=!0)})},v.readValue=function(){var a=g.val()||[],c=[];n(a,function(a){a=y.selectValueMap[a];a.disabled||c.push(y.getViewValueFromOption(a))});
return c});x?(p.remove(),a(p)(c),p.removeClass("ng-scope")):p=E(e.cloneNode(!1));u();c.$watchCollection(L.getWatchables,u);L.trackBy&&c.$watch(l.ngModel,function(){w.$render()},!0)}}}}],we=["$locale","$interpolate","$log",function(a,c,d){var e=/{}/g,f=/^when(Minus)?(.+)$/;return{link:function(h,g,l){function k(a){g.text(a||"")}var m=l.count,q=l.$attr.when&&g.attr(l.$attr.when),r=l.offset||0,s=h.$eval(q)||{},u={},w=c.startSymbol(),v=c.endSymbol(),p=w+m+"-"+r+v,x=aa.noop,A;n(l,function(a,c){var d=f.exec(c);
d&&(d=(d[1]?"-":"")+N(d[2]),s[d]=g.attr(l.$attr[c]))});n(s,function(a,d){u[d]=c(a.replace(e,p))});h.$watch(m,function(c){var e=parseFloat(c),f=isNaN(e);f||e in s||(e=a.pluralCat(e-r));e===A||f&&X(A)&&isNaN(A)||(x(),f=u[e],F(f)?(null!=c&&d.debug("ngPluralize: no rule defined for '"+e+"' in "+q),x=z,k()):x=h.$watch(f,k),A=e)})}}}],xe=["$parse","$animate",function(a,c){var d=J("ngRepeat"),e=function(a,c,d,e,k,m,n){a[d]=e;k&&(a[k]=m);a.$index=c;a.$first=0===c;a.$last=c===n-1;a.$middle=!(a.$first||a.$last);
a.$odd=!(a.$even=0===(c&1))};return{restrict:"A",multiElement:!0,transclude:"element",priority:1E3,terminal:!0,$$tlb:!0,compile:function(f,h){var g=h.ngRepeat,l=Y.createComment(" end ngRepeat: "+g+" "),k=g.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!k)throw d("iexp",g);var m=k[1],q=k[2],r=k[3],s=k[4],k=m.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/);if(!k)throw d("iidexp",m);var w=k[3]||k[1],z=k[2];if(r&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(r)||
/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(r)))throw d("badident",r);var v,p,x,A,y={$id:Ea};s?v=a(s):(x=function(a,c){return Ea(c)},A=function(a){return a});return function(a,f,h,k,m){v&&(p=function(c,d,e){z&&(y[z]=c);y[w]=d;y.$index=e;return v(a,y)});var s=ma();a.$watchCollection(q,function(h){var k,q,t=f[0],v,y=ma(),B,F,H,C,J,D,I;r&&(a[r]=h);if(Ra(h))J=h,q=p||x;else for(I in q=p||A,J=[],h)h.hasOwnProperty(I)&&"$"!==I.charAt(0)&&J.push(I);B=J.length;
I=Array(B);for(k=0;k<B;k++)if(F=h===J?k:J[k],H=h[F],C=q(F,H,k),s[C])D=s[C],delete s[C],y[C]=D,I[k]=D;else{if(y[C])throw n(I,function(a){a&&a.scope&&(s[a.id]=a)}),d("dupes",g,C,H);I[k]={id:C,scope:u,clone:u};y[C]=!0}for(v in s){D=s[v];C=mb(D.clone);c.leave(C);if(C[0].parentNode)for(k=0,q=C.length;k<q;k++)C[k].$$NG_REMOVED=!0;D.scope.$destroy()}for(k=0;k<B;k++)if(F=h===J?k:J[k],H=h[F],D=I[k],D.scope){v=t;do v=v.nextSibling;while(v&&v.$$NG_REMOVED);D.clone[0]!=v&&c.move(mb(D.clone),null,E(t));t=D.clone[D.clone.length-
1];e(D.scope,k,w,H,z,F,B)}else m(function(a,d){D.scope=d;var f=l.cloneNode(!1);a[a.length++]=f;c.enter(a,null,E(t));t=f;D.clone=a;y[D.id]=D;e(D.scope,k,w,H,z,F,B)});s=y})}}}}],ye=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,function(c){a[c?"removeClass":"addClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],re=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngHide,function(c){a[c?"addClass":"removeClass"](d,
"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],ze=La(function(a,c,d){a.$watch(d.ngStyle,function(a,d){d&&a!==d&&n(d,function(a,d){c.css(d,"")});a&&c.css(a)},!0)}),Ae=["$animate",function(a){return{require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,f){var h=[],g=[],l=[],k=[],m=function(a,c){return function(){a.splice(c,1)}};c.$watch(e.ngSwitch||e.on,function(c){var d,e;d=0;for(e=l.length;d<e;++d)a.cancel(l[d]);d=l.length=0;for(e=k.length;d<e;++d){var s=mb(g[d].clone);
k[d].$destroy();(l[d]=a.leave(s)).then(m(l,d))}g.length=0;k.length=0;(h=f.cases["!"+c]||f.cases["?"])&&n(h,function(c){c.transclude(function(d,e){k.push(e);var f=c.element;d[d.length++]=Y.createComment(" end ngSwitchWhen: ");g.push({clone:d});a.enter(d,f.parent(),f)})})})}}}],Be=La({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[];e.cases["!"+d.ngSwitchWhen].push({transclude:f,element:c})}}),
Ce=La({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["?"]=e.cases["?"]||[];e.cases["?"].push({transclude:f,element:c})}}),Ee=La({restrict:"EAC",link:function(a,c,d,e,f){if(!f)throw J("ngTransclude")("orphan",ua(c));f(function(a){c.empty();c.append(a)})}}),ee=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,c[0].text)}}}],tg={$setViewValue:z,$render:z},ug=["$element",
"$scope","$attrs",function(a,c,d){var e=this,f=new eb;e.ngModelCtrl=tg;e.unknownOption=E(Y.createElement("option"));e.renderUnknownOption=function(c){c="? "+Ea(c)+" ?";e.unknownOption.val(c);a.prepend(e.unknownOption);a.val(c)};c.$on("$destroy",function(){e.renderUnknownOption=z});e.removeUnknownOption=function(){e.unknownOption.parent()&&e.unknownOption.remove()};c=0;d=a.children();for(var h=d.length;c<h;c++)if(""===d[c].value){e.emptyOption=d.eq(c);break}e.readValue=function(){e.removeUnknownOption();
return a.val()};e.writeValue=function(c){e.hasOption(c)?(e.removeUnknownOption(),a.val(c),""===c&&e.emptyOption.prop("selected",!0)):F(c)&&e.emptyOption?(e.removeUnknownOption(),a.val("")):e.renderUnknownOption(c)};e.addOption=function(a){Pa(a,'"option value"');var c=f.get(a)||0;f.put(a,c+1)};e.removeOption=function(a){var c=f.get(a);c&&(1===c?f.remove(a):f.put(a,c-1))};e.hasOption=function(a){return!!f.get(a)}}],fe=function(){return{restrict:"E",require:["select","?ngModel"],controller:ug,link:function(a,
c,d,e){var f=e[1];if(f){var h=e[0];h.ngModelCtrl=f;f.$render=function(){h.writeValue(f.$viewValue)};c.on("change",function(){a.$apply(function(){f.$setViewValue(h.readValue())})});if(d.multiple){h.readValue=function(){var a=[];n(c.find("option"),function(c){c.selected&&a.push(c.value)});return a};h.writeValue=function(a){var d=new eb(a);n(c.find("option"),function(a){a.selected=w(d.get(a.value))})};var g,l=NaN;a.$watch(function(){l!==f.$viewValue||ka(g,f.$viewValue)||(g=fa(f.$viewValue),f.$render());
l=f.$viewValue});f.$isEmpty=function(a){return!a||0===a.length}}}}}},he=["$interpolate",function(a){function c(a){a[0].hasAttribute("selected")&&(a[0].selected=!0)}return{restrict:"E",priority:100,compile:function(d,e){if(F(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),m=k.data("$selectController")||k.parent().data("$selectController");m&&m.ngModelCtrl&&(f?a.$watch(f,function(a,f){e.$set("value",a);f!==a&&m.removeOption(f);m.addOption(a,d);m.ngModelCtrl.$render();
