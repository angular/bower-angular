/*
 ...
 License: MIT
*/
(function(P,Y,v){'use strict';function S(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3794+sha.2b8baf7/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Oa(b){if(null==b||Pa(b))return!1;var a=b.length;
...
e=0;e<d.length;e++)a.call(c,b[d[e]],d[e]);return d}function gc(b){return function(a,c){b(c,a)}}function zd(){return++hb}function hc(b,a){a?b.$$hashKey=a:delete b.$$hashKey}function z(b){for(var a=b.$$hashKey,c=1,d=arguments.length;c<d;c++){var e=arguments[c];if(e)for(var f=Object.keys(e),g=0,h=f.length;g<h;g++){var l=f[g];b[l]=e[l]}}hc(b,a);return b}function ca(b){return parseInt(b,10)}function I(){}function ia(b){return b}function da(b){return function(){return b}}function E(b){return"undefined"===
...
b)if("$"!==c.charAt(0)||"$"!==c.charAt(1))a[c]=b[c];return a||b}function ka(b,a){if(b===a)return!0;if(null===b||null===a)return!1;if(b!==b&&a!==a)return!0;var c=typeof b,d;if(c==typeof a&&"object"==c)if(K(b)){if(!K(a))return!1;if((c=b.length)==a.length){for(d=0;d<c;d++)if(!ka(b[d],a[d]))return!1;return!0}}else{if(ja(b))return ja(a)?ka(b.getTime(),a.getTime()):!1;if(ib(b)&&ib(a))return b.toString()==a.toString();if(Qa(b)||Qa(a)||Pa(b)||Pa(a)||K(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!H(b[d])){if(!ka(b[d],
a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==v&&!H(a[d]))return!1;return!0}return!1}function Ta(b,a,c){return b.concat(Ua.call(a,c))}function jc(b,a){var c=2<arguments.length?Ua.call(arguments,2):[];return!H(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,Ta(c,arguments,0)):a.apply(b,c)}:function(){return arguments.length?a.apply(b,arguments):a.call(b)}}function Bd(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?
...
injector:Jb,noop:I,bind:jc,toJson:Va,fromJson:kc,identity:ia,isUndefined:E,isDefined:y,isString:Q,isFunction:H,isObject:O,isNumber:T,isElement:ic,isArray:K,version:Kd,isDate:ja,lowercase:B,uppercase:ob,callbacks:{counter:0},getTestability:Fd,$$minErr:S,$$csp:Wa,reloadWithDebugInfo:Ed});Xa=Id(P);try{Xa("ngLocale")}catch(a){Xa("ngLocale",[]).provider("$locale",Ld)}Xa("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:Md});a.provider("$compile",sc).directive({a:Nd,input:tc,textarea:tc,
...
!(!Y.querySelector("[ng-csp]")&&!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Wa.isActive_=b},lb=["ng-","data-ng-","ng:","x-ng-"],Gd=/[A-Z]/g,qc=!1,Kb,na=1,jb=3,Kd={full:"1.4.0-build.3794+sha.2b8baf7",major:1,minor:4,dot:0,codeName:"snapshot"};C.expando="ng339";var tb=C.cache={},bf=1;C._data=function(b){return this.cache[b[this.expando]]||{}};var Xe=/([\:\-\_]+(.))/g,Ye=/^moz([A-Z])/,Jf={mouseleave:"mouseout",mouseenter:"mouseover"},Nb=S("jqLite"),af=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,
...
Ya(a);if(y(c))b.style[a]=c;else return b.style[a]},attr:function(b,a,c){var d=B(a);if(yb[d])if(y(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||I).specified?d:v;else if(y(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,2),null===b?v:b},prop:function(b,a,c){if(y(c))b[a]=c;else return b[a]},text:function(){function b(a,b){if(E(b)){var d=a.nodeType;return d===na||d===jb?a.textContent:""}a.textContent=b}b.$dv=
...
h):y(c)?v:g,k=a(g,h,l)||I;if(f)for(var m=d.length;m--;)f[m]=ra(d[m](g,h),e);ra(l,e);if(k){if(k.constructor===k)throw fa("isecfn",e);if(k===Nf||k===Of||k===Pf)throw fa("isecff",e);}l=k.apply?k.apply(l,f):k(f[0],f[1],f[2],f[3],f[4]);return ra(l,e)}},arrayDeclaration:function(){var a=[];if("]"!==this.peekToken().text){do{if(this.peek("]"))break;a.push(this.expression())}while(this.expect(","))}this.consume("]");return z(function(c,d){for(var e=[],f=0,g=a.length;f<g;f++)e.push(a[f](c,d));return e},{literal:!0,
...
N=null,p=this;this.$$setOptions=function(a){if((p.$options=a)&&a.getterSetter){var c=f(d.ngModel+"()"),g=f(d.ngModel+"($$$p)");t=function(a){var d=n(a);H(d)&&(d=c(a));return d};s=function(a,c){H(n(a))?g(a,{$$$p:p.$modelValue}):q(a,p.$modelValue)}}else if(!n.assign)throw Hb("nonassign",d.ngModel,ta(e));};this.$render=I;this.$isEmpty=function(a){return E(a)||""===a||null===a||a!==a};var u=e.inheritedData("$formController")||Eb,x=0;md({ctrl:this,$element:e,set:function(a,c){a[c]=!0},unset:function(a,
...
!0:(r(p.$asyncValidators,function(a,c){h(c,null)}),!1)}function g(){var a=[],e=!0;r(p.$asyncValidators,function(f,g){var l=f(c,d);if(!l||!H(l.then))throw Hb("$asyncValidators",l);h(g,v);a.push(l.then(function(){h(g,!0)},function(a){e=!1;h(g,!1)}))});a.length?k.all(a).then(function(){l(e)},I):l(!0)}function h(a,c){m===x&&p.$setValidity(a,c)}function l(a){m===x&&e(a)}x++;var m=x;(function(a){var c=p.$$parserName||"parse";if(a===v)h(c,null);else if(h(c,a),!a)return r(p.$validators,function(a,c){h(c,
...
A)});var t=ea();a.$watchCollection(n,function(g){var k,n,p=f[0],A,C=ea(),D,E,I,B,H,z,K;q&&(a[q]=g);if(Oa(g))H=g,n=u||x;else{n=u||w;H=[];for(K in g)g.hasOwnProperty(K)&&"$"!=K.charAt(0)&&H.push(K);H.sort()}D=H.length;K=Array(D);for(k=0;k<D;k++)if(E=g===H?k:H[k],I=g[E],B=n(E,I,k),t[B])z=t[B],delete t[B],C[B]=z,K[k]=z;else{if(C[B])throw r(K,function(a){a&&a.scope&&(t[a.id]=a)}),d("dupes",h,B,I);K[k]={id:B,scope:v,clone:v};C[B]=!0}for(A in t){z=t[A];B=nb(z.clone);c.leave(B);if(B[0].parentNode)for(k=0,
n=B.length;k<n;k++)B[k].$$NG_REMOVED=!0;z.scope.$destroy()}for(k=0;k<D;k++)if(E=g===H?k:H[k],I=g[E],z=K[k],z.scope){A=p;do A=A.nextSibling;while(A&&A.$$NG_REMOVED);z.clone[0]!=A&&c.move(nb(z.clone),null,F(p));p=z.clone[z.clone.length-1];e(z.scope,k,s,I,y,E,D)}else m(function(a,d){z.scope=d;var f=l.cloneNode(!1);a[a.length++]=f;c.enter(a,null,F(p));p=f;z.clone=a;C[z.id]=z;e(z.scope,k,s,I,y,E,D)});t=C})}}}}],ie=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,
