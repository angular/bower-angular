/*
 ...
 License: MIT
*/
(function(P,Y,v){'use strict';function S(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3797+sha.0db5b21/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Oa(b){if(null==b||Pa(b))return!1;var a=b.length;
return b.nodeType===na&&a?!0:Q(b)||K(b)||0===a||"number"===typeof a&&0<a&&a-1 in b}function r(b,a,c){var d,e;if(b)if(I(b))for(d in b)"prototype"==d||"length"==d||"name"==d||b.hasOwnProperty&&!b.hasOwnProperty(d)||a.call(c,b[d],d,b);else if(K(b)||Oa(b)){var f="object"!==typeof b;d=0;for(e=b.length;d<e;d++)(f||d in b)&&a.call(c,b[d],d,b)}else if(b.forEach&&b.forEach!==r)b.forEach(a,c,b);else for(d in b)b.hasOwnProperty(d)&&a.call(c,b[d],d,b);return b}function yd(b,a,c){for(var d=Object.keys(b).sort(),
e=0;e<d.length;e++)a.call(c,b[d[e]],d[e]);return d}function gc(b){return function(a,c){b(c,a)}}function zd(){return++hb}function hc(b,a){a?b.$$hashKey=a:delete b.$$hashKey}function z(b){for(var a=b.$$hashKey,c=1,d=arguments.length;c<d;c++){var e=arguments[c];if(e)for(var f=Object.keys(e),g=0,h=f.length;g<h;g++){var l=f[g];b[l]=e[l]}}hc(b,a);return b}function ca(b){return parseInt(b,10)}function H(){}function ia(b){return b}function da(b){return function(){return b}}function E(b){return"undefined"===
typeof b}function y(b){return"undefined"!==typeof b}function O(b){return null!==b&&"object"===typeof b}function Q(b){return"string"===typeof b}function T(b){return"number"===typeof b}function ja(b){return"[object Date]"===Ba.call(b)}function I(b){return"function"===typeof b}function ib(b){return"[object RegExp]"===Ba.call(b)}function Pa(b){return b&&b.window===b}function Qa(b){return b&&b.$evalAsync&&b.$watch}function Ra(b){return"boolean"===typeof b}function ic(b){return!(!b||!(b.nodeName||b.prop&&
b.attr&&b.find))}function Ad(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function sa(b){return B(b.nodeName||b[0]&&b[0].nodeName)}function Sa(b,a){var c=b.indexOf(a);0<=c&&b.splice(c,1);return a}function xa(b,a,c,d){if(Pa(b)||Qa(b))throw Ia("cpws");if(a){if(b===a)throw Ia("cpi");c=c||[];d=d||[];if(O(b)){var e=c.indexOf(b);if(-1!==e)return d[e];c.push(b);d.push(a)}if(K(b))for(var f=a.length=0;f<b.length;f++)e=xa(b[f],null,c,d),O(b[f])&&(c.push(b[f]),d.push(e)),a.push(e);
else{var g=a.$$hashKey;K(a)?a.length=0:r(a,function(b,c){delete a[c]});for(f in b)b.hasOwnProperty(f)&&(e=xa(b[f],null,c,d),O(b[f])&&(c.push(b[f]),d.push(e)),a[f]=e);hc(a,g)}}else if(a=b)K(b)?a=xa(b,[],c,d):ja(b)?a=new Date(b.getTime()):ib(b)?(a=new RegExp(b.source,b.toString().match(/[^\/]*$/)[0]),a.lastIndex=b.lastIndex):O(b)&&(e=Object.create(Object.getPrototypeOf(b)),a=xa(b,e,c,d));return a}function oa(b,a){if(K(b)){a=a||[];for(var c=0,d=b.length;c<d;c++)a[c]=b[c]}else if(O(b))for(c in a=a||{},
b)if("$"!==c.charAt(0)||"$"!==c.charAt(1))a[c]=b[c];return a||b}function ka(b,a){if(b===a)return!0;if(null===b||null===a)return!1;if(b!==b&&a!==a)return!0;var c=typeof b,d;if(c==typeof a&&"object"==c)if(K(b)){if(!K(a))return!1;if((c=b.length)==a.length){for(d=0;d<c;d++)if(!ka(b[d],a[d]))return!1;return!0}}else{if(ja(b))return ja(a)?ka(b.getTime(),a.getTime()):!1;if(ib(b)&&ib(a))return b.toString()==a.toString();if(Qa(b)||Qa(a)||Pa(b)||Pa(a)||K(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!I(b[d])){if(!ka(b[d],
a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==v&&!I(a[d]))return!1;return!0}return!1}function Ta(b,a,c){return b.concat(Ua.call(a,c))}function jc(b,a){var c=2<arguments.length?Ua.call(arguments,2):[];return!I(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,Ta(c,arguments,0)):a.apply(b,c)}:function(){return arguments.length?a.apply(b,arguments):a.call(b)}}function Bd(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?
c=v:Pa(a)?c="$WINDOW":a&&Y===a?c="$DOCUMENT":Qa(a)&&(c="$SCOPE");return c}function Va(b,a){if("undefined"===typeof b)return v;T(a)||(a=a?2:null);return JSON.stringify(b,Bd,a)}function kc(b){return Q(b)?JSON.parse(b):b}function ta(b){b=F(b).clone();try{b.empty()}catch(a){}var c=F("<div>").append(b).html();try{return b[0].nodeType===jb?B(c):c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,function(a,b){return"<"+B(b)})}catch(d){return B(c)}}function lc(b){try{return decodeURIComponent(b)}catch(a){}}function mc(b){var a=
{},c,d;r((b||"").split("&"),function(b){b&&(c=b.replace(/\+/g,"%20").split("="),d=lc(c[0]),y(d)&&(b=y(c[1])?lc(c[1]):!0,nc.call(a,d)?K(a[d])?a[d].push(b):a[d]=[a[d],b]:a[d]=b))});return a}function Ib(b){var a=[];r(b,function(b,d){K(b)?r(b,function(b){a.push(Ca(d,!0)+(!0===b?"":"="+Ca(b,!0)))}):a.push(Ca(d,!0)+(!0===b?"":"="+Ca(b,!0)))});return a.length?a.join("&"):""}function kb(b){return Ca(b,!0).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+")}function Ca(b,a){return encodeURIComponent(b).replace(/%40/gi,
...
injector:Jb,noop:H,bind:jc,toJson:Va,fromJson:kc,identity:ia,isUndefined:E,isDefined:y,isString:Q,isFunction:I,isObject:O,isNumber:T,isElement:ic,isArray:K,version:Kd,isDate:ja,lowercase:B,uppercase:ob,callbacks:{counter:0},getTestability:Fd,$$minErr:S,$$csp:Wa,reloadWithDebugInfo:Ed});Xa=Id(P);try{Xa("ngLocale")}catch(a){Xa("ngLocale",[]).provider("$locale",Ld)}Xa("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:Md});a.provider("$compile",sc).directive({a:Nd,input:tc,textarea:tc,
...
typeof n)throw Ea("itkn",n);h.push(f&&f.hasOwnProperty(n)?f[n]:d(n,g))}K(b)&&(b=b[k]);return b.apply(c,h)}return{invoke:e,instantiate:function(a,b,c){var d=Object.create((K(a)?a[a.length-1]:a).prototype);a=e(a,d,b,c);return O(a)||I(a)?a:d},get:d,annotate:Rb,has:function(a){return n.hasOwnProperty(a+"Provider")||b.hasOwnProperty(a)}}}a=!0===a;var l={},k=[],m=new zb([],!0),n={$provide:{provider:c(d),factory:c(f),service:c(function(a,b){return f(a,["$injector",function(a){return a.instantiate(b)}])}),
value:c(function(a,b){return f(a,da(b),!1)}),constant:c(function(a,b){Ka(a,"constant");n[a]=b;t[a]=b}),decorator:function(a,b){var c=q.get(a+"Provider"),d=c.$get;c.$get=function(){var a=s.invoke(d,c);return s.invoke(b,null,{$delegate:a})}}}},q=n.$injector=h(n,function(a,b){U.isString(b)&&k.push(b);throw Ea("unpr",k.join(" <- "));}),t={},s=t.$injector=h(t,function(a,b){var c=q.get(a+"Provider",b);return s.invoke(c.$get,c,v,a)});r(g(b),function(a){s.invoke(a||H)});return s}function ve(){var b=!0;this.disableAutoScrolling=
...
L.require,Z,t),Za)}s=s||{};for(var u=-Number.MAX_VALUE,G,A=s.controllerDirectives,ga,J=s.newIsolateScopeDirective,ha=s.templateDirective,la=s.nonTlbTranscludeDirective,H=!1,z=!1,ya=s.hasElementTranscludeDirective,B=e.$$element=F(d),M,P,C,ua=f,T,U=0,W=a.length;U<W;U++){M=a[U];var ba=M.$$start,ea=M.$$end;ba&&(B=$(d,ba,ea));C=v;if(u>M.priority)break;if(C=M.scope)M.templateUrl||(O(C)?(La("new/isolated scope",J||G,M,B),J=M):La("new/isolated scope",J,M,B)),G=G||M;P=M.name;!M.templateUrl&&M.controller&&
(C=M.controller,A=A||{},La("'"+P+"' controller",A[P],M,B),A[P]=M);if(C=M.transclude)H=!0,M.$$tlb||(La("transclusion",la,M,B),la=M),"element"==C?(ya=!0,u=M.priority,C=B,B=e.$$element=F(Y.createComment(" "+P+": "+e[P]+" ")),d=B[0],X(g,Ua.call(C,0),d),ua=D(C,f,u,l&&l.name,{nonTlbTranscludeDirective:la})):(C=F(Ob(d)).contents(),B.empty(),ua=D(C,f));if(M.template)if(z=!0,La("template",ha,M,B),ha=M,C=I(M.template)?M.template(B,e):M.template,C=fa(C),M.replace){l=M;C=Mb.test(C)?Nc(Tb(M.templateNamespace,
V(C))):[];d=C[0];if(1!=C.length||d.nodeType!==na)throw ma("tplrt",P,"");X(g,B,d);W={$attr:{}};C=Z(d,[],W);var ia=a.splice(U+1,a.length-(U+1));J&&E(C);a=a.concat(C).concat(ia);Lc(e,W);W=a.length}else B.html(C);if(M.templateUrl)z=!0,La("template",ha,M,B),ha=M,M.replace&&(l=M),w=S(a.splice(U,a.length-U),B,e,g,H&&ua,k,n,{controllerDirectives:A,newIsolateScopeDirective:J,templateDirective:ha,nonTlbTranscludeDirective:la}),W=a.length;else if(M.compile)try{T=M.compile(B,e,ua),I(T)?L(null,T,ba,ea):T&&L(T.pre,
T.post,ba,ea)}catch(ja){c(ja,ta(B))}M.terminal&&(w.terminal=!0,u=Math.max(u,M.priority))}w.scope=G&&!0===G.scope;w.transcludeOnThisElement=H;w.elementTranscludeOnThisElement=ya;w.templateOnThisElement=z;w.transclude=ua;s.hasElementTranscludeDirective=ya;return w}function E(a){for(var b=0,c=a.length;b<c;b++){var d=b,e;e=z(Object.create(a[b]),{$$isolateScope:!0});a[d]=e}}function la(b,e,f,g,h,l,k){if(e===h)return null;h=null;if(d.hasOwnProperty(e)){var q;e=a.get(e+"Directive");for(var s=0,p=e.length;s<
...
(a["class"]?a["class"]+" ":"")+b):"style"==f?(e.attr("style",e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==f.charAt(0)||a.hasOwnProperty(f)||(a[f]=b,d[f]=c[f])})}function S(a,b,c,d,e,f,g,h){var l=[],k,n,q=b[0],p=a.shift(),u=z({},p,{templateUrl:null,transclude:null,replace:null,$$originalDirective:p}),G=I(p.templateUrl)?p.templateUrl(b,c):p.templateUrl,x=p.templateNamespace;b.empty();s(w.getTrustedResourceUrl(G)).then(function(s){var w,N;s=fa(s);if(p.replace){s=Mb.test(s)?Nc(Tb(x,
...
D.$$addBindingInfo=k?function(a,b){var c=a.data("$binding")||[];K(b)?c=c.concat(b):c.push(b);a.data("$binding",c)}:H;D.$$addBindingClass=k?function(a){L(a,"ng-binding")}:H;D.$$addScopeInfo=k?function(a,b,c,d){a.data(c?d?"$isolateScopeNoTemplate":"$isolateScope":"$scope",b)}:H;D.$$addScopeClass=k?function(a,b){L(a,b?"ng-isolate-scope":"ng-scope")}:H;return D}]}function va(b){return Ya(b.replace(Mc,""))}function Oc(b,a){var c="",d=b.split(/\s+/),e=a.split(/\s+/),f=0;a:for(;f<d.length;f++){for(var g=
...
arguments)}}]}function Ub(b,a){if(Q(b)){var c=b.replace(lf,"").trim();if(c){var d=a("Content-Type");(d=d&&0===d.indexOf(Pc))||(d=(d=c.match(mf))&&nf[d[0]].test(c));d&&(b=kc(c))}}return b}function Qc(b){var a=ea(),c,d,e;if(!b)return a;r(b.split("\n"),function(b){e=b.indexOf(":");c=B(V(b.substr(0,e)));d=V(b.substr(e+1));c&&(a[c]=a[c]?a[c]+", "+d:d)});return a}function Rc(b){var a=O(b)?b:v;return function(c){a||(a=Qc(b));return c?(c=a[B(c)],void 0===c&&(c=null),c):a}}function Sc(b,a,c,d){if(I(d))return d(b,
...
0);(200<=b&&300>b?t.resolve:t.reject)({data:a,status:b,headers:Rc(d),config:c,statusText:e})}function x(a){m(a.data,a.status,oa(a.headers()),a.statusText)}function w(){var a=k.pendingRequests.indexOf(c);-1!==a&&k.pendingRequests.splice(a,1)}var t=h.defer(),G=t.promise,L,D,r=c.headers,J=n(c.url,c.params);k.pendingRequests.push(c);G.then(w,w);!c.cache&&!b.cache||!1===c.cache||"GET"!==c.method&&"JSONP"!==c.method||(L=O(c.cache)?c.cache:O(b.cache)?b.cache:q);L&&(D=L.get(J),y(D)?D&&I(D.then)?D.then(x,
...
u();x&&x.abort()}function N(a,d,e,f,g){A!==v&&c.cancel(A);u=x=null;a(d,e,f,g);b.$$completeOutstandingRequest(H)}b.$$incOutstandingRequestCount();h=h||b.url();if("jsonp"==B(e)){var p="_"+(d.counter++).toString(36);d[p]=function(a){d[p].data=a;d[p].called=!0};var u=f(h.replace("JSON_CALLBACK","angular.callbacks."+p),p,function(a,b){N(k,a,d[p].data,"",b);d[p]=H})}else{var x=a();x.open(e,h,!0);r(m,function(a,b){y(a)&&x.setRequestHeader(b,a)});x.onload=function(){var a=x.statusText||"",b="response"in x?
...
u.constant?u.$$watchDelegate=m:x?(u=e(u),u.$$watchDelegate=u.literal?k:l):u.inputs&&(u.$$watchDelegate=h),A[w]=u);return n(u,f);case "function":return n(d,f);default:return n(H,f)}}}]}function Ke(){this.$get=["$rootScope","$exceptionHandler",function(b,a){return $c(function(a){b.$evalAsync(a)},a)}]}function Le(){this.$get=["$browser","$exceptionHandler",function(b,a){return $c(function(a){b.defer(a)},a)}]}function $c(b,a){function c(a,b,c){function d(b){return function(c){e||(e=!0,b.call(a,c))}}var e=
...
(b.$$childTail.$$nextSibling=d,b.$$childTail=d):b.$$childHead=b.$$childTail=d;(a||b!=this)&&d.$on("$destroy",c);return d},$watch:function(a,b,d){var e=g(a);if(e.$$watchDelegate)return e.$$watchDelegate(this,b,d,e);var f=this.$$watchers,h={fn:b,last:n,get:e,exp:a,eq:!!d};c=null;I(b)||(h.fn=H);f||(f=this.$$watchers=[]);f.unshift(h);return function(){Sa(f,h);c=null}},$watchGroup:function(a,b){function c(){h=!1;l?(l=!1,b(e,e,g)):b(e,d,g)}var d=Array(a.length),e=Array(a.length),f=[],g=this,h=!1,l=!0;if(!a.length){var k=
...
{cache:b,transformResponse:g}).finally(function(){d.totalPendingRequests--}).then(function(a){return a.data},function(a){if(!f)throw ma("tpload",e,a.status,a.statusText);return c.reject(a)})}d.totalPendingRequests=0;return d}]}function Re(){this.$get=["$rootScope","$browser","$location",function(b,a,c){return{findBindings:function(a,b,c){a=a.getElementsByClassName("ng-binding");var g=[];r(a,function(a){var d=U.element(a).data("$binding");d&&r(d,function(d){c?(new RegExp("(^|\\s)"+ad(b)+"(\\s|\\||$)")).test(d)&&
...
l,k){I(f)||(k=l,l=f,f=H);var m=y(k)&&!k,n=(m?d:c).defer(),q=n.promise;l=a.defer(function(){try{n.resolve(f())}catch(a){n.reject(a),e(a)}finally{delete g[q.$$timeoutId]}m||b.$apply()},l);q.$$timeoutId=l;g[l]=n;return q}var g={};f.cancel=function(b){return b&&b.$$timeoutId in g?(g[b.$$timeoutId].reject("canceled"),delete g[b.$$timeoutId],a.defer.cancel(b.$$timeoutId)):!1};return f}]}function za(b){bb&&(X.setAttribute("href",b),b=X.href);X.setAttribute("href",b);return{href:X.href,protocol:X.protocol?
...
B=function(b){return Q(b)?b.toLowerCase():b},nc=Object.prototype.hasOwnProperty,ob=function(b){return Q(b)?b.toUpperCase():b},bb,F,pa,Ua=[].slice,kf=[].splice,If=[].push,Ba=Object.prototype.toString,Ia=S("ng"),U=P.angular||(P.angular={}),Xa,hb=0;bb=Y.documentMode;H.$inject=[];ia.$inject=[];var K=Array.isArray,V=function(b){return Q(b)?b.trim():b},ad=function(b){return b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")},Wa=function(){if(y(Wa.isActive_))return Wa.isActive_;var b=
!(!Y.querySelector("[ng-csp]")&&!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Wa.isActive_=b},lb=["ng-","data-ng-","ng:","x-ng-"],Gd=/[A-Z]/g,qc=!1,Kb,na=1,jb=3,Kd={full:"1.4.0-build.3797+sha.0db5b21",major:1,minor:4,dot:0,codeName:"snapshot"};C.expando="ng339";var tb=C.cache={},bf=1;C._data=function(b){return this.cache[b[this.expando]]||{}};var Xe=/([\:\-\_]+(.))/g,Ye=/^moz([A-Z])/,Jf={mouseleave:"mouseout",mouseenter:"mouseover"},Nb=S("jqLite"),af=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,
Mb=/<|&#?\w+;/,Ze=/<([\w:]+)/,$e=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,W={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};W.optgroup=W.option;W.tbody=W.tfoot=W.colgroup=W.caption=W.thead;W.th=W.td;var Ja=C.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=
!1;"complete"===Y.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),C(P).on("load",a))},toString:function(){var b=[];r(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?F(this[b]):F(this[this.length+b])},length:0,push:If,sort:[].sort,splice:[].splice},yb={};r("multiple selected checked disabled readOnly required open".split(" "),function(b){yb[B(b)]=b});var Hc={};r("input select option textarea button form details".split(" "),function(b){Hc[b]=!0});var Ic=
{ngMinlength:"minlength",ngMaxlength:"maxlength",ngMin:"min",ngMax:"max",ngPattern:"pattern"};r({data:Pb,removeData:rb},function(b,a){C[a]=b});r({data:Pb,inheritedData:xb,scope:function(b){return F.data(b,"$scope")||xb(b.parentNode||b,["$isolateScope","$scope"])},isolateScope:function(b){return F.data(b,"$isolateScope")||F.data(b,"$isolateScopeNoTemplate")},controller:Ec,injector:function(b){return xb(b,"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:ub,css:function(b,a,c){a=
Ya(a);if(y(c))b.style[a]=c;else return b.style[a]},attr:function(b,a,c){var d=B(a);if(yb[d])if(y(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||H).specified?d:v;else if(y(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,2),null===b?v:b},prop:function(b,a,c){if(y(c))b[a]=c;else return b[a]},text:function(){function b(a,b){if(E(b)){var d=a.nodeType;return d===na||d===jb?a.textContent:""}a.textContent=b}b.$dv=
"";return b}(),val:function(b,a){if(E(a)){if(b.multiple&&"select"===sa(b)){var c=[];r(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(E(a))return b.innerHTML;qb(b,!0);b.innerHTML=a},empty:Fc},function(b,a){C.prototype[a]=function(a,d){var e,f,g=this.length;if(b!==Fc&&(2==b.length&&b!==ub&&b!==Ec?a:d)===v){if(O(a)){for(e=0;e<g;e++)if(b===Pb)b(this[e],a);else for(f in a)b(this[e],f,a[f]);return this}e=b.$dv;g=e===
v?Math.min(g,1):g;for(f=0;f<g;f++){var h=b(this[f],a,d);e=e?e+h:h}return e}for(e=0;e<g;e++)b(this[e],a,d);return this}});r({removeData:rb,on:function a(c,d,e,f){if(y(f))throw Nb("onargs");if(Ac(c)){var g=sb(c,!0);f=g.events;var h=g.handle;h||(h=g.handle=ef(c,f));for(var g=0<=d.indexOf(" ")?d.split(" "):[d],l=g.length;l--;){d=g[l];var k=f[d];k||(f[d]=[],"mouseenter"===d||"mouseleave"===d?a(c,Jf[d],function(a){var c=a.relatedTarget;c&&(c===this||this.contains(c))||h(a,d)}):"$destroy"!==d&&c.addEventListener(d,
...
!0!==a||g||d.push(c)});return 0<d.length+e.length&&[d.length?d:null,e.length?e:null]}function h(a,c,d){for(var e=0,f=c.length;e<f;++e)a[c[e]]=d}function l(){m||(m=a.defer(),d(function(){m.resolve();m=null}));return m.promise}function k(a,c){if(U.isObject(c)){var d=z(c.from||{},c.to||{});a.css(d)}}var m;return{animate:function(a,c,d){k(a,{from:c,to:d});return l()},enter:function(a,c,d,e){k(a,e);d?d.after(a):c.prepend(a);return l()},leave:function(a,c){a.remove();return l()},move:function(a,c,d,e){return this.enter(a,
...
h):y(c)?v:g,k=a(g,h,l)||H;if(f)for(var m=d.length;m--;)f[m]=ra(d[m](g,h),e);ra(l,e);if(k){if(k.constructor===k)throw fa("isecfn",e);if(k===Nf||k===Of||k===Pf)throw fa("isecff",e);}l=k.apply?k.apply(l,f):k(f[0],f[1],f[2],f[3],f[4]);return ra(l,e)}},arrayDeclaration:function(){var a=[];if("]"!==this.peekToken().text){do{if(this.peek("]"))break;a.push(this.expression())}while(this.expect(","))}this.consume("]");return z(function(c,d){for(var e=[],f=0,g=a.length;f<g;f++)e.push(a[f](c,d));return e},{literal:!0,
...
"yyyy-MM-ddTHH:mm:ss.sss"),time:db("time",wd,Gb(wd,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:db("week",fc,function(a,c){if(ja(a))return a;if(Q(a)){fc.lastIndex=0;var d=fc.exec(a);if(d){var e=+d[1],f=+d[2],g=d=0,h=0,l=0,k=jd(e),f=7*(f-1);c&&(d=c.getHours(),g=c.getMinutes(),h=c.getSeconds(),l=c.getMilliseconds());return new Date(e,0,k.getDate()+f,d,g,h,l)}}return NaN},"yyyy-Www"),month:db("month",vd,Gb(vd,["yyyy","MM"]),"yyyy-MM"),number:function(a,c,d,e,f,g){nd(a,c,d,e);cb(a,c,d,e,f,g);e.$$parserName=
...
N=null,p=this;this.$$setOptions=function(a){if((p.$options=a)&&a.getterSetter){var c=f(d.ngModel+"()"),g=f(d.ngModel+"($$$p)");t=function(a){var d=n(a);I(d)&&(d=c(a));return d};s=function(a,c){I(n(a))?g(a,{$$$p:p.$modelValue}):q(a,p.$modelValue)}}else if(!n.assign)throw Hb("nonassign",d.ngModel,ta(e));};this.$render=H;this.$isEmpty=function(a){return E(a)||""===a||null===a||a!==a};var u=e.inheritedData("$formController")||Eb,x=0;md({ctrl:this,$element:e,set:function(a,c){a[c]=!0},unset:function(a,
...
!0:(r(p.$asyncValidators,function(a,c){h(c,null)}),!1)}function g(){var a=[],e=!0;r(p.$asyncValidators,function(f,g){var l=f(c,d);if(!l||!I(l.then))throw Hb("$asyncValidators",l);h(g,v);a.push(l.then(function(){h(g,!0)},function(a){e=!1;h(g,!1)}))});a.length?k.all(a).then(function(){l(e)},H):l(!0)}function h(a,c){m===x&&p.$setValidity(a,c)}function l(a){m===x&&e(a)}x++;var m=x;(function(a){var c=p.$$parserName||"parse";if(a===v)h(c,null);else if(h(c,a),!a)return r(p.$validators,function(a,c){h(c,
...
if(!m)throw Yf("iexp",a,ta(d));var n=m[4]||m[6],q=m[5];a=/ as /.test(m[0])&&m[1];d=m[8];var r=c(m[2]?m[1]:n),s=a&&c(a)||r,v=d&&c(d),p=d?function(a,c){return v(e,c)}:function(a){return Da(a)},u=c(m[2]||m[1]),x=c(m[3]||""),w=c(m[7]),A={},G=q?function(a,c){A[q]=c;A[n]=a;return A}:function(a){A[n]=a;return A};return{getWatchables:c(w,function(a){var c=[];a=a||[];Object.keys(a).forEach(function(d){var f=G(a[d],d),g=u(e,f);d=p(a[d],f);c.push(d);c.push(g)});return c}),getOptions:function(){var a=[],c={},
d=w(e)||[];Object.keys(d).forEach(function(g){if("$"!==g.charAt(0)){var h=G(d[g],g),m=s(e,h);g=p(m,h);var n=u(e,h),h=x(e,h),m=new f(g,m,n,h);a.push(m);c[g]=m}});return{items:a,selectValueMap:c,getOptionFromViewValue:function(a){return c[p(a,G(a))]}}}}}var e=Y.createElement("option"),f=Y.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select","?ngModel"],link:function(c,h,l,k){function m(a,c){a.element=c;a.value!==c.value&&(c.value=a.selectValue);a.label!==c.label&&(c.label=a.label,
...
if(!k)throw d("iexp",h);var m=k[1],n=k[2],q=k[3],t=k[4],k=m.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/);if(!k)throw d("iidexp",m);var s=k[3]||k[1],y=k[2];if(q&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(q)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent)$/.test(q)))throw d("badident",q);var p,u,x,w,A={$id:Da};t?p=a(t):(x=function(a,c){return Da(c)},w=function(a){return a});return function(a,f,g,k,m){p&&(u=function(c,d,e){y&&(A[y]=c);A[s]=d;A.$index=e;return p(a,
A)});var t=ea();a.$watchCollection(n,function(g){var k,n,p=f[0],A,C=ea(),D,E,H,B,I,z,K;q&&(a[q]=g);if(Oa(g))I=g,n=u||x;else for(K in n=u||w,I=[],g)g.hasOwnProperty(K)&&"$"!==K.charAt(0)&&I.push(K);D=I.length;K=Array(D);for(k=0;k<D;k++)if(E=g===I?k:I[k],H=g[E],B=n(E,H,k),t[B])z=t[B],delete t[B],C[B]=z,K[k]=z;else{if(C[B])throw r(K,function(a){a&&a.scope&&(t[a.id]=a)}),d("dupes",h,B,H);K[k]={id:B,scope:v,clone:v};C[B]=!0}for(A in t){z=t[A];B=nb(z.clone);c.leave(B);if(B[0].parentNode)for(k=0,n=B.length;k<
n;k++)B[k].$$NG_REMOVED=!0;z.scope.$destroy()}for(k=0;k<D;k++)if(E=g===I?k:I[k],H=g[E],z=K[k],z.scope){A=p;do A=A.nextSibling;while(A&&A.$$NG_REMOVED);z.clone[0]!=A&&c.move(nb(z.clone),null,F(p));p=z.clone[z.clone.length-1];e(z.scope,k,s,H,y,E,D)}else m(function(a,d){z.scope=d;var f=l.cloneNode(!1);a[a.length++]=f;c.enter(a,null,F(p));p=f;z.clone=a;C[z.id]=z;e(z.scope,k,s,H,y,E,D)});t=C})}}}}],ie=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,function(c){a[c?
