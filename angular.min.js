...
sb=function(){if(y(sb.name_))return sb.name_;var a,b,d=Qa.length,c,e;for(b=0;b<d;++b)if(c=Qa[b],a=W.querySelector("["+c.replace(":","\\:")+"jq]")){e=a.getAttribute(c+"jq");break}return sb.name_=e},Qa=["ng-","data-ng-","ng:","x-ng-"],ge=/[A-Z]/g,Cc=!1,Pa=3,ke={full:"1.5.0-build.4552+sha.8f94b5b",major:1,minor:5,dot:0,codeName:"snapshot"};U.expando="ng339";var jb=U.cache={},Mf=1;U._data=function(a){return this.cache[a[this.expando]]||{}};var Hf=/([\:\-\_]+(.))/g,If=/^moz([A-Z])/,zb={mouseleave:"mouseout",
