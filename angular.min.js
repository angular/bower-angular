/*
 ...
 License: MIT
*/
(function(S,Y,u){'use strict';function P(a){return function(){var b=arguments[0],d;d="["+(a?a+":":"")+b+"] http://errors.angularjs.org/1.5.0-build.4493+sha.8ccc054/"+(a?a+"/":"")+b;for(b=1;b<arguments.length;b++){d=d+(1==b?"?":"&")+"p"+(b-1)+"=";var c=encodeURIComponent,e;e=arguments[b];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;d+=c(e)}return Error(d)}}function Da(a){if(null==a||Za(a))return!1;if(E(a)||I(a)||
...
a.$new(),M.$$addScopeInfo(C(k),l)):l=a,F=c.transcludeOnThisElement?ha(a,c.transclude,e):!c.templateOnThisElement&&e?e:!e&&b?ha(a,b):null,c(f,l,k,d,F)):f&&f(a,k.childNodes,u,e)}for(var h=[],k,l,m,r,p,F=0;F<a.length;F++){k=new ka;l=Ka(a[F],[],k,0===F?d:u,e);(f=l.length?na(l,a[F],k,b,c,null,[],[],f):null)&&f.scope&&M.$$addScopeClass(k.$$element);k=f&&f.terminal||!(m=a[F].childNodes)||!m.length?null:W(m,f?(f.transcludeOnThisElement||!f.templateOnThisElement)&&f.transclude:b);if(f||k)h.push(F,f,k),r=!0,
p=p||f;f=null}return r?g:null}function ha(a,b,c){var d=function(d,e,f,g,h){d||(d=a.$new(!1,h),d.$$transcluded=!0);return b(d,e,{parentBoundTranscludeFn:c,transcludeControllers:f,futureParentElement:g})},e=d.$$slots=Z(),f;for(f in b.$$slots)e[f]=b.$$slots[f]?ha(a,b.$$slots[f],c):null;return d}function Ka(a,b,c,d,e){var h=c.$attr,k;switch(a.nodeType){case 1:pa(b,ta(qa(a)),"E",d,e);for(var l,m,r,p=a.attributes,F=0,w=p&&p.length;F<w;F++){var y=!1,M=!1;l=p[F];k=l.name;m=X(l.value);l=ta(k);if(r=ja.test(l))k=
k.replace(Vc,"").substr(8).replace(/_(.)/g,function(a,b){return b.toUpperCase()});(l=l.match(oa))&&ra(l[1])&&(y=k,M=k.substr(0,k.length-5)+"end",k=k.substr(0,k.length-6));l=ta(k.toLowerCase());h[l]=k;if(r||!c.hasOwnProperty(l))c[l]=m,Rc(a,l)&&(c[l]=!0);T(a,b,m,l,r);pa(b,l,"A",d,e,y,M)}a=a.className;G(a)&&(a=a.animVal);if(I(a)&&""!==a)for(;k=g.exec(a);)l=ta(k[2]),pa(b,l,"C",d,e)&&(c[l]=X(k[3])),a=a.substr(k.index+k[0].length);break;case Qa:if(11===za)for(;a.parentNode&&a.nextSibling&&a.nextSibling.nodeType===
Qa;)a.nodeValue+=a.nextSibling.nodeValue,a.parentNode.removeChild(a.nextSibling);S(b,a.nodeValue);break;case 8:try{if(k=f.exec(a.nodeValue))l=ta(k[1]),pa(b,l,"M",d,e)&&(c[l]=X(k[2]))}catch(x){}}b.sort(ua);return b}function q(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ia("uterdir",b,c);1==a.nodeType&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&e--);d.push(a);a=a.nextSibling}while(0<e)}else d.push(a);return C(d)}function v(a,b,c){return function(d,e,f,g,h){e=q(e[0],b,
...
u;if(y>H.priority)break;if(J=H.scope)H.templateUrl||(G(J)?(Wa("new/isolated scope",B||s,H,z),B=H):Wa("new/isolated scope",B,H,z)),s=s||H;ra=H.name;if(!pa&&(H.replace&&(H.templateUrl||H.template)||H.transclude&&!H.$$tlb)){for(J=ua+1;pa=a[J++];)if(pa.transclude&&!pa.$$tlb||pa.replace&&(pa.templateUrl||pa.template)){S=!0;break}pa=!0}!H.templateUrl&&H.controller&&(J=H.controller,N=N||Z(),Wa("'"+ra+"' controller",N[ra],H,z),N[ra]=H);if(J=H.transclude)if(R=!0,H.$$tlb||(Wa("transclusion",W,H,z),W=H),"element"==
...
d&&(k=m&&b(m,!0,g,f),d=m);k&&(h[e]=k(a),(c[e]||(c[e]=[])).$$inter=!0,(h.$$observers&&h.$$observers[e].$$scope||a).$watch(k,function(a,b){"class"===e&&a!=b?h.$updateClass(a,b):h.$set(e,a)}))}}}})}}function $(a,b,c){var d=b[0],e=b.length,f=d.parentNode,g,h;if(a)for(g=0,h=a.length;g<h;g++)if(a[g]==d){a[g++]=c;h=g+e-1;for(var k=a.length;g<k;g++,h++)h<k?a[g]=a[h]:delete a[g];a.length-=e-1;a.context===d&&(a.context=c);break}f&&f.replaceChild(c,d);a=Y.createDocumentFragment();for(g=0;g<e;g++)a.appendChild(b[g]);
C.hasData(d)&&(C.data(c,C.data(d)),C(d).off("$destroy"));C.cleanData(a.querySelectorAll("*"));for(g=1;g<e;g++)delete b[g];b[0]=c;b.length=1}function ca(a,b){return O(function(){return a.apply(null,arguments)},a,b)}function da(a,b,d,e,f,g){try{a(b,d,e,f,g)}catch(h){c(h,sa(d))}}function ea(a,c,d,e,f){var g=[];n(e,function(e,h){var k=e.attrName,l=e.optional,m,r,F,w;switch(e.mode){case "@":l||va.call(c,k)||(d[h]=c[k]=void 0);c.$observe(k,function(a){I(a)&&(d[h]=a)});c.$$observers[k].$$scope=a;I(c[k])&&
(d[h]=b(c[k])(a));break;case "=":if(!va.call(c,k)){if(l)break;c[k]=void 0}if(l&&!c[k])break;r=p(c[k]);w=r.literal?la:function(a,b){return a===b||a!==a&&b!==b};F=r.assign||function(){m=d[h]=r(a);throw ia("nonassign",c[k],f.name);};m=d[h]=r(a);l=function(b){w(b,d[h])||(w(b,m)?F(a,b=d[h]):d[h]=b);return m=b};l.$stateful=!0;l=e.collection?a.$watchCollection(c[k],l):a.$watch(p(c[k],l),null,r.literal);g.push(l);break;case "&":r=c.hasOwnProperty(k)?p(c[k]):z;if(r===z&&l)break;d[h]=function(b){return r(a,
b)}}});return g.length&&function(){for(var a=0,b=g.length;a<b;++a)g[a]()}}var ba=/^\w/,aa=Y.createElement("div"),ka=function(a,b){if(b){var c=Object.keys(b),d,e,f;d=0;for(e=c.length;d<e;d++)f=c[d],this[f]=b[f]}else this.$attr={};this.$$element=a};ka.prototype={$normalize:ta,$addClass:function(a){a&&0<a.length&&F.addClass(this.$$element,a)},$removeClass:function(a){a&&0<a.length&&F.removeClass(this.$$element,a)},$updateClass:function(a,b){var c=Yc(a,b);c&&c.length&&F.addClass(this.$$element,c);(c=
Yc(b,a))&&c.length&&F.removeClass(this.$$element,c)},$set:function(a,b,d,e){var f=Rc(this.$$element[0],a),g=Zc[a],h=a;f?(this.$$element.prop(a,b),e=f):g&&(this[g]=b,h=g);this[a]=b;e?this.$attr[a]=e:(e=this.$attr[a])||(this.$attr[a]=e=Ac(a,"-"));f=qa(this.$$element);if("a"===f&&("href"===a||"xlinkHref"===a)||"img"===f&&"src"===a)this[a]=b=B(b,"src"===a);else if("img"===f&&"srcset"===a){for(var f="",g=X(b),k=/(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/,k=/\s/.test(g)?k:/(,)/,g=g.split(k),k=Math.floor(g.length/
2),l=0;l<k;l++)var m=2*l,f=f+B(X(g[m]),!0),f=f+(" "+X(g[m+1]));g=X(g[2*l]).split(/\s/);f+=B(X(g[0]),!0);2===g.length&&(f+=" "+X(g[1]));this[a]=b=f}!1!==d&&(null===b||A(b)?this.$$element.removeAttr(e):ba.test(e)?this.$$element.attr(e,b):R(this.$$element[0],e,b));(a=this.$$observers)&&n(a[h],function(a){try{a(b)}catch(d){c(d)}})},$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers=Z()),e=d[a]||(d[a]=[]);e.push(b);w.$evalAsync(function(){e.$$inter||!c.hasOwnProperty(a)||A(c[a])||b(c[a])});
return function(){db(e,b)}}};var V=b.startSymbol(),ga=b.endSymbol(),ma="{{"==V||"}}"==ga?ab:function(a){return a.replace(/\{\{/g,V).replace(/}}/g,ga)},ja=/^ngAttr[A-Z]/,oa=/^(.+)Start$/;M.$$addBindingInfo=m?function(a,b){var c=a.data("$binding")||[];E(b)?c=c.concat(b):c.push(b);a.data("$binding",c)}:z;M.$$addBindingClass=m?function(a){N(a,"ng-binding")}:z;M.$$addScopeInfo=m?function(a,b,c,d){a.data(c?d?"$isolateScopeNoTemplate":"$isolateScope":"$scope",b)}:z;M.$$addScopeClass=m?function(a,b){N(a,
b?"ng-isolate-scope":"ng-scope")}:z;return M}]}function ta(a){return hb(a.replace(Vc,""))}function Yc(a,b){var d="",c=a.split(/\s+/),e=b.split(/\s+/),f=0;a:for(;f<c.length;f++){for(var g=c[f],h=0;h<e.length;h++)if(g==e[h])continue a;d+=(0<d.length?" ":"")+g}return d}function Wc(a){a=C(a);var b=a.length;if(1>=b)return a;for(;b--;)8===a[b].nodeType&&Wf.call(a,b,1);return a}function Uc(a,b){if(b&&I(b))return b;if(I(a)){var d=$c.exec(a);if(d)return d[3]}}function af(){var a={},b=!1;this.register=function(b,
c){Ua(b,"controller");G(b)?O(a,b):a[b]=c};this.allowGlobals=function(){b=!0};this.$get=["$injector","$window",function(d,c){function e(a,b,c,d){if(!a||!G(a.$scope))throw P("$controller")("noscp",d,b);a.$scope[b]=c}return function(f,g,h,k){var l,m,t;h=!0===h;k&&I(k)&&(t=k);if(I(f)){k=f.match($c);if(!k)throw Xf("ctrlfmt",f);m=k[1];t=t||k[3];f=a.hasOwnProperty(m)?a[m]:Cc(g.$scope,m,!0)||(b?Cc(c,m,!0):u);Ta(f,m,!0)}if(h)return h=(E(f)?f[f.length-1]:f).prototype,l=Object.create(h||null),t&&e(g,t,l,m||
f.name),O(function(){var a=d.invoke(f,l,g,m);a!==l&&(G(a)||D(a))&&(l=a,t&&e(g,t,l,m||f.name));return l},{instance:l,identifier:t});l=d.instantiate(f,g,m);t&&e(g,t,l,m||f.name);return l}}]}function bf(){this.$get=["$window",function(a){return C(a.document)}]}function cf(){this.$get=["$log",function(a){return function(b,d){a.error.apply(a,arguments)}}]}function ac(a){return G(a)?aa(a)?a.toISOString():fb(a):a}function hf(){this.$get=function(){return function(a){if(!a)return"";var b=[];qc(a,function(a,
c){null===a||A(a)||(E(a)?n(a,function(a,d){b.push(ga(c)+"="+ga(ac(a)))}):b.push(ga(c)+"="+ga(ac(a))))});return b.join("&")}}}function jf(){this.$get=function(){return function(a){function b(a,e,f){null===a||A(a)||(E(a)?n(a,function(a,c){b(a,e+"["+(G(a)?c:"")+"]")}):G(a)&&!aa(a)?qc(a,function(a,c){b(a,e+(f?"":"[")+c+(f?"":"]"))}):d.push(ga(e)+"="+ga(ac(a))))}if(!a)return"";var d=[];b(a,"",!0);return d.join("&")}}}function bc(a,b){if(I(a)){var d=a.replace(Yf,"").trim();if(d){var c=b("Content-Type");
(c=c&&0===c.indexOf(ad))||(c=(c=d.match(Zf))&&$f[c[0]].test(d));c&&(a=vc(d))}}return a}function bd(a){var b=Z(),d;I(a)?n(a.split("\n"),function(a){d=a.indexOf(":");var e=K(X(a.substr(0,d)));a=X(a.substr(d+1));e&&(b[e]=b[e]?b[e]+", "+a:a)}):G(a)&&n(a,function(a,d){var f=K(d),g=X(a);f&&(b[f]=b[f]?b[f]+", "+g:g)});return b}function cd(a){var b;return function(d){b||(b=bd(a));return d?(d=b[K(d)],void 0===d&&(d=null),d):b}}function dd(a,b,d,c){if(D(c))return c(a,b,d);n(c,function(c){a=c(a,b,d)});return a}
function gf(){var a=this.defaults={transformResponse:[bc],transformRequest:[function(a){return G(a)&&"[object File]"!==fa.call(a)&&"[object Blob]"!==fa.call(a)&&"[object FormData]"!==fa.call(a)?fb(a):a}],headers:{common:{Accept:"application/json, text/plain, */*"},post:V(cc),put:V(cc),patch:V(cc)},xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",paramSerializer:"$httpParamSerializer"},b=!1;this.useApplyAsync=function(a){return v(a)?(b=!!a,this):b};var d=!0;this.useLegacyPromiseExtensions=
...
a+d+this.$$url}}function Gb(a){return function(){return this[a]}}function jd(a,b){return function(d){if(A(d))return this[a];this[a]=b(d);this.$$compose();return this}}function mf(){var a="",b={enabled:!1,requireBase:!0,rewriteLinks:!0};this.hashPrefix=function(b){return v(b)?(a=b,this):a};this.html5Mode=function(a){return cb(a)?(b.enabled=a,this):G(a)?(cb(a.enabled)&&(b.enabled=a.enabled),cb(a.requireBase)&&(b.requireBase=a.requireBase),cb(a.rewriteLinks)&&(b.rewriteLinks=a.rewriteLinks),this):b};
...
l);default:return k(z,l)}}}]}function qf(){this.$get=["$rootScope","$exceptionHandler",function(a,b){return sd(function(b){a.$evalAsync(b)},b)}]}function rf(){this.$get=["$browser","$exceptionHandler",function(a,b){return sd(function(b){a.defer(b)},b)}]}function sd(a,b){function d(){this.$$state={status:0}}function c(a,b){return function(c){b.call(a,c)}}function e(c){!c.processScheduled&&c.pending&&(c.processScheduled=!0,a(function(){var a,d,e;e=c.pending;c.processScheduled=!1;c.pending=u;for(var f=
...
!(a.eq?la(g,k):"number"===typeof g&&"number"===typeof k&&isNaN(g)&&isNaN(k)))r=!0,c=a,a.last=a.eq?Pa(g,null):g,a.fn(g,k===q?g:k,p),5>n&&(Q=4-n,y[Q]||(y[Q]=[]),y[Q].push({msg:D(a.exp)?"fn: "+(a.exp.name||a.exp.toString()):a.exp,newVal:g,oldVal:k}));else if(a===c){r=!1;break a}}catch(A){f(A)}if(!(l=p.$$watchersCount&&p.$$childHead||p!==this&&p.$$nextSibling))for(;p!==this&&!(l=p.$$nextSibling);)p=p.$parent}while(p=l);if((r||w.length)&&!n--)throw x.$$phase=null,d("infdig",b,y);}while(r||w.length);for(x.$$phase=
...
b)};c[hb("get_trusted_"+d)]=function(b){return f(a,b)};c[hb("trust_as_"+d)]=function(b){return g(a,b)}});return c}]}function uf(){this.$get=["$window","$document",function(a,b){var d={},c=da((/android (\d+)/.exec(K((a.navigator||{}).userAgent))||[])[1]),e=/Boxee/i.test((a.navigator||{}).userAgent),f=b[0]||{},g,h=/^(Moz|webkit|ms)(?=[A-Z])/,k=f.body&&f.body.style,l=!1,m=!1;if(k){for(var t in k)if(l=h.exec(t)){g=l[0];g=g.substr(0,1).toUpperCase()+g.substr(1);break}g||(g="WebkitOpacity"in k&&"webkit");
...
setLocation:function(b){b!==d.url()&&(d.url(b),a.$digest())},whenStable:function(a){b.notifyWhenNoOutstandingRequests(a)}}}]}function yf(){this.$get=["$rootScope","$browser","$q","$$q","$exceptionHandler",function(a,b,d,c,e){function f(f,k,l){D(f)||(l=k,k=f,f=z);var m=wa.call(arguments,3),t=v(l)&&!l,r=(t?c:d).defer(),n=r.promise,q;q=b.defer(function(){try{r.resolve(f.apply(null,m))}catch(b){r.reject(b),e(b)}finally{delete g[n.$$timeoutId]}t||a.$apply()},k);n.$$timeoutId=q;g[q]=r;return n}var g={};
f.cancel=function(a){return a&&a.$$timeoutId in g?(g[a.$$timeoutId].reject("canceled"),delete g[a.$$timeoutId],b.defer.cancel(a.$$timeoutId)):!1};return f}]}function Aa(a){za&&($.setAttribute("href",a),a=$.href);$.setAttribute("href",a);return{href:$.href,protocol:$.protocol?$.protocol.replace(/:$/,""):"",host:$.host,search:$.search?$.search.replace(/^\?/,""):"",hash:$.hash?$.hash.replace(/^#/,""):"",hostname:$.hostname,port:$.port,pathname:"/"===$.pathname.charAt(0)?$.pathname:"/"+$.pathname}}function fd(a){a=
I(a)?Aa(a):a;return a.protocol===vd.protocol&&a.host===vd.host}function zf(){this.$get=ka(S)}function wd(a){function b(a){try{return decodeURIComponent(a)}catch(b){return a}}var d=a[0]||{},c={},e="";return function(){var a,g,h,k,l;a=d.cookie||"";if(a!==e)for(e=a,a=e.split("; "),c={},h=0;h<a.length;h++)g=a[h],k=g.indexOf("="),0<k&&(l=b(g.substring(0,k)),A(c[l])&&(c[l]=b(g.substring(k+1))));return c}}function Df(){this.$get=wd}function Kc(a){function b(d,c){if(G(d)){var e={};n(d,function(a,c){e[c]=
...
"mediumDate";d=a.DATETIME_FORMATS[d]||d;I(c)&&(c=rg.test(c)?da(c):b(c));U(c)&&(c=new Date(c));if(!aa(c)||!isFinite(c.getTime()))return c;for(;d;)(l=sg.exec(d))?(h=eb(h,l,1),d=h.pop()):(h.push(d),d=null);var m=c.getTimezoneOffset();f&&(m=wc(f,c.getTimezoneOffset()),c=Sb(c,f,!0));n(h,function(b){k=tg[b];g+=k?k(c,a.DATETIME_FORMATS,m):b.replace(/(^'|'$)/g,"").replace(/''/g,"'")});return g}}function kg(){return function(a,b){A(b)&&(b=2);return fb(a,b)}}function lg(){return function(a,b,d){b=Infinity===
...
b||m(a,this,this.value)});if(e.hasEvent("paste"))b.on("paste cut",m)}b.on("change",k);c.$render=function(){var a=c.$isEmpty(c.$viewValue)?"":c.$viewValue;b.val()!==a&&b.val(a)}}function Nb(a,b){return function(d,c){var e,f;if(aa(d))return d;if(I(d)){'"'==d.charAt(0)&&'"'==d.charAt(d.length-1)&&(d=d.substring(1,d.length-1));if(ug.test(d))return new Date(d);a.lastIndex=0;if(e=a.exec(d))return e.shift(),f=c?{yyyy:c.getFullYear(),MM:c.getMonth()+1,dd:c.getDate(),HH:c.getHours(),mm:c.getMinutes(),ss:c.getSeconds(),
...
a},td=function(a){return a.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")},Fa=function(){if(!v(Fa.rules)){var a=Y.querySelector("[ng-csp]")||Y.querySelector("[data-ng-csp]");if(a){var b=a.getAttribute("ng-csp")||a.getAttribute("data-ng-csp");Fa.rules={noUnsafeEval:!b||-1!==b.indexOf("no-unsafe-eval"),noInlineStyle:!b||-1!==b.indexOf("no-inline-style")}}else{a=Fa;try{new Function(""),b=!1}catch(d){b=!0}a.rules={noUnsafeEval:b,noInlineStyle:!1}}}return Fa.rules},sb=function(){if(v(sb.name_))return sb.name_;
var a,b,d=Ra.length,c,e;for(b=0;b<d;++b)if(c=Ra[b],a=Y.querySelector("["+c.replace(":","\\:")+"jq]")){e=a.getAttribute(c+"jq");break}return sb.name_=e},Ra=["ng-","data-ng-","ng:","x-ng-"],de=/[A-Z]/g,Bc=!1,Qa=3,he={full:"1.5.0-build.4493+sha.8ccc054",major:1,minor:5,dot:0,codeName:"snapshot"};J.expando="ng339";var jb=J.cache={},Jf=1;J._data=function(a){return this.cache[a[this.expando]]||{}};var Ef=/([\:\-\_]+(.))/g,Ff=/^moz([A-Z])/,zb={mouseleave:"mouseout",mouseenter:"mouseover"},Wb=P("jqLite"),
If=/^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,Vb=/<|&#?\w+;/,Gf=/<([\w:-]+)/,Hf=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,ma={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};ma.optgroup=ma.option;ma.tbody=ma.tfoot=ma.colgroup=ma.caption=ma.thead;ma.th=ma.td;var Of=Node.prototype.contains||
...
function(b,c){var e,f,g=this.length;if(a!==Qc&&A(2==a.length&&a!==Ab&&a!==Pc?b:c)){if(G(b)){for(e=0;e<g;e++)if(a===Yb)a(this[e],b);else for(f in b)a(this[e],f,b[f]);return this}e=a.$dv;g=A(e)?Math.min(g,1):g;for(f=0;f<g;f++){var h=a(this[f],b,c);e=e?e+h:h}return e}for(e=0;e<g;e++)a(this[e],b,c);return this}});n({removeData:ib,on:function(a,b,d,c){if(v(c))throw Wb("onargs");if(Lc(a)){c=yb(a,!0);var e=c.events,f=c.handle;f||(f=c.handle=Lf(a,e));c=0<=b.indexOf(" ")?b.split(" "):[b];for(var g=c.length,
...
J.prototype.on;J.prototype.unbind=J.prototype.off});Va.prototype={put:function(a,b){this[Ga(a,this.nextUid)]=b},get:function(a){return this[Ga(a,this.nextUid)]},remove:function(a){var b=this[a=Ga(a,this.nextUid)];delete this[a];return b}};var Cf=[function(){this.$get=[function(){return Va}]}],Qf=/^([^\(]+?)=>/,Rf=/^[^\(]*\(\s*([^\)]*)\)/m,xg=/,/,yg=/^\s*(_?)(\S+?)\1\s*$/,Pf=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Ha=P("$injector");gb.$$annotate=function(a,b,d){var c;if("function"===typeof a){if(!(c=a.$inject)){c=
[];if(a.length){if(b)throw I(d)&&d||(d=a.name||Sf(a)),Ha("strictdi",d);b=Tc(a);n(b[1].split(xg),function(a){a.replace(yg,function(a,b,d){c.push(d)})})}a.$inject=c}}else E(a)?(b=a.length-1,Ta(a[b],"fn"),c=a.slice(0,b)):Ta(a,"fn",!0);return c};var Nd=P("$animate"),Ve=function(){this.$get=function(){}},We=function(){var a=new Va,b=[];this.$get=["$$AnimateRunner","$rootScope",function(d,c){function e(a,b,c){var d=!1;b&&(b=I(b)?b.split(" "):E(b)?b:[],n(b,function(b){b&&(d=!0,a[b]=c)}));return d}function f(){n(b,
function(b){var c=a.get(b);if(c){var d=Tf(b.attr("class")),e="",f="";n(c,function(a,b){a!==!!d[b]&&(a?e+=(e.length?" ":"")+b:f+=(f.length?" ":"")+b)});n(b,function(a){e&&Cb(a,e);f&&Bb(a,f)});a.remove(b)}});b.length=0}return{enabled:z,on:z,off:z,pin:z,push:function(g,h,k,l){l&&l();k=k||{};k.from&&g.css(k.from);k.to&&g.css(k.to);if(k.addClass||k.removeClass)if(h=k.addClass,l=k.removeClass,k=a.get(g)||{},h=e(k,h,!0),l=e(k,l,!1),h||l)a.put(g,k),b.push(g),1===b.length&&c.$$postDigest(f);g=new d;g.complete();
return g}}}]},Te=["$provide",function(a){var b=this;this.$$registeredAnimations=Object.create(null);this.register=function(d,c){if(d&&"."!==d.charAt(0))throw Nd("notcsel",d);var e=d+"-animation";b.$$registeredAnimations[d.substr(1)]=e;a.factory(e,c)};this.classNameFilter=function(a){if(1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?a:null)&&/(\s+|\/)ng-animate(\s+|\/)/.test(this.$$classNameFilter.toString()))throw Nd("nongcls","ng-animate");return this.$$classNameFilter};this.$get=
["$$animateQueue",function(a){function b(a,c,d){if(d){var h;a:{for(h=0;h<d.length;h++){var k=d[h];if(1===k.nodeType){h=k;break a}}h=void 0}!h||h.parentNode||h.previousElementSibling||(d=null)}d?d.after(a):c.prepend(a)}return{on:a.on,off:a.off,pin:a.pin,enabled:a.enabled,cancel:function(a){a.end&&a.end()},enter:function(e,f,g,h){f=f&&C(f);g=g&&C(g);f=f||g.parent();b(e,f,g);return a.push(e,"enter",Ia(h))},move:function(e,f,g,h){f=f&&C(f);g=g&&C(g);f=f||g.parent();b(e,f,g);return a.push(e,"move",Ia(h))},
leave:function(b,c){return a.push(b,"leave",Ia(c),function(){b.remove()})},addClass:function(b,c,g){g=Ia(g);g.addClass=kb(g.addclass,c);return a.push(b,"addClass",g)},removeClass:function(b,c,g){g=Ia(g);g.removeClass=kb(g.removeClass,c);return a.push(b,"removeClass",g)},setClass:function(b,c,g,h){h=Ia(h);h.addClass=kb(h.addClass,c);h.removeClass=kb(h.removeClass,g);return a.push(b,"setClass",h)},animate:function(b,c,g,h,k){k=Ia(k);k.from=k.from?O(k.from,c):c;k.to=k.to?O(k.to,g):g;k.tempClasses=kb(k.tempClasses,
h||"ng-inline-animate");return a.push(b,"animate",k)}}}]}],Ye=function(){this.$get=["$$rAF",function(a){function b(b){d.push(b);1<d.length||a(function(){for(var a=0;a<d.length;a++)d[a]();d=[]})}var d=[];return function(){var a=!1;b(function(){a=!0});return function(d){a?d():b(d)}}}]},Xe=function(){this.$get=["$q","$sniffer","$$animateAsyncRun",function(a,b,d){function c(a){this.setHost(a);this._doneCallbacks=[];this._runInAnimationFrame=d();this._state=0}c.chain=function(a,b){function c(){if(d===
a.length)b(!0);else a[d](function(a){!1===a?b(!1):(d++,c())})}var d=0;c()};c.all=function(a,b){function c(g){k=k&&g;++d===a.length&&b(k)}var d=0,k=!0;n(a,function(a){a.done(c)})};c.prototype={setHost:function(a){this.host=a||{}},done:function(a){2===this._state?a():this._doneCallbacks.push(a)},progress:z,getPromise:function(){if(!this.promise){var b=this;this.promise=a(function(a,c){b.done(function(b){!1===b?c():a()})})}return this.promise},then:function(a,b){return this.getPromise().then(a,b)},"catch":function(a){return this.getPromise()["catch"](a)},
...
var Vc=/^((?:x|data)[\:\-_])/i,Xf=P("$controller"),$c=/^(\S+)(\s+as\s+(\w+))?$/,df=function(){this.$get=["$document",function(a){return function(b){b?!b.nodeType&&b instanceof C&&(b=b[0]):b=a[0].body;return b.offsetWidth+1}}]},ad="application/json",cc={"Content-Type":ad+";charset=utf-8"},Zf=/^\[|^\{(?!\{)/,$f={"[":/]$/,"{":/}$/},Yf=/^\)\]\}',?\n/,zg=P("$http"),ed=function(a){return function(){throw zg("legacy",a);}},Ma=ba.$interpolateMinErr=P("$interpolate");Ma.throwNoconcat=function(a){throw Ma("noconcat",
a);};Ma.interr=function(a,b){return Ma("interr",a,b.toString())};var Ag=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,bg={http:80,https:443,ftp:21},Fb=P("$location"),Bg={$$html5:!1,$$replace:!1,absUrl:Gb("$$absUrl"),url:function(a){if(A(a))return this.$$url;var b=Ag.exec(a);(b[1]||""===a)&&this.path(decodeURIComponent(b[1]));(b[2]||b[1]||""===a)&&this.search(b[3]||"");this.hash(b[5]||"");return this},protocol:Gb("$$protocol"),host:Gb("$$host"),port:Gb("$$port"),path:jd("$$path",function(a){a=null!==a?a.toString():
...
function(a){a.prototype=Object.create(Bg);a.prototype.state=function(b){if(!arguments.length)return this.$$state;if(a!==ec||!this.$$html5)throw Fb("nostate");this.$$state=A(b)?null:b;return this}});var ea=P("$parse"),dg=Function.prototype.call,eg=Function.prototype.apply,fg=Function.prototype.bind,Ob=Z();n("+ - * / % === !== == != < > <= >= && || ! = |".split(" "),function(a){Ob[a]=!0});var Cg={n:"\n",f:"\f",r:"\r",t:"\t",v:"\v","'":"'",'"':'"'},hc=function(a){this.options=a};hc.prototype={constructor:hc,
