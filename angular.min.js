/*
 ...
 License: MIT
*/
(function(L,T,r){'use strict';function A(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.0-build.2687+sha.ac37915/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function fb(b){if(null==
...
"register"),directive:b("$compileProvider","directive"),config:n,run:function(a){l.push(a);return this}};h&&n(h);return m}())}}())}function od(b){F(b,{bootstrap:ic,copy:da,extend:F,equals:ya,element:E,forEach:q,injector:Eb,noop:w,bind:jb,toJson:ra,fromJson:ec,identity:Da,isUndefined:I,isDefined:B,isString:v,isFunction:P,isObject:V,isNumber:Ea,isElement:gd,isArray:M,version:pd,isDate:pa,lowercase:z,uppercase:Ga,callbacks:{counter:0},$$minErr:A,$$csp:dc});Ua=nd(L);try{Ua("ngLocale")}catch(a){Ua("ngLocale",
...
q(a[1].split(He),function(a){a.replace(Ie,function(a,b,c){d.push(c)})})}b.$inject=d}}else M(b)?(a=b.length-1,Ta(b[a],"fn"),d=b.slice(0,a)):Ta(b,"fn",!0);return d}function Eb(b,a){function c(a){return function(b,c){if(V(b))q(b,$b(a));else return a(b,c)}}function d(a,b){Aa(a,"service");if(P(b)||M(b))b=m.instantiate(b);if(!b.$get)throw Ka("pget",a);return n[a+p]=b}function e(a,b){return d(a,{$get:b})}function f(a){var b=[],c;q(a,function(a){function d(a){var b,c;b=0;for(c=a.length;b<c;b++){var e=a[b],
...
return b[a]}try{return k.unshift(a),b[a]=g,b[a]=c(a)}catch(e){throw b[a]===g&&delete b[a],e;}finally{k.shift()}}function e(b,c,f,g){"string"===typeof f&&(g=f,f=null);var h=[];g=Nb(b,a,g);var p,k,l;k=0;for(p=g.length;k<p;k++){l=g[k];if("string"!==typeof l)throw Ka("itkn",l);h.push(f&&f.hasOwnProperty(l)?f[l]:d(l))}b.$inject||(b=b[p]);return b.apply(c,h)}return{invoke:e,instantiate:function(a,b,c){var d=function(){};d.prototype=(M(a)?a[a.length-1]:a).prototype;d=new d;a=e(a,d,b,c);return V(a)||P(a)?
...
t++;c=n(function(){delete s[c];e(a)},b||0);s[c]=!0;return c};g.defer.cancel=function(a){return s[a]?(delete s[a],m(a),e(w),!0):!1}}function ce(){this.$get=["$window","$log","$sniffer","$document",function(b,a,c,d){return new Je(b,d,a,c)}]}function de(){this.$get=function(){function b(b,d){function e(a){a!=n&&(m?m==a&&(m=a.n):m=a,f(a.n,a.p),f(a,n),n=a,n.n=null)}function f(a,b){a!=b&&(a&&(a.p=b),b&&(b.n=a))}if(b in a)throw A("$cacheFactory")("iid",b);var h=0,g=F({},d,{id:b}),p={},k=d&&d.capacity||Number.MAX_VALUE,
...
(this.$attr[a]=d=lb(a,"-"));e=Ma(this.$$element);if("A"===e&&"href"===a||"IMG"===e&&"src"===a)this[a]=b=x(b,"src"===a);!1!==c&&(null===b||b===r?this.$$element.removeAttr(d):this.$$element.attr(d,b));(c=this.$$observers)&&q(c[a],function(a){try{a(b)}catch(c){n(c)}})},$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers={}),e=d[a]||(d[a]=[]);e.push(b);u.$evalAsync(function(){e.$$inter||b(c[a])});return function(){Fa(e,b)}}};var U=b.startSymbol(),Y=b.endSymbol(),Bc="{{"==U||"}}"==Y?Da:function(a){return a.replace(/\{\{/g,
...
I(a.data)&&q(f,function(a,b){"content-type"===z(b)&&delete f[b]});I(a.withCredentials)&&!I(e.withCredentials)&&(a.withCredentials=e.withCredentials);return s(a,b,f).then(c,c)},r],k=l.when(d);for(q(u,function(a){(a.request||a.requestError)&&h.unshift(a.request,a.requestError);(a.response||a.responseError)&&h.push(a.response,a.responseError)});h.length;){a=h.shift();var p=h.shift(),k=k.then(a,p)}k.success=function(a){k.then(function(b){a(b.data,b.status,b.headers,d)});return k};k.error=function(a){k.then(null,
function(b){a(b.data,b.status,b.headers,d)});return k};return k}function s(b,c,f){function g(a,b,c,e){q&&(200<=a&&300>a?q.put(aa,[a,b,Dc(c),e]):q.remove(aa));p(b,a,c,e);d.$$phase||d.$apply()}function p(a,c,d,e){c=Math.max(c,0);(200<=c&&300>c?s.resolve:s.reject)({data:a,status:c,headers:Ec(d),config:b,statusText:e})}function n(){var a=ib(m.pendingRequests,b);-1!==a&&m.pendingRequests.splice(a,1)}var s=l.defer(),u=s.promise,q,y,aa=t(b.url,b.params);m.pendingRequests.push(b);u.then(n,n);(b.cache||e.cache)&&
(!1!==b.cache&&"GET"==b.method)&&(q=V(b.cache)?b.cache:V(e.cache)?e.cache:J);if(q)if(y=q.get(aa),B(y)){if(y.then)return y.then(n,n),y;M(y)?p(y[1],y[0],da(y[2]),y[3]):p(y,200,{},"OK")}else q.put(aa,u);I(y)&&a(b.method,aa,c,g,f,b.timeout,b.withCredentials,b.responseType);return u}function t(a,b){if(!b)return a;var c=[];fd(b,function(a,b){null===a||I(a)||(M(a)||(a=[a]),q(a,function(a){V(a)&&(a=ra(a));c.push(za(b)+"="+za(a))}))});0<c.length&&(a+=(-1==a.indexOf("?")?"?":"&")+c.join("&"));return a}var J=
c("$http"),u=[];q(f,function(a){u.unshift(v(a)?n.get(a):n.invoke(a))});m.pendingRequests=[];(function(a){q(arguments,function(a){m[a]=function(b,c){return m(F(c||{},{method:a,url:b}))}})})("get","delete","head","jsonp");(function(a){q(arguments,function(a){m[a]=function(b,c,d){return m(F(d||{},{method:a,url:b,data:c}))}})})("post","put");m.defaults=e;return m}]}function Me(b){if(8>=X&&(!b.match(/^(get|post|head|put|delete|options)$/i)||!L.XMLHttpRequest))return new L.ActiveXObject("Microsoft.XMLHTTP");
...
try{for(;g<h;g++){l=R(C[g](a));if(n&&I(l))return;l=y(l);l!==c[g]&&(m=!0);k[g]=l}m&&(N[b]=k,S[b]=e=O(k))}catch(s){a=Gc("interr",f,s.toString()),d(a)}return e},{exp:f,separators:J,expressions:u})}}var h=b.length,g=a.length;f.startSymbol=function(){return b};f.endSymbol=function(){return a};return f}]}function ie(){this.$get=["$rootScope","$window","$q",function(b,a,c){function d(d,h,g,p){var k=a.setInterval,l=a.clearInterval,n=c.defer(),m=n.promise,s=0,t=B(p)&&!p;g=B(g)?g:0;m.then(null,null,d);m.$$intervalId=
...
h(d)}},J=function(b){try{return(P(l)?l:d)(b)}catch(c){return a(c),h(c)}},u=function(b){try{return(P(n)?n:c)(b)}catch(d){a(d)}};b(function(){f(g).then(function(a){s||(s=!0,m.resolve(f(a).then(t,J,u)))},function(a){s||(s=!0,m.resolve(J(a)))},function(a){s||m.notify(u(a))})});return m.promise},all:function(a){var b=e(),c=0,d=M(a)?[]:{};q(a,function(a,e){c++;f(a).then(function(a){d.hasOwnProperty(e)||(d[e]=a,--c||b.resolve(d))},function(a){d.hasOwnProperty(e)||b.reject(a)})});0===c&&b.resolve(d);return b.promise}}}
...
{},d)Oc.call(d,a)&&(g[a]=d[a]);else g=d})},$digest:function(){var d,f,g,h,k=this.$$asyncQueue,l=this.$$postDigestQueue,q,x,r=b,N,S=[],O,B,y;p("$digest");c=null;do{x=!1;for(N=this;k.length;){try{y=k.shift(),y.scope.$eval(y.expression)}catch(E){m.$$phase=null,e(E)}c=null}a:do{if(h=N.$$watchers)for(q=h.length;q--;)try{if(d=h[q])if((f=d.get(N))!==(g=d.last)&&!(d.eq?ya(f,g):"number"==typeof f&&"number"==typeof g&&isNaN(f)&&isNaN(g)))x=!0,c=d,d.last=d.eq?da(f):f,d.fn(f,g===n?f:g,N),5>r&&(O=4-r,S[O]||(S[O]=
...
0)-h;g=U(b[6]||0);b=Math.round(1E3*parseFloat("0."+(b[7]||0)));p.call(a,f,h,g,b)}return a}var c=/^(\d{4})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/;return function(c,e){var f="",h=[],g,p;e=e||"mediumDate";e=b.DATETIME_FORMATS[e]||e;v(c)&&(c=Ye.test(c)?U(c):a(c));Ea(c)&&(c=new Date(c));if(!pa(c))return c;for(;e;)(p=Ze.exec(e))?(h=h.concat(qa.call(p,1)),e=h.pop()):(h.push(e),e=null);q(h,function(a){g=$e[a];f+=g?g(c,b.DATETIME_FORMATS):a.replace(/(^'|'$)/g,
...
function(a){a.$name&&f[a.$name]===a&&delete f[a.$name];q(p,function(b,c){f.$setValidity(c,!0,a)});Fa(k,a)};f.$setValidity=function(a,b,c){var d=p[a];if(b)d&&(Fa(d,c),d.length||(g--,g||(e(b),f.$valid=!0,f.$invalid=!1),p[a]=!1,e(!0,a),h.$setValidity(a,!0,f)));else{g||e(b);if(d){if(-1!=ib(d,c))return}else p[a]=d=[],g++,e(!1,a),h.$setValidity(a,!1,f);d.push(c);f.$valid=!1;f.$invalid=!0}};f.$setDirty=function(){d.removeClass(b,Oa);d.addClass(b,Bb);f.$dirty=!0;f.$pristine=!1;h.$setDirty()};f.$setPristine=
...
function(){k=!1;l()})}var l=function(e){if(!k){var f=a.val(),m=e&&e.type;if(X&&"input"===(e||p).type&&a[0].placeholder!==g)g=a[0].placeholder;else if(Ra(c.ngTrim||"T")&&(f=ba(f)),d.$viewValue!==f||h&&""===f&&!h.valueMissing)b.$$phase?d.$setViewValue(f,m):b.$apply(function(){d.$setViewValue(f,m)})}};if(d.$options&&d.$options.updateOn)a.on(d.$options.updateOn,l);if(!d.$options||d.$options.updateOnDefault){if(e.hasEvent("input"))a.on("input",l);else{var n,m=function(a){n||(n=f.defer(function(){l(a);
n=null}))};a.on("keydown",function(a){var b=a.keyCode;91===b||(15<b&&19>b||37<=b&&40>=b)||m(a)});if(e.hasEvent("paste"))a.on("paste cut",m)}a.on("change",l)}d.$render=function(){a.val(d.$isEmpty(d.$viewValue)?"":d.$viewValue)};var s=c.ngPattern;s&&((e=s.match(/^\/(.*)\/([gim]*)$/))?(s=RegExp(e[1],e[2]),e=function(a){return oa(d,"pattern",d.$isEmpty(a)||s.test(a),a)}):e=function(c){var e=b.$eval(s);if(!e||!e.test)throw A("ngPattern")("noregexp",s,e,ia(a));return oa(d,"pattern",d.$isEmpty(c)||e.test(c),
...
[])[1]));w.$inject=[];Da.$inject=[];var ba=function(){return String.prototype.trim?function(b){return v(b)?b.trim():b}:function(b){return v(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}();Ma=9>X?function(b){b=b.nodeName?b:b[0];return b.scopeName&&"HTML"!=b.scopeName?Ga(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var hc=["ng-","data-ng-","ng:","x-ng-"],md=/[A-Z]/g,pd={full:"1.3.0-build.2687+sha.ac37915",major:1,minor:3,dot:0,codeName:"snapshot"},
...
!0;this.$dirty=!1;this.$valid=!0;this.$invalid=!1;this.$name=d.name;var k=f(d.ngModel),l=k.assign,n=null,m=this;if(!l)throw A("ngModel")("nonassign",d.ngModel,ia(e));this.$render=w;this.$isEmpty=function(a){return I(a)||""===a||null===a||a!==a};var s=e.inheritedData("$formController")||Ab,t=0,r=this.$error={};e.addClass(Oa);p(!0);this.$setValidity=function(a,c){r[a]!==!c&&(c?(r[a]&&t--,t||(p(!0),m.$valid=!0,m.$invalid=!1)):(p(!1),m.$invalid=!0,m.$valid=!1,t++),r[a]=!c,p(c,a),s.$setValidity(a,c,m))};
this.$setPristine=function(){m.$dirty=!1;m.$pristine=!0;h.removeClass(e,Bb);h.addClass(e,Oa)};this.$cancelUpdate=function(){g.cancel(n);m.$render()};this.$$realSetViewValue=function(d){m.$viewValue=d;m.$pristine&&(m.$dirty=!0,m.$pristine=!1,h.removeClass(e,Oa),h.addClass(e,Bb),s.$setDirty());q(m.$parsers,function(a){d=a(d)});m.$modelValue!==d&&(m.$modelValue=d,l(a,d),q(m.$viewChangeListeners,function(a){try{a()}catch(d){c(d)}}))};this.$setViewValue=function(a,c){var d=0,e=m.$options;e&&B(e.debounce)&&
(e=e.debounce,Ea(e)?d=e:Ea(e[c])?d=e[c]:Ea(e["default"])&&(d=e["default"]));g.cancel(n);d?n=g(function(){m.$$realSetViewValue(a)},d):m.$$realSetViewValue(a)};a.$watch(function(){var c=k(a);if(m.$modelValue!==c){var d=m.$formatters,e=d.length;for(m.$modelValue=c;e--;)c=d[e](c);m.$viewValue!==c&&(m.$viewValue=c,m.$render())}return c})}],Vd=function(){return{require:["ngModel","^?form","^?ngModelOptions"],controller:kf,link:{pre:function(a,c,d,e){e[2]&&(e[0].$options=e[2].$options);var f=e[0],h=e[1]||
...
d,e,f,h){var g,p,k;c.$watch(e.ngIf,function(f){Ra(f)?p||(p=c.$new(),h(p,function(c){c[c.length++]=T.createComment(" end ngIf: "+e.ngIf+" ");g={clone:c};a.enter(c,d.parent(),d)})):(k&&(k.remove(),k=null),p&&(p.$destroy(),p=null),g&&(k=Gb(g.clone),a.leave(k,function(){k=null}),g=null))})}}}],Jd=["$http","$templateCache","$anchorScroll","$animate","$sce",function(a,c,d,e,f){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",controller:Sa.noop,compile:function(h,g){var p=g.ngInclude||
g.src,k=g.onload||"",l=g.autoscroll;return function(g,h,q,r,J){var u=0,C,D,G,x=function(){D&&(D.remove(),D=null);C&&(C.$destroy(),C=null);G&&(e.leave(G,function(){D=null}),D=G,G=null)};g.$watch(f.parseAsResourceUrl(p),function(f){var p=function(){!B(l)||l&&!g.$eval(l)||d()},q=++u;f?(a.get(f,{cache:c}).success(function(a){if(q===u){var c=g.$new();r.template=a;a=J(c,function(a){x();e.enter(a,null,h,p)});C=c;G=a;C.$emit("$includeContentLoaded");g.$eval(k)}}).error(function(){q===u&&x()}),g.$emit("$includeContentRequested")):
...
n,m,s,r,B,u,C={$id:Ja};if(!l)throw d("iexp",k);h=l[1];g=l[2];(l=l[3])?(n=a(l),m=function(a,c,d){u&&(C[u]=a);C[B]=c;C.$index=d;return n(e,C)}):(s=function(a,c){return Ja(c)},r=function(a){return a});l=h.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/);if(!l)throw d("iidexp",h);B=l[3]||l[1];u=l[2];var D={};e.$watchCollection(g,function(a){var g,h,l=f[0],n,C={},F,y,v,w,z,K,A=[];if(fb(a))z=a,n=m||s;else{n=m||r;z=[];for(v in a)a.hasOwnProperty(v)&&"$"!=v.charAt(0)&&z.push(v);z.sort()}F=z.length;
h=A.length=z.length;for(g=0;g<h;g++)if(v=a===z?g:z[g],w=a[v],w=n(v,w,g),Aa(w,"`track by` id"),D.hasOwnProperty(w))K=D[w],delete D[w],C[w]=K,A[g]=K;else{if(C.hasOwnProperty(w))throw q(A,function(a){a&&a.scope&&(D[a.id]=a)}),d("dupes",k,w);A[g]={id:w};C[w]=!1}for(v in D)D.hasOwnProperty(v)&&(K=D[v],g=Gb(K.clone),c.leave(g),q(g,function(a){a.$$NG_REMOVED=!0}),K.scope.$destroy());g=0;for(h=z.length;g<h;g++){v=a===z?g:z[g];w=a[v];K=A[g];A[g-1]&&(l=A[g-1].clone[A[g-1].clone.length-1]);if(K.scope){y=K.scope;
n=l;do n=n.nextSibling;while(n&&n.$$NG_REMOVED);K.clone[0]!=n&&c.move(Gb(K.clone),null,E(l));l=K.clone[K.clone.length-1]}else y=e.$new();y[B]=w;u&&(y[u]=v);y.$index=g;y.$first=0===g;y.$last=g===F-1;y.$middle=!(y.$first||y.$last);y.$odd=!(y.$even=0===(g&1));K.scope||p(y,function(a){a[a.length++]=T.createComment(" end ngRepeat: "+k+" ");c.enter(a,null,E(l));l=a;K.scope=y;K.clone=a;C[K.id]=K})}D=C})}}}],Od=["$animate",function(a){return function(c,d,e){c.$watch(e.ngShow,function(c){a[Ra(c)?"removeClass":
"addClass"](d,"ng-hide")})}}],Hd=["$animate",function(a){return function(c,d,e){c.$watch(e.ngHide,function(c){a[Ra(c)?"addClass":"removeClass"](d,"ng-hide")})}}],Pd=wa(function(a,c,d){a.$watch(d.ngStyle,function(a,d){d&&a!==d&&q(d,function(a,d){c.css(d,"")});a&&c.css(a)},!0)}),Qd=["$animate",function(a){return{restrict:"EA",require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,f){var h=[],g=[],p=[],k=[];c.$watch(e.ngSwitch||e.on,function(d){var n,m;n=0;for(m=p.length;n<
m;++n)p[n].remove();n=p.length=0;for(m=k.length;n<m;++n){var s=g[n];k[n].$destroy();p[n]=s;a.leave(s,function(){p.splice(n,1)})}g.length=0;k.length=0;if(h=f.cases["!"+d]||f.cases["?"])c.$eval(e.change),q(h,function(d){var e=c.$new();k.push(e);d.transclude(e,function(c){var e=d.element;g.push(c);a.enter(c,e.parent(),e)})})})}}}],Rd=wa({transclude:"element",priority:800,require:"^ngSwitch",link:function(a,c,d,e,f){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[];e.cases["!"+d.ngSwitchWhen].push({transclude:f,
...
h&&(w[0][1].selected=!1)}g.$setViewValue(k)})});g.$render=h;e.$watch(h)}if(p[1]){var m=p[0];p=p[1];var s=g.multiple,t=g.ngOptions,v=!1,u,C=E(T.createElement("option")),D=E(T.createElement("optgroup")),w=C.clone();g=0;for(var x=h.children(),F=x.length;g<F;g++)if(""===x[g].value){u=v=x.eq(g);break}m.init(p,v,w);s&&(p.$isEmpty=function(a){return!a||0===a.length});t?n(e,h,p):s?l(e,h,p):k(e,h,p,m)}}}}],xd=["$interpolate",function(a){var c={addOption:w,removeOption:w};return{restrict:"E",priority:100,compile:function(d,
