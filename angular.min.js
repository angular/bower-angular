/*
 ...
 License: MIT
*/
(function(K,T,s){'use strict';function G(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.0-build.2829+sha.993ac8a/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function gb(b){if(null==
...
a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==s&&!N(a[d]))return!1;return!0}return!1}function ac(){return T.securityPolicy&&T.securityPolicy.isActive||T.querySelector&&!(!T.querySelector("[ng-csp]")&&!T.querySelector("[data-ng-csp]"))}function Cb(b,a){var c=2<arguments.length?oa.call(arguments,2):[];return!N(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,c.concat(oa.call(arguments,0))):a.apply(b,c)}:function(){return arguments.length?
...
d}).replace(Ce,"Moz$1")}function De(b,a){var c,d,e=a.createDocumentFragment(),f=[];if(Hb.test(b)){c=c||e.appendChild(a.createElement("div"));d=(Ee.exec(b)||["",""])[1].toLowerCase();d=da[d]||da._default;c.innerHTML=d[1]+b.replace(Fe,"<$1></$2>")+d[2];for(d=d[0];d--;)c=c.lastChild;f=f.concat(oa.call(c.childNodes,void 0));c=e.firstChild;c.textContent=""}else f.push(a.createTextNode(b));e.textContent="";e.innerHTML="";q(f,function(a){e.appendChild(a)});return e}function O(b){if(b instanceof O)return b;
E(b)&&(b=$(b));if(!(this instanceof O)){if(E(b)&&"<"!=b.charAt(0))throw Ib("nosel");return new O(b)}if(E(b)){var a;a=T;var c;b=(c=Ge.exec(b))?[a.createElement(c[1])]:(c=De(b,a))?c.childNodes:[]}pc(this,b)}function Jb(b){return b.cloneNode(!0)}function Ha(b){qc(b);for(var a=0,c=b.children,d=c&&c.length||0;a<d;a++)b=c[a],Ha(b)}function rc(b,a,c,d){if(F(d))throw Ib("offargs");var e=ja(b,"events");ja(b,"handle")&&(y(a)?q(e,function(a,c){Va(b,c,a);delete e[c]}):q(a.split(" "),function(a){y(c)?(Va(b,a,
e[a]),delete e[a]):Ea(e[a]||[],c)}))}function qc(b,a){var c=b.ng,d=Wa[c];d&&(a?delete Wa[c].data[a]:(d.handle&&(d.events.$destroy&&d.handle({},"$destroy"),rc(b)),delete Wa[c],b.ng=s))}function ja(b,a,c){var d=b.ng,d=Wa[d||-1];if(F(c))d||(b.ng=d=++He,d=Wa[d]={}),d[a]=c;else return d&&d[a]}function sc(b,a,c){var d=ja(b,"data"),e=F(c),f=!e&&F(a),g=f&&!P(a);d||g||ja(b,"data",d={});if(e){if(1===b.nodeType||9===b.nodeType)d[a]=c}else if(f){if(g)return d&&d[a];v(d,a)}else return d}function Kb(b,a){return b.getAttribute?
-1<(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").indexOf(" "+a+" "):!1}function lb(b,a){a&&b.setAttribute&&q(a.split(" "),function(a){b.setAttribute("class",$((" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").replace(" "+$(a)+" "," ")))})}function mb(b,a){if(a&&b.setAttribute){var c=(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ");q(a.split(" "),function(a){a=$(a);-1===c.indexOf(" "+a+" ")&&(c+=a+" ")});b.setAttribute("class",$(c))}}function pc(b,a){if(a)if(a.nodeType)b[b.length++]=
a;else{var c=a.length;"number"===typeof c&&a.window!==a?c&&tc.apply(b,a):b[b.length++]=a}}function uc(b,a){return nb(b,"$"+(a||"ngController")+"Controller")}function nb(b,a,c){b=z(b);9==b[0].nodeType&&(b=b.find("html"));for(a=L(a)?a:[a];b.length;){for(var d=b[0],e=0,f=a.length;e<f;e++)if((c=b.data(a[e]))!==s)return c;b=z(d.parentNode||11===d.nodeType&&d.host)}}function vc(b){for(var a=0,c=b.childNodes;a<c.length;a++)Ha(c[a]);for(;b.firstChild;)b.removeChild(b.firstChild)}function wc(b,a){var c=ob[a.toLowerCase()];
return c&&xc[b.nodeName]&&c}function Ie(b,a){var c=b.nodeName;return("INPUT"===c||"TEXTAREA"===c)&&yc[a]}function Je(b,a){var c=function(c,e){c.preventDefault||(c.preventDefault=function(){c.returnValue=!1});c.stopPropagation||(c.stopPropagation=function(){c.cancelBubble=!0});c.target||(c.target=c.srcElement||T);if(y(c.defaultPrevented)){var f=c.preventDefault;c.preventDefault=function(){c.defaultPrevented=!0;f.call(c)};c.defaultPrevented=!1}c.isDefaultPrevented=function(){return c.defaultPrevented||
!1===c.returnValue};var g=ia(a[e||c.type]||[]);q(g,function(a){a.call(b,c)});8>=U?(c.preventDefault=null,c.stopPropagation=null,c.isDefaultPrevented=null):(delete c.preventDefault,delete c.stopPropagation,delete c.isDefaultPrevented)};c.elem=b;return c}function Ia(b){var a=typeof b,c;"object"==a&&null!==b?"function"==typeof(c=b.$$hashKey)?c=b.$$hashKey():c===s&&(c=b.$$hashKey=++pb):c=b;return a+":"+c}function Xa(b){q(b,this.put,this)}function Ke(b){return(b=b.toString().replace(zc,"").match(Ac))?
"function("+(b[1]||"").replace(/[\s\r\n]+/," ")+")":"fn"}function Lb(b,a,c){var d;if("function"==typeof b){if(!(d=b.$inject)){d=[];if(b.length){if(a)throw E(c)&&c||(c=b.name||Ke(b)),Ja("strictdi",c);a=b.toString().replace(zc,"");a=a.match(Ac);q(a[1].split(Le),function(a){a.replace(Me,function(a,b,c){d.push(c)})})}b.$inject=d}}else L(b)?(a=b.length-1,Sa(b[a],"fn"),d=b.slice(0,a)):Sa(b,"fn",!0);return d}function Eb(b,a){function c(a){return function(b,c){if(P(b))q(b,Yb(a));else return a(b,c)}}function d(a,
b){za(a,"service");if(N(b)||L(b))b=k.instantiate(b);if(!b.$get)throw Ja("pget",a);return p[a+n]=b}function e(a,b){return d(a,{$get:b})}function f(a){var b=[],c;q(a,function(a){function d(a){var b,c;b=0;for(c=a.length;b<c;b++){var e=a[b],f=k.get(e[0]);f[e[1]].apply(f,e[2])}}if(!m.get(a)){m.put(a,!0);try{E(a)?(c=Ta(a),b=b.concat(f(c.requires)).concat(c._runBlocks),d(c._invokeQueue),d(c._configBlocks)):N(a)?b.push(k.invoke(a)):L(a)?b.push(k.invoke(a)):Sa(a,"module")}catch(e){throw L(a)&&(a=a[a.length-
1]),e.message&&(e.stack&&-1==e.stack.indexOf(e.message))&&(e=e.message+"\n"+e.stack),Ja("modulerr",a,e.stack||e.message||e);}}});return b}function g(b,c){function d(a){if(b.hasOwnProperty(a)){if(b[a]===h)throw Ja("cdep",a+" <- "+l.join(" <- "));return b[a]}try{return l.unshift(a),b[a]=h,b[a]=c(a)}catch(e){throw b[a]===h&&delete b[a],e;}finally{l.shift()}}function e(b,c,f,h){"string"===typeof f&&(h=f,f=null);var g=[];h=Lb(b,a,h);var n,k,m;k=0;for(n=h.length;k<n;k++){m=h[k];if("string"!==typeof m)throw Ja("itkn",
m);g.push(f&&f.hasOwnProperty(m)?f[m]:d(m))}b.$inject||(b=b[n]);return b.apply(c,g)}return{invoke:e,instantiate:function(a,b,c){var d=function(){};d.prototype=(L(a)?a[a.length-1]:a).prototype;d=new d;a=e(a,d,b,c);return P(a)||N(a)?a:d},get:d,annotate:Lb,has:function(a){return p.hasOwnProperty(a+n)||b.hasOwnProperty(a)}}}a=!0===a;var h={},n="Provider",l=[],m=new Xa,p={$provide:{provider:c(d),factory:c(e),service:c(function(a,b){return e(a,["$injector",function(a){return a.instantiate(b)}])}),value:c(function(a,
b){return e(a,ca(b))}),constant:c(function(a,b){za(a,"constant");p[a]=b;t[a]=b}),decorator:function(a,b){var c=k.get(a+n),d=c.$get;c.$get=function(){var a=w.invoke(d,c);return w.invoke(b,null,{$delegate:a})}}}},k=p.$injector=g(p,function(){throw Ja("unpr",l.join(" <- "));},a),t={},w=t.$injector=g(t,function(a){var b=k.get(a+n);return w.invoke(b.$get,b,s,a)},a);q(f(b),function(a){w.invoke(a||C)});return w}function de(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location",
"$rootScope",function(a,c,d){function e(a){var b=null;q(a,function(a){b||"a"!==r(a.nodeName)||(b=a)});return b}function f(){var b=c.hash(),d;b?(d=g.getElementById(b))?d.scrollIntoView():(d=e(g.getElementsByName(b)))?d.scrollIntoView():"top"===b&&a.scrollTo(0,0):a.scrollTo(0,0)}var g=a.document;b&&d.$watch(function(){return c.hash()},function(){d.$evalAsync(f)});return f}]}function Ae(){this.$get=["$$rAF","$timeout",function(b,a){return b.supported?function(a){return b(a)}:function(b){return a(b,0,
!1)}}]}function Ne(b,a,c,d){function e(a){try{a.apply(null,oa.call(arguments,1))}finally{if(w--,0===w)for(;Q.length;)try{Q.pop()()}catch(b){c.error(b)}}}function f(a,b){(function Oe(){q(u,function(a){a()});I=b(Oe,a)})()}function g(){x=null;A!=h.url()&&(A=h.url(),q(V,function(a){a(h.url())}))}var h=this,n=a[0],l=b.location,m=b.history,p=b.setTimeout,k=b.clearTimeout,t={};h.isMock=!1;var w=0,Q=[];h.$$completeOutstandingRequest=e;h.$$incOutstandingRequestCount=function(){w++};h.notifyWhenNoOutstandingRequests=
function(a){q(u,function(a){a()});0===w?a():Q.push(a)};var u=[],I;h.addPollFn=function(a){y(I)&&f(100,p);u.push(a);return a};var A=l.href,D=a.find("base"),x=null;h.url=function(a,c){l!==b.location&&(l=b.location);m!==b.history&&(m=b.history);if(a){if(A!=a)return A=a,d.history?c?m.replaceState(null,"",a):(m.pushState(null,"",a),D.attr("href",D.attr("href"))):(x=a,c?l.replace(a):l.href=a),h}else return x||l.href.replace(/%27/g,"'")};var V=[],M=!1;h.onUrlChange=function(a){if(!M){if(d.history)z(b).on("popstate",
g);if(d.hashchange)z(b).on("hashchange",g);else h.addPollFn(g);M=!0}V.push(a);return a};h.baseHref=function(){var a=D.attr("href");return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};var R={},S="",W=h.baseHref();h.cookies=function(a,b){var d,e,f,g;if(a)b===s?n.cookie=escape(a)+"=;path="+W+";expires=Thu, 01 Jan 1970 00:00:00 GMT":E(b)&&(d=(n.cookie=escape(a)+"="+escape(b)+";path="+W).length+1,4096<d&&c.warn("Cookie '"+a+"' possibly not set or overflowed because it was too large ("+d+" > 4096 bytes)!"));
...
l=l||{};for(var u=-Number.MAX_VALUE,D,S=l.controllerDirectives,x=l.newIsolateScopeDirective,R=l.templateDirective,J=l.nonTlbTranscludeDirective,ra=!1,Za=!1,y=l.hasElementTranscludeDirective,Y=d.$$element=z(c),H,v,r,Ya=e,G,K=0,O=a.length;K<O;K++){H=a[K];var Aa=H.$$start,qb=H.$$end;Aa&&(Y=B(c,Aa,qb));r=s;if(u>H.priority)break;if(r=H.scope)H.templateUrl||(P(r)?(La("new/isolated scope",x||D,H,Y),x=H):La("new/isolated scope",x,H,Y)),D=D||H;v=H.name;!H.templateUrl&&H.controller&&(r=H.controller,S=S||{},
La("'"+v+"' controller",S[v],H,Y),S[v]=H);if(r=H.transclude)ra=!0,H.$$tlb||(La("transclusion",J,H,Y),J=H),"element"==r?(y=!0,u=H.priority,r=B(c,Aa,qb),Y=d.$$element=z(T.createComment(" "+v+": "+d[v]+" ")),c=Y[0],rb(f,z(oa.call(r,0)),c),Ya=V(r,e,u,g&&g.name,{nonTlbTranscludeDirective:J})):(r=z(Jb(c)).contents(),Y.empty(),Ya=V(r,e));if(H.template)if(Za=!0,La("template",R,H,Y),R=H,r=N(H.template)?H.template(Y,d):H.template,r=Dc(r),H.replace){g=H;r=Hb.test(r)?z(Ec(H.type,$(r))):[];c=r[0];if(1!=r.length||
1!==c.nodeType)throw ha("tplrt",v,"");rb(f,Y,c);O={$attr:{}};r=W(c,[],O);var U=a.splice(K+1,a.length-(K+1));x&&F(r);a=a.concat(r).concat(U);ka(d,O);O=a.length}else Y.html(r);if(H.templateUrl)Za=!0,La("template",R,H,Y),R=H,H.replace&&(g=H),A=C(a.splice(K,a.length-K),Y,d,f,ra&&Ya,h,k,{controllerDirectives:S,newIsolateScopeDirective:x,templateDirective:R,nonTlbTranscludeDirective:J}),O=a.length;else if(H.compile)try{G=H.compile(Y,d,Ya),N(G)?t(null,G,Aa,qb):G&&t(G.pre,G.post,Aa,qb)}catch(X){p(X,ga(Y))}H.terminal&&
(A.terminal=!0,u=Math.max(u,H.priority))}A.scope=D&&!0===D.scope;A.transcludeOnThisElement=ra;A.templateOnThisElement=Za;A.transclude=Ya;l.hasElementTranscludeDirective=y;return A}function F(a){for(var b=0,c=a.length;b<c;b++)a[b]=$b(a[b],{$$isolateScope:!0})}function ra(b,e,f,g,h,k,m){if(e===h)return null;h=null;if(c.hasOwnProperty(e)){var t;e=a.get(e+d);for(var I=0,w=e.length;I<w;I++)try{t=e[I],(g===s||g>t.priority)&&-1!=t.restrict.indexOf(f)&&(k&&(t=$b(t,{$$start:k,$$end:m})),b.push(t),h=t)}catch(u){p(u)}}return h}
...
-1:1:a.index-b.index}function La(a,b,c,d){if(b)throw ha("multidir",b.name,c.name,a,ga(d));}function G(a,c){var d=b(c,!0);d&&a.push({priority:0,compile:function(a){var e=a.parent().length;e&&M(a.parent(),"ng-binding");return function(a,f){var g=f.parent(),h=g.data("$binding")||[];d=b(c);h.push(d);g.data("$binding",h);e||M(g,"ng-binding");a.$watch(d,function(a){f[0].nodeValue=a})}}})}function Ec(a,b){a=r(a||"html");switch(a){case "svg":case "math":var c=T.createElement("div");c.innerHTML="<"+a+">"+
b+"</"+a+">";return c.childNodes[0].childNodes;default:return b}}function Za(a,b){if("srcdoc"==b)return A.HTML;var c=Ka(a);if("xlinkHref"==b||"FORM"==c&&"action"==b||"IMG"!=c&&("src"==b||"ngSrc"==b))return A.RESOURCE_URL}function Y(a,c,d,e){var f=b(d,!0);if(f){if("multiple"===e&&"SELECT"===Ka(a))throw ha("selmulti",ga(a));c.push({priority:100,compile:function(){return{pre:function(c,d,k){d=k.$$observers||(k.$$observers={});if(h.test(e))throw ha("nodomevents");if(f=b(k[e],!0,Za(a,e),g[e]))k[e]=f(c),
...
delete b[d];b[0]=c;b.length=1}function Cc(a,b){return v(function(){return a.apply(null,arguments)},a,b)}var Mb=function(a,b){this.$$element=a;this.$attr=b||{}};Mb.prototype={$normalize:la,$addClass:function(a){a&&0<a.length&&D.addClass(this.$$element,a)},$removeClass:function(a){a&&0<a.length&&D.removeClass(this.$$element,a)},$updateClass:function(a,b){var c=Fc(a,b),d=Fc(b,a);0===c.length?D.removeClass(this.$$element,d):0===d.length?D.addClass(this.$$element,c):D.setClass(this.$$element,c,d)},$set:function(a,
b,c,d){var e=this.$$element[0],f=wc(e,a),g=Ie(e,a),e=a;f?(this.$$element.prop(a,b),d=f):g&&(this[g]=b,e=g);this[a]=b;d?this.$attr[a]=d:(d=this.$attr[a])||(this.$attr[a]=d=jb(a,"-"));f=Ka(this.$$element);if("A"===f&&"href"===a||"IMG"===f&&"src"===a)this[a]=b=x(b,"src"===a);!1!==c&&(null===b||b===s?this.$$element.removeAttr(d):this.$$element.attr(d,b));(a=this.$$observers)&&q(a[e],function(a){try{a(b)}catch(c){p(c)}})},$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers={}),e=d[a]||(d[a]=
[]);e.push(b);u.$evalAsync(function(){e.$$inter||b(c[a])});return function(){Ea(e,b)}}};var K=b.startSymbol(),O=b.endSymbol(),Dc="{{"==K||"}}"==O?Ca:function(a){return a.replace(/\{\{/g,K).replace(/}}/g,O)},Aa=/^ngAttr[A-Z]/;return V}]}function la(b){return Ua(b.replace(Re,""))}function Fc(b,a){var c="",d=b.split(/\s+/),e=a.split(/\s+/),f=0;a:for(;f<d.length;f++){for(var g=d[f],h=0;h<e.length;h++)if(g==e[h])continue a;c+=(0<c.length?" ":"")+g}return c}function he(){var b={},a=/^(\S+)(\s+as\s+(\w+))?$/;
this.register=function(a,d){za(a,"controller");P(a)?v(b,a):b[a]=d};this.$get=["$injector","$window",function(c,d){return function(e,f){var g,h,n;E(e)&&(g=e.match(a),h=g[1],n=g[3],e=b.hasOwnProperty(h)?b[h]:gc(f.$scope,h,!0)||gc(d,h,!0),Sa(e,h,!0));g=c.instantiate(e,f,h);if(n){if(!f||"object"!=typeof f.$scope)throw G("$controller")("noscp",h||e.name,n);f.$scope[n]=g}return g}}]}function ie(){this.$get=["$window",function(b){return z(b.document)}]}function je(){this.$get=["$log",function(b){return function(a,
...
function(b){return E(b)?b.trim():b}:function(b){return E(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}();Ka=9>U?function(b){b=b.nodeName?b:b[0];return b.scopeName&&"HTML"!=b.scopeName?Ga(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var ec=["ng-","data-ng-","ng:","x-ng-"],od=/[A-Z]/g,sd={full:"1.3.0-build.2829+sha.993ac8a",major:1,minor:3,dot:0,codeName:"snapshot"};O.expando="ng";var Wa=O.cache={},He=1,sb=K.document.addEventListener?function(b,
