/*
 ...
 License: MIT
*/
(function(P,Y,v){'use strict';function S(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3798+sha.d17fbc3/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Oa(b){if(null==b||Pa(b))return!1;var a=b.length;
...
b,d,e){b=Math.max(b,0);(200<=b&&300>b?t.resolve:t.reject)({data:a,status:b,headers:Rc(d),config:c,statusText:e})}function x(a){m(a.data,a.status,oa(a.headers()),a.statusText)}function w(){var a=k.pendingRequests.indexOf(c);-1!==a&&k.pendingRequests.splice(a,1)}var t=h.defer(),G=t.promise,L,D,r=c.headers,J=n(c.url,c.params);k.pendingRequests.push(c);G.then(w,w);!c.cache&&!b.cache||!1===c.cache||"GET"!==c.method&&"JSONP"!==c.method||(L=O(c.cache)?c.cache:O(b.cache)?b.cache:q);L&&(D=L.get(J),y(D)?D&&
I(D.then)?D.then(x,x):K(D)?m(D[1],D[0],oa(D[2]),D[3]):m(D,200,{},"OK"):L.put(J,G));E(D)&&((D=Tc(c.url)?e.cookies()[c.xsrfCookieName||b.xsrfCookieName]:v)&&(r[c.xsrfHeaderName||b.xsrfHeaderName]=D),d(c.method,J,f,l,r,c.timeout,c.withCredentials,c.responseType));return G}function n(a,b){if(!b)return a;var c=[];yd(b,function(a,b){null===a||E(a)||(K(a)||(a=[a]),r(a,function(a){O(a)&&(a=ja(a)?a.toISOString():Va(a));c.push(Ca(b)+"="+Ca(a))}))});0<c.length&&(a+=(-1==a.indexOf("?")?"?":"&")+c.join("&"));
return a}var q=f("$http"),t=[];r(c,function(a){t.unshift(Q(a)?l.get(a):l.invoke(a))});k.pendingRequests=[];(function(a){r(arguments,function(a){k[a]=function(b,c){return k(z(c||{},{method:a,url:b}))}})})("get","delete","head","jsonp");(function(a){r(arguments,function(a){k[a]=function(b,c,d){return k(z(d||{},{method:a,url:b,data:c}))}})})("post","put","patch");k.defaults=b;return k}]}function of(){return new P.XMLHttpRequest}function Fe(){this.$get=["$browser","$window","$document",function(b,a,c){return pf(b,
...
!(!Y.querySelector("[ng-csp]")&&!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Wa.isActive_=b},lb=["ng-","data-ng-","ng:","x-ng-"],Gd=/[A-Z]/g,qc=!1,Kb,na=1,jb=3,Kd={full:"1.4.0-build.3798+sha.d17fbc3",major:1,minor:4,dot:0,codeName:"snapshot"};C.expando="ng339";var tb=C.cache={},bf=1;C._data=function(b){return this.cache[b[this.expando]]||{}};var Xe=/([\:\-\_]+(.))/g,Ye=/^moz([A-Z])/,Jf={mouseleave:"mouseout",mouseenter:"mouseover"},Nb=S("jqLite"),af=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,
