/*
 ...
 License: MIT
*/
(function(R,X,w){'use strict';function P(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.0-build.3033+sha.a001a41/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function db(b){if(null==
...
a});t.$$observers[f].$$scope=e;t[f]&&(G[c]=b(t[f])(e));break;case "=":if(g&&!t[f])break;k=y(t[f]);p=k.literal?sa:function(a,b){return a===b};l=k.assign||function(){h=G[c]=k(e);throw la("nonassign",t[f],J.name);};h=G[c]=k(e);g=e.$watch(y(t[f],function(a){p(a,G[c])||(p(a,h)?l(e,a=G[c]):G[c]=a);return h=a}),null,k.literal);G.$on("$destroy",g);break;case "&":k=y(t[f]);G[c]=function(a){return k(e,a)};break;default:throw la("iscp",J.name,c,a);}})}da=l&&r;u&&q(u,function(a){var b={$scope:a===J||a.$$isolateScope?
G:e,$element:s,$attrs:t,$transclude:da},c;T=a.controller;"@"==T&&(T=t[a.name]);c=N(T,b);ba[a.name]=c;Ka||s.data("$"+a.name+"Controller",c);a.controllerAs&&(b.$scope[a.controllerAs]=c)});g=0;for(Bc=h.length;g<Bc;g++)try{H=h[g],H(H.isolateScope?G:e,s,t,H.require&&z(H.directiveName,H.require,s,ba),da)}catch(Re){p(Re,ja(s))}g=e;J&&(J.template||null===J.templateUrl)&&(g=G);a&&a(g,f.childNodes,w,l);for(g=k.length-1;0<=g;g--)try{H=k[g],H(H.isolateScope?G:e,s,t,H.require&&z(H.directiveName,H.require,s,ba),
da)}catch(C){p(C,ja(s))}}l=l||{};for(var t=-Number.MAX_VALUE,s,u=l.controllerDirectives,J=l.newIsolateScopeDirective,Q=l.templateDirective,da=l.nonTlbTranscludeDirective,C=!1,Ya=!1,Ka=l.hasElementTranscludeDirective,Y=d.$$element=v(c),I,E,M,O=e,R,Ba=0,ua=a.length;Ba<ua;Ba++){I=a[Ba];var U=I.$$start,V=I.$$end;U&&(Y=G(c,U,V));M=w;if(t>I.priority)break;if(M=I.scope)I.templateUrl||(S(M)?(P("new/isolated scope",J||s,I,Y),J=I):P("new/isolated scope",J,I,Y)),s=s||I;E=I.name;!I.templateUrl&&I.controller&&
(M=I.controller,u=u||{},P("'"+E+"' controller",u[E],I,Y),u[E]=I);if(M=I.transclude)C=!0,I.$$tlb||(P("transclusion",da,I,Y),da=I),"element"==M?(Ka=!0,t=I.priority,M=Y,Y=d.$$element=v(X.createComment(" "+E+": "+d[E]+" ")),c=Y[0],sb(f,ia.call(M,0),c),O=H(M,e,t,g&&g.name,{nonTlbTranscludeDirective:da})):(M=v(Kb(c)).contents(),Y.empty(),O=H(M,e));if(I.template)if(Ya=!0,P("template",Q,I,Y),Q=I,M=D(I.template)?I.template(Y,d):I.template,M=Dc(M),I.replace){g=I;M=Ib.test(M)?v(W(I.type,aa(M))):[];c=M[0];if(1!=
M.length||1!==c.nodeType)throw la("tplrt",E,"");sb(f,Y,c);ua={$attr:{}};M=T(c,[],ua);var Z=a.splice(Ba+1,a.length-(Ba+1));J&&Ja(M);a=a.concat(M).concat(Z);A(d,ua);ua=a.length}else Y.html(M);if(I.templateUrl)Ya=!0,P("template",Q,I,Y),Q=I,I.replace&&(g=I),B=x(a.splice(Ba,a.length-Ba),Y,d,f,C&&O,h,k,{controllerDirectives:u,newIsolateScopeDirective:J,templateDirective:Q,nonTlbTranscludeDirective:da}),ua=a.length;else if(I.compile)try{R=I.compile(Y,d,O),D(R)?r(null,R,U,V):R&&r(R.pre,R.post,U,V)}catch($){p($,
ja(Y))}I.terminal&&(B.terminal=!0,t=Math.max(t,I.priority))}B.scope=s&&!0===s.scope;B.transcludeOnThisElement=C;B.templateOnThisElement=Ya;B.transclude=O;l.hasElementTranscludeDirective=Ka;return B}function Ja(a){for(var b=0,c=a.length;b<c;b++)a[b]=dc(a[b],{$$isolateScope:!0})}function C(b,e,f,g,h,l,m){if(e===h)return null;h=null;if(c.hasOwnProperty(e)){var r;e=a.get(e+d);for(var B=0,z=e.length;B<z;B++)try{r=e[B],(g===w||g>r.priority)&&-1!=r.restrict.indexOf(f)&&(l&&(r=dc(r,{$$start:l,$$end:m})),
b.push(r),h=r)}catch(y){p(y)}}return h}function A(a,b){var c=b.$attr,d=a.$attr,e=a.$$element;q(a,function(d,e){"$"!=e.charAt(0)&&(b[e]&&b[e]!==d&&(d+=("style"===e?";":" ")+b[e]),a.$set(e,d,!0,c[e]))});q(b,function(b,f){"class"==f?(L(e,b),a["class"]=(a["class"]?a["class"]+" ":"")+b):"style"==f?(e.attr("style",e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==f.charAt(0)||a.hasOwnProperty(f)||(a[f]=b,d[f]=c[f])})}function x(a,b,c,d,e,f,g,h){var k=[],m,p,B=b[0],z=a.shift(),y=E({},z,{templateUrl:null,
transclude:null,replace:null,$$originalDirective:z}),N=D(z.templateUrl)?z.templateUrl(b,c):z.templateUrl,t=z.type;b.empty();l.get(s.getTrustedResourceUrl(N),{cache:r}).success(function(l){var r,s;l=Dc(l);if(z.replace){l=Ib.test(l)?v(W(t,aa(l))):[];r=l[0];if(1!=l.length||1!==r.nodeType)throw la("tplrt",z.name,N);l={$attr:{}};sb(d,b,r);var u=T(r,[],l);S(z.scope)&&Ja(u);a=u.concat(a);A(c,l)}else r=B,b.html(l);a.unshift(y);m=da(a,r,c,e,b,z,f,g,h);q(d,function(a,c){a==r&&(d[c]=b[0])});for(p=Q(b[0].childNodes,
e);k.length;){l=k.shift();s=k.shift();var H=k.shift(),G=k.shift(),u=b[0];if(s!==B){var ba=s.className;h.hasElementTranscludeDirective&&z.replace||(u=Kb(r));sb(H,v(s),u);L(v(u),ba)}s=m.transcludeOnThisElement?J(l,m.transclude,G):G;m(p,l,u,d,s)}k=null}).error(function(a,b,c,d){throw la("tpload",d.url);});return function(a,b,c,d,e){a=e;k?(k.push(b),k.push(c),k.push(d),k.push(a)):(m.transcludeOnThisElement&&(a=J(b,m.transclude,e)),m(p,b,c,d,a))}}function M(a,b){var c=b.priority-a.priority;return 0!==
c?c:a.name!==b.name?a.name<b.name?-1:1:a.index-b.index}function P(a,b,c,d){if(b)throw la("multidir",b.name,c.name,a,ja(d));}function Ka(a,c){var d=b(c,!0);d&&a.push({priority:0,compile:function(a){var b=a.parent().length;b&&L(a.parent(),"ng-binding");return function(a,c){var e=c.parent(),f=e.data("$binding")||[];f.push(d);e.data("$binding",f);b||L(e,"ng-binding");a.$watch(d,function(a){c[0].nodeValue=a})}}})}function W(a,b){a=O(a||"html");switch(a){case "svg":case "math":var c=X.createElement("div");
c.innerHTML="<"+a+">"+b+"</"+a+">";return c.childNodes[0].childNodes;default:return b}}function Ya(a,b){if("srcdoc"==b)return s.HTML;var c=pa(a);if("xlinkHref"==b||"form"==c&&"action"==b||"img"!=c&&("src"==b||"ngSrc"==b))return s.RESOURCE_URL}function Y(a,c,d,e){var f=b(d,!0);if(f){if("multiple"===e&&"select"===pa(a))throw la("selmulti",ja(a));c.push({priority:100,compile:function(){return{pre:function(c,d,k){d=k.$$observers||(k.$$observers={});if(g.test(e))throw la("nodomevents");if(f=b(k[e],!0,
...
var b=!(!X.querySelector("[ng-csp]")&&!X.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Sa.isActive_=b},hb=["ng-","data-ng-","ng:","x-ng-"],qd=/[A-Z]/g,ud={full:"1.3.0-build.3033+sha.a001a41",major:1,minor:3,dot:0,codeName:"snapshot"};W.expando="ng339";var Wa=W.cache={},Ke=1,tb=R.document.addEventListener?function(b,a,c){b.addEventListener(a,c,!1)}:function(b,a,c){b.attachEvent("on"+a,c)},Va=R.document.removeEventListener?function(b,a,c){b.removeEventListener(a,c,
...
Ha(a,this.nextUid)];delete this[a];return c}};var Ac=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,Oe=/,/,Pe=/^\s*(_?)(\S+?)\1\s*$/,zc=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Ia=P("$injector");Gb.$$annotate=Nb;var hf=P("$animate"),ge=["$provide",function(a){this.$$selectors={};this.register=function(c,d){var e=c+"-animation";if(c&&"."!=c.charAt(0))throw hf("notcsel",c);this.$$selectors[c.substr(1)]=e;a.factory(e,d)};this.classNameFilter=function(a){1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?
a:null);return this.$$classNameFilter};this.$get=["$timeout","$$asyncCallback",function(a,d){return{enter:function(a,c,h,g){h?h.after(a):c.prepend(a);g&&d(g);return A},leave:function(a,c){a.remove();c&&d(c);return A},move:function(a,c,d,g){return this.enter(a,c,d,g)},addClass:function(a,c,h){c=F(c)?c:K(c)?c.join(" "):"";q(a,function(a){pb(a,c)});h&&d(h);return A},removeClass:function(a,c,h){c=F(c)?c:K(c)?c.join(" "):"";q(a,function(a){ob(a,c)});h&&d(h);return A},setClass:function(a,c,h,g){q(a,function(a){pb(a,
c);ob(a,h)});g&&d(g);return A},enabled:A}}]}],la=P("$compile");jc.$inject=["$provide","$$sanitizeUriProvider"];var Se=/^(x[\:\-_]|data[\:\-_])/i,Qb=P("$interpolate"),jf=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,Ve={http:80,https:443,ftp:21},Tb=P("$location");Vb.prototype=Ub.prototype=Kc.prototype={$$html5:!1,$$replace:!1,absUrl:ub("$$absUrl"),url:function(a,c){if(x(a))return this.$$url;var d=jf.exec(a);d[1]&&this.path(decodeURIComponent(d[1]));(d[2]||d[1])&&this.search(d[3]||"");this.hash(d[5]||"",c);return this},
protocol:ub("$$protocol"),host:ub("$$host"),port:ub("$$port"),path:Lc("$$path",function(a){return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(F(a))this.$$search=gc(a);else if(S(a))q(a,function(c,e){null==c&&delete a[e]}),this.$$search=a;else throw Tb("isrcharg");break;default:x(c)||null===c?delete this.$$search[a]:this.$$search[a]=c}this.$$compose();return this},hash:Lc("$$hash",Ca),replace:function(){this.$$replace=!0;return this}};
