/*
 ...
 License: MIT
*/
(function(G){'use strict';function O(a){return function(){var b=arguments[0],d;d="["+(a?a+":":"")+b+"] http://errors.angularjs.org/1.5.7-build.4870+sha.9f68b0e/"+(a?a+"/":"")+b;for(b=1;b<arguments.length;b++){d=d+(1==b?"?":"&")+"p"+(b-1)+"=";var c=encodeURIComponent,e;e=arguments[b];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;d+=c(e)}return Error(d)}}function oa(a){if(null==a||Va(a))return!1;if(K(a)||H(a)||
...
rb=function(){if(x(rb.name_))return rb.name_;var a,b,d=Ma.length,c,e;for(b=0;b<d;++b)if(c=Ma[b],a=G.document.querySelector("["+c.replace(":","\\:")+"jq]")){e=a.getAttribute(c+"jq");break}return rb.name_=e},de=/:/g,Ma=["ng-","data-ng-","ng:","x-ng-"],ie=/[A-Z]/g,Ec=!1,cb=3,ne={full:"1.5.7-build.4870+sha.9f68b0e",major:1,minor:5,dot:7,codeName:"snapshot"};T.expando="ng339";var gb=T.cache={},Qf=1;T._data=function(a){return this.cache[a[this.expando]]||{}};var Lf=/([\:\-\_]+(.))/g,Mf=/^moz([A-Z])/,yb=
