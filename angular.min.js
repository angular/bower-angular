/*
 ...
 License: MIT
*/
(function(P,X,u){'use strict';function J(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3985+sha.249f9b8/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Qa(b){if(null==b||Ra(b))return!1;var a=b.length;
...
function(a,b){O(k,a,d[v].data,"",b);d[v]=s})}else{var w=a();w.open(e,g,!0);n(m,function(a,b){x(a)&&w.setRequestHeader(b,a)});w.onload=function(){var a=w.statusText||"",b="response"in w?w.response:w.responseText,c=1223===w.status?204:w.status;0===c&&(c=b?200:"file"==Aa(g).protocol?404:0);O(k,c,b,w.getAllResponseHeaders(),a)};e=function(){O(k,-1,null,null,"")};w.onerror=e;w.onabort=e;t&&(w.withCredentials=!0);if(y)try{w.responseType=y}catch(q){if("json"!==y)throw q;}w.send(l)}if(0<r)var z=c(G,r);else r&&
H(r.then)&&r.then(G)}}function Ve(){var b="{{",a="}}";this.startSymbol=function(a){return a?(b=a,this):b};this.endSymbol=function(b){return b?(a=b,this):a};this.$get=["$parse","$exceptionHandler","$sce",function(c,d,e){function f(a){return"\\\\\\"+a}function h(c){return c.replace(m,b).replace(r,a)}function g(f,g,m,r){function v(a){try{var b=a;a=m?e.getTrusted(m,b):e.valueOf(b);var c;if(r&&!x(a))c=a;else if(null==a)c="";else{switch(typeof a){case "string":break;case "number":a=""+a;break;default:a=
Ya(a)}c=a}return c}catch(g){d(Ha.interr(f,g))}}r=!!r;for(var p,n,q=0,z=[],A=[],M=f.length,B=[],T=[];q<M;)if(-1!=(p=f.indexOf(b,q))&&-1!=(n=f.indexOf(a,p+l)))q!==p&&B.push(h(f.substring(q,p))),q=f.substring(p+l,n),z.push(q),A.push(c(q,v)),q=n+k,T.push(B.length),B.push("");else{q!==M&&B.push(h(f.substring(q)));break}m&&1<B.length&&Ha.throwNoconcat(f);if(!g||z.length){var Y=function(a){for(var b=0,c=z.length;b<c;b++){if(r&&E(a[b]))return;B[T[b]]=a[b]}return B.join("")};return Q(function(a){var b=0,c=
z.length,e=Array(c);try{for(;b<c;b++)e[b]=A[b](a);return Y(e)}catch(g){d(Ha.interr(f,g))}},{exp:f,expressions:z,$$watchDelegate:function(a,b){var c;return a.$watchGroup(A,function(d,e){var f=Y(d);H(b)&&b.call(this,f,d!==e?c:f,a);c=f})}})}}var l=b.length,k=a.length,m=new RegExp(b.replace(/./g,f),"g"),r=new RegExp(a.replace(/./g,f),"g");g.startSymbol=function(){return b};g.endSymbol=function(){return a};return g}]}function We(){this.$get=["$rootScope","$window","$q","$$q",function(b,a,c,d){function e(e,
...
function(d,e){function f(d,f,l){var k=a.get(d);k||(a.put(d,k={}),c.push(d));f&&n(f.split(" "),function(a){a&&(k[a]=!0)});l&&n(l.split(" "),function(a){a&&(k[a]=!1)});1<c.length||e.$$postDigest(function(){n(c,function(c){var d=a.get(c);if(d){var e=Ef(c.attr("class")),f="",g="";n(d,function(a,c){a!==!!e[c]&&(a?f+=(f.length?" ":"")+c:g+=(g.length?" ":"")+c)});n(c,function(a){f&&vb(a,f);g&&ub(a,g)});a.remove(c)}});c.length=0})}return{enabled:s,on:s,off:s,pin:s,push:function(a,c,e,k){k&&k();e=e||{};e.from&&
a.css(e.from);e.to&&a.css(e.to);(e.addClass||e.removeClass)&&f(a,e.addClass,e.removeClass);return new d}}}]},Ne=["$provide",function(a){var c=this;this.$$registeredAnimations=Object.create(null);this.register=function(d,e){if(d&&"."!==d.charAt(0))throw jg("notcsel",d);var f=d+"-animation";c.$$registeredAnimations[d.substr(1)]=f;a.factory(f,e)};this.classNameFilter=function(a){1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?a:null);return this.$$classNameFilter};this.$get=["$$animateQueue",
function(a){function c(a,d,e){if(e){var l;a:{for(l=0;l<e.length;l++){var k=e[l];if(1===k.nodeType){l=k;break a}}l=void 0}!l||l.parentNode||l.previousElementSibling||(e=null)}e?e.after(a):d.prepend(a)}return{on:a.on,off:a.off,pin:a.pin,enabled:a.enabled,cancel:function(a){a.end&&a.end()},enter:function(f,h,g,l){h=h||g.parent();c(f,h,g);return a.push(f,"enter",l)},move:function(f,h,g,l){h=h||g.parent();c(f,h,g);return a.push(f,"move",l)},leave:function(c,e){return a.push(c,"leave",e,function(){c.remove()})},
addClass:function(c,e,g){g=g||{};g.addClass=db(g.addclass,e);return a.push(c,"addClass",g)},removeClass:function(c,e,g){g=g||{};g.removeClass=db(g.removeClass,e);return a.push(c,"removeClass",g)},setClass:function(c,e,g,l){l=l||{};l.addClass=db(l.addClass,e);l.removeClass=db(l.removeClass,g);return a.push(c,"setClass",l)},animate:function(c,e,g,l,k){k=k||{};k.from=k.from?Q(k.from,e):e;k.to=k.to?Q(k.to,g):g;k.tempClasses=db(k.tempClasses,l||"ng-inline-animate");return a.push(c,"animate",k)}}}]}],ga=
J("$compile");yc.$inject=["$provide","$$sanitizeUriProvider"];var Tc=/^((?:x|data)[\:\-_])/i,If=J("$controller"),Rc=/^(\S+)(\s+as\s+(\w+))?$/,Yc="application/json",Yb={"Content-Type":Yc+";charset=utf-8"},Kf=/^\[|^\{(?!\{)/,Lf={"[":/]$/,"{":/}$/},Jf=/^\)\]\}',?\n/,Ha=ba.$interpolateMinErr=J("$interpolate");Ha.throwNoconcat=function(a){throw Ha("noconcat",a);};Ha.interr=function(a,c){return Ha("interr",a,c.toString())};var kg=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,Of={http:80,https:443,ftp:21},zb=J("$location"),
lg={$$html5:!1,$$replace:!1,absUrl:Ab("$$absUrl"),url:function(a){if(E(a))return this.$$url;var c=kg.exec(a);(c[1]||""===a)&&this.path(decodeURIComponent(c[1]));(c[2]||c[1]||""===a)&&this.search(c[3]||"");this.hash(c[5]||"");return this},protocol:Ab("$$protocol"),host:Ab("$$host"),port:Ab("$$port"),path:fd("$$path",function(a){a=null!==a?a.toString():"";return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(C(a)||V(a))a=a.toString(),this.$$search=
