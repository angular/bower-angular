/*
 ...
 License: MIT
*/
(function(P,W,u){'use strict';function E(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3907+sha.3613a60/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Pa(b){if(null==b||Qa(b))return!1;var a=b.length;
...
!W.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return $a.isActive_=b},kb=function(){if(A(kb.name_))return kb.name_;var b,a,c=Ja.length,d,e;for(a=0;a<c;++a)if(d=Ja[a],b=W.querySelector("["+d.replace(":","\\:")+"jq]")){e=b.getAttribute(d+"jq");break}return kb.name_=e},Ja=["ng-","data-ng-","ng:","x-ng-"],Vd=/[A-Z]/g,xc=!1,Pb,pa=1,Ya=3,Zd={full:"1.4.0-build.3907+sha.3613a60",major:1,minor:4,dot:0,codeName:"snapshot"};S.expando="ng339";var sb=S.cache={},tf=1;S._data=function(b){return this.cache[b[this.expando]]||
