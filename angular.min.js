/*
 ...
 License: MIT
*/
(function(R,X,u){'use strict';function I(a){return function(){var b=arguments[0],d;d="["+(a?a+":":"")+b+"] http://errors.angularjs.org/1.5.0-build.4388+sha.ca7f4a3/"+(a?a+"/":"")+b;for(b=1;b<arguments.length;b++){d=d+(1==b?"?":"&")+"p"+(b-1)+"=";var c=encodeURIComponent,e;e=arguments[b];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;d+=c(e)}return Error(d)}}function Ba(a){if(null==a||Xa(a))return!1;if(K(a)||J(a)||
...
c.replace(":","\\:")+"jq]")){e=a.getAttribute(c+"jq");break}return qb.name_=e},Pa=["ng-","data-ng-","ng:","x-ng-"],de=/[A-Z]/g,Ac=!1,Oa=3,he={full:"1.5.0-build.4388+sha.ca7f4a3",major:1,minor:5,dot:0,codeName:"snapshot"};D.expando="ng339";var hb=D.cache={},Hf=1;D._data=function(a){return this.cache[a[this.expando]]||{}};var Cf=/([\:\-\_]+(.))/g,Df=/^moz([A-Z])/,xb={mouseleave:"mouseout",mouseenter:"mouseover"},Ub=I("jqLite"),Gf=/^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,Tb=/<|&#?\w+;/,Ef=/<([\w:-]+)/,Ff=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
