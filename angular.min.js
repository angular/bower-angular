/*
 ...
 License: MIT
*/
(function(O,Y,u){'use strict';function R(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3815+sha.28114fa/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Oa(b){if(null==b||Pa(b))return!1;var a=b.length;
...
a.toString();if(Ra(b)||Ra(a)||Pa(b)||Pa(a)||J(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!C(b[d])){if(!ka(b[d],a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==u&&!C(a[d]))return!1;return!0}return!1}function Ua(b,a,c){return b.concat(Va.call(a,c))}function lc(b,a){var c=2<arguments.length?Va.call(arguments,2):[];return!C(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,Ua(c,arguments,0)):a.apply(b,c)}:function(){return arguments.length?
a.apply(b,arguments):a.call(b)}}function Md(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?c=u:Pa(a)?c="$WINDOW":a&&Y===a?c="$DOCUMENT":Ra(a)&&(c="$SCOPE");return c}function Wa(b,a){if("undefined"===typeof b)return u;S(a)||(a=a?2:null);return JSON.stringify(b,Md,a)}function mc(b){return M(b)?JSON.parse(b):b}function va(b){b=I(b).clone();try{b.empty()}catch(a){}var c=I("<div>").append(b).html();try{return b[0].nodeType===gb?G(c):c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,
function(a,b){return"<"+G(b)})}catch(d){return G(c)}}function nc(b){try{return decodeURIComponent(b)}catch(a){}}function oc(b){var a={},c,d;r((b||"").split("&"),function(b){b&&(c=b.replace(/\+/g,"%20").split("="),d=nc(c[0]),w(d)&&(b=w(c[1])?nc(c[1]):!0,pc.call(a,d)?J(a[d])?a[d].push(b):a[d]=[a[d],b]:a[d]=b))});return a}function Kb(b){var a=[];r(b,function(b,d){J(b)?r(b,function(b){a.push(Ca(d,!0)+(!0===b?"":"="+Ca(b,!0)))}):a.push(Ca(d,!0)+(!0===b?"":"="+Ca(b,!0)))});return a.length?a.join("&"):""}
...
b,f=a.length,g=0;g<f;g++)d=a[g],b&&(b=(e=b)[d]);return!c&&C(b)?lc(e,b):b}function kb(b){var a=b[0];b=b[b.length-1];var c=[a];do{a=a.nextSibling;if(!a)break;c.push(a)}while(a!==b);return I(c)}function qa(){return Object.create(null)}function Sd(b){function a(a,b,c){return a[b]||(a[b]=c())}var c=R("$injector"),d=R("ng");b=a(b,"angular",Object);b.$$minErr=b.$$minErr||R;return a(b,"module",function(){var b={};return function(f,g,h){if("hasOwnProperty"===f)throw d("badname","module");g&&b.hasOwnProperty(f)&&
...
Ma("template",A,L,X),A=L,L.replace&&(g=L),N=R(a.splice(P,a.length-P),X,d,f,V&&O,l,k,{controllerDirectives:K,newIsolateScopeDirective:B,templateDirective:A,nonTlbTranscludeDirective:T}),S=a.length;else if(L.compile)try{Q=L.compile(X,d,O),C(Q)?m(null,Q,U,Tb):Q&&m(Q.pre,Q.post,U,Tb)}catch(ga){c(ga,va(X))}L.terminal&&(N.terminal=!0,x=Math.max(x,L.priority))}N.scope=z&&!0===z.scope;N.transcludeOnThisElement=V;N.elementTranscludeOnThisElement=D;N.templateOnThisElement=Sb;N.transclude=O;t.hasElementTranscludeDirective=
D;return N}function H(a){for(var b=0,c=a.length;b<c;b++)a[b]=Jb(a[b],{$$isolateScope:!0})}function X(b,e,f,g,h,k,l){if(e===h)return null;h=null;if(d.hasOwnProperty(e)){var t;e=a.get(e+"Directive");for(var q=0,v=e.length;q<v;q++)try{t=e[q],(g===u||g>t.priority)&&-1!=t.restrict.indexOf(f)&&(k&&(t=Jb(t,{$$start:k,$$end:l})),b.push(t),h=t)}catch(x){c(x)}}return h}function ma(b){if(d.hasOwnProperty(b))for(var c=a.get(b+"Directive"),e=0,f=c.length;e<f;e++)if(b=c[e],b.multiElement)return!0;return!1}function Oc(a,
b){var c=b.$attr,d=a.$attr,e=a.$$element;r(a,function(d,e){"$"!=e.charAt(0)&&(b[e]&&b[e]!==d&&(d+=("style"===e?";":" ")+b[e]),a.$set(e,d,!0,c[e]))});r(b,function(b,f){"class"==f?(N(e,b),a["class"]=(a["class"]?a["class"]+" ":"")+b):"style"==f?(e.attr("style",e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==f.charAt(0)||a.hasOwnProperty(f)||(a[f]=b,d[f]=c[f])})}function R(a,b,c,d,e,f,g,h){var k=[],l,t,m=b[0],s=a.shift(),q=Jb(s,{templateUrl:null,transclude:null,replace:null,$$originalDirective:s}),
z=C(s.templateUrl)?s.templateUrl(b,c):s.templateUrl,E=s.templateNamespace;b.empty();x(v.getTrustedResourceUrl(z)).then(function(v){var x,K;v=ha(v);if(s.replace){v=Nb.test(v)?Sc(Ub(E,W(v))):[];x=v[0];if(1!=v.length||x.nodeType!==na)throw ia("tplrt",s.name,z);v={$attr:{}};$(d,b,x);var y=da(x,[],v);F(s.scope)&&H(y);a=y.concat(a);Oc(c,v)}else x=m,b.html(v);a.unshift(q);l=w(a,x,c,e,b,s,f,g,h);r(d,function(a,c){a==x&&(d[c]=b[0])});for(t=V(b[0].childNodes,e);k.length;){v=k.shift();K=k.shift();var B=k.shift(),
A=k.shift(),y=b[0];if(!v.$$destroyed){if(K!==m){var p=K.className;h.hasElementTranscludeDirective&&s.replace||(y=Pb(x));$(B,I(K),y);N(I(y),p)}K=l.transcludeOnThisElement?T(v,l.transclude,A):A;l(t,v,y,d,K,l)}}k=null});return function(a,b,c,d,e){a=e;b.$$destroyed||(k?k.push(b,c,d,a):(l.transcludeOnThisElement&&(a=T(b,l.transclude,e)),l(t,b,c,d,a,l)))}}function O(a,b){var c=b.priority-a.priority;return 0!==c?c:a.name!==b.name?a.name<b.name?-1:1:a.index-b.index}function Ma(a,b,c,d){if(b)throw ia("multidir",
...
return l}}c.$stateful=!0;var d=this,e,f,h,k=1<b.length,l=0,m=g(a,c),n=[],t={},s=!0,q=0;return this.$watch(m,function(){s?(s=!1,b(e,e,d)):b(e,h,d);if(k)if(F(e))if(Oa(e)){h=Array(e.length);for(var a=0;a<e.length;a++)h[a]=e[a]}else for(a in h={},e)pc.call(e,a)&&(h[a]=e[a]);else h=e})},$digest:function(){var e,g,l,m,n,r,x=b,u,A=[],Z,w;k("$digest");h.$$checkUrlChange();this===p&&null!==d&&(h.defer.cancel(d),s());c=null;do{r=!1;for(u=this;q.length;){try{w=q.shift(),w.scope.$eval(w.expression,w.locals)}catch(I){f(I)}c=
...
!0}return Ya.isActive_=b},ib=function(){if(w(ib.name_))return ib.name_;var b,a,c=Ja.length;for(a=0;a<c&&!(b=Y.querySelector("["+Ja[a].replace(":","\\:")+"jq]"));++a);var d;b&&(d=qc(b,"jq"));return ib.name_=d},Ja=["ng-","data-ng-","ng:","x-ng-"],Qd=/[A-Z]/g,tc=!1,Lb,na=1,gb=3,Ud={full:"1.4.0-build.3815+sha.28114fa",major:1,minor:4,dot:0,codeName:"snapshot"};Q.expando="ng339";var qb=Q.cache={},mf=1;Q._data=function(b){return this.cache[b[this.expando]]||{}};var gf=/([\:\-\_]+(.))/g,hf=/^moz([A-Z])/,
