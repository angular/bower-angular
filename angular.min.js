/*
 ...
 License: MIT
*/
(function(u){'use strict';function ne(a){if(C(a))t(a.objectMaxDepth)&&(Lc.objectMaxDepth=Ub(a.objectMaxDepth)?a.objectMaxDepth:NaN);else return Lc}function Ub(a){return U(a)&&0<a}function M(a,b){b=b||Error;return function(){var d=arguments[0],c;c="["+(a?a+":":"")+d+"] http://errors.angularjs.org/1.6.7-build.5462+sha.97b00ca/"+(a?a+"/":"")+d;for(d=1;d<arguments.length;d++){c=c+(1==d?"?":"&")+"p"+(d-1)+"=";var e=encodeURIComponent,f;f=arguments[d];f="function"==typeof f?f.toString().replace(/ \{[\s\S]*$/,
...
q!==a&&(l++,f.length=q=a),b=0;b<a;b++)h=f[b],g=e[b],d=h!==h&&g!==g,d||h===g||(l++,f[b]=g);else{f!==n&&(f=n={},q=0,l++);a=0;for(b in e)sa.call(e,b)&&(a++,g=e[b],h=f[b],b in f?(d=h!==h&&g!==g,d||h===g||(l++,f[b]=g)):(q++,f[b]=g,l++));if(q>a)for(b in l++,f)sa.call(e,b)||(q--,delete f[b])}else f!==e&&(f=e,l++);return l}}c.$$pure=g(a).literal;c.$stateful=!c.$$pure;var d=this,e,f,h,k=1<b.length,l=0,m=g(a,c),p=[],n={},x=!0,q=0;return this.$watch(m,function(){x?(x=!1,b(e,e,d)):b(e,h,d);if(k)if(C(e))if(ra(e)){h=
Array(e.length);for(var a=0;a<e.length;a++)h[a]=e[a]}else for(a in h={},e)sa.call(e,a)&&(h[a]=e[a]);else h=e})},$digest:function(){var a,g,h,l,m,n,x,q=b,s,A=[],z,w;p("$digest");k.$$checkUrlChange();this===K&&null!==e&&(k.defer.cancel(e),y());c=null;do{x=!1;s=this;for(n=0;n<t.length;n++){try{w=t[n],l=w.fn,l(w.scope,w.locals)}catch(E){f(E)}c=null}t.length=0;a:do{if(n=s.$$watchers)for(n.$$digestWatchIndex=n.length;n.$$digestWatchIndex--;)try{if(a=n[n.$$digestWatchIndex])if(m=a.get,(g=m(s))!==(h=a.last)&&
!(a.eq?ta(g,h):fa(g)&&fa(h)))x=!0,c=a,a.last=a.eq?ya(g,null):g,l=a.fn,l(g,h===r?g:h,s),5>q&&(z=4-q,A[z]||(A[z]=[]),A[z].push({msg:D(a.exp)?"fn: "+(a.exp.name||a.exp.toString()):a.exp,newVal:g,oldVal:h}));else if(a===c){x=!1;break a}}catch(G){f(G)}if(!(n=s.$$watchersCount&&s.$$childHead||s!==this&&s.$$nextSibling))for(;s!==this&&!(n=s.$$nextSibling);)s=s.$parent}while(s=n);if((x||t.length)&&!q--)throw K.$$phase=null,d("infdig",b,A);}while(x||t.length);for(K.$$phase=null;F<u.length;)try{u[F++]()}catch(C){f(C)}u.length=
F=0;k.$$checkUrlChange()},$destroy:function(){if(!this.$$destroyed){var a=this.$parent;this.$broadcast("$destroy");this.$$destroyed=!0;this===K&&k.$$applicationDestroyed();n(this,-this.$$watchersCount);for(var b in this.$$listenerCount)x(this,this.$$listenerCount[b],b);a&&a.$$childHead===this&&(a.$$childHead=this.$$nextSibling);a&&a.$$childTail===this&&(a.$$childTail=this.$$prevSibling);this.$$prevSibling&&(this.$$prevSibling.$$nextSibling=this.$$nextSibling);this.$$nextSibling&&(this.$$nextSibling.$$prevSibling=
...
b.value;if(a.location.origin===c.origin)return!0;switch(c.protocol){case "http:":case "https:":case "ftp:":case "blob:":case "file:":case "data:":return!0;default:return!1}})}(u.document),ze=/[A-Z]/g,Wc=!1,Ma=3,Fe={full:"1.6.7-build.5462+sha.97b00ca",major:1,minor:6,dot:7,codeName:"snapshot"};T.expando="ng339";var ib=T.cache={},gg=1;T._data=function(a){return this.cache[a[this.expando]]||{}};var cg=/-([a-z])/g,Zg=/^-ms-/,Bb={mouseleave:"mouseout",mouseenter:"mouseover"},hc=M("jqLite"),fg=/^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,
