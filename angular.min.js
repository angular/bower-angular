/*
 ...
 License: MIT
*/
(function(K,S,t){'use strict';function G(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.0-build.2805+sha.751ebc1/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function hb(b){if(null==
b||Da(b))return!1;var a=b.length;return 1===b.nodeType&&a?!0:z(b)||M(b)||0===a||"number"===typeof a&&0<a&&a-1 in b}function q(b,a,c){var d;if(b)if(N(b))for(d in b)"prototype"==d||("length"==d||"name"==d||b.hasOwnProperty&&!b.hasOwnProperty(d))||a.call(c,b[d],d);else if(b.forEach&&b.forEach!==q)b.forEach(a,c);else if(hb(b))for(d=0;d<b.length;d++)a.call(c,b[d],d);else for(d in b)b.hasOwnProperty(d)&&a.call(c,b[d],d);return b}function $b(b){var a=[],c;for(c in b)b.hasOwnProperty(c)&&a.push(c);return a.sort()}
...
function W(b){return parseInt(b,10)}function cc(b,a){return D(new (D(function(){},{prototype:b})),a)}function A(){}function Ea(b){return b}function aa(b){return function(){return b}}function y(b){return"undefined"===typeof b}function F(b){return"undefined"!==typeof b}function Q(b){return null!=b&&"object"===typeof b}function z(b){return"string"===typeof b}function Fa(b){return"number"===typeof b}function oa(b){return"[object Date]"===wa.call(b)}function N(b){return"function"===typeof b}function jb(b){return"[object RegExp]"===
wa.call(b)}function Da(b){return b&&b.document&&b.location&&b.alert&&b.setInterval}function fd(b){return!(!b||!(b.nodeName||b.prop&&b.attr&&b.find))}function gd(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function hd(b,a,c){var d=[];q(b,function(b,f,h){d.push(a.call(c,b,f,h))});return d}function Pa(b,a){if(b.indexOf)return b.indexOf(a);for(var c=0;c<b.length;c++)if(a===b[c])return c;return-1}function Ga(b,a){var c=Pa(b,a);0<=c&&b.splice(c,1);return a}function xa(b,
...
if(jb(b)&&jb(a))return b.toString()==a.toString();if(b&&b.$evalAsync&&b.$watch||a&&a.$evalAsync&&a.$watch||Da(b)||Da(a)||M(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!N(b[d])){if(!ya(b[d],a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==t&&!N(a[d]))return!1;return!0}return!1}function dc(){return S.securityPolicy&&S.securityPolicy.isActive||S.querySelector&&!(!S.querySelector("[ng-csp]")&&!S.querySelector("[data-ng-csp]"))}function Eb(b,a){var c=2<arguments.length?
pa.call(arguments,2):[];return!N(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,c.concat(pa.call(arguments,0))):a.apply(b,c)}:function(){return arguments.length?a.apply(b,arguments):a.call(b)}}function id(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?c=t:Da(a)?c="$WINDOW":a&&S===a?c="$DOCUMENT":a&&(a.$evalAsync&&a.$watch)&&(c="$SCOPE");return c}function qa(b,a){return"undefined"===typeof b?t:JSON.stringify(b,id,a?"  ":null)}function ec(b){return z(b)?
...
b=ra.cleanData,b=b.$$original||b,ra.cleanData=function(a){for(var c=0,d;null!=(d=a[c]);c++)ra(d).triggerHandler("$destroy");b(a)},ra.cleanData.$$original=b):w=O;Sa.element=w}function Hb(b,a,c){if(!b)throw Qa("areq",a||"?",c||"required");return b}function Ta(b,a,c){c&&M(b)&&(b=b[b.length-1]);Hb(N(b),a,"not a function, got "+(b&&"object"==typeof b?b.constructor.name||"Object":typeof b));return b}function Aa(b,a){if("hasOwnProperty"===b)throw Qa("badname",a);}function jc(b,a,c){if(!a)return b;a=a.split(".");
for(var d,e=b,f=a.length,h=0;h<f;h++)d=a[h],b&&(b=(e=b)[d]);return!c&&N(b)?Eb(e,b):b}function Ib(b){var a=b[0];b=b[b.length-1];if(a===b)return w(a);var c=[a];do{a=a.nextSibling;if(!a)break;c.push(a)}while(a!==b);return w(c)}function nd(b){var a=G("$injector"),c=G("ng");b=b.angular||(b.angular={});b.$$minErr=b.$$minErr||G;return b.module||(b.module=function(){var b={};return function(e,f,h){if("hasOwnProperty"===e)throw c("badname","module");f&&b.hasOwnProperty(e)&&(b[e]=null);return b[e]||(b[e]=function(){function b(a,
...
8>=T?(c.preventDefault=null,c.stopPropagation=null,c.isDefaultPrevented=null):(delete c.preventDefault,delete c.stopPropagation,delete c.isDefaultPrevented)};c.elem=b;return c}function Ka(b){var a=typeof b,c;"object"==a&&null!==b?"function"==typeof(c=b.$$hashKey)?c=b.$$hashKey():c===t&&(c=b.$$hashKey=ib()):c=b;return a+":"+c}function Ya(b){q(b,this.put,this)}function Ge(b){return(b=b.toString().replace(xc,"").match(yc))?"function("+(b[1]||"").replace(/[\s\r\n]+/," ")+")":"fn"}function Ob(b,a,c){var d;
if("function"==typeof b){if(!(d=b.$inject)){d=[];if(b.length){if(a)throw z(c)&&c||(c=b.name||Ge(b)),La("strictdi",c);a=b.toString().replace(xc,"");a=a.match(yc);q(a[1].split(He),function(a){a.replace(Ie,function(a,b,c){d.push(c)})})}b.$inject=d}}else M(b)?(a=b.length-1,Ta(b[a],"fn"),d=b.slice(0,a)):Ta(b,"fn",!0);return d}function Gb(b,a){function c(a){return function(b,c){if(Q(b))q(b,ac(a));else return a(b,c)}}function d(a,b){Aa(a,"service");if(N(b)||M(b))b=k.instantiate(b);if(!b.$get)throw La("pget",
a);return p[a+n]=b}function e(a,b){return d(a,{$get:b})}function f(a){var b=[],c;q(a,function(a){function d(a){var b,c;b=0;for(c=a.length;b<c;b++){var e=a[b],f=k.get(e[0]);f[e[1]].apply(f,e[2])}}if(!l.get(a)){l.put(a,!0);try{z(a)?(c=Ua(a),b=b.concat(f(c.requires)).concat(c._runBlocks),d(c._invokeQueue),d(c._configBlocks)):N(a)?b.push(k.invoke(a)):M(a)?b.push(k.invoke(a)):Ta(a,"module")}catch(e){throw M(a)&&(a=a[a.length-1]),e.message&&(e.stack&&-1==e.stack.indexOf(e.message))&&(e=e.message+"\n"+e.stack),
La("modulerr",a,e.stack||e.message||e);}}});return b}function h(b,c){function d(a){if(b.hasOwnProperty(a)){if(b[a]===g)throw La("cdep",m.join(" <- "));return b[a]}try{return m.unshift(a),b[a]=g,b[a]=c(a)}catch(e){throw b[a]===g&&delete b[a],e;}finally{m.shift()}}function e(b,c,f,g){"string"===typeof f&&(g=f,f=null);var h=[];g=Ob(b,a,g);var n,l,s;l=0;for(n=g.length;l<n;l++){s=g[l];if("string"!==typeof s)throw La("itkn",s);h.push(f&&f.hasOwnProperty(s)?f[s]:d(s))}b.$inject||(b=b[n]);return b.apply(c,
h)}return{invoke:e,instantiate:function(a,b,c){var d=function(){};d.prototype=(M(a)?a[a.length-1]:a).prototype;d=new d;a=e(a,d,b,c);return Q(a)||N(a)?a:d},get:d,annotate:Ob,has:function(a){return p.hasOwnProperty(a+n)||b.hasOwnProperty(a)}}}a=!0===a;var g={},n="Provider",m=[],l=new Ya,p={$provide:{provider:c(d),factory:c(e),service:c(function(a,b){return e(a,["$injector",function(a){return a.instantiate(b)}])}),value:c(function(a,b){return e(a,aa(b))}),constant:c(function(a,b){Aa(a,"constant");p[a]=
b;s[a]=b}),decorator:function(a,b){var c=k.get(a+n),d=c.$get;c.$get=function(){var a=C.invoke(d,c);return C.invoke(b,null,{$delegate:a})}}}},k=p.$injector=h(p,function(){throw La("unpr",m.join(" <- "));},a),s={},C=s.$injector=h(s,function(a){var b=k.get(a+n);return C.invoke(b.$get,b,t,a)},a);q(f(b),function(a){C.invoke(a||A)});return C}function ae(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location","$rootScope",function(a,c,d){function e(a){var b=null;q(a,function(a){b||
...
g.addPollFn=function(a){y(I)&&f(100,p);x.push(a);return a};var u=m.href,E=a.find("base"),v=null;g.url=function(a,c){m!==b.location&&(m=b.location);l!==b.history&&(l=b.history);if(a){if(u!=a)return u=a,d.history?c?l.replaceState(null,"",a):(l.pushState(null,"",a),E.attr("href",E.attr("href"))):(v=a,c?m.replace(a):m.href=a),g}else return v||m.href.replace(/%27/g,"'")};var V=[],P=!1;g.onUrlChange=function(a){if(!P){if(d.history)w(b).on("popstate",h);if(d.hashchange)w(b).on("hashchange",h);else g.addPollFn(h);
P=!0}V.push(a);return a};g.baseHref=function(){var a=E.attr("href");return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};var R={},U="",ca=g.baseHref();g.cookies=function(a,b){var d,e,f,g;if(a)b===t?n.cookie=escape(a)+"=;path="+ca+";expires=Thu, 01 Jan 1970 00:00:00 GMT":z(b)&&(d=(n.cookie=escape(a)+"="+escape(b)+";path="+ca).length+1,4096<d&&c.warn("Cookie '"+a+"' possibly not set or overflowed because it was too large ("+d+" > 4096 bytes)!"));else{if(n.cookie!==U)for(U=n.cookie,d=U.split("; "),R=
{},f=0;f<d.length;f++)e=d[f],g=e.indexOf("="),0<g&&(a=unescape(e.substring(0,g)),R[a]===t&&(R[a]=unescape(e.substring(g+1))));return R}};g.defer=function(a,b){var c;C++;c=p(function(){delete s[c];e(a)},b||0);s[c]=!0;return c};g.defer.cancel=function(a){return s[a]?(delete s[a],k(a),e(A),!0):!1}}function ce(){this.$get=["$window","$log","$sniffer","$document",function(b,a,c,d){return new Je(b,d,a,c)}]}function de(){this.$get=function(){function b(b,d){function e(a){a!=p&&(k?k==a&&(k=a.n):k=a,f(a.n,
a.p),f(a,p),p=a,p.n=null)}function f(a,b){a!=b&&(a&&(a.p=b),b&&(b.n=a))}if(b in a)throw G("$cacheFactory")("iid",b);var h=0,g=D({},d,{id:b}),n={},m=d&&d.capacity||Number.MAX_VALUE,l={},p=null,k=null;return a[b]={put:function(a,b){if(m<Number.MAX_VALUE){var c=l[a]||(l[a]={key:a});e(c)}if(!y(b))return a in n||h++,n[a]=b,h>m&&this.remove(k.key),b},get:function(a){if(m<Number.MAX_VALUE){var b=l[a];if(!b)return;e(b)}return n[a]},remove:function(a){if(m<Number.MAX_VALUE){var b=l[a];if(!b)return;b==p&&(p=
b.p);b==k&&(k=b.n);f(b.n,b.p);delete l[a]}delete n[a];h--},removeAll:function(){n={};h=0;l={};p=k=null},destroy:function(){l=g=n=null;delete a[b]},info:function(){return D({},g,{size:h})}}}var a={};b.info=function(){var b={};q(a,function(a,e){b[e]=a.info()});return b};b.get=function(b){return a[b]};return b}}function te(){this.$get=["$cacheFactory",function(b){return b("templates")}]}function kc(b,a){var c={},d="Directive",e=/^\s*directive\:\s*([\d\w_\-]+)\s+(.*)$/,f=/(([\d\w_\-]+)(?:\:([^;]+))?;?)/,
h=gd("ngSrc,ngSrcset,src,srcset"),g=/^(on[a-z]+|formaction)$/;this.directive=function m(a,e){Aa(a,"directive");z(a)?(Hb(e,"directiveFactory"),c.hasOwnProperty(a)||(c[a]=[],b.factory(a+d,["$injector","$exceptionHandler",function(b,d){var e=[];q(c[a],function(c,f){try{var g=b.invoke(c);N(g)?g={compile:aa(g)}:!g.compile&&g.link&&(g.compile=aa(g.link));g.priority=g.priority||0;g.index=f;g.name=g.name||a;g.require=g.require||g.controller&&g.name;g.restrict=g.restrict||"A";e.push(g)}catch(h){d(h)}});return e}])),
...
U=k.controllerDirectives,v=k.newIsolateScopeDirective,R=k.templateDirective,J=k.nonTlbTranscludeDirective,sa=!1,ab=!1,Na=k.hasElementTranscludeDirective,y=d.$$element=w(c),H,D,r,Za=e,G,K=0,O=a.length;K<O;K++){H=a[K];var Ba=H.$$start,rb=H.$$end;Ba&&(y=B(c,Ba,rb));r=t;if(u>H.priority)break;if(r=H.scope)E=E||H,H.templateUrl||($a("new/isolated scope",v,H,y),Q(r)&&(v=H));D=H.name;!H.templateUrl&&H.controller&&(r=H.controller,U=U||{},$a("'"+D+"' controller",U[D],H,y),U[D]=H);if(r=H.transclude)sa=!0,H.$$tlb||
($a("transclusion",J,H,y),J=H),"element"==r?(Na=!0,u=H.priority,r=B(c,Ba,rb),y=d.$$element=w(S.createComment(" "+D+": "+d[D]+" ")),c=y[0],sb(f,w(pa.call(r,0)),c),Za=V(r,e,u,g&&g.name,{nonTlbTranscludeDirective:J})):(r=w(Mb(c)).contents(),y.empty(),Za=V(r,e));if(H.template)if(ab=!0,$a("template",R,H,y),R=H,r=N(H.template)?H.template(y,d):H.template,r=Bc(r),H.replace){g=H;r=Kb.test(r)?w(Cc(H.type,Y(r))):[];c=r[0];if(1!=r.length||1!==c.nodeType)throw ga("tplrt",D,"");sb(f,y,c);O={$attr:{}};r=ca(c,[],
O);var T=a.splice(K+1,a.length-(K+1));v&&F(r);a=a.concat(r).concat(T);ka(d,O);O=a.length}else y.html(r);if(H.templateUrl)ab=!0,$a("template",R,H,y),R=H,H.replace&&(g=H),x=A(a.splice(K,a.length-K),y,d,f,sa&&Za,h,m,{controllerDirectives:U,newIsolateScopeDirective:v,templateDirective:R,nonTlbTranscludeDirective:J}),O=a.length;else if(H.compile)try{G=H.compile(y,d,Za),N(G)?s(null,G,Ba,rb):G&&s(G.pre,G.post,Ba,rb)}catch(W){p(W,fa(y))}H.terminal&&(x.terminal=!0,u=Math.max(u,H.priority))}x.scope=E&&!0===
...
c[d],b[2](a)})}},promise:{then:function(b,f,g){var l=e(),L=function(d){try{l.resolve((N(b)?b:c)(d))}catch(e){l.reject(e),a(e)}},x=function(b){try{l.resolve((N(f)?f:d)(b))}catch(c){l.reject(c),a(c)}},I=function(b){try{l.notify((N(g)?g:c)(b))}catch(d){a(d)}};h?h.push([L,x,I]):m.then(L,x,I);return l.promise},"catch":function(a){return this.then(null,a)},"finally":function(a){function b(a,c){var d=e();c?d.resolve(a):d.reject(a);return d.promise}function d(e,f){var g=null;try{g=(a||c)()}catch(h){return b(h,
...
when:function(g,m,l,p){var k=e(),s,C=function(b){try{return(N(m)?m:c)(b)}catch(d){return a(d),h(d)}},L=function(b){try{return(N(l)?l:d)(b)}catch(c){return a(c),h(c)}},x=function(b){try{return(N(p)?p:c)(b)}catch(d){a(d)}};b(function(){f(g).then(function(a){s||(s=!0,k.resolve(f(a).then(C,L,x)))},function(a){s||(s=!0,k.resolve(L(a)))},function(a){s||k.notify(x(a))})});return k.promise},all:function(a){var b=e(),c=0,d=M(a)?[]:{};q(a,function(a,e){c++;f(a).then(function(a){d.hasOwnProperty(e)||(d[e]=a,
...
m=[],p={},q=!0,B=0;return this.$watch(c,function(){q?(q=!1,b(e,e,d)):b(e,h,d);if(k)if(Q(e))if(hb(e)){h=Array(e.length);for(var a=0;a<e.length;a++)h[a]=e[a]}else for(a in h={},e)Db.call(e,a)&&(h[a]=e[a]);else h=e})},$digest:function(){var d,f,g,h,l=this.$$asyncQueue,m=this.$$postDigestQueue,q,v,r=b,P,R=[],t=[],w,B,y;n("$digest");c=null;do{v=!1;for(P=this;l.length;){try{y=l.shift(),y.scope.$eval(y.expression)}catch(J){k.$$phase=null,e(J)}c=null}a:do{if(h=P.$$watchers)for(q=h.length;q--;)try{if(d=h[q])if((f=
d.get(P))!==(g=d.last)&&!(d.eq?ya(f,g):"number"==typeof f&&"number"==typeof g&&isNaN(f)&&isNaN(g)))v=!0,c=d,d.last=d.eq?xa(f,null):f,d.fn(f,g===p?f:g,P),5>r&&(w=4-r,R[w]||(R[w]=[]),B=N(d.exp)?"fn: "+(d.exp.name||d.exp.toString()):d.exp,B+="; newVal: "+qa(f)+"; oldVal: "+qa(g),R[w].push(B)),d.get.$$unwatch&&t.push({watch:d,array:h});else if(d===c){v=!1;break a}}catch(F){k.$$phase=null,e(F)}if(!(q=P.$$childHead||P!==this&&P.$$nextSibling))for(;P!==this&&!(q=P.$$nextSibling);)P=P.$parent}while(P=q);
...
b},T,w,ra,pa=[].slice,df=[].push,wa=Object.prototype.toString,Qa=G("ng"),Sa=K.angular||(K.angular={}),Ua,Ma,ha=["0","0","0"];T=W((/msie (\d+)/.exec(r(navigator.userAgent))||[])[1]);isNaN(T)&&(T=W((/trident\/.*; rv:(\d+)/.exec(r(navigator.userAgent))||[])[1]));A.$inject=[];Ea.$inject=[];var M=function(){return N(Array.isArray)?Array.isArray:function(b){return"[object Array]"===wa.call(b)}}(),Y=function(){return String.prototype.trim?function(b){return z(b)?b.trim():b}:function(b){return z(b)?b.replace(/^\s\s*/,
"").replace(/\s\s*$/,""):b}}();Ma=9>T?function(b){b=b.nodeName?b:b[0];return b.scopeName&&"HTML"!=b.scopeName?Ia(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var hc=["ng-","data-ng-","ng:","x-ng-"],ld=/[A-Z]/g,pd={full:"1.3.0-build.2805+sha.751ebc1",major:1,minor:3,dot:0,codeName:"snapshot"},Xa=O.cache={},mb=O.expando="ng"+(new Date).getTime(),Ee=1,tb=K.document.addEventListener?function(b,a,c){b.addEventListener(a,c,!1)}:function(b,a,c){b.attachEvent("on"+
a,c)},Wa=K.document.removeEventListener?function(b,a,c){b.removeEventListener(a,c,!1)}:function(b,a,c){b.detachEvent("on"+a,c)};O._data=function(b){return this.cache[b[this.expando]]||{}};var ye=/([\:\-\_]+(.))/g,ze=/^moz([A-Z])/,Lb=G("jqLite"),De=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Kb=/<|&#?\w+;/,Be=/<([\w:]+)/,Ce=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,ba={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],
tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};ba.optgroup=ba.option;ba.tbody=ba.tfoot=ba.colgroup=ba.caption=ba.thead;ba.th=ba.td;var Ha=O.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===S.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),O(K).on("load",a))},toString:function(){var b=[];q(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?w(this[b]):w(this[this.length+
b])},length:0,push:df,sort:[].sort,splice:[].splice},qb={};q("multiple selected checked disabled readOnly required open".split(" "),function(b){qb[r(b)]=b});var wc={};q("input select option textarea button form details".split(" "),function(b){wc[Ia(b)]=!0});q({data:sc,inheritedData:pb,scope:function(b){return w(b).data("$scope")||pb(b.parentNode||b,["$isolateScope","$scope"])},isolateScope:function(b){return w(b).data("$isolateScope")||w(b).data("$isolateScopeNoTemplate")},controller:tc,injector:function(b){return pb(b,
"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:Nb,css:function(b,a,c){a=Va(a);if(F(c))b.style[a]=c;else{var d;8>=T&&(d=b.currentStyle&&b.currentStyle[a],""===d&&(d="auto"));d=d||b.style[a];8>=T&&(d=""===d?t:d);return d}},attr:function(b,a,c){var d=r(a);if(qb[d])if(F(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||A).specified?d:t;else if(F(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,
2),null===b?t:b},prop:function(b,a,c){if(F(c))b[a]=c;else return b[a]},text:function(){function b(b,d){var e=a[b.nodeType];if(y(d))return e?b[e]:"";b[e]=d}var a=[];9>T?(a[1]="innerText",a[3]="nodeValue"):a[1]=a[3]="textContent";b.$dv="";return b}(),val:function(b,a){if(y(a)){if("SELECT"===Ma(b)&&b.multiple){var c=[];q(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(y(a))return b.innerHTML;for(var c=0,d=b.childNodes;c<
d.length;c++)Ja(d[c]);b.innerHTML=a},empty:uc},function(b,a){O.prototype[a]=function(a,d){var e,f;if(b!==uc&&(2==b.length&&b!==Nb&&b!==tc?a:d)===t){if(Q(a)){for(e=0;e<this.length;e++)if(b===sc)b(this[e],a);else for(f in a)b(this[e],f,a[f]);return this}e=b.$dv;f=e===t?Math.min(this.length,1):this.length;for(var h=0;h<f;h++){var g=b(this[h],a,d);e=e?e+g:g}return e}for(e=0;e<this.length;e++)b(this[e],a,d);return this}});q({removeData:qc,dealoc:Ja,on:function a(c,d,e,f){if(F(f))throw Lb("onargs");var h=
ja(c,"events"),g=ja(c,"handle");h||ja(c,"events",h={});g||ja(c,"handle",g=Fe(c,h));q(d.split(" "),function(d){var f=h[d];if(!f){if("mouseenter"==d||"mouseleave"==d){var l=S.body.contains||S.body.compareDocumentPosition?function(a,c){var d=9===a.nodeType?a.documentElement:a,e=c&&c.parentNode;return a===e||!!(e&&1===e.nodeType&&(d.contains?d.contains(e):a.compareDocumentPosition&&a.compareDocumentPosition(e)&16))}:function(a,c){if(c)for(;c=c.parentNode;)if(c===a)return!0;return!1};h[d]=[];a(c,{mouseleave:"mouseout",
mouseenter:"mouseover"}[d],function(a){var c=a.relatedTarget;c&&(c===this||l(this,c))||g(a,d)})}else tb(c,d,g),h[d]=[];f=h[d]}f.push(e)})},off:rc,one:function(a,c,d){a=w(a);a.on(c,function f(){a.off(c,d);a.off(c,f)});a.on(c,d)},replaceWith:function(a,c){var d,e=a.parentNode;Ja(a);q(new O(c),function(c){d?e.insertBefore(c,d.nextSibling):e.replaceChild(c,a);d=c})},children:function(a){var c=[];q(a.childNodes,function(a){1===a.nodeType&&c.push(a)});return c},contents:function(a){return a.contentDocument||
a.childNodes||[]},append:function(a,c){q(new O(c),function(c){1!==a.nodeType&&11!==a.nodeType||a.appendChild(c)})},prepend:function(a,c){if(1===a.nodeType){var d=a.firstChild;q(new O(c),function(c){a.insertBefore(c,d)})}},wrap:function(a,c){c=w(c)[0];var d=a.parentNode;d&&d.replaceChild(c,a);c.appendChild(a)},remove:function(a){Ja(a);var c=a.parentNode;c&&c.removeChild(a)},after:function(a,c){var d=a,e=a.parentNode;q(new O(c),function(a){e.insertBefore(a,d.nextSibling);d=a})},addClass:ob,removeClass:nb,
...
q(c,function(c){c.apply(a,e.concat(d))})}},function(a,c){O.prototype[c]=function(c,e,f){for(var h,g=0;g<this.length;g++)y(h)?(h=a(this[g],c,e,f),F(h)&&(h=w(h))):pc(h,a(this[g],c,e,f));return F(h)?h:this};O.prototype.bind=O.prototype.on;O.prototype.unbind=O.prototype.off});Ya.prototype={put:function(a,c){this[Ka(a)]=c},get:function(a){return this[Ka(a)]},remove:function(a){var c=this[a=Ka(a)];delete this[a];return c}};var yc=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,He=/,/,Ie=/^\s*(_?)(\S+?)\1\s*$/,xc=
/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,La=G("$injector");Gb.$$annotate=Ob;var ef=G("$animate"),be=["$provide",function(a){this.$$selectors={};this.register=function(c,d){var e=c+"-animation";if(c&&"."!=c.charAt(0))throw ef("notcsel",c);this.$$selectors[c.substr(1)]=e;a.factory(e,d)};this.classNameFilter=function(a){1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?a:null);return this.$$classNameFilter};this.$get=["$timeout","$$asyncCallback",function(a,d){return{enter:function(a,c,h,g){h?
h.after(a):c.prepend(a);g&&d(g)},leave:function(a,c){a.remove();c&&d(c)},move:function(a,c,d,g){this.enter(a,c,d,g)},addClass:function(a,c,h){c=z(c)?c:M(c)?c.join(" "):"";q(a,function(a){ob(a,c)});h&&d(h)},removeClass:function(a,c,h){c=z(c)?c:M(c)?c.join(" "):"";q(a,function(a){nb(a,c)});h&&d(h)},setClass:function(a,c,h,g){q(a,function(a){ob(a,c);nb(a,h)});g&&d(g)},enabled:A}}]}],ga=G("$compile");kc.$inject=["$provide","$$sanitizeUriProvider"];var Ne=/^(x[\:\-_]|data[\:\-_])/i,Hc=G("$interpolate"),
ff=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,Qe={http:80,https:443,ftp:21},Tb=G("$location");Vb.prototype=Ub.prototype=Kc.prototype={$$html5:!1,$$replace:!1,absUrl:ub("$$absUrl"),url:function(a,c){if(y(a))return this.$$url;var d=ff.exec(a);d[1]&&this.path(decodeURIComponent(d[1]));(d[2]||d[1])&&this.search(d[3]||"");this.hash(d[5]||"",c);return this},protocol:ub("$$protocol"),host:ub("$$host"),port:ub("$$port"),path:Lc("$$path",function(a){return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;
