/*
 ...
 License: MIT
*/
(function(O,Y,u){'use strict';function R(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3824+sha.c211e7a/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Oa(b){if(null==b||Pa(b))return!1;var a=b.length;
...
e=0;e<d.length;e++)a.call(c,b[d[e]],d[e]);return d}function hc(b){return function(a,c){b(c,a)}}function Kd(){return++eb}function ic(b,a){a?b.$$hashKey=a:delete b.$$hashKey}function P(b){for(var a=b.$$hashKey,c=1,d=arguments.length;c<d;c++){var e=arguments[c];if(e)for(var f=Object.keys(e),g=0,h=f.length;g<h;g++){var l=f[g];b[l]=e[l]}}ic(b,a);return b}function ba(b){return parseInt(b,10)}function Jb(b,a){return P(Object.create(b),a)}function C(){}function Qa(b){return b}function oa(b){return function(){return b}}
...
a.toString();if(Ra(b)||Ra(a)||Pa(b)||Pa(a)||F(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!I(b[d])){if(!ka(b[d],a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==u&&!I(a[d]))return!1;return!0}return!1}function Ua(b,a,c){return b.concat(Va.call(a,c))}function lc(b,a){var c=2<arguments.length?Va.call(arguments,2):[];return!I(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,Ua(c,arguments,0)):a.apply(b,c)}:function(){return arguments.length?
a.apply(b,arguments):a.call(b)}}function Md(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?c=u:Pa(a)?c="$WINDOW":a&&Y===a?c="$DOCUMENT":Ra(a)&&(c="$SCOPE");return c}function Wa(b,a){if("undefined"===typeof b)return u;S(a)||(a=a?2:null);return JSON.stringify(b,Md,a)}function mc(b){return K(b)?JSON.parse(b):b}function va(b){b=H(b).clone();try{b.empty()}catch(a){}var c=H("<div>").append(b).html();try{return b[0].nodeType===gb?D(c):c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,
...
a.unshift("ng");d=Xa(a,c.strictDi);d.invoke(["$rootScope","$rootElement","$compile","$injector",function(a,b,c,d){a.$apply(function(){b.data("$injector",d);c(b)(a)})}]);return d},e=/^NG_ENABLE_DEBUG_INFO!/,f=/^NG_DEFER_BOOTSTRAP!/;O&&e.test(O.name)&&(c.debugInfoEnabled=!0,O.name=O.name.replace(e,""));if(O&&!f.test(O.name))return d();O.name=O.name.replace(f,"");ca.resumeBootstrap=function(b){r(b,function(b){a.push(b)});return d()};I(ca.resumeDeferredBootstrap)&&ca.resumeDeferredBootstrap()}function Od(){O.name=
...
b,f=a.length,g=0;g<f;g++)d=a[g],b&&(b=(e=b)[d]);return!c&&I(b)?lc(e,b):b}function kb(b){var a=b[0];b=b[b.length-1];var c=[a];do{a=a.nextSibling;if(!a)break;c.push(a)}while(a!==b);return H(c)}function qa(){return Object.create(null)}function Sd(b){function a(a,b,c){return a[b]||(a[b]=c())}var c=R("$injector"),d=R("ng");b=a(b,"angular",Object);b.$$minErr=b.$$minErr||R;return a(b,"module",function(){var b={};return function(f,g,h){if("hasOwnProperty"===f)throw d("badname","module");g&&b.hasOwnProperty(f)&&
...
!0}return Ya.isActive_=b},ib=function(){if(v(ib.name_))return ib.name_;var b,a,c=Ja.length;for(a=0;a<c&&!(b=Y.querySelector("["+Ja[a].replace(":","\\:")+"jq]"));++a);var d;b&&(d=qc(b,"jq"));return ib.name_=d},Ja=["ng-","data-ng-","ng:","x-ng-"],Qd=/[A-Z]/g,tc=!1,Lb,na=1,gb=3,Ud={full:"1.4.0-build.3824+sha.c211e7a",major:1,minor:4,dot:0,codeName:"snapshot"};Q.expando="ng339";var qb=Q.cache={},mf=1;Q._data=function(b){return this.cache[b[this.expando]]||{}};var gf=/([\:\-\_]+(.))/g,hf=/^moz([A-Z])/,
...
ga.caption=ga.thead;ga.th=ga.td;var Ka=Q.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===Y.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),Q(O).on("load",a))},toString:function(){var b=[];r(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?H(this[b]):H(this[this.length+b])},length:0,push:Sf,sort:[].sort,splice:[].splice},vb={};r("multiple selected checked disabled readOnly required open".split(" "),function(b){vb[D(b)]=b});
var Kc={};r("input select option textarea button form details".split(" "),function(b){Kc[b]=!0});var Lc={ngMinlength:"minlength",ngMaxlength:"maxlength",ngMin:"min",ngMax:"max",ngPattern:"pattern"};r({data:Qb,removeData:ob},function(b,a){Q[a]=b});r({data:Qb,inheritedData:ub,scope:function(b){return H.data(b,"$scope")||ub(b.parentNode||b,["$isolateScope","$scope"])},isolateScope:function(b){return H.data(b,"$isolateScope")||H.data(b,"$isolateScopeNoTemplate")},controller:Hc,injector:function(b){return ub(b,
...
b){if(B(b)){var d=a.nodeType;return d===na||d===gb?a.textContent:""}a.textContent=b}b.$dv="";return b}(),val:function(b,a){if(B(a)){if(b.multiple&&"select"===ta(b)){var c=[];r(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(B(a))return b.innerHTML;nb(b,!0);b.innerHTML=a},empty:Ic},function(b,a){Q.prototype[a]=function(a,d){var e,f,g=this.length;if(b!==Ic&&(2==b.length&&b!==rb&&b!==Hc?a:d)===u){if(J(a)){for(e=0;e<
...
Pc=/^(\S+)(\s+as\s+(\w+))?$/,Uc="application/json",Wb={"Content-Type":Uc+";charset=utf-8"},wf=/^\[|^\{(?!\{)/,xf={"[":/]$/,"{":/}$/},vf=/^\)\]\}',?\n/,Xb=R("$interpolate"),Xf=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,Af={http:80,https:443,ftp:21},yb=R("$location"),Yf={$$html5:!1,$$replace:!1,absUrl:zb("$$absUrl"),url:function(a){if(B(a))return this.$$url;var c=Xf.exec(a);(c[1]||""===a)&&this.path(decodeURIComponent(c[1]));(c[2]||c[1]||""===a)&&this.search(c[3]||"");this.hash(c[5]||"");return this},protocol:zb("$$protocol"),
host:zb("$$host"),port:zb("$$port"),path:bd("$$path",function(a){a=null!==a?a.toString():"";return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(K(a)||S(a))a=a.toString(),this.$$search=oc(a);else if(J(a))a=ua(a,{}),r(a,function(c,e){null==c&&delete a[e]}),this.$$search=a;else throw yb("isrcharg");break;default:B(c)||null===c?delete this.$$search[a]:this.$$search[a]=c}this.$$compose();return this},hash:bd("$$hash",function(a){return null!==
...
a+",text)"},ensureSafeFunction:function(a){return"ensureSafeFunction("+a+",text)"},lazyRecurse:function(a,c,d,e,f,g){var h=this;return function(){h.recurse(a,c,d,e,f,g)}},lazyAssign:function(a,c){var d=this;return function(){d.assign(a,c)}},stringEscapeRegex:/[^ a-zA-Z0-9]/g,stringEscapeFn:function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)},escape:function(a){if(K(a))return"'"+a.replace(this.stringEscapeRegex,this.stringEscapeFn)+"'";if(S(a))return a.toString();if(!0===a)return"true";
...
{value:a}:a};case p.NGValueParameter:return function(a,d,e,f){return c?{value:e}:e}}},"unary+":function(a,c){return function(d,e,f,g){d=a(d,e,f,g);d=v(d)?+d:0;return c?{value:d}:d}},"unary-":function(a,c){return function(d,e,f,g){d=a(d,e,f,g);d=v(d)?-d:0;return c?{value:d}:d}},"unary!":function(a,c){return function(d,e,f,g){d=!a(d,e,f,g);return c?{value:d}:d}},"binary+":function(a,c,d){return function(e,f,g,h){var l=a(e,f,g,h);e=c(e,f,g,h);l=dd(l,e);return d?{value:l}:l}},"binary-":function(a,c,d){return function(e,
...
"yyyy-MM-ddTHH:mm:ss.sss"),time:cb("time",Hd,Gb(Hd,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:cb("week",gc,function(a,c){if(pa(a))return a;if(K(a)){gc.lastIndex=0;var d=gc.exec(a);if(d){var e=+d[1],f=+d[2],g=d=0,h=0,l=0,k=ud(e),f=7*(f-1);c&&(d=c.getHours(),g=c.getMinutes(),h=c.getSeconds(),l=c.getMilliseconds());return new Date(e,0,k.getDate()+f,d,g,h,l)}}return NaN},"yyyy-Www"),month:cb("month",Gd,Gb(Gd,["yyyy","MM"]),"yyyy-MM"),number:function(a,c,d,e,f,g){yd(a,c,d,e);bb(a,c,d,e,f,g);e.$$parserName=
"number";e.$parsers.push(function(a){return e.$isEmpty(a)?null:bg.test(a)?parseFloat(a):u});e.$formatters.push(function(a){if(!e.$isEmpty(a)){if(!S(a))throw Hb("numfmt",a);a=a.toString()}return a});if(v(d.min)||d.ngMin){var h;e.$validators.min=function(a){return e.$isEmpty(a)||B(h)||a>=h};d.$observe("min",function(a){v(a)&&!S(a)&&(a=parseFloat(a,10));h=S(a)&&!isNaN(a)?a:u;e.$validate()})}if(v(d.max)||d.ngMax){var l;e.$validators.max=function(a){return e.$isEmpty(a)||B(l)||a<=l};d.$observe("max",function(a){v(a)&&
!S(a)&&(a=parseFloat(a,10));l=S(a)&&!isNaN(a)?a:u;e.$validate()})}},url:function(a,c,d,e,f,g){bb(a,c,d,e,f,g);ec(e);e.$$parserName="url";e.$validators.url=function(a,c){var d=a||c;return e.$isEmpty(d)||$f.test(d)}},email:function(a,c,d,e,f,g){bb(a,c,d,e,f,g);ec(e);e.$$parserName="email";e.$validators.email=function(a,c){var d=a||c;return e.$isEmpty(d)||ag.test(d)}},radio:function(a,c,d,e){B(d.name)&&c.attr("name",++eb);c.on("click",function(a){c[0].checked&&e.$setViewValue(d.value,a&&a.type)});e.$render=
function(){c[0].checked=d.value==e.$viewValue};d.$observe("value",e.$render)},checkbox:function(a,c,d,e,f,g,h,l){var k=zd(l,a,"ngTrueValue",d.ngTrueValue,!0),n=zd(l,a,"ngFalseValue",d.ngFalseValue,!1);c.on("click",function(a){e.$setViewValue(c[0].checked,a&&a.type)});e.$render=function(){c[0].checked=e.$viewValue};e.$isEmpty=function(a){return!1===a};e.$formatters.push(function(a){return ka(a,k)});e.$parsers.push(function(a){return a?k:n})},hidden:C,button:C,submit:C,reset:C,file:C},wc=["$browser",
...
controller:ca.noop,compile:function(f,g){var h=g.ngInclude||g.src,l=g.onload||"",k=g.autoscroll;return function(f,g,p,r,u){var y=0,q,G,z,w=function(){G&&(G.remove(),G=null);q&&(q.$destroy(),q=null);z&&(d.leave(z).then(function(){G=null}),G=z,z=null)};f.$watch(e.parseAsResourceUrl(h),function(e){var h=function(){!v(k)||k&&!f.$eval(k)||c()},p=++y;e?(a(e,!0).then(function(a){if(p===y){var c=f.$new();r.template=a;a=u(c,function(a){w();d.enter(a,null,g).then(h)});q=c;z=a;q.$emit("$includeContentLoaded",
e);f.$eval(l)}},function(){p===y&&(w(),f.$emit("$includeContentError",e))}),f.$emit("$includeContentRequested",e)):(w(),r.template=null)})}}}}],Ee=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(c,d,e,f){/SVG/.test(d[0].toString())?(d.empty(),a(Ec(f.template,Y).childNodes)(c,function(a){d.append(a)},{futureParentElement:d})):(d.html(f.template),a(d.contents())(c))}}}],oe=Ia({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),
Ae=function(){return{restrict:"A",priority:100,require:"ngModel",link:function(a,c,d,e){var f=c.attr(d.$attr.ngList)||", ",g="false"!==d.ngTrim,h=g?W(f):f;e.$parsers.push(function(a){if(!B(a)){var c=[];a&&r(a.split(h),function(a){a&&c.push(g?W(a):a)});return c}});e.$formatters.push(function(a){return F(a)?a.join(f):u});e.$isEmpty=function(a){return!a||!a.length}}}},db="ng-valid",Ad="ng-invalid",Na="ng-pristine",Fb="ng-dirty",Cd="ng-pending",Hb=new R("ngModel"),eg=["$scope","$exceptionHandler","$attrs",
...
y=null,q=this;this.$$setOptions=function(a){if((q.$options=a)&&a.getterSetter){var c=f(d.ngModel+"()"),g=f(d.ngModel+"($$$p)");s=function(a){var d=m(a);I(d)&&(d=c(a));return d};A=function(a,c){I(m(a))?g(a,{$$$p:q.$modelValue}):p(a,q.$modelValue)}}else if(!m.assign)throw Hb("nonassign",d.ngModel,va(e));};this.$render=C;this.$isEmpty=function(a){return B(a)||""===a||null===a||a!==a};var G=e.inheritedData("$formController")||Eb,z=0;xd({ctrl:this,$element:e,set:function(a,c){a[c]=!0},unset:function(a,
c){delete a[c]},parentForm:G,$animate:g});this.$setPristine=function(){q.$dirty=!1;q.$pristine=!0;g.removeClass(e,Fb);g.addClass(e,Na)};this.$setDirty=function(){q.$dirty=!0;q.$pristine=!1;g.removeClass(e,Na);g.addClass(e,Fb);G.$setDirty()};this.$setUntouched=function(){q.$touched=!1;q.$untouched=!0;g.setClass(e,"ng-untouched","ng-touched")};this.$setTouched=function(){q.$touched=!0;q.$untouched=!1;g.setClass(e,"ng-touched","ng-untouched")};this.$rollbackViewValue=function(){h.cancel(y);q.$viewValue=
...
!0:(r(q.$asyncValidators,function(a,c){h(c,null)}),!1)}function g(){var a=[],e=!0;r(q.$asyncValidators,function(f,g){var k=f(c,d);if(!k||!I(k.then))throw Hb("$asyncValidators",k);h(g,u);a.push(k.then(function(){h(g,!0)},function(a){e=!1;h(g,!1)}))});a.length?k.all(a).then(function(){l(e)},C):l(!0)}function h(a,c){m===z&&q.$setValidity(a,c)}function l(a){m===z&&e(a)}z++;var m=z;(function(a){var c=q.$$parserName||"parse";if(a===u)h(c,null);else if(h(c,a),!a)return r(q.$validators,function(a,c){h(c,
null)}),r(q.$asyncValidators,function(a,c){h(c,null)}),!1;return!0})(a)?f()?g():l(!1):l(!1)};this.$commitViewValue=function(){var a=q.$viewValue;h.cancel(y);if(q.$$lastCommittedViewValue!==a||""===a&&q.$$hasNativeValidators)q.$$lastCommittedViewValue=a,q.$pristine&&this.$setDirty(),this.$$parseAndValidate()};this.$$parseAndValidate=function(){var c=q.$$lastCommittedViewValue,d=B(c)?u:!0;if(d)for(var e=0;e<q.$parsers.length;e++)if(c=q.$parsers[e](c),B(c)){d=!1;break}S(q.$modelValue)&&isNaN(q.$modelValue)&&
...
q.$$debounceViewValueCommit(c)};this.$$debounceViewValueCommit=function(c){var d=0,e=q.$options;e&&v(e.debounce)&&(e=e.debounce,S(e)?d=e:S(e[c])?d=e[c]:S(e["default"])&&(d=e["default"]));h.cancel(y);d?y=h(function(){q.$commitViewValue()},d):l.$$phase?q.$commitViewValue():a.$apply(function(){q.$commitViewValue()})};a.$watch(function(){var c=s(a);if(c!==q.$modelValue){q.$modelValue=q.$$rawModelValue=c;for(var d=q.$formatters,e=d.length,f=c;e--;)f=d[e](f);q.$viewValue!==f&&(q.$viewValue=q.$$lastCommittedViewValue=
f,q.$render(),q.$$runValidators(u,c,f,C))}return c})}],ze=["$rootScope",function(a){return{restrict:"A",require:["ngModel","^?form","^?ngModelOptions"],controller:eg,priority:1,compile:function(c){c.addClass(Na).addClass("ng-untouched").addClass(db);return{pre:function(a,c,f,g){var h=g[0],l=g[1]||Eb;h.$$setOptions(g[2]&&g[2].$options);l.$addControl(h);f.$observe("name",function(a){h.$name!==a&&l.$$renameControl(h,a)});a.$on("$destroy",function(){l.$removeControl(h)})},post:function(c,e,f,g){var h=
...
if(!n)throw gg("iexp",a,va(d));var m=n[4]||n[6],p=n[5];a=/ as /.test(n[0])&&n[1];d=n[8];var r=c(n[2]?n[1]:m),u=a&&c(a)||r,y=d&&c(d),q=d?function(a,c){return y(e,c)}:function(a){return Da(a)},G=c(n[2]||n[1]),z=c(n[3]||""),w=c(n[7]),x={},v=p?function(a,c){x[p]=c;x[m]=a;return x}:function(a){x[m]=a;return x};return{getWatchables:c(w,function(a){var c=[];a=a||[];Object.keys(a).forEach(function(d){var f=v(a[d],d),g=G(e,f);d=q(a[d],f);c.push(d);c.push(g)});return c}),getOptions:function(){var a=[],c={},
d=w(e)||[];Object.keys(d).forEach(function(g){if("$"!==g.charAt(0)){var h=v(d[g],g),m=u(e,h);g=q(m,h);var n=G(e,h),h=z(e,h),m=new f(g,m,n,h);a.push(m);c[g]=m}});return{items:a,selectValueMap:c,getOptionFromViewValue:function(a){return c[q(a,v(a))]}}}}}var e=Y.createElement("option"),f=Y.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select","?ngModel"],link:function(c,h,l,k){function n(a,c){a.element=c;a.value!==c.value&&(c.value=a.selectValue);a.label!==c.label&&(c.label=a.label,
c.textContent=a.label)}function m(a,c,d,e){c&&D(c.nodeName)===d?d=c:(d=e.cloneNode(!1),c?a.insertBefore(d,c):a.appendChild(d));return d}function p(a){for(var c;a;)c=a.nextSibling,Rb(a),a=c}function r(a){var c=v&&v[0],d=w&&w[0];if(c||d)for(;a&&(a===c||a===d);)a=a.nextSibling;return a}function u(){var a=x&&q.readValue();x=M.getOptions();var c={},d=h[0].firstChild;z&&h.prepend(v);d=r(d);x.items.forEach(function(a){var g,k;a.group?(g=c[a.group],g||(g=m(h[0],d,"optgroup",f),d=g.nextSibling,g.label=a.group,
g=c[a.group]={groupElement:g,currentOptionElement:g.firstChild}),k=m(g.groupElement,g.currentOptionElement,"option",e),n(a,k),g.currentOptionElement=k.nextSibling):(k=m(h[0],d,"option",e),n(a,k),d=k.nextSibling)});Object.keys(c).forEach(function(a){p(c[a].currentOptionElement)});p(d);y.$render();if(!y.$isEmpty(a)){var g=q.readValue();ka(a,g)||y.$setViewValue(g)}}var y=k[1];if(y){var q=k[0];k=l.multiple;var v=q.emptyOption,z=!!v,w=H(e.cloneNode(!1));w.val("?");var x,M=d(l.ngOptions,h,c);q.writeValue=
function(a){var c=x.getOptionFromViewValue(a);c?h[0].value!==c.selectValue&&(w.remove(),z||v.remove(),h[0].value=c.selectValue,c.element.selected=!0,c.element.setAttribute("selected","selected")):null===a||z?(w.remove(),z||h.prepend(v),h.val(""),v.prop("selected",!0),v.attr("selected",!0)):(z||v.remove(),h.prepend(w),h.val("?"),w.prop("selected",!0),w.attr("selected",!0))};q.readValue=function(){var a=x.selectValueMap[h.val()];return a?(z||v.remove(),w.remove(),a.viewValue):null};k&&(y.$isEmpty=function(a){return!a||
0===a.length},q.writeValue=function(a){x.items.forEach(function(a){a.element.selected=!1});a&&a.forEach(function(a){if(a=x.getOptionFromViewValue(a))a.element.selected=!0})},q.readValue=function(){return(h.val()||[]).map(function(a){return x.selectValueMap[a].viewValue})});z?(v.remove(),a(v)(c),v.removeClass("ng-scope")):v=H(e.cloneNode(!1));u();c.$watchCollection(M.getWatchables,u)}}}}],qe=["$locale","$interpolate","$log",function(a,c,d){var e=/{}/g,f=/^when(Minus)?(.+)$/;return{restrict:"EA",link:function(g,
h,l){function k(a){h.text(a||"")}var n=l.count,m=l.$attr.when&&h.attr(l.$attr.when),p=l.offset||0,s=g.$eval(m)||{},u={},v=c.startSymbol(),q=c.endSymbol(),G=v+n+"-"+p+q,z=ca.noop,w;r(l,function(a,c){var d=f.exec(c);d&&(d=(d[1]?"-":"")+D(d[2]),s[d]=h.attr(l.$attr[c]))});r(s,function(a,d){u[d]=c(a.replace(e,G))});g.$watch(n,function(c){var e=parseFloat(c),f=isNaN(e);f||e in s||(e=a.pluralCat(e-p));e===w||f&&S(w)&&isNaN(w)||(z(),f=u[e],B(f)?(null!=c&&d.debug("ngPluralize: no rule defined for '"+e+"' in "+
m),z=C,k()):z=g.$watch(f,k),w=e)})}}}],re=["$parse","$animate",function(a,c){var d=R("ngRepeat"),e=function(a,c,d,e,k,n,m){a[d]=e;k&&(a[k]=n);a.$index=c;a.$first=0===c;a.$last=c===m-1;a.$middle=!(a.$first||a.$last);a.$odd=!(a.$even=0===(c&1))};return{restrict:"A",multiElement:!0,transclude:"element",priority:1E3,terminal:!0,$$tlb:!0,compile:function(f,g){var h=g.ngRepeat,l=Y.createComment(" end ngRepeat: "+h+" "),k=h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
if(!k)throw d("iexp",h);var n=k[1],m=k[2],p=k[3],s=k[4],k=n.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/);if(!k)throw d("iidexp",n);var v=k[3]||k[1],y=k[2];if(p&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(p)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(p)))throw d("badident",p);var q,G,z,w,x={$id:Da};s?q=a(s):(z=function(a,c){return Da(c)},w=function(a){return a});return function(a,f,g,k,n){q&&(G=function(c,d,e){y&&(x[y]=c);x[v]=d;x.$index=
e;return q(a,x)});var s=qa();a.$watchCollection(m,function(g){var k,m,q=f[0],x,E=qa(),C,D,I,B,J,F,K;p&&(a[p]=g);if(Oa(g))J=g,m=G||z;else for(K in m=G||w,J=[],g)g.hasOwnProperty(K)&&"$"!==K.charAt(0)&&J.push(K);C=J.length;K=Array(C);for(k=0;k<C;k++)if(D=g===J?k:J[k],I=g[D],B=m(D,I,k),s[B])F=s[B],delete s[B],E[B]=F,K[k]=F;else{if(E[B])throw r(K,function(a){a&&a.scope&&(s[a.id]=a)}),d("dupes",h,B,I);K[k]={id:B,scope:u,clone:u};E[B]=!0}for(x in s){F=s[x];B=kb(F.clone);c.leave(B);if(B[0].parentNode)for(k=
0,m=B.length;k<m;k++)B[k].$$NG_REMOVED=!0;F.scope.$destroy()}for(k=0;k<C;k++)if(D=g===J?k:J[k],I=g[D],F=K[k],F.scope){x=q;do x=x.nextSibling;while(x&&x.$$NG_REMOVED);F.clone[0]!=x&&c.move(kb(F.clone),null,H(q));q=F.clone[F.clone.length-1];e(F.scope,k,v,I,y,D,C)}else n(function(a,d){F.scope=d;var f=l.cloneNode(!1);a[a.length++]=f;c.enter(a,null,H(q));q=f;F.clone=a;E[F.id]=F;e(F.scope,k,v,I,y,D,C)});s=E})}}}}],se=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,
...
h.writeValue=function(a){var c=new wb(a);r(d.find("option"),function(a){a.selected=v(c.get(a.value))})},c.$watch(function(){ka(a,g.$viewValue)||(a=fa(g.$viewValue),g.$render())}),g.$isEmpty=function(a){return!a||0===a.length})}}}},be=["$interpolate",function(a){function c(a){a[0].hasAttribute("selected")&&(a[0].selected=!0)}return{restrict:"E",priority:100,compile:function(d,e){if(B(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),n=k.data("$selectController")||
