/*
 ...
 License: MIT
*/
(function(O,Y,u){'use strict';function H(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3946+sha.731c8b5/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Ra(b){if(null==b||Sa(b))return!1;var a=b.length;
...
e=0;e<d.length;e++)a.call(c,b[d[e]],d[e]);return d}function kc(b){return function(a,c){b(c,a)}}function Nd(){return++jb}function lc(b,a){a?b.$$hashKey=a:delete b.$$hashKey}function Kb(b,a,c){for(var d=b.$$hashKey,e=0,f=a.length;e<f;++e){var h=a[e];if(E(h)||G(h))for(var g=Object.keys(h),l=0,k=g.length;l<k;l++){var m=g[l],q=h[m];c&&E(q)?(E(b[m])||(b[m]=C(q)?[]:{}),Kb(b[m],[q],!0)):b[m]=q}}lc(b,d);return b}function Q(b){return Kb(b,qa.call(arguments,1),!1)}function Od(b){return Kb(b,qa.call(arguments,
...
ra.call(b)}function Sa(b){return b&&b.window===b}function Va(b){return b&&b.$evalAsync&&b.$watch}function Wa(b){return"boolean"===typeof b}function mc(b){return!(!b||!(b.nodeName||b.prop&&b.attr&&b.find))}function Pd(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function sa(b){return M(b.nodeName||b[0]&&b[0].nodeName)}function Xa(b,a){var c=b.indexOf(a);0<=c&&b.splice(c,1);return c}function ta(b,a,c,d){if(Sa(b)||Va(b))throw Ea("cpws");if(nc.test(ra.call(a)))throw Ea("cpta");
if(a){if(b===a)throw Ea("cpi");c=c||[];d=d||[];if(E(b)){var e=c.indexOf(b);if(-1!==e)return d[e];c.push(b);d.push(a)}if(C(b))for(var f=a.length=0;f<b.length;f++)e=ta(b[f],null,c,d),E(b[f])&&(c.push(b[f]),d.push(e)),a.push(e);else{var h=a.$$hashKey;C(a)?a.length=0:n(a,function(b,c){delete a[c]});for(f in b)b.hasOwnProperty(f)&&(e=ta(b[f],null,c,d),E(b[f])&&(c.push(b[f]),d.push(e)),a[f]=e);lc(a,h)}}else if(a=b)C(b)?a=ta(b,[],c,d):nc.test(ra.call(b))?a=new b.constructor(b):da(b)?a=new Date(b.getTime()):
...
a.length){for(d=0;d<c;d++)if(!ja(b[d],a[d]))return!1;return!0}}else{if(da(b))return da(a)?ja(b.getTime(),a.getTime()):!1;if(Ua(b))return Ua(a)?b.toString()==a.toString():!1;if(Va(b)||Va(a)||Sa(b)||Sa(a)||C(a)||da(a)||Ua(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!G(b[d])){if(!ja(b[d],a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==u&&!G(a[d]))return!1;return!0}return!1}function Ya(b,a,c){return b.concat(qa.call(a,c))}function oc(b,a){var c=2<arguments.length?
qa.call(arguments,2):[];return!G(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,Ya(c,arguments,0)):a.apply(b,c)}:function(){return arguments.length?a.apply(b,arguments):a.call(b)}}function Qd(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?c=u:Sa(a)?c="$WINDOW":a&&Y===a?c="$DOCUMENT":Va(a)&&(c="$SCOPE");return c}function Za(b,a){if("undefined"===typeof b)return u;W(a)||(a=a?2:null);return JSON.stringify(b,Qd,a)}function pc(b){return I(b)?JSON.parse(b):
b}function qc(b,a){var c=Date.parse("Jan 01, 1970 00:00:00 "+b)/6E4;return isNaN(c)?a:c}function Mb(b,a,c){c=c?-1:1;var d=qc(a,b.getTimezoneOffset());a=b;b=c*(d-b.getTimezoneOffset());a=new Date(a.getTime());a.setMinutes(a.getMinutes()+b);return a}function ua(b){b=A(b).clone();try{b.empty()}catch(a){}var c=A("<div>").append(b).html();try{return b[0].nodeType===$a?M(c):c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,function(a,b){return"<"+M(b)})}catch(d){return M(c)}}function rc(b){try{return decodeURIComponent(b)}catch(a){}}
function sc(b){var a={},c,d;n((b||"").split("&"),function(b){b&&(c=b.replace(/\+/g,"%20").split("="),d=rc(c[0]),x(d)&&(b=x(c[1])?rc(c[1]):!0,tc.call(a,d)?C(a[d])?a[d].push(b):a[d]=[a[d],b]:a[d]=b))});return a}function Nb(b){var a=[];n(b,function(b,d){C(b)?n(b,function(b){a.push(Fa(d,!0)+(!0===b?"":"="+Fa(b,!0)))}):a.push(Fa(d,!0)+(!0===b?"":"="+Fa(b,!0)))});return a.length?a.join("&"):""}function kb(b){return Fa(b,!0).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+")}function Fa(b,a){return encodeURIComponent(b).replace(/%40/gi,
"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%3B/gi,";").replace(/%20/g,a?"%20":"+")}function Rd(b,a){var c,d,e=Ma.length;for(d=0;d<e;++d)if(c=Ma[d]+a,I(c=b.getAttribute(c)))return c;return null}function Sd(b,a){var c,d,e={};n(Ma,function(a){a+="app";!c&&b.hasAttribute&&b.hasAttribute(a)&&(c=b,d=b.getAttribute(a))});n(Ma,function(a){a+="app";var e;!c&&(e=b.querySelector("["+a.replace(":","\\:")+"]"))&&(c=e,d=e.getAttribute(a))});c&&(e.strictDi=null!==Rd(c,"strict-di"),
a(c,d?[d]:[],e))}function uc(b,a,c){E(c)||(c={});c=Q({strictDi:!1},c);var d=function(){b=A(b);if(b.injector()){var d=b[0]===Y?"document":ua(b);throw Ea("btstrpd",d.replace(/</,"&lt;").replace(/>/,"&gt;"));}a=a||[];a.unshift(["$provide",function(a){a.value("$rootElement",b)}]);c.debugInfoEnabled&&a.push(["$compileProvider",function(a){a.debugInfoEnabled(!0)}]);a.unshift("ng");d=ab(a,c.strictDi);d.invoke(["$rootScope","$rootElement","$compile","$injector",function(a,b,c,d){a.$apply(function(){b.data("$injector",
d);c(b)(a)})}]);return d},e=/^NG_ENABLE_DEBUG_INFO!/,f=/^NG_DEFER_BOOTSTRAP!/;O&&e.test(O.name)&&(c.debugInfoEnabled=!0,O.name=O.name.replace(e,""));if(O&&!f.test(O.name))return d();O.name=O.name.replace(f,"");$.resumeBootstrap=function(b){n(b,function(b){a.push(b)});return d()};G($.resumeDeferredBootstrap)&&$.resumeDeferredBootstrap()}function Td(){O.name="NG_ENABLE_DEBUG_INFO!"+O.name;O.location.reload()}function Ud(b){b=$.element(b).injector();if(!b)throw Ea("test");return b.get("$$testability")}
function vc(b,a){a=a||"_";return b.replace(Vd,function(b,d){return(d?a:"")+b.toLowerCase()})}function Wd(){var b;if(!wc){var a=lb();ka=O.jQuery;x(a)&&(ka=null===a?u:O[a]);ka&&ka.fn.on?(A=ka,Q(ka.fn,{scope:Na.scope,isolateScope:Na.isolateScope,controller:Na.controller,injector:Na.injector,inheritedData:Na.inheritedData}),b=ka.cleanData,ka.cleanData=function(a){var d;if(Ob)Ob=!1;else for(var e=0,f;null!=(f=a[e]);e++)(d=ka._data(f,"events"))&&d.$destroy&&ka(f).triggerHandler("$destroy");b(a)}):A=P;$.element=
A;wc=!0}}function Pb(b,a,c){if(!b)throw Ea("areq",a||"?",c||"required");return b}function Oa(b,a,c){c&&C(b)&&(b=b[b.length-1]);Pb(G(b),a,"not a function, got "+(b&&"object"===typeof b?b.constructor.name||"Object":typeof b));return b}function Pa(b,a){if("hasOwnProperty"===b)throw Ea("badname",a);}function xc(b,a,c){if(!a)return b;a=a.split(".");for(var d,e=b,f=a.length,h=0;h<f;h++)d=a[h],b&&(b=(e=b)[d]);return!c&&G(b)?oc(e,b):b}function mb(b){var a=b[0];b=b[b.length-1];var c=[a];do{a=a.nextSibling;
if(!a)break;c.push(a)}while(a!==b);return A(c)}function la(){return Object.create(null)}function Xd(b){function a(a,b,c){return a[b]||(a[b]=c())}var c=H("$injector"),d=H("ng");b=a(b,"angular",Object);b.$$minErr=b.$$minErr||H;return a(b,"module",function(){var b={};return function(f,h,g){if("hasOwnProperty"===f)throw d("badname","module");h&&b.hasOwnProperty(f)&&(b[f]=null);return a(b,f,function(){function a(c,d,e,f){f||(f=b);return function(){f[e||"push"]([c,d,arguments]);return t}}if(!h)throw c("nomod",
...
config:r,run:function(a){e.push(a);return this}};g&&r(g);return t})}})}function Yd(b){Q(b,{bootstrap:uc,copy:ta,extend:Q,merge:Od,equals:ja,element:A,forEach:n,injector:ab,noop:w,bind:oc,toJson:Za,fromJson:pc,identity:Ta,isUndefined:D,isDefined:x,isString:I,isFunction:G,isObject:E,isNumber:W,isElement:mc,isArray:C,version:Zd,isDate:da,lowercase:M,uppercase:nb,callbacks:{counter:0},getTestability:Ud,$$minErr:H,$$csp:bb,reloadWithDebugInfo:Td});cb=Xd(O);try{cb("ngLocale")}catch(a){cb("ngLocale",[]).provider("$locale",
$d)}cb("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:ae});a.provider("$compile",yc).directive({a:be,input:zc,textarea:zc,form:ce,script:de,select:ee,style:fe,option:ge,ngBind:he,ngBindHtml:ie,ngBindTemplate:je,ngClass:ke,ngClassEven:le,ngClassOdd:me,ngCloak:ne,ngController:oe,ngForm:pe,ngHide:qe,ngIf:re,ngInclude:se,ngInit:te,ngNonBindable:ue,ngPluralize:ve,ngRepeat:we,ngShow:xe,ngStyle:ye,ngSwitch:ze,ngSwitchWhen:Ae,ngSwitchDefault:Be,ngOptions:Ce,ngTransclude:De,ngModel:Ee,
ngList:Fe,ngChange:Ge,pattern:Ac,ngPattern:Ac,required:Bc,ngRequired:Bc,minlength:Cc,ngMinlength:Cc,maxlength:Dc,ngMaxlength:Dc,ngValue:He,ngModelOptions:Ie}).directive({ngInclude:Je}).directive(ob).directive(Ec);a.provider({$anchorScroll:Ke,$animate:Le,$browser:Me,$cacheFactory:Ne,$controller:Oe,$document:Pe,$exceptionHandler:Qe,$filter:Fc,$interpolate:Re,$interval:Se,$http:Te,$httpBackend:Ue,$location:Ve,$log:We,$parse:Xe,$rootScope:Ye,$q:Ze,$$q:$e,$sce:af,$sceDelegate:bf,$sniffer:cf,$templateCache:df,
$templateRequest:ef,$$testability:ff,$timeout:gf,$window:hf,$$rAF:jf,$$asyncCallback:kf,$$jqLite:lf,$$HashMap:mf,$$cookieReader:nf})}])}function db(b){return b.replace(of,function(a,b,d,e){return e?d.toUpperCase():d}).replace(pf,"Moz$1")}function Gc(b){b=b.nodeType;return b===na||!b||9===b}function Hc(b,a){var c,d,e=a.createDocumentFragment(),f=[];if(Qb.test(b)){c=c||e.appendChild(a.createElement("div"));d=(qf.exec(b)||["",""])[1].toLowerCase();d=fa[d]||fa._default;c.innerHTML=d[1]+b.replace(rf,"<$1></$2>")+
d[2];for(d=d[0];d--;)c=c.lastChild;f=Ya(f,c.childNodes);c=e.firstChild;c.textContent=""}else f.push(a.createTextNode(b));e.textContent="";e.innerHTML="";n(f,function(a){e.appendChild(a)});return e}function P(b){if(b instanceof P)return b;var a;I(b)&&(b=V(b),a=!0);if(!(this instanceof P)){if(a&&"<"!=b.charAt(0))throw Rb("nosel");return new P(b)}if(a){a=Y;var c;b=(c=sf.exec(b))?[a.createElement(c[1])]:(c=Hc(b,a))?c.childNodes:[]}Ic(this,b)}function Sb(b){return b.cloneNode(!0)}function pb(b,a){a||qb(b);
...
Jc(b)),delete sb[c],b.ng339=u))}function rb(b,a){var c=b.ng339,c=c&&sb[c];a&&!c&&(b.ng339=c=++tf,c=sb[c]={events:{},data:{},handle:u});return c}function Tb(b,a,c){if(Gc(b)){var d=x(c),e=!d&&a&&!E(a),f=!a;b=(b=rb(b,!e))&&b.data;if(d)b[a]=c;else{if(f)return b;if(e)return b&&b[a];Q(b,a)}}}function tb(b,a){return b.getAttribute?-1<(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").indexOf(" "+a+" "):!1}function ub(b,a){a&&b.setAttribute&&n(a.split(" "),function(a){b.setAttribute("class",V((" "+
(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").replace(" "+V(a)+" "," ")))})}function vb(b,a){if(a&&b.setAttribute){var c=(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ");n(a.split(" "),function(a){a=V(a);-1===c.indexOf(" "+a+" ")&&(c+=a+" ")});b.setAttribute("class",V(c))}}function Ic(b,a){if(a)if(a.nodeType)b[b.length++]=a;else{var c=a.length;if("number"===typeof c&&a.window!==a){if(c)for(var d=0;d<c;d++)b[b.length++]=a[d]}else b[b.length++]=a}}function Kc(b,a){return wb(b,
"$"+(a||"ngController")+"Controller")}function wb(b,a,c){9==b.nodeType&&(b=b.documentElement);for(a=C(a)?a:[a];b;){for(var d=0,e=a.length;d<e;d++)if((c=A.data(b,a[d]))!==u)return c;b=b.parentNode||11===b.nodeType&&b.host}}function Lc(b){for(pb(b,!0);b.firstChild;)b.removeChild(b.firstChild)}function Ub(b,a){a||pb(b);var c=b.parentNode;c&&c.removeChild(b)}function uf(b,a){a=a||O;if("complete"===a.document.readyState)a.setTimeout(b);else A(a).on("load",b)}function Mc(b,a){var c=xb[a.toLowerCase()];
return c&&Nc[sa(b)]&&c}function vf(b,a){var c=b.nodeName;return("INPUT"===c||"TEXTAREA"===c)&&Oc[a]}function wf(b,a){var c=function(c,e){c.isDefaultPrevented=function(){return c.defaultPrevented};var f=a[e||c.type],h=f?f.length:0;if(h){if(D(c.immediatePropagationStopped)){var g=c.stopImmediatePropagation;c.stopImmediatePropagation=function(){c.immediatePropagationStopped=!0;c.stopPropagation&&c.stopPropagation();g&&g.call(c)}}c.isImmediatePropagationStopped=function(){return!0===c.immediatePropagationStopped};
1<h&&(f=ea(f));for(var l=0;l<h;l++)c.isImmediatePropagationStopped()||f[l].call(b,c)}};c.elem=b;return c}function lf(){this.$get=function(){return Q(P,{hasClass:function(b,a){b.attr&&(b=b[0]);return tb(b,a)},addClass:function(b,a){b.attr&&(b=b[0]);return vb(b,a)},removeClass:function(b,a){b.attr&&(b=b[0]);return ub(b,a)}})}}function Ga(b,a){var c=b&&b.$$hashKey;if(c)return"function"===typeof c&&(c=b.$$hashKey()),c;c=typeof b;return c="function"==c||"object"==c&&null!==b?b.$$hashKey=c+":"+(a||Nd)():
c+":"+b}function eb(b,a){if(a){var c=0;this.nextUid=function(){return++c}}n(b,this.put,this)}function xf(b){return(b=b.toString().replace(Pc,"").match(Qc))?"function("+(b[1]||"").replace(/[\s\r\n]+/," ")+")":"fn"}function ab(b,a){function c(a){return function(b,c){if(E(b))n(b,kc(a));else return a(b,c)}}function d(a,b){Pa(a,"service");if(G(b)||C(b))b=r.instantiate(b);if(!b.$get)throw Ha("pget",a);return q[a+"Provider"]=b}function e(a,b){return function(){var c=F.invoke(b,this);if(D(c))throw Ha("undef",
...
b){Pa(a,"constant");q[a]=b;t[a]=b}),decorator:function(a,b){var c=r.get(a+"Provider"),d=c.$get;c.$get=function(){var a=F.invoke(d,c);return F.invoke(b,null,{$delegate:a})}}}},r=q.$injector=g(q,function(a,b){$.isString(b)&&k.push(b);throw Ha("unpr",k.join(" <- "));}),t={},F=t.$injector=g(t,function(a,b){var c=r.get(a+"Provider",b);return F.invoke(c.$get,c,u,a)});n(h(b),function(a){F.invoke(a||w)});return F}function Ke(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location",
"$rootScope",function(a,c,d){function e(a){var b=null;Array.prototype.some.call(a,function(a){if("a"===sa(a))return b=a,!0});return b}function f(b){if(b){b.scrollIntoView();var c;c=h.yOffset;G(c)?c=c():mc(c)?(c=c[0],c="fixed"!==a.getComputedStyle(c).position?0:c.getBoundingClientRect().bottom):W(c)||(c=0);c&&(b=b.getBoundingClientRect().top,a.scrollBy(0,b-c))}else a.scrollTo(0,0)}function h(a){a=I(a)?a:c.hash();var b;a?(b=g.getElementById(a))?f(b):(b=e(g.getElementsByName(a)))?f(b):"top"===a&&f(null):
f(null)}var g=a.document;b&&d.$watch(function(){return c.hash()},function(a,b){a===b&&""===a||uf(function(){d.$evalAsync(h)})});return h}]}function kf(){this.$get=["$$rAF","$timeout",function(b,a){return b.supported?function(a){return b(a)}:function(b){return a(b,0,!1)}}]}function yf(b,a,c,d){function e(a){try{a.apply(null,qa.call(arguments,1))}finally{if(F--,0===F)for(;R.length;)try{R.pop()()}catch(b){c.error(b)}}}function f(){h();g()}function h(){a:{try{v=m.state;break a}catch(a){}v=void 0}v=D(v)?
null:v;ja(v,B)&&(v=B);B=v}function g(){if(y!==l.url()||p!==v)y=l.url(),p=v,n(K,function(a){a(l.url(),v)})}var l=this,k=b.location,m=b.history,q=b.setTimeout,r=b.clearTimeout,t={};l.isMock=!1;var F=0,R=[];l.$$completeOutstandingRequest=e;l.$$incOutstandingRequestCount=function(){F++};l.notifyWhenNoOutstandingRequests=function(a){0===F?a():R.push(a)};var v,p,y=k.href,va=a.find("base"),z=null;h();p=v;l.url=function(a,c,e){D(e)&&(e=null);k!==b.location&&(k=b.location);m!==b.history&&(m=b.history);if(a){var f=
...
return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};l.defer=function(a,b){var c;F++;c=q(function(){delete t[c];e(a)},b||0);t[c]=!0;return c};l.defer.cancel=function(a){return t[a]?(delete t[a],r(a),e(w),!0):!1}}function Me(){this.$get=["$window","$log","$sniffer","$document",function(b,a,c,d){return new yf(b,d,a,c)}]}function Ne(){this.$get=function(){function b(b,d){function e(a){a!=q&&(r?r==a&&(r=a.n):r=a,f(a.n,a.p),f(a,q),q=a,q.n=null)}function f(a,b){a!=b&&(a&&(a.p=b),b&&(b.n=a))}if(b in a)throw H("$cacheFactory")("iid",
...
g=l=null;delete a[b]},info:function(){return Q({},g,{size:h})}}}var a={};b.info=function(){var b={};n(a,function(a,e){b[e]=a.info()});return b};b.get=function(b){return a[b]};return b}}function df(){this.$get=["$cacheFactory",function(b){return b("templates")}]}function yc(b,a){function c(a,b,c){var d=/^\s*([@&]|=(\*?))(\??)\s*(\w*)\s*$/,e={};n(a,function(a,f){var h=a.match(d);if(!h)throw ga("iscp",b,f,a,c?"controller bindings definition":"isolate scope definition");e[f]={mode:h[1][0],collection:"*"===
h[2],optional:"?"===h[3],attrName:h[4]||f}});return e}function d(a){var b=a.charAt(0);if(!b||b!==M(b))throw ga("baddir",a);}var e={},f=/^\s*directive\:\s*([\w\-]+)\s+(.*)$/,h=/(([\w\-]+)(?:\:([^;]+))?;?)/,g=Pd("ngSrc,ngSrcset,src,srcset"),l=/^(?:(\^\^?)?(\?)?(\^\^?)?)?/,k=/^(on[a-z]+|formaction)$/;this.directive=function r(a,f){Pa(a,"directive");I(a)?(d(a),Pb(f,"directiveFactory"),e.hasOwnProperty(a)||(e[a]=[],b.factory(a+"Directive",["$injector","$exceptionHandler",function(b,d){var f=[];n(e[a],
...
function za(a,b,c,d,e){var g=c.$attr,k;switch(a.nodeType){case na:H(b,xa(sa(a)),"E",d,e);for(var l,r,m,p=a.attributes,t=0,K=p&&p.length;t<K;t++){var F=!1,N=!1;l=p[t];k=l.name;r=V(l.value);l=xa(k);if(m=ia.test(l))k=k.replace(Sc,"").substr(8).replace(/_(.)/g,function(a,b){return b.toUpperCase()});var B=l.replace(/(Start|End)$/,"");O(B)&&l===B+"Start"&&(F=k,N=k.substr(0,k.length-5)+"end",k=k.substr(0,k.length-6));l=xa(k.toLowerCase());g[l]=k;if(m||!c.hasOwnProperty(l))c[l]=r,Mc(a,l)&&(c[l]=!0);X(a,b,
...
a)},$updateClass:function(a,b){var c=Vc(a,b);c&&c.length&&K.addClass(this.$$element,c);(c=Vc(b,a))&&c.length&&K.removeClass(this.$$element,c)},$set:function(a,b,d,e){var f=this.$$element[0],g=Mc(f,a),h=vf(f,a),f=a;g?(this.$$element.prop(a,b),e=g):h&&(this[h]=b,f=h);this[a]=b;e?this.$attr[a]=e:(e=this.$attr[a])||(this.$attr[a]=e=vc(a,"-"));g=sa(this.$$element);if("a"===g&&"href"===a||"img"===g&&"src"===a)this[a]=b=N(b,"src"===a);else if("img"===g&&"srcset"===a){for(var g="",h=V(b),k=/(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/,
...
"ng-scope")}:w;return U}]}function xa(b){return db(b.replace(Sc,""))}function Vc(b,a){var c="",d=b.split(/\s+/),e=a.split(/\s+/),f=0;a:for(;f<d.length;f++){for(var h=d[f],g=0;g<e.length;g++)if(h==e[g])continue a;c+=(0<c.length?" ":"")+h}return c}function Tc(b){b=A(b);var a=b.length;if(1>=a)return b;for(;a--;)8===b[a].nodeType&&Af.call(b,a,1);return b}function Oe(){var b={},a=!1;this.register=function(a,d){Pa(a,"controller");E(a)?Q(b,a):b[a]=d};this.allowGlobals=function(){a=!0};this.$get=["$injector",
"$window",function(c,d){function e(a,b,c,d){if(!a||!E(a.$scope))throw H("$controller")("noscp",d,b);a.$scope[b]=c}return function(f,h,g,l){var k,m,q;g=!0===g;l&&I(l)&&(q=l);if(I(f)){l=f.match(Rc);if(!l)throw Bf("ctrlfmt",f);m=l[1];q=q||l[3];f=b.hasOwnProperty(m)?b[m]:xc(h.$scope,m,!0)||(a?xc(d,m,!0):u);Oa(f,m,!0)}if(g)return g=(C(f)?f[f.length-1]:f).prototype,k=Object.create(g||null),q&&e(h,q,k,m||f.name),Q(function(){var a=c.invoke(f,k,h,m);a!==k&&(E(a)||G(a))&&(k=a,q&&e(h,q,k,m||f.name));return k},
{instance:k,identifier:q});k=c.instantiate(f,h,m);q&&e(h,q,k,m||f.name);return k}}]}function Pe(){this.$get=["$window",function(b){return A(b.document)}]}function Qe(){this.$get=["$log",function(b){return function(a,c){b.error.apply(b,arguments)}}]}function Xb(b,a){if(I(b)){var c=b.replace(Cf,"").trim();if(c){var d=a("Content-Type");(d=d&&0===d.indexOf(Wc))||(d=(d=c.match(Df))&&Ef[d[0]].test(c));d&&(b=pc(c))}}return b}function Xc(b){var a=la(),c;I(b)?n(b.split("\n"),function(b){c=b.indexOf(":");var e=
M(V(b.substr(0,c)));b=V(b.substr(c+1));e&&(a[e]=a[e]?a[e]+", "+b:b)}):E(b)&&n(b,function(b,c){var f=M(c),h=V(b);f&&(a[f]=a[f]?a[f]+", "+h:h)});return a}function Yc(b){var a;return function(c){a||(a=Xc(b));return c?(c=a[M(c)],void 0===c&&(c=null),c):a}}function Zc(b,a,c,d){if(G(d))return d(b,a,c);n(d,function(d){b=d(b,a,c)});return b}function Te(){var b=this.defaults={transformResponse:[Xb],transformRequest:[function(a){return E(a)&&"[object File]"!==ra.call(a)&&"[object Blob]"!==ra.call(a)&&"[object FormData]"!==
ra.call(a)?Za(a):a}],headers:{common:{Accept:"application/json, text/plain, */*"},post:ea(Yb),put:ea(Yb),patch:ea(Yb)},xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN"},a=!1;this.useApplyAsync=function(b){return x(b)?(a=!!b,this):a};var c=this.interceptors=[];this.$get=["$httpBackend","$$cookieReader","$cacheFactory","$rootScope","$q","$injector",function(d,e,f,h,g,l){function k(a){function c(a){var b=Q({},a);b.data=a.data?Zc(a.data,a.headers,a.status,e.transformResponse):a.data;a=a.status;
...
a.headers,e=Zc(a.data,Yc(d),u,a.transformRequest);D(e)&&n(d,function(a,b){"content-type"===M(b)&&delete d[b]});D(a.withCredentials)&&!D(b.withCredentials)&&(a.withCredentials=b.withCredentials);return m(a,e).then(c,c)},u],h=g.when(e);for(n(t,function(a){(a.request||a.requestError)&&f.unshift(a.request,a.requestError);(a.response||a.responseError)&&f.push(a.response,a.responseError)});f.length;){a=f.shift();var k=f.shift(),h=h.then(a,k)}h.success=function(a){Oa(a,"fn");h.then(function(b){a(b.data,
b.status,b.headers,e)});return h};h.error=function(a){Oa(a,"fn");h.then(null,function(b){a(b.data,b.status,b.headers,e)});return h};return h}function m(c,f){function l(b,c,d,e){function f(){m(c,b,d,e)}N&&(200<=b&&300>b?N.put(S,[b,c,Xc(d),e]):N.remove(S));a?h.$applyAsync(f):(f(),h.$$phase||h.$apply())}function m(a,b,d,e){b=Math.max(b,0);(200<=b&&300>b?z.resolve:z.reject)({data:a,status:b,headers:Yc(d),config:c,statusText:e})}function t(a){m(a.data,a.status,ea(a.headers()),a.statusText)}function n(){var a=
k.pendingRequests.indexOf(c);-1!==a&&k.pendingRequests.splice(a,1)}var z=g.defer(),K=z.promise,N,B,U=c.headers,S=q(c.url,c.params);k.pendingRequests.push(c);K.then(n,n);!c.cache&&!b.cache||!1===c.cache||"GET"!==c.method&&"JSONP"!==c.method||(N=E(c.cache)?c.cache:E(b.cache)?b.cache:r);N&&(B=N.get(S),x(B)?B&&G(B.then)?B.then(t,t):C(B)?m(B[1],B[0],ea(B[2]),B[3]):m(B,200,{},"OK"):N.put(S,K));D(B)&&((B=$c(c.url)?e()[c.xsrfCookieName||b.xsrfCookieName]:u)&&(U[c.xsrfHeaderName||b.xsrfHeaderName]=B),d(c.method,
S,f,l,U,c.timeout,c.withCredentials,c.responseType));return K}function q(a,b){if(!b)return a;var c=[];Md(b,function(a,b){null===a||D(a)||(C(a)||(a=[a]),n(a,function(a){E(a)&&(a=da(a)?a.toISOString():Za(a));c.push(Fa(b)+"="+Fa(a))}))});0<c.length&&(a+=(-1==a.indexOf("?")?"?":"&")+c.join("&"));return a}var r=f("$http"),t=[];n(c,function(a){t.unshift(I(a)?l.get(a):l.invoke(a))});k.pendingRequests=[];(function(a){n(arguments,function(a){k[a]=function(b,c){return k(Q(c||{},{method:a,url:b}))}})})("get",
"delete","head","jsonp");(function(a){n(arguments,function(a){k[a]=function(b,c,d){return k(Q(d||{},{method:a,url:b,data:c}))}})})("post","put","patch");k.defaults=b;return k}]}function Ff(){return new O.XMLHttpRequest}function Ue(){this.$get=["$browser","$window","$document",function(b,a,c){return Gf(b,Ff,b.defer,a.angular.callbacks,c[0])}]}function Gf(b,a,c,d,e){function f(a,b,c){var f=e.createElement("script"),m=null;f.type="text/javascript";f.src=a;f.async=!0;m=function(a){f.removeEventListener("load",
...
"")};y.onerror=e;y.onabort=e;r&&(y.withCredentials=!0);if(t)try{y.responseType=t}catch(s){if("json"!==t)throw s;}y.send(l||null)}if(0<q)var z=c(F,q);else q&&G(q.then)&&q.then(F)}}function Re(){var b="{{",a="}}";this.startSymbol=function(a){return a?(b=a,this):b};this.endSymbol=function(b){return b?(a=b,this):a};this.$get=["$parse","$exceptionHandler","$sce",function(c,d,e){function f(a){return"\\\\\\"+a}function h(c){return c.replace(m,b).replace(q,a)}function g(f,g,m,q){function v(a){try{var b=a;
...
shortTime:"h:mm a",ERANAMES:["Before Christ","Anno Domini"],ERAS:["BC","AD"]},pluralCat:function(b){return 1===b?"one":"other"}}}}function Zb(b){b=b.split("/");for(var a=b.length;a--;)b[a]=kb(b[a]);return b.join("/")}function ad(b,a){var c=Ba(b);a.$$protocol=c.protocol;a.$$host=c.hostname;a.$$port=ba(c.port)||Hf[c.protocol]||null}function bd(b,a){var c="/"!==b.charAt(0);c&&(b="/"+b);var d=Ba(b);a.$$path=decodeURIComponent(c&&"/"===d.pathname.charAt(0)?d.pathname.substring(1):d.pathname);a.$$search=
sc(d.search);a.$$hash=decodeURIComponent(d.hash);a.$$path&&"/"!=a.$$path.charAt(0)&&(a.$$path="/"+a.$$path)}function ya(b,a){if(0===a.indexOf(b))return a.substr(b.length)}function Ia(b){var a=b.indexOf("#");return-1==a?b:b.substr(0,a)}function yb(b){return b.replace(/(#.+)|#$/,"$1")}function $b(b){return b.substr(0,Ia(b).lastIndexOf("/")+1)}function ac(b,a){this.$$html5=!0;a=a||"";var c=$b(b);ad(b,this);this.$$parse=function(a){var b=ya(c,a);if(!I(b))throw zb("ipthprfx",a,c);bd(b,this);this.$$path||
(this.$$path="/");this.$$compose()};this.$$compose=function(){var a=Nb(this.$$search),b=this.$$hash?"#"+kb(this.$$hash):"";this.$$url=Zb(this.$$path)+(a?"?"+a:"")+b;this.$$absUrl=c+this.$$url.substr(1)};this.$$parseLinkUrl=function(d,e){if(e&&"#"===e[0])return this.hash(e.slice(1)),!0;var f,h;(f=ya(b,d))!==u?(h=f,h=(f=ya(a,f))!==u?c+(ya("/",f)||f):b+h):(f=ya(c,d))!==u?h=c+f:c==d+"/"&&(h=c);h&&this.$$parse(h);return!!h}}function bc(b,a){var c=$b(b);ad(b,this);this.$$parse=function(d){d=ya(b,d)||ya(c,
d);var e;"#"===d.charAt(0)?(e=ya(a,d),D(e)&&(e=d)):e=this.$$html5?d:"";bd(e,this);d=this.$$path;var f=/^\/[A-Z]:(\/.*)/;0===e.indexOf(b)&&(e=e.replace(b,""));f.exec(e)||(d=(e=f.exec(d))?e[1]:d);this.$$path=d;this.$$compose()};this.$$compose=function(){var c=Nb(this.$$search),e=this.$$hash?"#"+kb(this.$$hash):"";this.$$url=Zb(this.$$path)+(c?"?"+c:"")+e;this.$$absUrl=b+(this.$$url?a+this.$$url:"")};this.$$parseLinkUrl=function(a,c){return Ia(b)==Ia(a)?(this.$$parse(a),!0):!1}}function cd(b,a){this.$$html5=
!0;bc.apply(this,arguments);var c=$b(b);this.$$parseLinkUrl=function(d,e){if(e&&"#"===e[0])return this.hash(e.slice(1)),!0;var f,h;b==Ia(d)?f=d:(h=ya(c,d))?f=b+a+h:c===d+"/"&&(f=c);f&&this.$$parse(f);return!!f};this.$$compose=function(){var c=Nb(this.$$search),e=this.$$hash?"#"+kb(this.$$hash):"";this.$$url=Zb(this.$$path)+(c?"?"+c:"")+e;this.$$absUrl=b+a+this.$$url}}function Ab(b){return function(){return this[b]}}function dd(b,a){return function(c){if(D(c))return this[b];this[b]=a(c);this.$$compose();
return this}}function Ve(){var b="",a={enabled:!1,requireBase:!0,rewriteLinks:!0};this.hashPrefix=function(a){return x(a)?(b=a,this):b};this.html5Mode=function(b){return Wa(b)?(a.enabled=b,this):E(b)?(Wa(b.enabled)&&(a.enabled=b.enabled),Wa(b.requireBase)&&(a.requireBase=b.requireBase),Wa(b.rewriteLinks)&&(a.rewriteLinks=b.rewriteLinks),this):a};this.$get=["$rootScope","$browser","$sniffer","$rootElement","$window",function(c,d,e,f,h){function g(a,b,c){var e=k.url(),f=k.$$state;try{d.url(a,b,c),k.$$state=
d.state()}catch(g){throw k.url(e),k.$$state=f,g;}}function l(a,b){c.$broadcast("$locationChangeSuccess",k.absUrl(),a,k.$$state,b)}var k,m;m=d.baseHref();var q=d.url(),r;if(a.enabled){if(!m&&a.requireBase)throw zb("nobase");r=q.substring(0,q.indexOf("/",q.indexOf("//")+2))+(m||"/");m=e.history?ac:cd}else r=Ia(q),m=bc;k=new m(r,"#"+b);k.$$parseLinkUrl(q,q);k.$$state=d.state();var t=/^\s*(javascript|mailto):/i;f.on("click",function(b){if(a.rewriteLinks&&!b.ctrlKey&&!b.metaKey&&!b.shiftKey&&2!=b.which&&
...
f):(r&&g(b,h,f===k.$$state?null:k.$$state),l(a,f)))});k.$$replace=!1});return k}]}function We(){var b=!0,a=this;this.debugEnabled=function(a){return x(a)?(b=a,this):b};this.$get=["$window",function(c){function d(a){a instanceof Error&&(a.stack?a=a.message&&-1===a.stack.indexOf(a.message)?"Error: "+a.message+"\n"+a.stack:a.stack:a.sourceURL&&(a=a.message+"\n"+a.sourceURL+":"+a.line));return a}function e(a){var b=c.console||{},e=b[a]||b.log||w;a=!1;try{a=!!e.apply}catch(l){}return a?function(){var a=
...
!1,b.toWatch=[]}}function gd(b){if(1==b.length){b=b[0].expression;var a=b.toWatch;return 1!==a.length?a:a[0]!==b?a:u}}function hd(b){return b.type===s.Identifier||b.type===s.MemberExpression}function id(b){if(1===b.body.length&&hd(b.body[0].expression))return{type:s.AssignmentExpression,left:b.body[0].expression,right:{type:s.NGValueParameter},operator:"="}}function jd(b){return 0===b.body.length||1===b.body.length&&(b.body[0].expression.type===s.Literal||b.body[0].expression.type===s.ArrayExpression||
b.body[0].expression.type===s.ObjectExpression)}function kd(b,a){this.astBuilder=b;this.$filter=a}function ld(b,a){this.astBuilder=b;this.$filter=a}function Bb(b,a,c,d){ia(b,d);a=a.split(".");for(var e,f=0;1<a.length;f++){e=Ca(a.shift(),d);var h=ia(b[e],d);h||(h={},b[e]=h);b=h}e=Ca(a.shift(),d);ia(b[e],d);return b[e]=c}function Cb(b){return"constructor"==b}function cc(b){return G(b.valueOf)?b.valueOf():Mf.call(b)}function Xe(){var b=la(),a=la();this.$get=["$filter","$sniffer",function(c,d){function e(a,
...
d.charAt(0)&&":"===d.charAt(1)&&(v=!0,d=d.substring(2)),F=F?q:m,n=new dc(F),n=(new ec(n,c,F)).parse(d),n.constant?n.$$watchDelegate=l:v?n.$$watchDelegate=n.literal?g:h:n.inputs&&(n.$$watchDelegate=f),s[p]=n);return k(n,e);case "function":return k(d,e);default:return w}}}]}function Ze(){this.$get=["$rootScope","$exceptionHandler",function(b,a){return md(function(a){b.$evalAsync(a)},a)}]}function $e(){this.$get=["$browser","$exceptionHandler",function(b,a){return md(function(a){b.defer(a)},a)}]}function md(b,
...
b.length,k=0,m=g(a,c),q=[],r={},p=!0,t=0;return this.$watch(m,function(){p?(p=!1,b(e,e,d)):b(e,h,d);if(l)if(E(e))if(Ra(e)){h=Array(e.length);for(var a=0;a<e.length;a++)h[a]=e[a]}else for(a in h={},e)tc.call(e,a)&&(h[a]=e[a]);else h=e})},$digest:function(){var b,f,g,k,m,r,t=a,n,z=[],v,w;q("$digest");l.$$checkUrlChange();this===p&&null!==e&&(l.defer.cancel(e),s());d=null;do{r=!1;for(n=this;u.length;){try{w=u.shift(),w.scope.$eval(w.expression,w.locals)}catch(A){h(A)}d=null}a:do{if(k=n.$$watchers)for(m=
...
[];return p}]}function ae(){var b=/^\s*(https?|ftp|mailto|tel|file):/,a=/^\s*((https?|ftp|file|blob):|data:image\/)/;this.aHrefSanitizationWhitelist=function(a){return x(a)?(b=a,this):b};this.imgSrcSanitizationWhitelist=function(b){return x(b)?(a=b,this):a};this.$get=function(){return function(c,d){var e=d?a:b,f;f=Ba(c).href;return""===f||f.match(e)?c:"unsafe:"+f}}}function Nf(b){if("self"===b)return b;if(I(b)){if(-1<b.indexOf("***"))throw Da("iwcard",b);b=nd(b).replace("\\*\\*",".*").replace("\\*",
"[^:/.?&;]*");return new RegExp("^"+b+"$")}if(Ua(b))return new RegExp("^"+b.source+"$");throw Da("imatcher");}function od(b){var a=[];x(b)&&n(b,function(b){a.push(Nf(b))});return a}function bf(){this.SCE_CONTEXTS=ma;var b=["self"],a=[];this.resourceUrlWhitelist=function(a){arguments.length&&(b=od(a));return b};this.resourceUrlBlacklist=function(b){arguments.length&&(a=od(b));return a};this.$get=["$injector",function(c){function d(a,b){return"self"===a?$c(b):!!a.exec(b.href)}function e(a){var b=function(a){this.$$unwrapTrustedValue=
...
h?a.$$unwrapTrustedValue():a}}}]}function af(){var b=!0;this.enabled=function(a){arguments.length&&(b=!!a);return b};this.$get=["$parse","$sceDelegate",function(a,c){if(b&&8>fb)throw Da("iequirks");var d=ea(ma);d.isEnabled=function(){return b};d.trustAs=c.trustAs;d.getTrusted=c.getTrusted;d.valueOf=c.valueOf;b||(d.trustAs=d.getTrusted=function(a,b){return b},d.valueOf=Ta);d.parseAs=function(b,c){var e=a(c);return e.literal&&e.constant?e:a(c,function(a){return d.getTrusted(b,a)})};var e=d.parseAs,
f=d.getTrusted,h=d.trustAs;n(ma,function(a,b){var c=M(b);d[db("parse_as_"+c)]=function(b){return e(a,b)};d[db("get_trusted_"+c)]=function(b){return f(a,b)};d[db("trust_as_"+c)]=function(b){return h(a,b)}});return d}]}function cf(){this.$get=["$window","$document",function(b,a){var c={},d=ba((/android (\d+)/.exec(M((b.navigator||{}).userAgent))||[])[1]),e=/Boxee/i.test((b.navigator||{}).userAgent),f=a[0]||{},h,g=/^(Moz|webkit|ms)(?=[A-Z])/,l=f.body&&f.body.style,k=!1,m=!1;if(l){for(var q in l)if(k=
g.exec(q)){h=k[0];h=h.substr(0,1).toUpperCase()+h.substr(1);break}h||(h="WebkitOpacity"in l&&"webkit");k=!!("transition"in l||h+"Transition"in l);m=!!("animation"in l||h+"Animation"in l);!d||k&&m||(k=I(l.webkitTransition),m=I(l.webkitAnimation))}return{history:!(!b.history||!b.history.pushState||4>d||e),hasEvent:function(a){if("input"===a&&11>=fb)return!1;if(D(c[a])){var b=f.createElement("div");c[a]="on"+a in b}return c[a]},csp:bb(),vendorPrefix:h,transitions:k,animations:m,android:d}}]}function ef(){this.$get=
["$templateCache","$http","$q",function(b,a,c){function d(e,f){d.totalPendingRequests++;var h=a.defaults&&a.defaults.transformResponse;C(h)?h=h.filter(function(a){return a!==Xb}):h===Xb&&(h=null);return a.get(e,{cache:b,transformResponse:h})["finally"](function(){d.totalPendingRequests--}).then(function(a){b.put(e,a.data);return a.data},function(a){if(!f)throw ga("tpload",e,a.status,a.statusText);return c.reject(a)})}d.totalPendingRequests=0;return d}]}function ff(){this.$get=["$rootScope","$browser",
"$location",function(b,a,c){return{findBindings:function(a,b,c){a=a.getElementsByClassName("ng-binding");var h=[];n(a,function(a){var d=$.element(a).data("$binding");d&&n(d,function(d){c?(new RegExp("(^|\\s)"+nd(b)+"(\\s|\\||$)")).test(d)&&h.push(a):-1!=d.indexOf(b)&&h.push(a)})});return h},findModels:function(a,b,c){for(var h=["ng-","data-ng-","ng\\:"],g=0;g<h.length;++g){var l=a.querySelectorAll("["+h[g]+"model"+(c?"=":"*=")+'"'+b+'"]');if(l.length)return l}},getLocation:function(){return c.url()},
...
f.cancel=function(b){return b&&b.$$timeoutId in h?(h[b.$$timeoutId].reject("canceled"),delete h[b.$$timeoutId],a.defer.cancel(b.$$timeoutId)):!1};return f}]}function Ba(b){fb&&(Z.setAttribute("href",b),b=Z.href);Z.setAttribute("href",b);return{href:Z.href,protocol:Z.protocol?Z.protocol.replace(/:$/,""):"",host:Z.host,search:Z.search?Z.search.replace(/^\?/,""):"",hash:Z.hash?Z.hash.replace(/^#/,""):"",hostname:Z.hostname,port:Z.port,pathname:"/"===Z.pathname.charAt(0)?Z.pathname:"/"+Z.pathname}}function $c(b){b=
I(b)?Ba(b):b;return b.protocol===pd.protocol&&b.host===pd.host}function hf(){this.$get=oa(O)}function qd(b){function a(a){try{return decodeURIComponent(a)}catch(b){return a}}var c=b[0],d={},e="";return function(){var b,h,g,l,k;if(c.cookie!==e)for(e=c.cookie,b=e.split("; "),d={},g=0;g<b.length;g++)h=b[g],l=h.indexOf("="),0<l&&(k=a(h.substring(0,l)),d[k]===u&&(d[k]=a(h.substring(l+1))));return d}}function nf(){this.$get=qd}function Fc(b){function a(c,d){if(E(c)){var e={};n(c,function(b,c){e[c]=a(c,
b)});return e}return b.factory(c+"Filter",d)}this.register=a;this.$get=["$injector",function(a){return function(b){return a.get(b+"Filter")}}];a("currency",rd);a("date",sd);a("filter",Of);a("json",Pf);a("limitTo",Qf);a("lowercase",Rf);a("number",td);a("orderBy",ud);a("uppercase",Sf)}function Of(){return function(b,a,c){if(!C(b)){if(null==b)return b;throw H("filter")("notarray",b);}var d;switch(fc(a)){case "function":break;case "boolean":case "null":case "number":case "string":d=!0;case "object":a=
Tf(a,c,d);break;default:return b}return b.filter(a)}}function Tf(b,a,c){var d=E(b)&&"$"in b;!0===a?a=ja:G(a)||(a=function(a,b){if(D(a))return!1;if(null===a||null===b)return a===b;var c;!(c=E(b))&&(c=E(a))&&(c=a,c=!(G(c.toString)&&c.toString!==Object.prototype.toString));if(c)return!1;a=M(""+a);b=M(""+b);return-1!==a.indexOf(b)});return function(e){return d&&!E(e)?Ka(e,b.$,a,!1):Ka(e,b,a,c)}}function Ka(b,a,c,d,e){var f=fc(b),h=fc(a);if("string"===h&&"!"===a.charAt(0))return!Ka(b,a.substring(1),c,
d);if(C(b))return b.some(function(b){return Ka(b,a,c,d)});switch(f){case "object":var g;if(d){for(g in b)if("$"!==g.charAt(0)&&Ka(b[g],a,c,!0))return!0;return e?!1:Ka(b,a,c,!1)}if("object"===h){for(g in a)if(e=a[g],!G(e)&&!D(e)&&(f="$"===g,!Ka(f?b:b[g],e,c,f,f)))return!1;return!0}return c(b,a);case "function":return!1;default:return c(b,a)}}function fc(b){return null===b?"null":typeof b}function rd(b){var a=b.NUMBER_FORMATS;return function(b,d,e){D(d)&&(d=a.CURRENCY_SYM);D(e)&&(e=a.PATTERNS[1].maxFrac);
return null==b?b:vd(b,a.PATTERNS[1],a.GROUP_SEP,a.DECIMAL_SEP,e).replace(/\u00A4/g,d)}}function td(b){var a=b.NUMBER_FORMATS;return function(b,d){return null==b?b:vd(b,a.PATTERNS[0],a.GROUP_SEP,a.DECIMAL_SEP,d)}}function vd(b,a,c,d,e){if(E(b))return"";var f=0>b;b=Math.abs(b);var h=Infinity===b;if(!h&&!isFinite(b))return"";var g=b+"",l="",k=!1,m=[];h&&(l="\u221e");if(!h&&-1!==g.indexOf("e")){var q=g.match(/([\d\.]+)e(-?)(\d+)/);q&&"-"==q[2]&&q[3]>e+1?b=0:(l=g,k=!0)}if(h||k)0<e&&1>b&&(l=b.toFixed(e),
b=parseFloat(l));else{h=(g.split(wd)[1]||"").length;D(e)&&(e=Math.min(Math.max(a.minFrac,h),a.maxFrac));b=+(Math.round(+(b.toString()+"e"+e)).toString()+"e"+-e);var h=(""+b).split(wd),g=h[0],h=h[1]||"",q=0,r=a.lgSize,t=a.gSize;if(g.length>=r+t)for(q=g.length-r,k=0;k<q;k++)0===(q-k)%t&&0!==k&&(l+=c),l+=g.charAt(k);for(k=q;k<g.length;k++)0===(g.length-k)%r&&0!==k&&(l+=c),l+=g.charAt(k);for(;h.length<e;)h+="0";e&&"0"!==e&&(l+=d+h.substr(0,e))}0===b&&(f=!1);m.push(f?a.negPre:a.posPre,l,f?a.negSuf:a.posSuf);
return m.join("")}function Db(b,a,c){var d="";0>b&&(d="-",b=-b);for(b=""+b;b.length<a;)b="0"+b;c&&(b=b.substr(b.length-a));return d+b}function aa(b,a,c,d){c=c||0;return function(e){e=e["get"+b]();if(0<c||e>-c)e+=c;0===e&&-12==c&&(e=12);return Db(e,a,d)}}function Eb(b,a){return function(c,d){var e=c["get"+b](),f=nb(a?"SHORT"+b:b);return d[f][e]}}function xd(b){var a=(new Date(b,0,1)).getDay();return new Date(b,0,(4>=a?5:12)-a)}function yd(b){return function(a){var c=xd(a.getFullYear());a=+new Date(a.getFullYear(),
a.getMonth(),a.getDate()+(4-a.getDay()))-+c;a=1+Math.round(a/6048E5);return Db(a,b)}}function gc(b,a){return 0>=b.getFullYear()?a.ERAS[0]:a.ERAS[1]}function sd(b){function a(a){var b;if(b=a.match(c)){a=new Date(0);var f=0,h=0,g=b[8]?a.setUTCFullYear:a.setFullYear,l=b[8]?a.setUTCHours:a.setHours;b[9]&&(f=ba(b[9]+b[10]),h=ba(b[9]+b[11]));g.call(a,ba(b[1]),ba(b[2])-1,ba(b[3]));f=ba(b[4]||0)-f;h=ba(b[5]||0)-h;g=ba(b[6]||0);b=Math.round(1E3*parseFloat("0."+(b[7]||0)));l.call(a,f,h,g,b)}return a}var c=
/^(\d{4})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/;return function(c,e,f){var h="",g=[],l,k;e=e||"mediumDate";e=b.DATETIME_FORMATS[e]||e;I(c)&&(c=Uf.test(c)?ba(c):a(c));W(c)&&(c=new Date(c));if(!da(c)||!isFinite(c.getTime()))return c;for(;e;)(k=Vf.exec(e))?(g=Ya(g,k,1),e=g.pop()):(g.push(e),e=null);var m=c.getTimezoneOffset();f&&(m=qc(f,c.getTimezoneOffset()),c=Mb(c,f,!0));n(g,function(a){l=Wf[a];h+=l?l(c,b.DATETIME_FORMATS,m):a.replace(/(^'|'$)/g,
"").replace(/''/g,"'")});return h}}function Pf(){return function(b,a){D(a)&&(a=2);return Za(b,a)}}function Qf(){return function(b,a,c){a=Infinity===Math.abs(Number(a))?Number(a):ba(a);if(isNaN(a))return b;W(b)&&(b=b.toString());if(!C(b)&&!I(b))return b;c=!c||isNaN(c)?0:ba(c);c=0>c&&c>=-b.length?b.length+c:c;return 0<=a?b.slice(c,c+a):0===c?b.slice(a,b.length):b.slice(Math.max(0,c+a),c)}}function ud(b){return function(a,c,d){function e(a,b){return b?function(b,c){return a(c,b)}:a}function f(a){switch(typeof a){case "number":case "boolean":case "string":return!0;
default:return!1}}function h(a){return null===a?"null":"function"===typeof a.valueOf&&(a=a.valueOf(),f(a))||"function"===typeof a.toString&&(a=a.toString(),f(a))?a:""}function g(a,b){var c=typeof a,d=typeof b;c===d&&"object"===c&&(a=h(a),b=h(b));return c===d?("string"===c&&(a=a.toLowerCase(),b=b.toLowerCase()),a===b?0:a<b?-1:1):c<d?-1:1}if(!Ra(a))return a;c=C(c)?c:[c];0===c.length&&(c=["+"]);c=c.map(function(a){var c=!1,d=a||Ta;if(I(a)){if("+"==a.charAt(0)||"-"==a.charAt(0))c="-"==a.charAt(0),a=a.substring(1);
if(""===a)return e(g,c);d=b(a);if(d.constant){var f=d();return e(function(a,b){return g(a[f],b[f])},c)}}return e(function(a,b){return g(d(a),d(b))},c)});return qa.call(a).sort(e(function(a,b){for(var d=0;d<c.length;d++){var e=c[d](a,b);if(0!==e)return e}return 0},d))}}function La(b){G(b)&&(b={link:b});b.restrict=b.restrict||"AC";return oa(b)}function zd(b,a,c,d,e){var f=this,h=[],g=f.$$parentForm=b.parent().controller("form")||Fb;f.$error={};f.$$success={};f.$pending=u;f.$name=e(a.name||a.ngForm||
"")(c);f.$dirty=!1;f.$pristine=!0;f.$valid=!0;f.$invalid=!1;f.$submitted=!1;g.$addControl(f);f.$rollbackViewValue=function(){n(h,function(a){a.$rollbackViewValue()})};f.$commitViewValue=function(){n(h,function(a){a.$commitViewValue()})};f.$addControl=function(a){Pa(a.$name,"input");h.push(a);a.$name&&(f[a.$name]=a)};f.$$renameControl=function(a,b){var c=a.$name;f[c]===a&&delete f[c];f[b]=a;a.$name=b};f.$removeControl=function(a){a.$name&&f[a.$name]===a&&delete f[a.$name];n(f.$pending,function(b,c){f.$setValidity(c,
null,a)});n(f.$error,function(b,c){f.$setValidity(c,null,a)});n(f.$$success,function(b,c){f.$setValidity(c,null,a)});Xa(h,a)};Ad({ctrl:this,$element:b,set:function(a,b,c){var d=a[b];d?-1===d.indexOf(c)&&d.push(c):a[b]=[c]},unset:function(a,b,c){var d=a[b];d&&(Xa(d,c),0===d.length&&delete a[b])},parentForm:g,$animate:d});f.$setDirty=function(){d.removeClass(b,Qa);d.addClass(b,Gb);f.$dirty=!0;f.$pristine=!1;g.$setDirty()};f.$setPristine=function(){d.setClass(b,Qa,Gb+" ng-submitted");f.$dirty=!1;f.$pristine=
!0;f.$submitted=!1;n(h,function(a){a.$setPristine()})};f.$setUntouched=function(){n(h,function(a){a.$setUntouched()})};f.$setSubmitted=function(){d.addClass(b,"ng-submitted");f.$submitted=!0;g.$setSubmitted()}}function hc(b){b.$formatters.push(function(a){return b.$isEmpty(a)?a:a.toString()})}function gb(b,a,c,d,e,f){var h=M(a[0].type);if(!e.android){var g=!1;a.on("compositionstart",function(a){g=!0});a.on("compositionend",function(){g=!1;l()})}var l=function(b){k&&(f.defer.cancel(k),k=null);if(!g){var e=
a.val();b=b&&b.type;"password"===h||c.ngTrim&&"false"===c.ngTrim||(e=V(e));(d.$viewValue!==e||""===e&&d.$$hasNativeValidators)&&d.$setViewValue(e,b)}};if(e.hasEvent("input"))a.on("input",l);else{var k,m=function(a,b,c){k||(k=f.defer(function(){k=null;b&&b.value===c||l(a)}))};a.on("keydown",function(a){var b=a.keyCode;91===b||15<b&&19>b||37<=b&&40>=b||m(a,this,this.value)});if(e.hasEvent("paste"))a.on("paste cut",m)}a.on("change",l);d.$render=function(){a.val(d.$isEmpty(d.$viewValue)?"":d.$viewValue)}}
...
1E3*f.sss||0)}return NaN}}function hb(b,a,c,d){return function(e,f,h,g,l,k,m){function q(a){return a&&!(a.getTime&&a.getTime()!==a.getTime())}function r(a){return x(a)?da(a)?a:c(a):u}Bd(e,f,h,g);gb(e,f,h,g,l,k);var t=g&&g.$options&&g.$options.timezone,n;g.$$parserName=b;g.$parsers.push(function(b){return g.$isEmpty(b)?null:a.test(b)?(b=c(b,n),t&&(b=Mb(b,t)),b):u});g.$formatters.push(function(a){if(a&&!da(a))throw Ib("datefmt",a);if(q(a))return(n=a)&&t&&(n=Mb(n,t,!0)),m("date")(a,d,t);n=null;return""});
if(x(h.min)||h.ngMin){var s;g.$validators.min=function(a){return!q(a)||D(s)||c(a)>=s};h.$observe("min",function(a){s=r(a);g.$validate()})}if(x(h.max)||h.ngMax){var v;g.$validators.max=function(a){return!q(a)||D(v)||c(a)<=v};h.$observe("max",function(a){v=r(a);g.$validate()})}}}function Bd(b,a,c,d){(d.$$hasNativeValidators=E(a[0].validity))&&d.$parsers.push(function(b){var c=a.prop("validity")||{};return c.badInput&&!c.typeMismatch?u:b})}function Cd(b,a,c,d,e){if(x(d)){b=b(d);if(!b.constant)throw H("ngModel")("constexpr",
c,d);return b(a)}return e}function ic(b,a){b="ngClass"+b;return["$animate",function(c){function d(a,b){var c=[],d=0;a:for(;d<a.length;d++){for(var e=a[d],m=0;m<b.length;m++)if(e==b[m])continue a;c.push(e)}return c}function e(a){var b=[];return C(a)?(n(a,function(a){b=b.concat(e(a))}),b):I(a)?a.split(" "):E(a)?(n(a,function(a,c){a&&(b=b.concat(c.split(" ")))}),b):a}return{restrict:"AC",link:function(f,h,g){function l(a,b){var c=h.data("$classCounts")||{},d=[];n(a,function(a){if(0<b||c[a])c[a]=(c[a]||
0)+b,c[a]===+(0<b)&&d.push(a)});h.data("$classCounts",c);return d.join(" ")}function k(b){if(!0===a||f.$index%2===a){var k=e(b||[]);if(!m){var t=l(k,1);g.$addClass(t)}else if(!ja(b,m)){var n=e(m),t=d(k,n),k=d(n,k),t=l(t,1),k=l(k,-1);t&&t.length&&c.addClass(h,t);k&&k.length&&c.removeClass(h,k)}}m=ea(b)}var m;f.$watch(g[b],k,!0);g.$observe("class",function(a){k(f.$eval(g[b]))});"ngClass"!==b&&f.$watch("$index",function(c,d){var h=c&1;if(h!==(d&1)){var k=e(f.$eval(g[b]));h===a?(h=l(k,1),g.$addClass(h)):
(h=l(k,-1),g.$removeClass(h))}})}}}]}function Ad(b){function a(a,b){b&&!f[a]?(k.addClass(e,a),f[a]=!0):!b&&f[a]&&(k.removeClass(e,a),f[a]=!1)}function c(b,c){b=b?"-"+vc(b,"-"):"";a(ib+b,!0===c);a(Dd+b,!1===c)}var d=b.ctrl,e=b.$element,f={},h=b.set,g=b.unset,l=b.parentForm,k=b.$animate;f[Dd]=!(f[ib]=e.hasClass(ib));d.$setValidity=function(b,e,f){e===u?(d.$pending||(d.$pending={}),h(d.$pending,b,f)):(d.$pending&&g(d.$pending,b,f),Ed(d.$pending)&&(d.$pending=u));Wa(e)?e?(g(d.$error,b,f),h(d.$$success,
b,f)):(h(d.$error,b,f),g(d.$$success,b,f)):(g(d.$error,b,f),g(d.$$success,b,f));d.$pending?(a(Fd,!0),d.$valid=d.$invalid=u,c("",null)):(a(Fd,!1),d.$valid=Ed(d.$error),d.$invalid=!d.$valid,c("",d.$valid));e=d.$pending&&d.$pending[b]?u:d.$error[b]?!1:d.$$success[b]?!0:null;c(b,e);l.$setValidity(b,e,d)}}function Ed(b){if(b)for(var a in b)return!1;return!0}var Yf=/^\/(.+)\/([a-z]*)$/,M=function(b){return I(b)?b.toLowerCase():b},tc=Object.prototype.hasOwnProperty,nb=function(b){return I(b)?b.toUpperCase():
b},fb,A,ka,qa=[].slice,Af=[].splice,Zf=[].push,ra=Object.prototype.toString,Ea=H("ng"),$=O.angular||(O.angular={}),cb,jb=0;fb=Y.documentMode;w.$inject=[];Ta.$inject=[];var C=Array.isArray,nc=/^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/,V=function(b){return I(b)?b.trim():b},nd=function(b){return b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")},bb=function(){if(x(bb.isActive_))return bb.isActive_;var b=!(!Y.querySelector("[ng-csp]")&&
!Y.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return bb.isActive_=b},lb=function(){if(x(lb.name_))return lb.name_;var b,a,c=Ma.length,d,e;for(a=0;a<c;++a)if(d=Ma[a],b=Y.querySelector("["+d.replace(":","\\:")+"jq]")){e=b.getAttribute(d+"jq");break}return lb.name_=e},Ma=["ng-","data-ng-","ng:","x-ng-"],Vd=/[A-Z]/g,wc=!1,Ob,na=1,$a=3,Zd={full:"1.4.0-build.3946+sha.731c8b5",major:1,minor:4,dot:0,codeName:"snapshot"};P.expando="ng339";var sb=P.cache={},tf=1;P._data=function(b){return this.cache[b[this.expando]]||
{}};var of=/([\:\-\_]+(.))/g,pf=/^moz([A-Z])/,$f={mouseleave:"mouseout",mouseenter:"mouseover"},Rb=H("jqLite"),sf=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Qb=/<|&#?\w+;/,qf=/<([\w:]+)/,rf=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,fa={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};
fa.optgroup=fa.option;fa.tbody=fa.tfoot=fa.colgroup=fa.caption=fa.thead;fa.th=fa.td;var Na=P.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===Y.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),P(O).on("load",a))},toString:function(){var b=[];n(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?A(this[b]):A(this[this.length+b])},length:0,push:Zf,sort:[].sort,splice:[].splice},xb={};n("multiple selected checked disabled readOnly required open".split(" "),
function(b){xb[M(b)]=b});var Nc={};n("input select option textarea button form details".split(" "),function(b){Nc[b]=!0});var Oc={ngMinlength:"minlength",ngMaxlength:"maxlength",ngMin:"min",ngMax:"max",ngPattern:"pattern"};n({data:Tb,removeData:qb},function(b,a){P[a]=b});n({data:Tb,inheritedData:wb,scope:function(b){return A.data(b,"$scope")||wb(b.parentNode||b,["$isolateScope","$scope"])},isolateScope:function(b){return A.data(b,"$isolateScope")||A.data(b,"$isolateScopeNoTemplate")},controller:Kc,
...
a,c){if(x(c))b[a]=c;else return b[a]},text:function(){function b(a,b){if(D(b)){var d=a.nodeType;return d===na||d===$a?a.textContent:""}a.textContent=b}b.$dv="";return b}(),val:function(b,a){if(D(a)){if(b.multiple&&"select"===sa(b)){var c=[];n(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(D(a))return b.innerHTML;pb(b,!0);b.innerHTML=a},empty:Lc},function(b,a){P.prototype[a]=function(a,d){var e,f,h=this.length;
if(b!==Lc&&(2==b.length&&b!==tb&&b!==Kc?a:d)===u){if(E(a)){for(e=0;e<h;e++)if(b===Tb)b(this[e],a);else for(f in a)b(this[e],f,a[f]);return this}e=b.$dv;h=e===u?Math.min(h,1):h;for(f=0;f<h;f++){var g=b(this[f],a,d);e=e?e+g:g}return e}for(e=0;e<h;e++)b(this[e],a,d);return this}});n({removeData:qb,on:function a(c,d,e,f){if(x(f))throw Rb("onargs");if(Gc(c)){var h=rb(c,!0);f=h.events;var g=h.handle;g||(g=h.handle=wf(c,f));for(var h=0<=d.indexOf(" ")?d.split(" "):[d],l=h.length;l--;){d=h[l];var k=f[d];
k||(f[d]=[],"mouseenter"===d||"mouseleave"===d?a(c,$f[d],function(a){var c=a.relatedTarget;c&&(c===this||this.contains(c))||g(a,d)}):"$destroy"!==d&&c.addEventListener(d,g,!1),k=f[d]);k.push(e)}}},off:Jc,one:function(a,c,d){a=A(a);a.on(c,function f(){a.off(c,d);a.off(c,f)});a.on(c,d)},replaceWith:function(a,c){var d,e=a.parentNode;pb(a);n(new P(c),function(c){d?e.insertBefore(c,d.nextSibling):e.replaceChild(c,a);d=c})},children:function(a){var c=[];n(a.childNodes,function(a){a.nodeType===na&&c.push(a)});
...
Ic(h,a(this[g],c,e,f));return x(h)?h:this};P.prototype.bind=P.prototype.on;P.prototype.unbind=P.prototype.off});eb.prototype={put:function(a,c){this[Ga(a,this.nextUid)]=c},get:function(a){return this[Ga(a,this.nextUid)]},remove:function(a){var c=this[a=Ga(a,this.nextUid)];delete this[a];return c}};var mf=[function(){this.$get=[function(){return eb}]}],Qc=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,ag=/,/,bg=/^\s*(_?)(\S+?)\1\s*$/,Pc=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Ha=H("$injector");ab.$$annotate=function(a,
c,d){var e;if("function"===typeof a){if(!(e=a.$inject)){e=[];if(a.length){if(c)throw I(d)&&d||(d=a.name||xf(a)),Ha("strictdi",d);c=a.toString().replace(Pc,"");c=c.match(Qc);n(c[1].split(ag),function(a){a.replace(bg,function(a,c,d){e.push(d)})})}a.$inject=e}}else C(a)?(c=a.length-1,Oa(a[c],"fn"),e=a.slice(0,c)):Oa(a,"fn",!0);return e};var cg=H("$animate"),Le=["$provide",function(a){this.$$selectors={};this.register=function(c,d){var e=c+"-animation";if(c&&"."!=c.charAt(0))throw cg("notcsel",c);this.$$selectors[c.substr(1)]=
...
cancel:w}}]}],ga=H("$compile");yc.$inject=["$provide","$$sanitizeUriProvider"];var Sc=/^((?:x|data)[\:\-_])/i,Bf=H("$controller"),Rc=/^(\S+)(\s+as\s+(\w+))?$/,Wc="application/json",Yb={"Content-Type":Wc+";charset=utf-8"},Df=/^\[|^\{(?!\{)/,Ef={"[":/]$/,"{":/}$/},Cf=/^\)\]\}',?\n/,Ja=$.$interpolateMinErr=H("$interpolate");Ja.throwNoconcat=function(a){throw Ja("noconcat",a);};Ja.interr=function(a,c){return Ja("interr",a,c.toString())};var dg=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,Hf={http:80,https:443,ftp:21},
zb=H("$location"),eg={$$html5:!1,$$replace:!1,absUrl:Ab("$$absUrl"),url:function(a){if(D(a))return this.$$url;var c=dg.exec(a);(c[1]||""===a)&&this.path(decodeURIComponent(c[1]));(c[2]||c[1]||""===a)&&this.search(c[3]||"");this.hash(c[5]||"");return this},protocol:Ab("$$protocol"),host:Ab("$$host"),port:Ab("$$port"),path:dd("$$path",function(a){a=null!==a?a.toString():"";return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(I(a)||W(a))a=
a.toString(),this.$$search=sc(a);else if(E(a))a=ta(a,{}),n(a,function(c,e){null==c&&delete a[e]}),this.$$search=a;else throw zb("isrcharg");break;default:D(c)||null===c?delete this.$$search[a]:this.$$search[a]=c}this.$$compose();return this},hash:dd("$$hash",function(a){return null!==a?a.toString():""}),replace:function(){this.$$replace=!0;return this}};n([cd,bc,ac],function(a){a.prototype=Object.create(eg);a.prototype.state=function(c){if(!arguments.length)return this.$$state;if(a!==ac||!this.$$html5)throw zb("nostate");
this.$$state=D(c)?null:c;return this}});var ca=H("$parse"),If=Function.prototype.call,Jf=Function.prototype.apply,Kf=Function.prototype.bind,Jb=la();n("+ - * / % === !== == != < > <= >= && || ! = |".split(" "),function(a){Jb[a]=!0});var fg={n:"\n",f:"\f",r:"\r",t:"\t",v:"\v","'":"'",'"':'"'},dc=function(a){this.options=a};dc.prototype={constructor:dc,lex:function(a){this.text=a;this.index=0;for(this.tokens=[];this.index<this.text.length;)if(a=this.text.charAt(this.index),'"'===a||"'"===a)this.readString(a);
...
value:null},undefined:{type:s.Literal,value:u},"this":{type:s.ThisExpression}}};kd.prototype={compile:function(a,c){var d=this,e=this.astBuilder.ast(a);this.state={nextId:0,filters:{},expensiveChecks:c,fn:{vars:[],body:[],own:{}},assign:{vars:[],body:[],own:{}},inputs:[]};X(e,d.$filter);var f="",h;this.stage="assign";if(h=id(e))this.state.computing="assign",f=this.nextId(),this.recurse(h,f),f="fn.assign="+this.generateFunction("assign","s,v,l");h=gd(e.body);d.stage="inputs";n(h,function(a,c){var e=
"fn"+c;d.state[e]={vars:[],body:[],own:{}};d.state.computing=e;var f=d.nextId();d.recurse(a,f);d.return_(f);d.state.inputs.push(e);a.watchId=c});this.state.computing="fn";this.stage="main";this.recurse(e);f='"'+this.USE+" "+this.STRICT+'";\n'+this.filterPrefix()+"var fn="+this.generateFunction("fn","s,l,a,i")+f+this.watchFns()+"return fn;";f=(new Function("$filter","ensureSafeMemberName","ensureSafeObject","ensureSafeFunction","ifDefined","plus","text",f))(this.$filter,Ca,ia,ed,Lf,fd,a);this.state=
this.stage=u;f.literal=jd(e);f.constant=e.constant;return f},USE:"use",STRICT:"strict",watchFns:function(){var a=[],c=this.state.inputs,d=this;n(c,function(c){a.push("var "+c+"="+d.generateFunction(c,"s"))});c.length&&a.push("fn.inputs=["+c.join(",")+"];");return a.join("")},generateFunction:function(a,c){return"function("+c+"){"+this.varsPrefix(a)+this.body(a)+"};"},filterPrefix:function(){var a=[],c=this;n(this.state.filters,function(d,e){a.push(d+"=$filter("+c.escape(e)+")")});return a.length?
"var "+a.join(",")+";":""},varsPrefix:function(a){return this.state[a].vars.length?"var "+this.state[a].vars.join(",")+";":""},body:function(a){return this.state[a].body.join("")},recurse:function(a,c,d,e,f,h){var g,l,k=this,m,q;e=e||w;if(!h&&x(a.watchId))c=c||this.nextId(),this.if_("i",this.lazyAssign(c,this.computedMember("i",a.watchId)),this.lazyRecurse(a,c,d,e,f,!0));else switch(a.type){case s.Program:n(a.body,function(c,d){k.recurse(c.expression,u,u,function(a){l=a});d!==a.body.length-1?k.current().body.push(l,
...
c||this.nextId();k.recurse(a.left,c);k.if_("&&"===a.operator?c:k.not(c),k.lazyRecurse(a.right,c));e(c);break;case s.ConditionalExpression:c=c||this.nextId();k.recurse(a.test,c);k.if_(c,k.lazyRecurse(a.alternate,c),k.lazyRecurse(a.consequent,c));e(c);break;case s.Identifier:c=c||this.nextId();d&&(d.context="inputs"===k.stage?"s":this.assign(this.nextId(),this.getHasOwnProperty("l",a.name)+"?l:s"),d.computed=!1,d.name=a.name);Ca(a.name);k.if_("inputs"===k.stage||k.not(k.getHasOwnProperty("l",a.name)),
function(){k.if_("inputs"===k.stage||"s",function(){f&&1!==f&&k.if_(k.not(k.nonComputedMember("s",a.name)),k.lazyAssign(k.nonComputedMember("s",a.name),"{}"));k.assign(c,k.nonComputedMember("s",a.name))})},c&&k.lazyAssign(c,k.nonComputedMember("l",a.name)));(k.state.expensiveChecks||Cb(a.name))&&k.addEnsureSafeObject(c);e(c);break;case s.MemberExpression:g=d&&(d.context=this.nextId())||this.nextId();c=c||this.nextId();k.recurse(a.object,g,u,function(){k.if_(k.notNull(g),function(){if(a.computed)l=
k.nextId(),k.recurse(a.property,l),k.addEnsureSafeMemberName(l),f&&1!==f&&k.if_(k.not(k.computedMember(g,l)),k.lazyAssign(k.computedMember(g,l),"{}")),q=k.ensureSafeObject(k.computedMember(g,l)),k.assign(c,q),d&&(d.computed=!0,d.name=l);else{Ca(a.property.name);f&&1!==f&&k.if_(k.not(k.nonComputedMember(g,a.property.name)),k.lazyAssign(k.nonComputedMember(g,a.property.name),"{}"));q=k.nonComputedMember(g,a.property.name);if(k.state.expensiveChecks||Cb(a.property.name))q=k.ensureSafeObject(q);k.assign(c,
q);d&&(d.computed=!1,d.name=a.property.name)}e(c)})},!!f);break;case s.CallExpression:c=c||this.nextId();a.filter?(l=k.filter(a.callee.name),m=[],n(a.arguments,function(a){var c=k.nextId();k.recurse(a,c);m.push(c)}),q=l+"("+m.join(",")+")",k.assign(c,q),e(c)):(l=k.nextId(),g={},m=[],k.recurse(a.callee,l,g,function(){k.if_(k.notNull(l),function(){k.addEnsureSafeFunction(l);n(a.arguments,function(a){k.recurse(a,k.nextId(),u,function(a){m.push(k.ensureSafeObject(a))})});g.name?(k.state.expensiveChecks||
k.addEnsureSafeObject(g.context),q=k.member(g.context,g.name,g.computed)+"("+m.join(",")+")"):q=l+"("+m.join(",")+")";q=k.ensureSafeObject(q);k.assign(c,q);e(c)})}));break;case s.AssignmentExpression:l=this.nextId();g={};if(!hd(a.left))throw ca("lval");this.recurse(a.left,u,g,function(){k.if_(k.notNull(g.context),function(){k.recurse(a.right,l);k.addEnsureSafeObject(k.member(g.context,g.name,g.computed));q=k.member(g.context,g.name,g.computed)+a.operator+l;k.assign(c,q);e(c||q)})},1);break;case s.ArrayExpression:m=
[];n(a.elements,function(a){k.recurse(a,k.nextId(),u,function(a){m.push(a)})});q="["+m.join(",")+"]";this.assign(c,q);e(q);break;case s.ObjectExpression:m=[];n(a.properties,function(a){k.recurse(a.value,k.nextId(),u,function(c){m.push(k.escape(a.key.type===s.Identifier?a.key.name:""+a.key.value)+":"+c)})});q="{"+m.join(",")+"}";this.assign(c,q);e(q);break;case s.ThisExpression:this.assign(c,"s");e("s");break;case s.NGValueParameter:this.assign(c,"v"),e("v")}},getHasOwnProperty:function(a,c){var d=
...
h.expensiveChecks,c,d,h.expression);case s.CallExpression:return g=[],n(a.arguments,function(a){g.push(h.recurse(a))}),a.filter&&(f=this.$filter(a.callee.name)),a.filter||(f=this.recurse(a.callee,!0)),a.filter?function(a,d,e,h){for(var r=[],n=0;n<g.length;++n)r.push(g[n](a,d,e,h));a=f.apply(u,r,h);return c?{context:u,name:u,value:a}:a}:function(a,d,e,q){var r=f(a,d,e,q),n;if(null!=r.value){ia(r.context,h.expression);ed(r.value,h.expression);n=[];for(var s=0;s<g.length;++s)n.push(ia(g[s](a,d,e,q),
...
c;this.options=d;this.ast=new s(this.lexer);this.astCompiler=d.csp?new ld(this.ast,c):new kd(this.ast,c)};ec.prototype={constructor:ec,parse:function(a){return this.astCompiler.compile(a,this.options.expensiveChecks)}};la();la();var Mf=Object.prototype.valueOf,Da=H("$sce"),ma={HTML:"html",CSS:"css",URL:"url",RESOURCE_URL:"resourceUrl",JS:"js"},ga=H("$compile"),Z=Y.createElement("a"),pd=Ba(O.location.href);qd.$inject=["$document"];Fc.$inject=["$provide"];rd.$inject=["$locale"];td.$inject=["$locale"];
...
a?"floor":"ceil"](a/60),2)+Db(Math.abs(a%60),2))},ww:yd(2),w:yd(1),G:gc,GG:gc,GGG:gc,GGGG:function(a,c){return 0>=a.getFullYear()?c.ERANAMES[0]:c.ERANAMES[1]}},Vf=/((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/,Uf=/^\-?\d+$/;sd.$inject=["$locale"];var Rf=oa(M),Sf=oa(nb);ud.$inject=["$parse"];var be=oa({restrict:"E",compile:function(a,c){if(!c.href&&!c.xlinkHref)return function(a,c){if("a"===c[0].nodeName.toLowerCase()){var f="[object SVGAnimatedString]"===ra.call(c.prop("href"))?
"xlink:href":"href";c.on("click",function(a){c.attr(f)||a.preventDefault()})}}}}),ob={};n(xb,function(a,c){function d(a,d,f){a.$watch(f[e],function(a){f.$set(c,!!a)})}if("multiple"!=a){var e=xa("ng-"+c),f=d;"checked"===a&&(f=function(a,c,f){f.ngModel!==f[e]&&d(a,c,f)});ob[e]=function(){return{restrict:"A",priority:100,link:f}}}});n(Oc,function(a,c){ob[c]=function(){return{priority:100,link:function(a,e,f){if("ngPattern"===c&&"/"==f.ngPattern.charAt(0)&&(e=f.ngPattern.match(Yf))){f.$set("ngPattern",
...
$setDirty:w,$setPristine:w,$setSubmitted:w};zd.$inject=["$element","$attrs","$scope","$animate","$interpolate"];var Gd=function(a){return["$timeout",function(c){return{name:"form",restrict:a?"EAC":"E",controller:zd,compile:function(d,e){d.addClass(Qa).addClass(ib);var f=e.name?"name":a&&e.ngForm?"ngForm":!1;return{pre:function(a,d,e,k){if(!("action"in e)){var m=function(c){a.$apply(function(){k.$commitViewValue();k.$setSubmitted()});c.preventDefault()};d[0].addEventListener("submit",m,!1);d.on("$destroy",
function(){c(function(){d[0].removeEventListener("submit",m,!1)},0,!1)})}var q=k.$$parentForm;f&&(Bb(a,k.$name,k,k.$name),e.$observe(f,function(c){k.$name!==c&&(Bb(a,k.$name,u,k.$name),q.$$renameControl(k,c),Bb(a,k.$name,k,k.$name))}));d.on("$destroy",function(){q.$removeControl(k);f&&Bb(a,e[f],u,k.$name);Q(k,Fb)})}}}}}]},ce=Gd(),pe=Gd(!0),Xf=/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/,gg=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
hg=/^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,ig=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,Hd=/^(\d{4})-(\d{2})-(\d{2})$/,Id=/^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,jc=/^(\d{4})-W(\d\d)$/,Jd=/^(\d{4})-(\d\d)$/,Kd=/^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,Ld={text:function(a,c,d,e,f,h){gb(a,c,d,e,f,h);hc(e)},date:hb("date",Hd,Hb(Hd,["yyyy","MM","dd"]),"yyyy-MM-dd"),"datetime-local":hb("datetimelocal",Id,Hb(Id,"yyyy MM dd HH mm ss sss".split(" ")),
"yyyy-MM-ddTHH:mm:ss.sss"),time:hb("time",Kd,Hb(Kd,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:hb("week",jc,function(a,c){if(da(a))return a;if(I(a)){jc.lastIndex=0;var d=jc.exec(a);if(d){var e=+d[1],f=+d[2],h=d=0,g=0,l=0,k=xd(e),f=7*(f-1);c&&(d=c.getHours(),h=c.getMinutes(),g=c.getSeconds(),l=c.getMilliseconds());return new Date(e,0,k.getDate()+f,d,h,g,l)}}return NaN},"yyyy-Www"),month:hb("month",Jd,Hb(Jd,["yyyy","MM"]),"yyyy-MM"),number:function(a,c,d,e,f,h){Bd(a,c,d,e);gb(a,c,d,e,f,h);e.$$parserName=
"number";e.$parsers.push(function(a){return e.$isEmpty(a)?null:ig.test(a)?parseFloat(a):u});e.$formatters.push(function(a){if(!e.$isEmpty(a)){if(!W(a))throw Ib("numfmt",a);a=a.toString()}return a});if(x(d.min)||d.ngMin){var g;e.$validators.min=function(a){return e.$isEmpty(a)||D(g)||a>=g};d.$observe("min",function(a){x(a)&&!W(a)&&(a=parseFloat(a,10));g=W(a)&&!isNaN(a)?a:u;e.$validate()})}if(x(d.max)||d.ngMax){var l;e.$validators.max=function(a){return e.$isEmpty(a)||D(l)||a<=l};d.$observe("max",function(a){x(a)&&
!W(a)&&(a=parseFloat(a,10));l=W(a)&&!isNaN(a)?a:u;e.$validate()})}},url:function(a,c,d,e,f,h){gb(a,c,d,e,f,h);hc(e);e.$$parserName="url";e.$validators.url=function(a,c){var d=a||c;return e.$isEmpty(d)||gg.test(d)}},email:function(a,c,d,e,f,h){gb(a,c,d,e,f,h);hc(e);e.$$parserName="email";e.$validators.email=function(a,c){var d=a||c;return e.$isEmpty(d)||hg.test(d)}},radio:function(a,c,d,e){D(d.name)&&c.attr("name",++jb);c.on("click",function(a){c[0].checked&&e.$setViewValue(d.value,a&&a.type)});e.$render=
function(){c[0].checked=d.value==e.$viewValue};d.$observe("value",e.$render)},checkbox:function(a,c,d,e,f,h,g,l){var k=Cd(l,a,"ngTrueValue",d.ngTrueValue,!0),m=Cd(l,a,"ngFalseValue",d.ngFalseValue,!1);c.on("click",function(a){e.$setViewValue(c[0].checked,a&&a.type)});e.$render=function(){c[0].checked=e.$viewValue};e.$isEmpty=function(a){return!1===a};e.$formatters.push(function(a){return ja(a,k)});e.$parsers.push(function(a){return a?k:m})},hidden:w,button:w,submit:w,reset:w,file:w},zc=["$browser",
"$sniffer","$filter","$parse",function(a,c,d,e){return{restrict:"E",require:["?ngModel"],link:{pre:function(f,h,g,l){l[0]&&(Ld[M(g.type)]||Ld.text)(f,h,g,l[0],c,a,d,e)}}}}],jg=/^(true|false|\d+)$/,He=function(){return{restrict:"A",priority:100,compile:function(a,c){return jg.test(c.ngValue)?function(a,c,f){f.$set("value",a.$eval(f.ngValue))}:function(a,c,f){a.$watch(f.ngValue,function(a){f.$set("value",a)})}}}},he=["$compile",function(a){return{restrict:"AC",compile:function(c){a.$$addBindingClass(c);
return function(c,e,f){a.$$addBindingInfo(e,f.ngBind);e=e[0];c.$watch(f.ngBind,function(a){e.textContent=a===u?"":a})}}}}],je=["$interpolate","$compile",function(a,c){return{compile:function(d){c.$$addBindingClass(d);return function(d,f,h){d=a(f.attr(h.$attr.ngBindTemplate));c.$$addBindingInfo(f,d.expressions);f=f[0];h.$observe("ngBindTemplate",function(a){f.textContent=a===u?"":a})}}}}],ie=["$sce","$parse","$compile",function(a,c,d){return{restrict:"A",compile:function(e,f){var h=c(f.ngBindHtml),
g=c(f.ngBindHtml,function(a){return(a||"").toString()});d.$$addBindingClass(e);return function(c,e,f){d.$$addBindingInfo(e,f.ngBindHtml);c.$watch(g,function(){e.html(a.getTrustedHtml(h(c))||"")})}}}}],Ge=oa({restrict:"A",require:"ngModel",link:function(a,c,d,e){e.$viewChangeListeners.push(function(){a.$eval(d.ngChange)})}}),ke=ic("",!0),me=ic("Odd",0),le=ic("Even",1),ne=La({compile:function(a,c){c.$set("ngCloak",u);a.removeClass("ng-cloak")}}),oe=[function(){return{restrict:"A",scope:!0,controller:"@",
priority:500}}],Ec={},kg={blur:!0,focus:!0};n("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=xa("ng-"+a);Ec[c]=["$parse","$rootScope",function(d,e){return{restrict:"A",compile:function(f,h){var g=d(h[c],null,!0);return function(c,d){d.on(a,function(d){var f=function(){g(c,{$event:d})};kg[a]&&e.$$phase?c.$evalAsync(f):c.$apply(f)})}}}}]});var re=["$animate",function(a){return{multiElement:!0,
transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(c,d,e,f,h){var g,l,k;c.$watch(e.ngIf,function(c){c?l||h(function(c,f){l=f;c[c.length++]=Y.createComment(" end ngIf: "+e.ngIf+" ");g={clone:c};a.enter(c,d.parent(),d)}):(k&&(k.remove(),k=null),l&&(l.$destroy(),l=null),g&&(k=mb(g.clone),a.leave(k).then(function(){k=null}),g=null))})}}}],se=["$templateRequest","$anchorScroll","$animate","$sce",function(a,c,d,e){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",
...
e);f.$eval(l)}},function(){n===u&&(w(),f.$emit("$includeContentError",e))}),f.$emit("$includeContentRequested",e)):(w(),t.template=null)})}}}}],Je=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(c,d,e,f){/SVG/.test(d[0].toString())?(d.empty(),a(Hc(f.template,Y).childNodes)(c,function(a){d.append(a)},{futureParentElement:d})):(d.html(f.template),a(d.contents())(c))}}}],te=La({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),
Fe=function(){return{restrict:"A",priority:100,require:"ngModel",link:function(a,c,d,e){var f=c.attr(d.$attr.ngList)||", ",h="false"!==d.ngTrim,g=h?V(f):f;e.$parsers.push(function(a){if(!D(a)){var c=[];a&&n(a.split(g),function(a){a&&c.push(h?V(a):a)});return c}});e.$formatters.push(function(a){return C(a)?a.join(f):u});e.$isEmpty=function(a){return!a||!a.length}}}},ib="ng-valid",Dd="ng-invalid",Qa="ng-pristine",Gb="ng-dirty",Fd="ng-pending",Ib=new H("ngModel"),lg=["$scope","$exceptionHandler","$attrs",
...
A=null,v,p=this;this.$$setOptions=function(a){if((p.$options=a)&&a.getterSetter){var c=f(d.ngModel+"()"),g=f(d.ngModel+"($$$p)");t=function(a){var d=q(a);G(d)&&(d=c(a));return d};s=function(a,c){G(q(a))?g(a,{$$$p:p.$modelValue}):r(a,p.$modelValue)}}else if(!q.assign)throw Ib("nonassign",d.ngModel,ua(e));};this.$render=w;this.$isEmpty=function(a){return D(a)||""===a||null===a||a!==a};var y=e.inheritedData("$formController")||Fb,E=0;Ad({ctrl:this,$element:e,set:function(a,c){a[c]=!0},unset:function(a,
...
Ee=["$rootScope",function(a){return{restrict:"A",require:["ngModel","^?form","^?ngModelOptions"],controller:lg,priority:1,compile:function(c){c.addClass(Qa).addClass("ng-untouched").addClass(ib);return{pre:function(a,c,f,h){var g=h[0],l=h[1]||Fb;g.$$setOptions(h[2]&&h[2].$options);l.$addControl(g);f.$observe("name",function(a){g.$name!==a&&l.$$renameControl(g,a)});a.$on("$destroy",function(){l.$removeControl(g)})},post:function(c,e,f,h){var g=h[0];if(g.$options&&g.$options.updateOn)e.on(g.$options.updateOn,
function(a){g.$$debounceViewValueCommit(a&&a.type)});e.on("blur",function(e){g.$touched||(a.$$phase?c.$evalAsync(g.$setTouched):c.$apply(g.$setTouched))})}}}}}],mg=/(\s+|^)default(\s+|$)/,Ie=function(){return{restrict:"A",controller:["$scope","$attrs",function(a,c){var d=this;this.$options=ta(a.$eval(c.ngModelOptions));this.$options.updateOn!==u?(this.$options.updateOnDefault=!1,this.$options.updateOn=V(this.$options.updateOn.replace(mg,function(){d.$options.updateOnDefault=!0;return" "}))):this.$options.updateOnDefault=
!0}]}},ue=La({terminal:!0,priority:1E3}),ng=H("ngOptions"),og=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,Ce=["$compile","$parse",function(a,c){function d(a,d,e){function f(a,c,d,e,g){this.selectValue=a;this.viewValue=c;this.label=d;this.group=e;this.disabled=g}var m=a.match(og);if(!m)throw ng("iexp",a,ua(d));
...
l=f.$viewValue});f.$isEmpty=function(a){return!a||0===a.length}}}}}},ge=["$interpolate",function(a){function c(a){a[0].hasAttribute("selected")&&(a[0].selected=!0)}return{restrict:"E",priority:100,compile:function(d,e){if(D(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),m=k.data("$selectController")||k.parent().data("$selectController");m&&m.ngModelCtrl&&(f?a.$watch(f,function(a,f){e.$set("value",a);f!==a&&m.removeOption(f);m.addOption(a,d);m.ngModelCtrl.$render();
c(d)}):(m.addOption(e.value,d),m.ngModelCtrl.$render(),c(d)),d.on("$destroy",function(){m.removeOption(e.value);m.ngModelCtrl.$render()}))}}}}],fe=oa({restrict:"E",terminal:!1}),Bc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){e&&(d.required=!0,e.$validators.required=function(a,c){return!d.required||!e.$isEmpty(c)},d.$observe("required",function(){e.$validate()}))}}},Ac=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f,h=d.ngPattern||d.pattern;
d.$observe("pattern",function(a){I(a)&&0<a.length&&(a=new RegExp("^"+a+"$"));if(a&&!a.test)throw H("ngPattern")("noregexp",h,a,ua(c));f=a||u;e.$validate()});e.$validators.pattern=function(a){return e.$isEmpty(a)||D(f)||f.test(a)}}}}},Dc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f=-1;d.$observe("maxlength",function(a){a=ba(a);f=isNaN(a)?-1:a;e.$validate()});e.$validators.maxlength=function(a,c){return 0>f||e.$isEmpty(c)||c.length<=f}}}}},Cc=function(){return{restrict:"A",
require:"?ngModel",link:function(a,c,d,e){if(e){var f=0;d.$observe("minlength",function(a){f=ba(a)||0;e.$validate()});e.$validators.minlength=function(a,c){return e.$isEmpty(c)||c.length>=f}}}}};O.angular.bootstrap?console.log("WARNING: Tried to load angular more than once."):(Wd(),Yd($),A(Y).ready(function(){Sd(Y,uc)}))})(window,document);!window.angular.$$csp()&&window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>');
