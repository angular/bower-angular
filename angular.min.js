/*
 ...
 License: MIT
*/
(function(M,T,r){'use strict';function B(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.0-build.2692+sha.7f5e0f0/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function fb(b){if(null==
...
function U(b){return parseInt(b,10)}function ac(b,a){return F(new (F(function(){},{prototype:b})),a)}function w(){}function Ea(b){return b}function ca(b){return function(){return b}}function I(b){return"undefined"===typeof b}function C(b){return"undefined"!==typeof b}function V(b){return null!=b&&"object"===typeof b}function y(b){return"string"===typeof b}function Fa(b){return"number"===typeof b}function pa(b){return"[object Date]"===xa.call(b)}function N(b){return"[object Array]"===xa.call(b)}function P(b){return"function"===
typeof b}function hb(b){return"[object RegExp]"===xa.call(b)}function Da(b){return b&&b.document&&b.location&&b.alert&&b.setInterval}function fd(b){return!(!b||!(b.nodeName||b.prop&&b.attr&&b.find))}function gd(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function hd(b,a,c){var d=[];q(b,function(b,f,h){d.push(a.call(c,b,f,h))});return d}function ib(b,a){if(b.indexOf)return b.indexOf(a);for(var c=0;c<b.length;c++)if(a===b[c])return c;return-1}function Ga(b,a){var c=ib(b,
...
function(b){q(b,function(b){a.push(b)});d()}}function lb(b,a){a=a||"_";return b.replace(ld,function(b,d){return(d?a:"")+b.toLowerCase()})}function md(){var b;(Aa=M.jQuery)?(E=Aa,F(Aa.fn,{scope:Ha.scope,isolateScope:Ha.isolateScope,controller:Ha.controller,injector:Ha.injector,inheritedData:Ha.inheritedData}),b=Aa.cleanData,b=b.$$original||b,Aa.cleanData=function(a){for(var c=0,d;null!=(d=a[c]);c++)Aa(d).triggerHandler("$destroy");b(a)},Aa.cleanData.$$original=b):E=W;Sa.element=E}function Fb(b,a,c){if(!b)throw Qa("areq",
a||"?",c||"required");return b}function Ta(b,a,c){c&&N(b)&&(b=b[b.length-1]);Fb(P(b),a,"not a function, got "+(b&&"object"==typeof b?b.constructor.name||"Object":typeof b));return b}function Ba(b,a){if("hasOwnProperty"===b)throw Qa("badname",a);}function ic(b,a,c){if(!a)return b;a=a.split(".");for(var d,e=b,f=a.length,h=0;h<f;h++)d=a[h],b&&(b=(e=b)[d]);return!c&&P(b)?jb(e,b):b}function Gb(b){var a=b[0];b=b[b.length-1];if(a===b)return E(a);var c=[a];do{a=a.nextSibling;if(!a)break;c.push(a)}while(a!==
b);return E(c)}function nd(b){var a=B("$injector"),c=B("ng");b=b.angular||(b.angular={});b.$$minErr=b.$$minErr||B;return b.module||(b.module=function(){var b={};return function(e,f,h){if("hasOwnProperty"===e)throw c("badname","module");f&&b.hasOwnProperty(e)&&(b[e]=null);return b[e]||(b[e]=function(){function b(a,d,e,f){f||(f=c);return function(){f[e||"push"]([a,d,arguments]);return m}}if(!f)throw a("nomod",e);var c=[],d=[],l=[],n=b("$injector","invoke","push",d),m={_invokeQueue:c,_configBlocks:d,
_runBlocks:l,requires:f,name:e,provider:b("$provide","provider"),factory:b("$provide","factory"),service:b("$provide","service"),value:b("$provide","value"),constant:b("$provide","constant","unshift"),animation:b("$animateProvider","register"),filter:b("$filterProvider","register"),controller:b("$controllerProvider","register"),directive:b("$compileProvider","directive"),config:n,run:function(a){l.push(a);return this}};h&&n(h);return m}())}}())}function od(b){F(b,{bootstrap:hc,copy:da,extend:F,equals:ya,
element:E,forEach:q,injector:Eb,noop:w,bind:jb,toJson:ra,fromJson:dc,identity:Ea,isUndefined:I,isDefined:C,isString:y,isFunction:P,isObject:V,isNumber:Fa,isElement:fd,isArray:N,version:pd,isDate:pa,lowercase:z,uppercase:Ia,callbacks:{counter:0},$$minErr:B,$$csp:cc});Ua=nd(M);try{Ua("ngLocale")}catch(a){Ua("ngLocale",[]).provider("$locale",qd)}Ua("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:rd});a.provider("$compile",jc).directive({a:sd,input:kc,textarea:kc,form:td,script:ud,
...
!e&&b?c(f,m,k,d,L(a,l||b)):c(f,m,k,d,e)):f&&f(a,k.childNodes,r,e)}for(var h=[],k,l,m,n,s=0;s<a.length;s++)k=new Nb,l=S(a[s],[],k,0===s?d:r,e),(f=l.length?ea(l,a[s],k,b,c,null,[],[],f):null)&&f.scope&&O(E(a[s]),"ng-scope"),k=f&&f.terminal||!(m=a[s].childNodes)||!m.length?null:R(m,f?f.transclude:b),h.push(f,k),n=n||f||k,f=null;return n?g:null}function L(a,b){return function(c,d,e){var f=!1;c||(c=a.$new(),f=c.$$transcluded=!0);d=b(c,d,e);if(f)d.on("$destroy",jb(c,c.$destroy));return d}}function S(a,
b,c,d,g){var h=c.$attr,k;switch(a.nodeType){case 1:C(b,ma(Ma(a).toLowerCase()),"E",d,g);var l,m,n;k=a.attributes;for(var s=0,A=k&&k.length;s<A;s++){var D=!1,t=!1;l=k[s];if(!X||8<=X||l.specified){m=l.name;n=ma(m);sa.test(n)&&(m=lb(n.substr(6),"-"));var J=n.replace(/(Start|End)$/,"");n===J+"Start"&&(D=m,t=m.substr(0,m.length-5)+"end",m=m.substr(0,m.length-6));n=ma(m.toLowerCase());h[n]=m;c[n]=l=aa(l.value);uc(a,n)&&(c[n]=!0);Q(a,b,l,n);C(b,n,"A",d,g,D,t)}}a=a.className;if(y(a)&&""!==a)for(;k=f.exec(a);)n=
...
Q=Ac(Q),H.replace){g=H;Q=Ib.test(Q)?E(W(H.type,aa(Q))):[];c=Q[0];if(1!=Q.length||1!==c.nodeType)throw ja("tplrt",F,"");sb(f,K,c);sa={$attr:{}};Q=S(c,[],sa);var X=a.splice(M+1,a.length-(M+1));L&&rb(Q);a=a.concat(Q).concat(X);w(d,sa);sa=a.length}else K.html(Q);if(H.templateUrl)$a("template",R,H,K),R=H,H.replace&&(g=H),D=I(a.splice(M,a.length-M),K,d,f,z,h,k,{controllerDirectives:G,newIsolateScopeDirective:L,templateDirective:R,nonTlbTranscludeDirective:ea}),sa=a.length;else if(H.compile)try{B=H.compile(K,
d,z),P(B)?s(null,B,Za,U):B&&s(B.pre,B.post,Za,U)}catch(Y){n(Y,ia(K))}H.terminal&&(D.terminal=!0,x=Math.max(x,H.priority))}D.scope=v&&!0===v.scope;D.transclude=C&&z;m.hasElementTranscludeDirective=Na;return D}function rb(a){for(var b=0,c=a.length;b<c;b++)a[b]=ac(a[b],{$$isolateScope:!0})}function C(b,e,f,g,h,l,m){if(e===h)return null;h=null;if(c.hasOwnProperty(e)){var s;e=a.get(e+d);for(var A=0,D=e.length;A<D;A++)try{s=e[A],(g===r||g>s.priority)&&-1!=s.restrict.indexOf(f)&&(l&&(s=ac(s,{$$start:l,$$end:m})),
...
b.hasOwnProperty(g)?b[g]:ic(f.$scope,g,!0)||ic(d,g,!0),Ta(e,g,!0));h=c.instantiate(e,f,g);if(p){if(!f||"object"!=typeof f.$scope)throw B("$controller")("noscp",g||e.name,p);f.$scope[p]=h}return h}}]}function fe(){this.$get=["$window",function(b){return E(b.document)}]}function ge(){this.$get=["$log",function(b){return function(a,c){b.error.apply(b,arguments)}}]}function Cc(b){var a={},c,d,e;if(!b)return a;q(b.split("\n"),function(b){e=b.indexOf(":");c=z(aa(b.substr(0,e)));d=aa(b.substr(e+1));c&&(a[c]=
a[c]?a[c]+(", "+d):d)});return a}function Dc(b){var a=V(b)?b:r;return function(c){a||(a=Cc(b));return c?a[z(c)]||null:a}}function Ec(b,a,c){if(P(c))return c(b,a);q(c,function(c){b=c(b,a)});return b}function je(){var b=/^\s*(\[|\{[^\{])/,a=/[\}\]]\s*$/,c=/^\)\]\}',?\n/,d={"Content-Type":"application/json;charset=utf-8"},e=this.defaults={transformResponse:[function(d){y(d)&&(d=d.replace(c,""),b.test(d)&&a.test(d)&&(d=dc(d)));return d}],transformRequest:[function(a){return V(a)&&"[object File]"!==xa.call(a)&&
...
if(l&&q&&(v||1<A.length))throw Fc("noconcat",f);if(!k||q){Z.length=J.length+A.length;var L=function(a){for(var b=0,c=A.length;b<c;b++)Z[2*b]=J[b],Z[2*b+1]=a[b];Z[2*c]=J[c];return Z.join("")},S=function(a){return a=l?e.getTrusted(l,a):e.valueOf(a)},u=function(a){if(I(a)||null===a)a="";"string"!=typeof a&&(a=ra(a));return a};return F(function(a){var b=a&&a.$id||"notAScope",c=O[b],e=R[b],g=0,h=A.length,k=Array(h),l,m=e===r?!0:!1;c||(c=[],m=!0,a&&a.$on&&a.$on("$destroy",function(){O[b]=null;R[b]=null}));
...
fullDate:"EEEE, MMMM d, y",longDate:"MMMM d, y",mediumDate:"MMM d, y",shortDate:"M/d/yy",mediumTime:"h:mm:ss a",shortTime:"h:mm a"},pluralCat:function(b){return 1===b?"one":"other"}}}}function Pb(b){b=b.split("/");for(var a=b.length;a--;)b[a]=kb(b[a]);return b.join("/")}function Gc(b,a,c){b=ta(b,c);a.$$protocol=b.protocol;a.$$host=b.hostname;a.$$port=U(b.port)||Oe[b.protocol]||null}function Hc(b,a,c){var d="/"!==b.charAt(0);d&&(b="/"+b);b=ta(b,c);a.$$path=decodeURIComponent(d&&"/"===b.pathname.charAt(0)?
b.pathname.substring(1):b.pathname);a.$$search=fc(b.search);a.$$hash=decodeURIComponent(b.hash);a.$$path&&"/"!=a.$$path.charAt(0)&&(a.$$path="/"+a.$$path)}function na(b,a){if(0===a.indexOf(b))return a.substr(b.length)}function ab(b){var a=b.indexOf("#");return-1==a?b:b.substr(0,a)}function Qb(b){return b.substr(0,ab(b).lastIndexOf("/")+1)}function Ic(b,a){this.$$html5=!0;a=a||"";var c=Qb(b);Gc(b,this,b);this.$$parse=function(a){var e=na(c,a);if(!y(e))throw Rb("ipthprfx",a,c);Hc(e,this,b);this.$$path||
...
h.toString()&&(h=ta(h.animVal).href);if(p===Tb){var k=e.attr("href")||e.attr("xlink:href");if(0>k.indexOf("://"))if(h="#"+b,"/"==k[0])h=n+h+k;else if("#"==k[0])h=n+h+(g.path()||"/")+k;else{for(var l=g.path().split("/"),k=k.split("/"),m=0;m<k.length;m++)"."!=k[m]&&(".."==k[m]?l.pop():k[m].length&&l.push(k[m]));h=n+h+l.join("/")}}l=g.$$rewrite(h);h&&(!e.attr("target")&&l&&!a.isDefaultPrevented())&&(a.preventDefault(),l!=d.url()&&(g.$$parse(l),c.$apply(),M.angular["ff-684208-preventDefault"]=!0))}});
...
k)return k;k=k[b];if(!a)return k;if(null==k)return r;k=k[a];if(!c)return k;if(null==k)return r;k=k[c];if(!d)return k;if(null==k)return r;k=k[d];return e?null==k?r:k=k[e]:k}}function Pe(b,a){ga(b,a);return function(a,d){return null==a?r:(d&&d.hasOwnProperty(b)?d:a)[b]}}function Qe(b,a,c){ga(b,c);ga(a,c);return function(c,e){if(null==c)return r;c=(e&&e.hasOwnProperty(b)?e:c)[b];return null==c?r:c[a]}}function Lc(b,a,c){if(Ub.hasOwnProperty(b))return Ub[b];var d=b.split("."),e=d.length,f;if(a.unwrapPromises||
1!==e)if(a.unwrapPromises||2!==e)if(a.csp)f=6>e?Kc(d[0],d[1],d[2],d[3],d[4],c,a):function(b,f){var g=0,h;do h=Kc(d[g++],d[g++],d[g++],d[g++],d[g++],c,a)(b,f),f=r,b=h;while(g<e);return h};else{var h="var p;\n";q(d,function(b,d){ga(b,c);h+="if(s == null) return undefined;\ns="+(d?"s":'((k&&k.hasOwnProperty("'+b+'"))?k:s)')+'["'+b+'"];\n'+(a.unwrapPromises?'if (s && s.then) {\n pw("'+c.replace(/(["\r\n])/g,"\\$1")+'");\n if (!("$$v" in s)) {\n p=s;\n p.$$v = undefined;\n p.then(function(v) {p.$$v=v;});\n}\n s=s.$$v\n}\n':
"")});var h=h+"return s;",g=new Function("s","k","pw",h);g.toString=ca(h);f=a.unwrapPromises?function(a,b){return g(a,b,ua)}:g}else f=Qe(d[0],d[1],c);else f=Pe(d[0],c);"hasOwnProperty"!==b&&(Ub[b]=f);return f}function ne(){var b={},a={csp:!1,unwrapPromises:!1,logPromiseWarnings:!0};this.unwrapPromises=function(b){return C(b)?(a.unwrapPromises=!!b,this):a.unwrapPromises};this.logPromiseWarnings=function(b){return C(b)?(a.logPromiseWarnings=b,this):a.logPromiseWarnings};this.$get=["$filter","$sniffer",
"$log",function(c,d,e){a.csp=d.csp;ua=function(b){a.logPromiseWarnings&&!Mc.hasOwnProperty(b)&&(Mc[b]=!0,e.warn("[$parse] Promise found in the expression `"+b+"`. Automatic unwrapping of promises in Angular expressions is deprecated."))};return function(d){var e;switch(typeof d){case "string":if(b.hasOwnProperty(d))return b[d];e=new Vb(a);e=(new cb(e,c,a)).parse(d,!1);"hasOwnProperty"!==d&&(b[d]=e);return e;case "function":return d;default:return w}}}]}function pe(){this.$get=["$rootScope","$exceptionHandler",
...
b)return b;if(y(b)){if(-1<b.indexOf("***"))throw va("iwcard",b);b=b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08").replace("\\*\\*",".*").replace("\\*","[^:/.?&;]*");return RegExp("^"+b+"$")}if(hb(b))return RegExp("^"+b.source+"$");throw va("imatcher");}function Oc(b){var a=[];C(b)&&q(b,function(b){a.push(Se(b))});return a}function re(){this.SCE_CONTEXTS=ha;var b=["self"],a=[];this.resourceUrlWhitelist=function(a){arguments.length&&(b=Oc(a));return b};this.resourceUrlBlacklist=
function(b){arguments.length&&(a=Oc(b));return a};this.$get=["$injector",function(c){function d(a){var b=function(a){this.$$unwrapTrustedValue=function(){return a}};a&&(b.prototype=new a);b.prototype.valueOf=function(){return this.$$unwrapTrustedValue()};b.prototype.toString=function(){return this.$$unwrapTrustedValue().toString()};return b}var e=function(a){throw va("unsafe");};c.has("$sanitize")&&(e=c.get("$sanitize"));var f=d(),h={};h[ha.HTML]=d(f);h[ha.CSS]=d(f);h[ha.URL]=d(f);h[ha.JS]=d(f);h[ha.RESOURCE_URL]=
d(h[ha.URL]);return{trustAs:function(a,b){var c=h.hasOwnProperty(a)?h[a]:null;if(!c)throw va("icontext",a,b);if(null===b||b===r||""===b)return b;if("string"!==typeof b)throw va("itype",a);return new c(b)},getTrusted:function(c,d){if(null===d||d===r||""===d)return d;var f=h.hasOwnProperty(c)?h[c]:null;if(f&&d instanceof f)return d.$$unwrapTrustedValue();if(c===ha.RESOURCE_URL){var f=ta(d.toString()),l,n,m=!1;l=0;for(n=b.length;l<n;l++)if("self"===b[l]?Ob(f):b[l].exec(f.href)){m=!0;break}if(m)for(l=
0,n=a.length;l<n;l++)if("self"===a[l]?Ob(f):a[l].exec(f.href)){m=!1;break}if(m)return d;throw va("insecurl",d.toString());}if(c===ha.HTML)return e(d);throw va("unsafe");},valueOf:function(a){return a instanceof f?a.$$unwrapTrustedValue():a}}}]}function qe(){var b=!0;this.enabled=function(a){arguments.length&&(b=!!a);return b};this.$get=["$parse","$sniffer","$sceDelegate",function(a,c,d){if(b&&c.msie&&8>c.msieDocumentMode)throw va("iequirks");var e=da(ha);e.isEnabled=function(){return b};e.trustAs=
...
V(b))return"";var f=0>b;b=Math.abs(b);var h=b+"",g="",p=[],k=!1;if(-1!==h.indexOf("e")){var l=h.match(/([\d\.]+)e(-?)(\d+)/);l&&"-"==l[2]&&l[3]>e+1?h="0":(g=h,k=!0)}if(k)0<e&&(-1<b&&1>b)&&(g=b.toFixed(e));else{h=(h.split(Vc)[1]||"").length;I(e)&&(e=Math.min(Math.max(a.minFrac,h),a.maxFrac));h=Math.pow(10,e);b=Math.round(b*h)/h;b=(""+b).split(Vc);h=b[0];b=b[1]||"";var l=0,n=a.lgSize,m=a.gSize;if(h.length>=n+m)for(l=h.length-n,k=0;k<l;k++)0===(l-k)%m&&0!==k&&(g+=c),g+=h.charAt(k);for(k=l;k<h.length;k++)0===
...
a.length;p++){var k=a[p];e[k.key]=k.value(c,d)}return e},{literal:!0,constant:c})}};var Ub={},va=B("$sce"),ha={HTML:"html",CSS:"css",URL:"url",RESOURCE_URL:"resourceUrl",JS:"js"},Y=T.createElement("a"),Pc=ta(M.location.href,!0);nc.$inject=["$provide"];Qc.$inject=["$locale"];Sc.$inject=["$locale"];var Vc=".",$e={yyyy:$("FullYear",4),yy:$("FullYear",2,0,!0),y:$("FullYear",1),MMMM:xb("Month"),MMM:xb("Month",!0),MM:$("Month",2,1),M:$("Month",1,1),dd:$("Date",2),d:$("Date",1),HH:$("Hours",2),H:$("Hours",
...
ca(z),Xe=ca(Ia);Tc.$inject=["$parse"];var sd=ca({restrict:"E",compile:function(a,c){8>=X&&(c.href||c.name||c.$set("href",""),a.append(T.createComment("IE fix")));if(!c.href&&!c.xlinkHref&&!c.name)return function(a,c){var f="[object SVGAnimatedString]"===xa.call(c.prop("href"))?"xlink:href":"href";c.on("click",function(a){c.attr(f)||a.preventDefault()})}}}),Hb={};q(qb,function(a,c){if("multiple"!=a){var d=ma("ng-"+c);Hb[d]=function(){return{priority:100,link:function(a,f,h){a.$watch(h[d],function(a){h.$set(c,
...
function(c){e.html(a.getTrustedHtml(h(d))||"")})}}],Bd=Wb("",!0),Dd=Wb("Odd",0),Cd=Wb("Even",1),Ed=wa({compile:function(a,c){c.$set("ngCloak",r);a.removeClass("ng-cloak")}}),Fd=[function(){return{scope:!0,controller:"@",priority:500}}],mc={};q("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=ma("ng-"+a);mc[c]=["$parse",function(d){return{compile:function(e,f){var h=d(f[c]);return function(c,
